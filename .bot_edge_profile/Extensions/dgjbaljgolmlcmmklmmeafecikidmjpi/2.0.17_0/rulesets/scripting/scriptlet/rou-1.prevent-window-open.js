!function() {
    function t(t = "", n = "", r = "") {
        const s = function() {
            ...
            return e;
        }(), i = s.makeLogPrefix("no-window-open-if", t, n, r), c = !1 === t.startsWith("!");
        !1 === c && (t = t.slice(1));
        const l = s.patternToRegex(t), a = 1e3 * (parseFloat(n) || 0), p = self.setTimeout, g = function(t, e, o) {
            const n = document.createElement(t);
            return n[e] = o, n.style.setProperty("height", "1px", "important"), n.style.setProperty("position", "fixed", "important"), 
        ...
        e("open", (function(e) {
            ...
            const {callArgs: o} = e, u = o.join(" ");
            if (l.test(u) !== c) return s.logLevel > 1 && s.uboLog(i, `Allowed (${o.join(", ")})`), 
            e.reflect();
            if (s.uboLog(i, `Prevented (${o.join(", ")})`), "" === n) return null;
            if ("blank" === r) {
                o[0] = "about:blank";
                const t = e.reflect();
                return p((() => {
            ...
            return "object" == typeof h && null !== h ? Object.defineProperty(h, "closed", {
                ...
                get: function(t, e, ...o) {
                    const n = Reflect.get(t, e, ...o);
                    return s.uboLog(i, `popup / get ${e} === ${n}`), "function" == typeof n ? (...e) => n.call(t, ...e) : n;
                },
                set: function(t, e, o, ...n) {
                    return s.uboLog(i, `popup / set ${e} = ${o}`), Reflect.set(t, e, o, ...n);
                }
            })), h;
        }));
    }
    function e(t = "", o = "") {
        ...
        s.prototype?.constructor === s && (l.construct = function(t, n) {
            return o(e.CtorContext.factory(t, n));
        }), n[r] = new Proxy(s, l);
    }
    const o = {}, n = [ [], [ "", "10" ] ], r = new Map([ [ "nosteam.ro", 0 ], [ "nosteamgames.ro", 0 ], [ "posturi.live", 0 ], [ "filmeserialegratis.*", 0 ], [ "fsplayer.*", 0 ], [ "vzlinks.com", 0 ], [ "onlyplay.online", 1 ] ]), s = new Map([]), i = (t, e, o) => {
        let n = e.get(t);
    ...
    ((t, e = "") => {
        ...
        if (0 !== n) {
            ...
            {
                const t = n - 1;
                for (let n = 0; n < t; n++) for (let c = t; c > n; c--) {
                    const t = `${o.slice(n, c).join(".")}.*${e}`;
                    i(t, r, a), i(t, s, p);
                }
            }
        }
