!function() {
    ...
    const t = {}, n = [ [ "/^ev_did|ev_sid/", "$remove$" ], [ "marketingConsent", "false" ], [ "necessaryConsent", "true" ], [ "personalisationConsent", "false" ] ], r = new Map([ [ "synonymer.se", 0 ], [ "webhallen.com", [ 1, 2, 3 ] ] ]), o = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
