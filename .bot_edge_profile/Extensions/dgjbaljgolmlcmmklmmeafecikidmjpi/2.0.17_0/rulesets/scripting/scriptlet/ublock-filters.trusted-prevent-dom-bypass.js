!function() {
    function t(t = "", o = "") {
        ...
        const r = function() {
            ...
            return e;
        }(), i = r.makeLogPrefix("trusted-prevent-dom-bypass", t, o);
        e(t, (function(t) {
            const e = new Set(t.callArgs.filter((t => t instanceof HTMLElement))), n = t.reflect();
            if (0 === e.length) return n;
            for (const t of e) try {
                if ("[object Window]" != `${t.contentWindow}`) continue;
                if ("about:blank" !== t.contentWindow.location.href && t.contentWindow.location.href !== self.location.href) continue;
                if ("" !== o) {
                    let e = self, n = t.contentWindow, r = o;
                    for (;;) {
                        const t = r.indexOf(".");
                        if (-1 === t) break;
                        const o = r.slice(0, t);
                        e = e[o], n = n[o], r = r.slice(t + 1);
                    }
                    n[r] = e[r];
                } else Object.defineProperty(t, "contentWindow", {
                    value: self
                });
                r.uboLog(i, "Bypass prevented");
            } catch {}
            return n;
        }));
    }
    ...
    const n = {}, o = [ [ "Node.prototype.appendChild", "fetch" ], [ "Node.prototype.appendChild", "Request" ], [ "Node.prototype.appendChild", "JSON.parse" ] ], r = new Map([ [ "www.youtube.com", [ 0, 1, 2 ] ] ]), i = new Map([]), s = (t, e, n) => {
        let o = e.get(t);
