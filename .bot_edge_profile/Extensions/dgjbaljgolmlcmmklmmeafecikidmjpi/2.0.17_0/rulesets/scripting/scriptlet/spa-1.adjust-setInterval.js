    ...
    function e(e = "", n = "", r = "") {
        ...
        a = !1 === isNaN(a) && isFinite(a) ? Math.min(Math.max(a, .001), 50) : .05, self.setInterval = new Proxy(self.setInterval, {
            apply: function(e, t, n) {
                const [r, o] = n;
                return -1 !== i && o !== i || !s.test(r.toString()) || (n[1] = o * a), e.apply(t, n);
            }
        });
    }
    const t = {}, n = [ [ "seconds", "*", "0.001" ], [ "getid", "*", "0.001" ], [ "countdown", "*", "0.001" ], [ ".style.display", "*", "0.02" ], [ "Loading...", "", "0.02" ], [ "adsHandle_noclick", "", "0.02" ], [ "start_preroll", "*", "0.001" ] ], r = new Map([ [ "fgtd.online", 0 ], [ "infohojeonline.blogspot.com", 1 ], [ "xupalace.org", 2 ], [ "player.cuevana3.*", 2 ], [ "player.gnula.*", 2 ], [ "player.poseidonhd2.co", 2 ], [ "player.cuevana2espanol.*", 2 ], [ "player.cuevana.*", 2 ], [ "sejasaudavel.net", 3 ], [ "cuevana-3.wtf", 4 ], [ "topflix.*", 5 ], [ "compucalitv.tv", 6 ] ]), o = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
