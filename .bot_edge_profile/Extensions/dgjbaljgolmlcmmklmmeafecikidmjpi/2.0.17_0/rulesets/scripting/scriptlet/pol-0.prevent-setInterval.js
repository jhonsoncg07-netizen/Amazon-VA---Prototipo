!function() {
    function t(t = "", o = "") {
        const i = function() {
            ...
            return e;
        }(), s = i.makeLogPrefix("prevent-setInterval", t, o), c = "!" === t.charAt(0), a = i.patternToRegex(c ? t.slice(1) : t), l = new n(o);
        e("setInterval", (function(e) {
            const {callArgs: n} = e, r = n[0] instanceof Function ? i.String(i.Function_toString(n[0])) : i.String(n[0]), o = n[1];
            return "" === t && l.unbound() ? (i.uboLog(s, `Called:\n${r}\n${o}`), e.reflect()) : (a.test(r) !== c && l.test(o) && (n[0] = function() {}, 
    ...
    const r = {}, o = [ [ 'function neTick(){neTickCounter++;if(neTickCounter<=neTickCountLimit){neTickAjax=$.ajax({type:"POST"', 'url:adminAjaxUrl+"?action=ne_tick"', 'dataType:"json"', "success:function(data){neTickResponseAction(data)}})}}", "10000" ] ], i = new Map([ [ "naekranie.pl", 0 ] ]), s = new Map([]), c = (t, e, n) => {
        let r = e.get(t);
