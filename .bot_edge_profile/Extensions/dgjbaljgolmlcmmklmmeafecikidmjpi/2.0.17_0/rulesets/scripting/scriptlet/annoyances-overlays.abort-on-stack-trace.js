!function() {
    function e(e = "", r = "") {
        ...
        const i = n(), c = i.initPattern(r, {
            canNegate: !0
        }), s = i.getExtraArgs(Array.from(arguments), 2);
        "" === r && (s.log = "all");
        const a = function(e, n) {
            ...
            if (-1 === r) {
                ...
                return void Object.defineProperty(e, n, {
                    get: function() {
                        const e = i.logLevel > 1 ? "all" : "match";
                        if (o(c, e)) throw new ReferenceError(t());
                        return r;
                    },
                    set: function(e) {
                        const n = i.logLevel > 1 ? "all" : "match";
                        if (o(c, n)) throw new ReferenceError(t());
                        r = e;
                    }
                });
            }
            const s = n.slice(0, r);
            let l = e[s];
            if (n = n.slice(r + 1), l) return void a(l, n);
            const g = Object.getOwnPropertyDescriptor(e, s);
            g && void 0 !== g.set || Object.defineProperty(e, s, {
                get: function() {
                    return l;
                },
                set: function(e) {
                    l = e, e instanceof Object && a(e, n);
                }
            });
        }, l = window;
        a(l, e);
    ...
    function o(e, o = "") {
        const r = n(), i = t(), c = new r.Error(i), s = new URL(self.location.href);
        s.hash = "";
        const a = /(.*?@)?(\S+)(:\d+):\d+\)?$/, l = [];
        for (let e of r.String_split.call(c.stack, /[\n\r]+/)) {
        ...
        const g = l.join("\t"), d = !0 !== e.matchAll && r.testPattern(e, g);
        return ("all" === o || "match" === o && d || "nomatch" === o && !d) && r.uboLog(g.replace(/\t/g, "\n")), 
        d;
    }
    function n() {
    ...
    const r = {}, i = [ [ "encodeURIComponent", "inlineScript" ], [ "String.prototype.charCodeAt", "ai_" ], [ "Drupal.CTools.Modal.show", "/(^(?!.*(injectedScript|makeProxy).*))/" ], [ "getSelection", "quoty-public" ], [ "document.createElement", "createAdblockFallbackSubscribeToProtopageAdDiv" ], [ "document.getElementById", "nouplaod" ], [ "document.oncontextmenu" ], [ "Object", "/(?=^(?!.*(jquery|inlineScript)))/" ], [ "document.createElement", "admiral" ], [ "eval", "build.js" ], [ "navigator.userAgent", "phimv" ], [ "console.clear" ], [ "document.addEventListener", "preventDeleteDialog" ], [ "Promise", "/isEnable|isOpen/" ], [ "$", "/mainseto.js:286:1" ], [ "document.getSelection", "inlineScript" ], [ "player.pause", "/stackDepth:(9|10).+https:[./0-9a-z]+\\/video\\.[0-9a-f]+\\.js:1\\d{2}:1.+\\.emit/" ] ], c = new Map([ [ "secondlifetranslations.com", 0 ], [ "waves4you.com", 1 ], [ "timeshighereducation.com", 2 ], [ "ilovefreesoftware.com", 3 ], [ "protopage.com", 4 ], [ "fantasytagtree.com", 5 ], [ "jamilacuisine.ro", [ 6, 7 ] ], [ "golfdigest.com", 8 ], [ "pobre.*", 9 ], [ "ophim.vip", 10 ], [ "aniwave.*", 11 ], [ "anix.*", 11 ], [ "flixhq.*", 11 ], [ "fmovies.*", 11 ], [ "f2movies.ru", 11 ], [ "hdtoday.so", 11 ], [ "hurawatch.bz", 11 ], [ "movies2watch.ru", 11 ], [ "putlockernew.vc", 11 ], [ "vidplay.site", 11 ], [ "vid2faf.site", 11 ], [ "vidstream.pro", 11 ], [ "mcloud.to", 11 ], [ "team-octavi.com", 12 ], [ "embtaku.pro", 13 ], [ "indahonline.com", 14 ], [ "tweaktown.com", 15 ], [ "bilibili.com", 16 ] ]), s = new Map([]), a = (e, t, o) => {
        let n = t.get(e);
