!function() {
    function e(...e) {
        !function(e = !1, r = "", n = "") {
            if ("" === r) return;
            const o = t(), i = o.makeLogPrefix("set-constant", r, n), c = o.getExtraArgs(Array.from(arguments), 3);
            function s(r, n) {
                const s = (() => {
                ...
                let u = function(e, r, n = {}) {
                    ...
                    if ("undefined" === r) i = void 0; else if ("false" === r) i = !1; else if ("true" === r) i = !0; else if ("null" === r) i = null; else if ("''" === r || "" === r) i = ""; else if ("[]" === r || "emptyArr" === r) i = []; else if ("{}" === r || "emptyObj" === r) i = {}; else if ("noopFunc" === r) i = function() {}; else if ("trueFunc" === r) i = function() {
                        ...
                        if (r.startsWith("json:")) try {
                            i = o.JSON_parse(r.slice(5));
                        } catch {
                            return;
                        } else if (r.startsWith("{") && r.endsWith("}")) try {
                            i = o.JSON_parse(r).value;
                        } catch {
                            return;
                        }
                    }
                ...
                "noopFunc" !== n && "trueFunc" !== n && "falseFunc" !== n || (u = (e => (o.Object_defineProperty(e, "name", {
                    value: s
                }), new Proxy(e, {
                    defineProperty(e, t) {
                ...
                let f = !1;
                const d = function(t) {
                    return !e && (!!f || (f = null != t && null != u && typeof t != typeof u, f && o.uboLog(i, `Aborted because value set to ${t}`), 
                    f));
                }, p = function(e, t, r, n) {
                    if (!1 === n.init(r ? e[t] : u)) return;
                    const c = o.Object_getOwnPropertyDescriptor(e, t);
                    let s, a;
                    c instanceof o.Object && (e[t] = u, c.get instanceof Function && (s = c.get), c.set instanceof Function && (a = c.set));
                    try {
                        o.Object_defineProperty(e, t, {
                            configurable: r,
                            get: () => (void 0 !== s && s(), n.getter()),
                            set(e) {
                                void 0 !== a && a(e), n.setter(e);
                            }
                    ...
                    const r = t.indexOf(".");
                    if (-1 === r) return void p(e, t, !1, {
                        v: void 0,
                        init: function(e) {
                            return !d(e) && (this.v = e, !0);
                        },
                        getter: function() {
                            return document.currentScript === l ? this.v : (o.uboLog(i, "Property read"), u);
                        },
                        setter: function(e) {
                            !1 !== d(e) && (u = e);
                        }
                    });
                    const n = t.slice(0, r), c = e[n];
                    t = t.slice(r + 1), c instanceof o.Object || "object" == typeof c && null !== c ? g(c, t) : p(e, n, !0, {
                        v: void 0,
                        init: function(e) {
                            return this.v = e, !0;
                        },
            ...
            !function(e, r) {
                ...
                const c = t(), s = [ "readystatechange", () => {
                    n(document.readyState) < o || (e(), c.removeEventListener.apply(document, s));
                }, {
                    capture: !0
                } ];
