!function() {
    function e(e = "", o = "") {
        const s = n(), i = s.getExtraArgs(Array.from(arguments), 2), c = s.makeLogPrefix("prevent-addEventListener", e, o), a = s.patternToRegex(e, void 0, !0), l = s.patternToRegex(o), g = (function(e) {
            if (e instanceof Object == 0) return !1;
            r.canDebug && e.debug;
        }(i), i.elements || void 0), u = e => {
            if (e instanceof Window) return "window";
            if (e instanceof Document) return "document";
            if (e instanceof Element == 0) return "?";
            const t = [], n = String(e.id);
            "" !== n && t.push(`#${CSS.escape(n)}`);
            ...
            const r = s.RegExp_test.call(a, t), o = s.RegExp_test.call(l, n), i = r && o;
            return (!i || void 0 === g || !1 !== (c = e, "window" === g ? c === window : "document" === g ? c === document : !!(c && c.matches && c.matches(g)) || Array.from(document.querySelectorAll(g)).includes(c))) && i;
            var c;
        }, d = function(t) {
            const {callArgs: n, thisArg: r} = t;
            let i, a;
            try {
            ...
            if ("" === e && "" === o) s.uboLog(c, `Called: ${i}\n${a}\n${u(r)}`); else if (p(r, i, a)) return s.uboLog(c, `Prevented: ${i}\n${a}\n${u(r)}`);
            return t.reflect();
        };
        !function(e, t) {
            const r = e => {
            ...
            t("EventTarget.prototype.addEventListener", d), t("document.addEventListener", d);
        }), i.runAt);
    }
    function t(e = "", n = "") {
        let r = globalThis, o = e;
        for (;;) {
            const e = o.indexOf(".");
            if (-1 === e) break;
            if (r = r[o.slice(0, e)], r instanceof Object == 0) return;
            o = o.slice(e + 1);
        }
        const s = r[o];
        ...
        void 0 === t.CtorContext && (t.ctorContexts = [], t.CtorContext = class {
            ...
            init(e, t, n) {
                return this.callFn = e, this.thisArg = t, this.callArgs = n, this;
            }
            reflect() {
        ...
        const i = s.toString(), c = function() {
            ...
            apply: (e, r, o) => n(t.ApplyContext.factory(e, r, o)),
            get: (e, t) => "toString" === t ? c : Reflect.get(e, t)
        };
        s.prototype?.constructor === s && (a.construct = function(e, r) {
            return n(t.CtorContext.factory(e, r));
        }), r[o] = new Proxy(s, a);
    }
    function n() {
    ...
    const r = {}, o = [ [ "blur", "i.focusPlayerElement" ], [ "scroll", "t.view.updateBounds" ], [ "/adblockDetector|adsInserted|partnerExternalLinkClick/" ], [ "contextmenu", ".disabled" ], [ "contextmenu", "", "showCopyrightBox" ], [ "/^(?:adBlocker|contextmenu)$/" ], [ "scroll", "helpers.scroll(id)" ], [ "wheel" ], [ "/contextmenu|cut|copy|paste/" ], [ "contextmenu" ], [ "/mousewheel|DOMMouseScroll/", "smoothScrollEvent" ], [ "wheel", "scroll" ] ], s = new Map([ [ "allas.se", [ 0, 1 ] ], [ "elle.se", [ 0, 1 ] ], [ "femina.se", [ 0, 1 ] ], [ "hant.se", [ 0, 1 ] ], [ "mabra.com", [ 0, 1 ] ], [ "residencemagazine.se", [ 0, 1 ] ], [ "svenskdam.se", [ 0, 1 ] ], [ "motherhood.se", [ 0, 1 ] ], [ "byggahus.se", 2 ], [ "expressen.se", 3 ], [ "di.se", 3 ], [ "fotosidan.se", 4 ], [ "lwcdn.com", 5 ], [ "mitti.se", 6 ], [ "praktisktbatagande.se", 6 ], [ "qasa.se", 7 ], [ "lundagard.se", 7 ], [ "boktugg.se", 7 ], [ "morotsliv.com", 7 ], [ "affarsstaden.se", 7 ], [ "kurera.se", 7 ], [ "nyfiknainvesterare.se", 7 ], [ "allagodating.se", 7 ], [ "sexpacket.se", 8 ], [ "streamio.com", 9 ], [ "nyan.ax", 9 ], [ "spelhubben.se", 9 ], [ "illvet.se", 9 ], [ "varldenshistoria.se", 9 ], [ "home2tiny.se", 10 ], [ "stadshem.se", 11 ] ]), i = new Map([]), c = (e, t, n) => {
        let r = t.get(e);
    ...
    for (const t of g) if (!u.has(t)) try {
        e(...o[t]);
    } catch {}
}();