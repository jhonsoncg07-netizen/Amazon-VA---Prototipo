!function() {
                    ...
                    const r = function() {
                        ...
                        const e = globalThis, t = {
                            ...
                            initPattern(e, o = {}) {
                                ...
                                !1 === t && (e = e.slice(1));
                                const a = /^\/(.+)\/([gimsu]*)$/.exec(e);
                                return null !== a ? {
                                    re: new this.RegExp(a[1], a[2] || o.flags),
                                    expect: t
                                } : void 0 !== o.flags ? {
                            ...
                            patternToRegex(e, o, t = !1) {
                                ...
                                const a = /^\/(.+)\/([gimsu]*)$/.exec(e);
                                if (null === a) {
                                    const a = this.escapeRegexChars(e);
                                    return new RegExp(t ? `^${a}$` : a, o);
                                }
                                try {
                            ...
                            getExtraArgs(e, o = 0) {
                                const t = e.slice(o).reduce(((e, o, t, a) => {
                                    if (0 == (1 & t)) {
                                        const o = a[t + 1], r = /^\d+$/.test(o) ? parseInt(o, 10) : o;
                                        e.push([ a[t], r ]);
                                    }
                                    return e;
                                }), []);
                        ...
                        t.toLogText = (e, ...o) => {
                            ...
                            return t === r && e === a && Date.now() - c < 5e3 ? void 0 : (a = e, r = t, c = Date.now(), 
                            t);
                        };
                        try {
                            ...
                            t.sendToLogger = (e, ...o) => {
                                ...
                                switch (e.data) {
                                  case "iamready!":
                                    if (void 0 === r) break;
                                    r.forEach((({type: e, text: o}) => a.postMessage({
                                        what: "messageToLogger",
                                        type: e,
                                        text: o
                                    }))), r = void 0;
                            ...
                            t.sendToLogger = (e, ...o) => {
                                ...
                                void 0 !== a && t.log(`uBO ${a}`);
                            };
                        }
                        return t;
                    }().patternToRegex(a, void 0, !0), c = [];
    ...
    for (const o of m) if (!s.has(o)) try {
        e(...t[o]);
    } catch {}
}();