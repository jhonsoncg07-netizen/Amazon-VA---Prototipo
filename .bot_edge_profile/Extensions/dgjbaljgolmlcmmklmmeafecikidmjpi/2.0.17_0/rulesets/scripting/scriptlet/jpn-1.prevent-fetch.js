!function() {
        ...
        !function(t = !1, o = "", s = "", i = "") {
            ...
            if (/^\{.*\}$/.test(i)) try {
                Object.entries(JSON.parse(i)).forEach((([t, e]) => {
                    void 0 !== p[t] && !1 !== p[t].includes(e) && (u[t] = {
                        value: e
                    });
                }));
            } catch {} else "" !== i && p.type.includes(i) && (u.type = {
                value: i
            });
            e("fetch", (function(e) {
    ...
    const r = {}, o = [ [ "adsbygoogle.js" ], [ "pagead2.googlesyndication.com" ], [ "adsbygoogle" ], [ "tpc.googlesyndication.com" ], [ "cdn.adschill.com" ] ], s = new Map([ [ "rkd3.dev", 0 ], [ "video.tv-tokyo.co.jp", 1 ], [ "gunauc.net", 1 ], [ "success-corp.co.jp", 1 ], [ "audio-sound-premium.com", 1 ], [ "tojav.net", 1 ], [ "kledgeb.blogspot.com", 1 ], [ "rxlife.net", 2 ], [ "rocketnews24.com", 3 ], [ "youpouch.com", 3 ], [ "manga1001.*", 4 ] ]), i = new Map([]), c = (t, e, n) => {
        let r = e.get(t);
