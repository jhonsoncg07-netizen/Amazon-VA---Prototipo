!function() {
    function e(e = "", r = "", n = "") {
        const o = t(), s = o.makeLogPrefix("trusted-replace-xhr-response", e, r, n), a = new WeakMap;
        "*" === e && (e = ".*");
        const i = o.patternToRegex(e), c = function(e, r = "") {
            const n = t(), o = new Map;
            ...
            return o;
        }(n, "url"), l = o.getExtraArgs(Array.from(arguments), 3), p = l.includes ? o.patternToRegex(l.includes) : null;
        self.XMLHttpRequest = class extends self.XMLHttpRequest {
            open(e, r, ...n) {
                ...
                let p = "match";
                return 0 !== c.size && void 0 === function(e, ...r) {
                    const n = t(), o = [];
                    ...
                    return o;
                }(c, l) && (p = "nomatch"), "match" === p && (o.logLevel > 1 && o.uboLog(s, 'Matched "propsToMatch"'), 
                a.set(this, l)), super.open(e, r, ...n);
            }
            get response() {
                const e = super.response, t = a.get(this);
                if (void 0 === t) return e;
                const n = "string" == typeof e ? e.length : void 0;
                if (t.lastResponseLength !== n && (t.response = void 0, t.lastResponseLength = n), 
                void 0 !== t.response) return t.response;
                if ("string" != typeof e) return t.response = e;
                if (p && !1 === p.test(e)) return t.response = e;
                const c = e, l = c.replace(i, r);
                return l !== c && o.uboLog(s, "Match"), t.response = l;
            }
            get responseText() {
    ...
    const r = {}, n = [ [ '"adPlacements"', '"no_ads"', "/playlist\\?list=|\\/player(?:\\?.+)?$|watch\\?[tv]=/" ], [ '/"adPlacements.*?([A-Z]"\\}|"\\}{2,4})\\}\\],/', "", "/playlist\\?list=|\\/player(?:\\?.+)?$|watch\\?[tv]=/" ], [ '/"adPlacements.*?("adSlots"|"adBreakHeartbeatParams")/gms', "$1", "/\\/player(?:\\?.+)?$/" ], [ '/\\{"node":\\{"role":"SEARCH_ADS"[^\\n]+?cursor":[^}]+\\}/g', "{}", "/api/graphql" ], [ '/\\{"node":\\{"__typename":"MarketplaceFeedAdStory"[^\\n]+?"cursor":(?:null|"\\{[^\\n]+?\\}"|[^\\n]+?MarketplaceSearchFeedStoriesEdge")\\}/g', "{}", "/api/graphql" ], [ '/\\{"node":\\{"__typename":"VideoHomeFeedUnitSectionComponent"[^\\n]+?"sponsored_data":\\{"ad_id"[^\\n]+?"cursor":null\\}/', "{}", "/api/graphql" ], [ '/"enabled":\\s*true/', '"enabled":false', "svonm.com" ], [ '"ads_disabled":false', '"ads_disabled":true', "payments" ] ], o = new Map([ [ "tv.youtube.com", 0 ], [ "www.youtube.com", [ 1, 2 ] ], [ "web.facebook.com", [ 3, 4, 5 ] ], [ "www.facebook.com", [ 3, 4, 5 ] ], [ "desired.de", 6 ], [ "app.hellovaia.com", 7 ], [ "app.studysmarter.de", 7 ], [ "app.vaia.com", 7 ] ]), s = new Map([]), a = (e, t, r) => {
        let n = t.get(e);
