    ...
    function e(e = "", n = "", r = "") {
        ...
        a = !1 === isNaN(a) && isFinite(a) ? Math.min(Math.max(a, .001), 50) : .05, self.setTimeout = new Proxy(self.setTimeout, {
            apply: function(e, t, n) {
                const [r, o] = n;
                return -1 !== s && o !== s || !i.test(r.toString()) || (n[1] = o * a), e.apply(t, n);
            }
        });
    }
    const t = {}, n = [ [ "simplegameAdCountDown", "1000", "0.02" ], [ "aeriaGamesAdCountDown", "", "0.02" ], [ "visibility", "4000" ], [ "[native code]", "2000", "0.3" ], [ "[native code]", "3000", "0.25" ], [ "[native code]", "4000", "0.2" ], [ "/nrWrapper\\(\\)|n\\.setTimeoutIds_\\.has\\(i\\)/", "10000" ], [ "window.ADGMAD.", "30000", "0.001" ] ], r = new Map([ [ "simplegame.jp", 0 ], [ "minigame.aeriagames.jp", 1 ], [ "ponta.abstractpainting.work", [ 2, 3, 4, 5 ] ], [ "tver.jp", 6 ], [ "kantangame.com", 7 ], [ "game.hiroba.dpoint.docomo.ne.jp", 7 ] ]), o = new Map([]), i = (e, t, n) => {
        let r = t.get(e);
