!function() {
    function e(e = "", n = "") {
        ...
        if ("" === e) return;
        const o = t(), i = o.makeLogPrefix("href-sanitizer", e, n);
        "" === n && (n = "text");
        const s = (e, t) => {
            let r = [];
            try {
            ...
            try {
                ...
                return null === o ? e : r ? a(o, t.slice(n)) : o;
            } catch {}
            return e;
        }, l = (e, t) => {
            ...
            const n = t.replace(/(\S)\?/g, "\\1?").split(/\s+/), o = 1 === n.length ? a(e.href, t) : r(e.href, !1, n);
            ...
            for (const e of t) {
                ...
                const t = e.getAttribute("href"), r = l(e, n), a = c(r);
                if ("" === a) continue;
                if (a === t) continue;
                e.setAttribute("href", a);
                const f = s(t, a);
                o.uboLog(i, `Sanitized ${f + 1} links to\n${a}`);
            }
            return !0;
        };
        let u, d;
        ...
        !function(e, r) {
            ...
            !1 !== f() && (u = new MutationObserver(p), u.observe(document.body, {
                subtree: !0,
                childList: !0
            }));
        }));
        ...
        try {
            ...
            for (const e of n) {
                ...
                if (35 !== n || "#" !== e) if (38 !== n) if (43 !== n || "+https" !== e) {
                    if (45 === n) {
                        ...
                        if ("-safebase64" === e) {
                            void 0 === r.safeBase64Replacer && (r.safeBase64Map = {
                                "-": "+",
                                _: "/"
                            }, r.safeBase64Replacer = e => r.safeBase64Map[e]), s = t.replace(/[-_]/g, r.safeBase64Replacer), 
                            s = self.atob(s);
                            continue;
                        }
                        if ("-uricomponent" === e) {
                    ...
                    if (47 !== n) {
                        if (63 !== n) return;
                        if (s = new URL(t).searchParams.get(e.slice(1)), null === s) return;
                        s.includes(" ") && (s = s.replace(/ /g, "%20"));
                    } else {
            ...
            const c = new URL(s);
            if ("https:" !== c.protocol && "http:" !== c.protocol) return;
            if (t && !0 !== i) return;
            return s;
        } catch {}
    }
    const n = {}, o = [ [ 'a[href^="/goto/"]', "?url -base64" ], [ 'a[href^="https://hamtamovie.nl/dl/?url="]', "?url" ], [ 'a[href^="https://l.vrgl.ir/r?"][href*="&l=http"]', "?l" ], [ 'div#link-container > a[data-sentry-element="Link"]', "?url" ], [ 'a[variant="contained"][href^="https://api2.zoomit.ir/catalog/store-links/"][href*="/click?url=http"]', "?url" ] ], i = new Map([ [ "fontchi.com", 0 ], [ "hamtamovie.nl", 1 ], [ "virgool.io", 2 ], [ "zarebin.ir", 3 ], [ "zoomit.ir", 4 ] ]), s = new Map([]), c = (e, t, r) => {
        let n = t.get(e);
