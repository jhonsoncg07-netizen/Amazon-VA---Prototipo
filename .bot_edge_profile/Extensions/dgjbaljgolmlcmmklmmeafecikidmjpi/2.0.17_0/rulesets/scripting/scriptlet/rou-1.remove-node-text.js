!function() {
    function e(e, r, ...n) {
        !function(e = "", r = "", n = "") {
            const o = t(), s = o.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), i = o.patternToRegex(e, "i", !0), c = o.patternToRegex(r, "gms"), a = o.getExtraArgs(Array.from(arguments), 3), l = a.includes || a.condition ? o.patternToRegex(a.includes || a.condition, "ms") : null, d = a.excludes ? o.patternToRegex(a.excludes, "ms") : null, g = (e = !0) => {
                e && m(x.takeRecords()), x.disconnect(), o.logLevel > 1 && o.uboLog(s, "Quitting");
            }, p = (() => {
                const e = {
                    createScript: e => e
                }, {trustedTypes: r} = self;
            ...
            const f = e => {
                ...
                c.lastIndex = 0;
                const i = "" !== r ? t.replace(c, n) : n;
                return e.textContent = "SCRIPT" === e.nodeName ? p.createScript(i) : i, o.logLevel > 1 && o.uboLog(s, `Text before:\n${t.trim()}`), 
                o.uboLog(s, `Text after:\n${i.trim()}`), 0 === u || 0 != (u -= 1);
            }, m = e => {
                for (const t of e) for (const e of t.addedNodes) if (!1 !== i.test(e.nodeName) && !f(e)) return void g(!1);
            ...
            if (x.observe(document, {
                ...
                for (;;) {
                    const r = e.nextNode();
                    if (t += 1, null === r) break;
                    if (!1 !== i.test(r.nodeName) && r !== document.currentScript && !f(r)) {
                        g();
                        break;
                    }
                }
                o.uboLog(s, `${t} nodes present before installing mutation observer`);
            }
            a.stay || function(e, r) {
                const n = e => {
                    const t = {
                ...
                const i = t(), c = [ "readystatechange", () => {
                    n(document.readyState) < o || (e(), i.removeEventListener.apply(document, c));
                }, {
                    capture: !0
                } ];
    ...
    const r = {}, n = [ [ "script", "adsbygoogle" ], [ "script", "/jQuery.*reload/" ], [ "script", "document.head.appendChild" ], [ "script", "ai_adb" ], [ "script", "maxbet" ] ], o = new Map([ [ "turdanews.net", 0 ], [ "sampmoduri.ro", 1 ], [ "filme2023.online", 2 ], [ "clujust.ro", 3 ], [ "gsp.ro", 4 ] ]), s = new Map([]), i = (e, t, r) => {
        let n = t.get(e);
