!function() {
    function e(e, r, ...n) {
        !function(e = "", r = "", n = "") {
            const o = t(), i = o.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), s = o.patternToRegex(e, "i", !0), c = o.patternToRegex(r, "gms"), a = o.getExtraArgs(Array.from(arguments), 3), l = a.includes || a.condition ? o.patternToRegex(a.includes || a.condition, "ms") : null, d = a.excludes ? o.patternToRegex(a.excludes, "ms") : null, p = (e = !0) => {
                e && m(x.takeRecords()), x.disconnect(), o.logLevel > 1 && o.uboLog(i, "Quitting");
            }, g = (() => {
                const e = {
                    createScript: e => e
                }, {trustedTypes: r} = self;
            ...
            const f = e => {
                ...
                if (l && (l.lastIndex = 0, !1 === o.RegExp_test.call(l, t))) return !0;
                if (d && (d.lastIndex = 0, o.RegExp_test.call(d, t))) return !0;
                if (c.lastIndex = 0, !1 === o.RegExp_test.call(c, t)) return !0;
                c.lastIndex = 0;
                const s = "" !== r ? t.replace(c, n) : n;
                return e.textContent = "SCRIPT" === e.nodeName ? g.createScript(s) : s, o.logLevel > 1 && o.uboLog(i, `Text before:\n${t.trim()}`), 
                o.uboLog(i, `Text after:\n${s.trim()}`), 0 === u || 0 != (u -= 1);
            }, m = e => {
                for (const t of e) for (const e of t.addedNodes) if (!1 !== s.test(e.nodeName) && !f(e)) return void p(!1);
            }, x = new MutationObserver(m);
            if (x.observe(document, {
                childList: !0,
                subtree: !0
                ...
                for (;;) {
                    const r = e.nextNode();
                    if (t += 1, null === r) break;
                    if (!1 !== s.test(r.nodeName) && r !== document.currentScript && !f(r)) {
                        p();
                        break;
                    }
                }
                o.uboLog(i, `${t} nodes present before installing mutation observer`);
            }
            a.stay || function(e, r) {
                const n = e => {
                    const t = {
    ...
    const r = {}, n = [ [ "script", "document.oncontextmenu =" ], [ "script", "ads_app_name" ], [ "script", "document.oncontextmenu=" ], [ "script", "/popTimes_|document\\.onkeydown|'contextmenu'/" ], [ "script", "window.location=" ], [ "script", "displayCountryInConsole" ], [ "script", "popTimes_" ], [ "script", "ad.setAttribute" ], [ "script", "showScrollAlert" ], [ "script", "Event.MOUSEDOWN" ] ], o = new Map([ [ "delta3da.cam", 0 ], [ "public-psychology.ir", 0 ], [ "sclinic.ir", 0 ], [ "farsroid.com", 1 ], [ "kihanb.ir", 2 ], [ "musiceman.net", 3 ], [ "najiremix.ir", 4 ], [ "persian-fa.ir", 5 ], [ "iran-music.com", 6 ], [ "tgju.org", 7 ], [ "tarafdari.com", 8 ], [ "vaamfaa.ir", 9 ] ]), i = new Map([]), s = (e, t, r) => {
        let n = t.get(e);
