!function() {
    ...
    const o = {}, i = [ [ "*", "*.media.*.advertisement_id" ], [ "ads breaks cuepoints times", "ads" ], [ "rot_url pop_type" ] ], s = new Map([ [ "sub100.com.br", 0 ], [ "app.prende.tv", 1 ], [ "animeblix.com", 2 ] ]), c = new Map([]), a = (e, t, n) => {
        let r = t.get(e);
