!function() {
    function e(...e) {
        return function(e = !1, n = "", s = "") {
            ...
            const o = t(), i = e ? "trusted-prevent-xhr" : "prevent-xhr", a = o.makeLogPrefix(i, n, s), p = new WeakMap, c = function(e, r = "") {
                const n = t(), s = new Map;
            ...
            self.XMLHttpRequest = class extends self.XMLHttpRequest {
                open(e, r, ...i) {
                    if (p.delete(this), void 0 !== l && r.startsWith(l)) return super.open(e, r, ...i);
                    const u = {
                        method: e,
                        url: r
                    };
                ...
                send(...n) {
                    ...
                    switch (this.responseType) {
                      ...
                      default:
                        ...
                        }(e, i.directive), c instanceof Promise ? c = c.then((e => {
                            i.props.response.value = e, i.props.responseText.value = e;
                        })) : (i.props.response.value = c, i.props.responseText.value = c), i.headers["content-type"] = "text/plain";
                    }
                    ...
                    Promise.resolve(c).then((() => i)).then((e => (Object.defineProperties(e.xhr, {
                        readyState: {
                            value: 1,
                            configurable: !0
                        },
    ...
    const r = {}, n = [ [ "/api/ads" ], [ "adsbygoogle" ], [ "pagead2.googlesyndication.com" ] ], s = new Map([ [ "noy1.top", 0 ], [ "pansearch.me", 1 ], [ "linetv.tw", 2 ] ]), o = new Map([]), i = (e, t, r) => {
        let n = t.get(e);
