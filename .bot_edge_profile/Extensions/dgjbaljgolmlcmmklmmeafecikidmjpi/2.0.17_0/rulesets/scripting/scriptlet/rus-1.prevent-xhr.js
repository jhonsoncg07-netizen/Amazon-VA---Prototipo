!function() {
    function e(...e) {
        return function(e = !1, n = "", s = "") {
            if ("string" != typeof n) return;
            const o = t(), i = e ? "trusted-prevent-xhr" : "prevent-xhr", a = o.makeLogPrefix(i, n, s), c = new WeakMap, p = function(e, r = "") {
                const n = t(), s = new Map;
                ...
                for (const t of n.String_split.call(e, /\s+/)) {
                    ...
                    void 0 !== i ? s.set(e, n.initPattern(i, o)) : "" !== r && s.set(r, n.initPattern(e, o)));
                }
                return s;
            ...
            self.XMLHttpRequest = class extends self.XMLHttpRequest {
                open(e, r, ...i) {
                    ...
                    if ("" === n && "" === s) return o.uboLog(a, `Called: ${o.JSON_stringify(u, null, 2)}`), 
                    super.open(e, r, ...i);
                    if (function(e, ...r) {
                        const n = t(), s = [];
                        for (const t of r) if (t instanceof Object != 0) for (const [r, o] of e) {
                            let e = t[r];
                            if (void 0 !== e) {
                                if ("string" != typeof e) {
                                    try {
                ...
                send(...n) {
                      ...
                      default:
                        ...
                        p = function(e, n) {
                            const s = t(), o = e => {
                                ...
                                let r = 0;
                                do {
                                    const e = s.Math_random().toString(36).slice(2);
                                    t.push(e), r += e.length;
                                } while (r < e);
                                return t.join(" ").slice(0, e);
                            };
                            if ("true" === n) return o(10);
                            ...
                            if (n.startsWith("length:")) {
                                ...
                                if (null === e) return "";
                                const t = parseInt(e[1], 10), r = s.Math_max(parseInt(e[2], 10) || 0, t) - t;
                                return o(0 | s.Math_min(t + r * s.Math_random(), 5e5));
                            }
                            return n.startsWith("war:") ? void 0 === r.warOrigin ? "" : new Promise((e => {
                                const t = [ r.warOrigin, "/", n.slice(4) ], o = r.warSecret;
                                void 0 !== o && t.push("?secret=", o);
                                const i = new s.XMLHttpRequest;
                    ...
                    Object.defineProperties(e.xhr, {
                        ...
                        }), u(e.xhr, "readystatechange"), u(e.xhr, "load"), u(e.xhr, "loadend"), o.uboLog(a, `Prevented with response:\n${e.xhr.response}`);
                    }));
                }
                getResponseHeader(e) {
                    const t = c.get(this);
    ...
    function t() {
        ...
        t.toLogText = (e, ...t) => {
            ...
            return r === s && e === n && Date.now() - o < 5e3 ? void 0 : (n = e, s = r, o = Date.now(), 
            r);
        };
        try {
            ...
            t.sendToLogger = (e, ...r) => {
                ...
                if (void 0 !== o) return void 0 === s ? n.postMessage({
    ...
    const r = {}, n = [ [ "yabs.yandex.ru/count/" ] ], s = new Map([ [ "ya.*", 0 ], [ "yandex.*", 0 ] ]), o = new Map([]), i = (e, t, r) => {
        let n = t.get(e);
        ...
        return e.ancestorOrigins && t.push(...e.ancestorOrigins), t.map(((e, t) => {
            ...
            if (-1 === r) return;
            const n = e.slice(r + 3), s = n.indexOf(":");
            return {
