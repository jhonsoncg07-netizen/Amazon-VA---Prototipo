!function() {
    function e(e = "", o = "") {
        const i = n(), c = i.getExtraArgs(Array.from(arguments), 2), s = i.makeLogPrefix("prevent-addEventListener", e, o), a = i.patternToRegex(e, void 0, !0), l = i.patternToRegex(o), g = (function(e) {
            if (e instanceof Object == 0) return !1;
            r.canDebug && e.debug;
        }(c), c.elements || void 0), p = e => {
            ...
            const r = i.RegExp_test.call(a, t), o = i.RegExp_test.call(l, n), c = r && o;
            return (!c || void 0 === g || !1 !== (s = e, "window" === g ? s === window : "document" === g ? s === document : !!(s && s.matches && s.matches(g)) || Array.from(document.querySelectorAll(g)).includes(s))) && c;
            var s;
        }, d = function(t) {
            const {callArgs: n, thisArg: r} = t;
            let c, a;
            try {
                c = String(n[0]), "function" == typeof n[1] ? a = String(i.Function_toString(n[1])) : "object" == typeof n[1] && null !== n[1] ? "function" == typeof n[1].handleEvent && (a = String(i.Function_toString(n[1].handleEvent))) : a = String(n[1]);
            } catch {}
            if ("" === e && "" === o) i.uboLog(s, `Called: ${c}\n${a}\n${p(r)}`); else if (u(r, c, a)) return i.uboLog(s, `Prevented: ${c}\n${a}\n${p(r)}`);
            return t.reflect();
        };
        !function(e, t) {
            const r = e => {
    ...
    const r = {}, o = [ [ "click", "location" ], [ "ended" ], [ "load", "document.cookie" ], [ "message", "fishing" ], [ "message", "_0x" ], [ "beforeunload", "()" ] ], i = new Map([ [ "indian-tv.cz", 0 ], [ "nerdfix.cz", 0 ], [ "navratdoreality.cz", 1 ], [ "titulky.com", 2 ], [ "seznamzpravy.cz", 3 ], [ "novinky.cz", [ 3, 5 ] ], [ "seznam.cz", 3 ], [ "super.cz", [ 3, 4, 5 ] ], [ "stream.cz", 3 ], [ "idnes.cz", 5 ], [ "aktualne.cz", 5 ], [ "reflex.cz", 5 ], [ "zive.cz", 5 ], [ "e15.cz", 5 ], [ "blesk.cz", 5 ], [ "ahaonline.cz", 5 ], [ "auto.cz", 5 ], [ "maminka.cz", 5 ], [ "autorevue.cz", 5 ], [ "osobnosti.cz", 5 ], [ "lidovky.cz", 5 ], [ "iprima.cz", 5 ], [ "kupi.cz", 5 ], [ "kinobox.cz", 5 ], [ "cnews.cz", 5 ], [ "zeny.cz", 5 ], [ "expres.cz", 5 ], [ "tiscali.cz", 5 ], [ "extra.cz", 5 ], [ "onetv.cz", 5 ], [ "dama.cz", 5 ], [ "g.cz", 5 ], [ "mojecelebrity.cz", 5 ], [ "spisovatele.cz", 5 ], [ "modnipeklo.cz", 5 ], [ "karaoketexty.cz", 5 ], [ "emimino.cz", 5 ], [ "vitalion.cz", 5 ], [ "mojezdravi.cz", 5 ], [ "abicko.cz", 5 ], [ "arome.cz", 5 ], [ "labuznik.cz", 5 ], [ "fights.cz", 5 ], [ "nasepenize.cz", 5 ] ]), c = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
