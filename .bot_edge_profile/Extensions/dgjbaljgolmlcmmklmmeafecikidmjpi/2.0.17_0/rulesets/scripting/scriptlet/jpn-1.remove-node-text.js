!function() {
    function e(e, r, ...o) {
        !function(e = "", r = "", o = "") {
            const n = t(), i = n.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), s = n.patternToRegex(e, "i", !0), a = n.patternToRegex(r, "gms"), c = n.getExtraArgs(Array.from(arguments), 3), l = c.includes || c.condition ? n.patternToRegex(c.includes || c.condition, "ms") : null, d = c.excludes ? n.patternToRegex(c.excludes, "ms") : null, g = (e = !0) => {
                e && m(x.takeRecords()), x.disconnect(), n.logLevel > 1 && n.uboLog(i, "Quitting");
            }, u = (() => {
                const e = {
                    createScript: e => e
                }, {trustedTypes: r} = self;
            ...
            const f = e => {
                ...
                if (d && (d.lastIndex = 0, n.RegExp_test.call(d, t))) return !0;
                if (a.lastIndex = 0, !1 === n.RegExp_test.call(a, t)) return !0;
                a.lastIndex = 0;
                const s = "" !== r ? t.replace(a, o) : o;
                return e.textContent = "SCRIPT" === e.nodeName ? u.createScript(s) : s, n.logLevel > 1 && n.uboLog(i, `Text before:\n${t.trim()}`), 
                n.uboLog(i, `Text after:\n${s.trim()}`), 0 === p || 0 != (p -= 1);
            }, m = e => {
            ...
            if (x.observe(document, {
                ...
                n.uboLog(i, `${t} nodes present before installing mutation observer`);
            }
            c.stay || function(e, r) {
                const o = e => {
                    const t = {
                ...
                const s = t(), a = [ "readystatechange", () => {
                    o(document.readyState) < n || (e(), s.removeEventListener.apply(document, a));
                }, {
                    capture: !0
                } ];
