!function() {
    ...
    const o = {}, r = [ [ "PrebidDamOpen", "800" ], [ "HubAPI", "3000" ], [ '/getComputedStyle[\\s\\S]*?style\\.display="none"[\\s\\S]*?styleBlocked[\\s\\S]*?detected/' ], [ 'function check(){console.log("checked");if($(".adform").children().length>3){console.log("its more");$(".adform").children(".adform-banner").show();clearTimeout(check)}}', "1000" ], [ "ubfix()" ], [ "no-ads-info" ], [ "bioEp.showPopup" ] ], i = new Map([ [ "www.dobreprogramy.pl", 0 ], [ "kafeteria.pl", 1 ], [ "polygamia.pl", 1 ], [ "open.fm", 1 ], [ "pudelek.pl", 1 ], [ "wp.pl", 2 ], [ "naekranie.pl", 3 ], [ "purepc.pl", 4 ], [ "calcoolator.pl", 5 ], [ "pl.vpnmentor.com", 6 ] ]), s = new Map([]), c = (t, e, n) => {
        let o = e.get(t);
