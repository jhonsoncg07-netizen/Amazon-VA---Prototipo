!function() {
    function e(e = "") {
        ...
        const r = t(), n = r.makeLogPrefix("abort-on-property-read", e), o = function() {
            ...
            c && void 0 !== c.set || Object.defineProperty(e, n, {
                get: function() {
                    return o;
                },
                set: function(e) {
    ...
    const r = {}, n = [ [ "nocontext" ], [ "vc_url" ], [ "show_wpcp_message" ], [ "fixedPostGroups" ], [ "tinPa" ], [ "SGPB_POPUP_PARAMS" ], [ "needpop" ], [ "window.LOCO_DATA.copyrightTranslation" ] ], o = new Map([ [ "anesthesianotes.ir", 0 ], [ "coffeeapps.ir", 0 ], [ "p30konkor.com", 0 ], [ "sclinic.ir", 0 ], [ "nab-music.com", 1 ], [ "shahanmusic.ir", 2 ], [ "saednews.com", 3 ], [ "tinroid.ir", 4 ], [ "tak3da.com", 5 ], [ "yeknet.ir", 6 ], [ "oila.tj", 7 ] ]), i = new Map([]), s = (e, t, r) => {
        let n = t.get(e);
    ...
    for (const t of g) if (!l.has(t)) try {
        e(...n[t]);
    } catch {}
}();