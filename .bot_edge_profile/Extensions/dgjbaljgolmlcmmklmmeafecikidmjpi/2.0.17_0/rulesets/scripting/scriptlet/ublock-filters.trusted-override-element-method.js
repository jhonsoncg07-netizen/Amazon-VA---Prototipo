!function() {
    function e(e = "", n = "", o = "") {
        if ("" === e) return;
        const i = r(), s = i.makeLogPrefix("trusted-override-element-method", e, n, o), c = i.getExtraArgs(Array.from(arguments), 3);
        t(e, (function(e) {
            let t = "" === n;
            if (!1 === t) {
                const {thisArg: r} = e;
            ...
            if (!1 === t) return e.reflect();
            if (i.uboLog(s, "Overridden"), "" !== o) {
                if ("debug" === o && i.logLevel, "throw" === o) throw new ReferenceError;
    ...
    function t(e = "", r = "") {
        ...
        i.prototype?.constructor === i && (a.construct = function(e, n) {
    ...
    const n = {}, o = [ [ "HTMLAnchorElement.prototype.click", 'a[target="_blank"][style]' ], [ "HTMLAnchorElement.prototype.click", 'a[target="_blank"]' ] ], i = new Map([ [ "cety.app", 0 ], [ "cuty.me", 0 ], [ "exnion.com", 0 ], [ "360news4u.net", 1 ], [ "upns.*", 1 ], [ "upn.one", 1 ] ]), s = new Map([]), c = (e, t, r) => {
        let n = t.get(e);
