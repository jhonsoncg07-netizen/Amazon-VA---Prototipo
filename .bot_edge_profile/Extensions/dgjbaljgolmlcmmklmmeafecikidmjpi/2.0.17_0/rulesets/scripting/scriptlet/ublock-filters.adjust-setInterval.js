!function() {
    function e(e = "", t = "", s = "") {
        ...
        const a = function() {
            ...
            const e = globalThis, t = {
                ...
                getExtraArgs(e, o = 0) {
                    const t = e.slice(o).reduce(((e, o, t, s) => {
                        if (0 == (1 & t)) {
                            const o = s[t + 1], n = /^\d+$/.test(o) ? parseInt(o, 10) : o;
                            e.push([ s[t], n ]);
                        }
                        return e;
                    }), []);
            ...
            t.toLogText = (e, ...o) => {
                ...
                return t === n && e === s && Date.now() - a < 5e3 ? void 0 : (s = e, n = t, a = Date.now(), 
                t);
            };
            try {
                const s = new e.BroadcastChannel(o.bcSecret);
                let n = [];
                t.sendToLogger = (e, ...o) => {
                    const a = t.toLogText(e, ...o);
                    if (void 0 !== a) return void 0 === n ? s.postMessage({
                    ...
                    switch (e.data) {
                      case "iamready!":
                        if (void 0 === n) break;
                        n.forEach((({type: e, text: o}) => s.postMessage({
                            what: "messageToLogger",
                            type: e,
                            text: o
                        }))), n = void 0;
    ...
    ((e, o = "") => {
        const t = e.split("."), m = t.length;
        if (0 !== m) {
            for (let e = 0; e < m; e++) {
                const m = `${t.slice(e).join(".")}${o}`;
                a(m, s, c), a(m, n, r);
            }
            {
                const e = m - 1;
                for (let m = 0; m < e; m++) for (let i = e; i > m; i--) {
                    const e = `${t.slice(m, i).join(".")}.*${o}`;
                    a(e, s, c), a(e, n, r);
                }
            }
        }
    })(i[0].hn);
    for (const o of c) if (!r.has(o)) try {
        e(...t[o]);
    } catch {}
}();