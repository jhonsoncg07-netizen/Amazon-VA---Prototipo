!function() {
    function t(t = "") {
        ...
        const r = function() {
            ...
            return e;
        }(), o = r.makeLogPrefix("noeval-if", t), s = r.patternToRegex(t);
        e("eval", (function(e) {
            const {callArgs: n} = e, i = String(n[0]);
            if ("" === t || !s.test(i)) return ("" === t || r.logLevel > 1) && r.uboLog(o, "Not prevented:\n", i), 
            e.reflect();
    ...
    const n = {}, r = [ [ "/chp_?ad/" ] ], o = new Map([ [ "193.142.147.230", 0 ], [ "5.253.86.213", 0 ], [ "ainzscans.net", 0 ], [ "igobokep.cam", 0 ], [ "jenismac.com", 0 ] ]), s = new Map([]), i = (t, e, n) => {
        let r = e.get(t);
