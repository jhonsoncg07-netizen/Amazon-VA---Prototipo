!function() {
    function e(e = "", n = "", r = "", i = "") {
        if ("" === e) return;
        const a = t(), s = a.makeLogPrefix("set-cookie", e, n, i), c = new Date;
        n.includes("$now$") && (n = n.replaceAll("$now$", c.getTime())), n.includes("$currentDate$") && (n = n.replaceAll("$currentDate$", c.toUTCString())), 
        n.includes("$currentISODate$") && (n = n.replaceAll("$currentISODate$", c.toISOString()));
        let l = "";
        if ("" !== r) {
            if ("1day" === r) c.setDate(c.getDate() + 1); else if ("1year" === r) c.setFullYear(c.getFullYear() + 1); else {
                if (!1 === /^\d+$/.test(r)) return;
                c.setSeconds(c.getSeconds() + parseInt(r, 10));
            }
            l = c.toUTCString();
        }
        const d = function(e = !1, t = "", n = "", r = "", i = "", a = {}) {
            !1 === e && /[^!#$%&'*+\-.0-9A-Z[\]^_`a-z|~]/.test(t) && (t = encodeURIComponent(t)), 
            /[^ -:<-[\]-~]/.test(n) && (n = encodeURIComponent(n));
            const s = o(t);
            if (void 0 !== s && a.dontOverwrite) return;
            if (s === n && a.reload) return;
            const c = [ t, "=", n ];
            if ("" !== r && c.push("; expires=", r), "" === i ? i = "/" : "none" === i && (i = ""), 
            "" !== i && "/" !== i) return;
            if ("/" === i && c.push("; path=/"), e) {
                if (a.domain) {
                    let e = a.domain;
                ...
                c.push("; Secure");
            } else /^__(Host|Secure)-/.test(t) && c.push("; Secure");
            try {
                document.cookie = c.join("");
            } catch {}
            const l = o(t) === n;
            return l && a.reload && window.location.reload(), l;
        }(!0, e, n, l, i, t().getExtraArgs(Array.from(arguments), 4));
        d && a.uboLog(s, "Done");
    }
    function t() {
