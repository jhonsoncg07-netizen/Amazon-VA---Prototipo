!function() {
    function e(...e) {
        !function(e = !1, r = "", n = "", o = "") {
            if (!0 !== e) return;
            const s = t(), i = s.makeLogPrefix("replace-fetch-response", r, n, o);
            "*" === r && (r = ".*");
            const a = s.patternToRegex(r), c = function(e, r = "") {
                const n = t(), o = new Map;
                ...
                return o;
            }(o, "url"), l = s.getExtraArgs(Array.from(arguments), 4), d = l.includes ? s.patternToRegex(l.includes) : null;
            self.fetch = new Proxy(self.fetch, {
                apply: function(e, o, l) {
                    const p = Reflect.apply(e, o, l);
                    if ("" === r) return p;
                    if (0 !== c.size) {
                        ...
                        l[1] instanceof Object && e.push(l[1]);
                        ...
                        s.logLevel > 1 && s.uboLog(i, `Matched "propsToMatch":\n\t${r.join("\n\t")}`);
                    }
                    return p.then((e => e.clone().text().then((t => {
                        if (d && !1 === d.test(t)) return e;
                        const r = t.replace(a, n);
                        if (r === t) return e;
                        s.uboLog(i, "Replaced");
                    ...
                    })).catch((t => (s.uboErr(i, t), e))))).catch((e => (s.uboErr(i, e), p)));
                }
            });
        }(!0, ...e);
    }
    ...
    const r = {}, n = [ [ '"adPlacements"', '"no_ads"', "player?" ], [ '"adSlots"', '"no_ads"', "player?" ], [ '"adSlots"', '"no_ads"', "/^\\W+$/" ], [ "/<VAST version.+VAST>/", '<VAST version=\\"4.0\\"></VAST>', "deezer.getAudiobreak" ], [ '/\\{"id":\\d{9,11}(?:(?!"ads":\\{"id":"").)+?"ads":\\{"id":"\\d+".+?"__typename":"ProductCarouselV2"\\},?/g', "", "/graphql/InspirationCarousel" ], [ '/\\{"category_id"(?:(?!"ads":\\{"id":"").)+?"ads":\\{"id":"\\d+".+?"__typename":"ProductCarouselV2"\\},?/g', "", "/graphql/InspirationalCarousel" ], [ '/\\{"id":\\d{9,11}(?:(?!"isTopads":false).)+?"isTopads":true.+?"__typename":"recommendationItem"\\},/g', "", "/\\/graphql\\/productRecommendation/i" ], [ '/,\\{"id":\\d{9,11}(?:(?!"isTopads":false).)+?"isTopads":true(?:(?!"__typename":"recommendationItem").)+?"__typename":"recommendationItem"\\}(?=\\])/', "", "/\\/graphql\\/productRecommendation/i" ], [ '/\\{"(?:productS|s)lashedPrice"(?:(?!"isTopads":false).)+?"isTopads":true.+?"__typename":"recommendationItem"\\},?/g', "", "/graphql/RecomWidget" ], [ '/\\{"appUrl"(?:(?!"isTopads":false).)+?"isTopads":true.+?"__typename":"recommendationItem"\\},?/g', "", "/graphql/ProductRecommendationQuery" ], [ "/#EXT-X-KEY:METHOD=NONE\\n#EXT(?:INF:[^\\n]+|-X-DISCONTINUITY)\\n.+?(?=#EXT-X-KEY)/gms", "", "/media.m3u8" ], [ '/"remainingWatchDuration":\\d+/', '"remainingWatchDuration":9999999999', "/stream" ], [ '/"midTierRemainingAdWatchCount":\\d+,"showAds":(false|true)/', '"midTierRemainingAdWatchCount":0,"showAds":false', "/stream" ] ], o = new Map([ [ "www.youtube.com", [ 0, 1, 2 ] ], [ "deezer.com", 3 ], [ "tokopedia.com", [ 4, 5, 6, 7, 8, 9 ] ], [ "canela.tv", 10 ], [ "rooter.gg", [ 11, 12 ] ] ]), s = new Map([]), i = (e, t, r) => {
        let n = t.get(e);
