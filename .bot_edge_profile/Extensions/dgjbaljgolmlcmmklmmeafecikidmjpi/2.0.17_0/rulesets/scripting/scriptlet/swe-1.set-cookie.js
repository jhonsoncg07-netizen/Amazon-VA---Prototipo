!function() {
    function e(e = "", o = "", r = "") {
        if ("" === e) return;
        const s = t(), i = s.makeLogPrefix("set-cookie", e, o, r), c = o.toLowerCase(), a = /^("?)(.+)\1$/.exec(c), l = a && a[2] || c;
        ...
        const d = function(e = !1, t = "", o = "", r = "", s = "", i = {}) {
            !1 === e && /[^!#$%&'*+\-.0-9A-Z[\]^_`a-z|~]/.test(t) && (t = encodeURIComponent(t)), 
            /[^ -:<-[\]-~]/.test(o) && (o = encodeURIComponent(o));
            const c = n(t);
            if (void 0 !== c && i.dontOverwrite) return;
            if (c === o && i.reload) return;
            const a = [ t, "=", o ];
            if ("" !== r && a.push("; expires=", r), "" === s ? s = "/" : "none" === s && (s = ""), 
            "" !== s && "/" !== s) return;
            if ("/" === s && a.push("; path=/"), e) {
                if (i.domain) {
                    let e = i.domain;
                    if (/^\/.+\//.test(e)) {
                        const t = new URL(document.baseURI), n = new RegExp(e.slice(1, -1)).exec(t.hostname);
                        e = n ? n[0] : void 0;
                    }
                    e && a.push(`; domain=${e}`);
                }
        ...
        }(!1, e, o, "", r, s.getExtraArgs(Array.from(arguments), 3));
        d && s.uboLog(i, "Done");
    }
    function t() {
    ...
    function n(e = "") {
        const n = t();
        for (const t of n.String_split.call(document.cookie, /\s*;\s*/)) {
            const n = t.indexOf("=");
            if (-1 !== n && t.slice(0, n) === e) return t.slice(n + 1).trim();
        }
    }
    const o = {}, r = [ [ "CM_cookieConsent", "0" ], [ "allow-marketing-cookies", "0" ], [ "cmplz_banner-status", "dismissed" ], [ "cmplz_functional", "allow" ], [ "cmplz_marketing", "deny" ], [ "cmplz_preferences", "deny" ], [ "cmplz_statistics", "deny" ] ], s = new Map([ [ "destination.se", 0 ], [ "sistaminuten.se", 0 ], [ "inet.se", 1 ], [ "inredningsvis.se", [ 2, 3, 4, 5, 6 ] ] ]), i = new Map([]), c = (e, t, n) => {
        let o = t.get(e);
