    ...
    function e(e = "") {
        ...
        const a = () => {
            o.String_split.call(document.cookie, ";").forEach((e => {
                ...
                const r = o + "=", i = `; domain=${c.hostname}`, a = `; domain=.${c.hostname}`;
                let l, d;
                if (s) l = `; domain=${s}`, d = `; domain=.${s}`; else if (document.domain) {
                    const e = document.domain;
                    e !== c.hostname && (l = `; domain=.${e}`), e.startsWith("www.") && (d = `; domain=${e.replace("www", "")}`);
                }
