!function() {
    function e(e = "", n = "") {
        const o = r(), s = o.makeLogPrefix("json-prune-fetch-response", e, n), i = o.getExtraArgs(Array.from(arguments), 2), c = function(e, t = "") {
            const n = r(), o = new Map;
            if (void 0 === e || "" === e) return o;
            const s = {
                canNegate: !0
            };
            for (const r of n.String_split.call(e, /\s+/)) {
                let [e, i] = n.String_split.call(r, ":");
                "" !== e && (void 0 !== i && /[^$\w -]/.test(e) && (e = `${e}:${i}`, i = void 0), 
                void 0 !== i ? o.set(e, n.initPattern(i, s)) : "" !== t && o.set(t, n.initPattern(e, s)));
            }
            return o;
        }(i.propsToMatch, "url"), a = o.initPattern(i.stackToMatch || "", {
            canNegate: !0
        }), l = "" === e;
        self.fetch = new Proxy(self.fetch, {
            apply: function(f, u, g) {
                const p = Reflect.apply(f, u, g);
                if (0 !== c.size) {
                    const e = [ g[0] instanceof Object ? g[0] : {
                        url: g[0]
                    } ];
                    if (e[0] instanceof Request) try {
                        e[0] = o.Request_clone.call(e[0]);
                    } catch (e) {
                        o.uboErr(s, "Error:", e);
                    }
                    g[1] instanceof Object && e.push(g[1]);
                    const t = function(e, ...t) {
                        const n = r(), o = [];
                        for (const r of t) if (r instanceof Object != 0) for (const [t, s] of e) {
                            let e = r[t];
                            if (void 0 !== e) {
                                if ("string" != typeof e) {
                                    try {
                    ...
                    o.logLevel > 1 && o.uboLog(s, `Matched "propsToMatch":\n\t${t.join("\n\t")}`);
                }
                return p.then((r => r.clone().json().then((c => {
                    if ("object" != typeof c) return r;
                    if (l) return o.uboLog(s, o.JSON_stringify(c, null, 2)), r;
                    const f = t(c, e, n, a, i);
                    if ("object" != typeof f) return r;
                    o.uboLog(s, "Pruned");
                    const u = Response.json(f, {
                        status: r.status,
                ...
                })).catch((e => (o.uboErr(s, "Error:", e), r))))).catch((e => (o.uboErr(s, "Error:", e), 
                p)));
            }
        });
    }
    function t(e, o, s, i = {
        ...
        const a = r(), l = "" !== o ? a.String_split.call(o, / +/) : [], f = 0 !== l.length && "" !== s ? a.String_split.call(s, / +/) : [];
        if (!0 !== i.matchAll && !1 === function(e, t = "") {
            const n = r(), o = function() {
                const e = function() {
                    const e = r();
                    return e.String_fromCharCode(Date.now() % 26 + 97) + e.Math_floor(982451653 * e.Math_random() + 982451653).toString(36);
                }(), t = self.onerror;
                return self.onerror = function(r, ...n) {
                    return !("string" != typeof r || !r.includes(e)) || (t instanceof Function ? t.call(this, r, ...n) : void 0);
                }.bind(), e;
            }(), s = new n.Error(o), i = new URL(self.location.href);
            i.hash = "";
            const c = /(.*?@)?(\S+)(:\d+):\d+\)?$/, a = [];
            for (let e of n.String_split.call(s.stack, /[\n\r]+/)) {
                if (e.includes(o)) continue;
                e = e.trim();
                const t = n.RegExp_exec.call(c, e);
                if (null === t) continue;
                let r = t[2];
                r.startsWith("(") && (r = r.slice(1)), r === i.href ? r = "inlineScript" : r.startsWith("<anonymous>") && (r = "injectedScript");
            ...
            const l = a.join("\t"), f = !0 !== e.matchAll && n.testPattern(e, l);
            return ("all" === t || "match" === t && f || "nomatch" === t && !f) && n.uboLog(l.replace(/\t/g, "\n")), 
            f;
        }(i, c.logstack)) return;
        if (void 0 === t.mustProcess && (t.mustProcess = (e, t) => {
            for (const r of t) if (!1 === n(e, r)) return !1;
            return !0;
        }), 0 === l.length) return;
        let u = "nomatch";
        if (t.mustProcess(e, f)) for (const t of l) n(e, t, !0) && (u = "match");
        return "match" === u ? e : void 0;
    }
    function r() {
    ...
    function n(e, t, o = !1) {
        ...
        for (;;) {
            ...
            if (-1 === e) {
                ...
                let e = !1;
                if ("*" === c) for (const t in i) !1 !== s.Object_hasOwn(i, t) && (delete i[t], 
                e = !0); else s.Object_hasOwn(i, c) && (delete i[c], e = !0);
                return e;
            }
            const t = c.slice(0, e), r = c.slice(e + 1);
            let a = !1;
            if ("[-]" === t && Array.isArray(i)) {
                let e = i.length;
                for (;e--; ) !1 !== n(i[e], r) && (i.splice(e, 1), a = !0);
                return a;
            }
            if ("{-}" === t && i instanceof Object) {
                for (const e of Object.keys(i)) !1 !== n(i[e], r) && (delete i[e], a = !0);
                return a;
            }
            if ("[]" === t && Array.isArray(i) || "{}" === t && i instanceof Object || "*" === t && i instanceof Object) {
                for (const e of Object.keys(i)) !1 !== n(i[e], r, o) && (a = !0);
                return a;
            }
    ...
    const o = {}, s = [ [ "bumpers", "", "propsToMatch", "url:/playback2.a2d.tv\\/play/" ], [ "playbackItem.isStitched", "", "propsToMatch", "prism.a2d.tv" ] ], i = new Map([ [ "mtv.fi", [ 0, 1 ] ], [ "mtvuutiset.fi", [ 0, 1 ] ] ]), c = new Map([]), a = (e, t, r) => {
        let n = t.get(e);
    ...
    for (const t of u) if (!g.has(t)) try {
        e(...s[t]);
    } catch {}
}();