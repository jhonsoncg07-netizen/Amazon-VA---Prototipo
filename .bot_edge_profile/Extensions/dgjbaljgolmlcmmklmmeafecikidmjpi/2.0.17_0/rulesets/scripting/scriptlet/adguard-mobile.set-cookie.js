!function() {
    function e(e = "", o = "", r = "") {
        if ("" === e) return;
        const i = t(), s = i.makeLogPrefix("set-cookie", e, o, r), c = o.toLowerCase(), a = /^("?)(.+)\1$/.exec(c), l = a && a[2] || c;
        ...
        const d = function(e = !1, t = "", o = "", r = "", i = "", s = {}) {
        ...
        }(!1, e, o, "", r, i.getExtraArgs(Array.from(arguments), 3));
        d && i.uboLog(s, "Done");
    }
    function t() {
    ...
    const o = {}, r = [ [ "in_m4", "1" ], [ "playcnt", "1" ], [ "no_postitial_content", "1" ], [ "no_postitial_video", "1" ], [ "inter", "1" ] ], i = new Map([ [ "hanime.tv", 0 ], [ "m.proporn.com", [ 1, 2 ] ], [ "m.nuvid.*", 3 ], [ "m.hd21.com", 3 ], [ "m.economictimes.com", 4 ] ]), s = new Map([]), c = (e, t, n) => {
        let o = t.get(e);
    ...
    ((e, t = "") => {
        ...
        if (0 !== o) {
            ...
            {
                const e = o - 1;
                for (let o = 0; o < e; o++) for (let r = e; r > o; r--) {
                    const e = `${n.slice(o, r).join(".")}.*${t}`;
                    c(e, i, d), c(e, s, g);
                }
            }
        }
