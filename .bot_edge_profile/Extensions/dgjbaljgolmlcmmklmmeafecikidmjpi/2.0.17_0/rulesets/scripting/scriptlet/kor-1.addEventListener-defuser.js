!function() {
    ...
    const r = {}, o = [ [ "hashchange", "#viewus-explore-more" ], [ "DOMContentLoaded", "link.coupang.com" ], [ "load", "_0x" ] ], i = new Map([ [ "youtu.co", 0 ], [ "dfast.kr", 0 ], [ "whathappen.co.kr", 1 ], [ "momkim.co.kr", 1 ], [ "klauncher.kr", 2 ] ]), s = new Map([]), c = (t, e, n) => {
        let r = e.get(t);
