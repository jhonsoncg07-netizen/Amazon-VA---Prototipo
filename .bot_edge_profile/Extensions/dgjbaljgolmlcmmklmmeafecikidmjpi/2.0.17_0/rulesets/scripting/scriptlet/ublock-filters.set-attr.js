!function() {
    function e(e = "", r = "", o = "") {
        const n = t().makeLogPrefix("set-attr", e, r, o);
        if (!1 === [ "", "false", "true" ].includes(o.toLowerCase())) if (/^\d+$/.test(o)) {
            const e = parseInt(o, 10);
            if (e >= 32768) return;
            o = `${e}`;
        } else if (!1 === /^\[.+\]$/.test(o)) return;
        !function(e = !1, r, o = "", n = "", s = "") {
            if ("" === o) return;
            if ("" === n) return;
            const i = t(), a = !1 === e && /^\[.+\]$/.test(s) ? s.slice(1, -1) : "", c = e => "" !== a ? e.getAttribute(a) || "" : s, l = () => {
                let e;
                try {
                ...
                for (const t of e) {
                    const e = t.getAttribute(n), o = c(t);
                    o !== e && ("" !== o && /^on/i.test(n) && n.toLowerCase() in t || (t.setAttribute(n, o), 
                    i.uboLog(r, `${n}="${o}"`)));
                }
                return !0;
            };
            ...
            const f = e => {
                ...
                !1 !== t && (g = self.requestAnimationFrame((() => {
                    g = void 0, l();
                })));
            };
            !function(e, r) {
                ...
                const i = t(), a = [ "readystatechange", () => {
                    o(document.readyState) < n || (e(), i.removeEventListener.apply(document, a));
                }, {
                    capture: !0
                } ];
                i.addEventListener.apply(document, a);
            }((() => {
                !1 !== l() && (d = new MutationObserver(f), d.observe(document.body, {
                    subtree: !0,
                    childList: !0
                }));
            }));
    ...
    const r = {}, o = [ [ ':is(.watch-on-link-logo, li.post) img.ezlazyload[src^="data:image"][data-ezsrc]', "src", "[data-ezsrc]" ], [ ".lazy", "src", "[data-sco-src]" ], [ 'iframe[data-src-cmplz][src="about:blank"]', "src", "[data-src-cmplz]" ], [ ".video-skip[data-time]", "data-time", "0" ], [ 'c-wiz[data-p] [data-query] a[target="_blank"][role="link"]', "rlhc", "1" ] ], n = new Map([ [ "wnynewsnow.com", 0 ], [ "rocketnews24.com", 1 ], [ "soranews24.com", 1 ], [ "youpouch.com", 1 ], [ "statisticsanddata.org", 2 ], [ "18kalebettv.xyz", 3 ], [ "19kalebettv.xyz", 3 ], [ "www.google.*", 4 ] ]), s = new Map([]), i = (e, t, r) => {
        let o = t.get(e);
