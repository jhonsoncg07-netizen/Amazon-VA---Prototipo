!function() {
    function e(e = "") {
        ...
        if ("" === e) return;
        const t = o(), r = t.makeLogPrefix("abort-on-property-read", e), n = function() {
            const e = function() {
                const e = o();
            ...
            throw t.uboLog(r, "Aborted"), new ReferenceError(n);
        }, i = function(e, o) {
            const t = o.indexOf(".");
            if (-1 === t) {
                const t = Object.getOwnPropertyDescriptor(e, o);
                return void (t && t.get === c || Object.defineProperty(e, o, {
                    get: c,
                    set: function() {}
                }));
            }
            const r = o.slice(0, t);
            let n = e[r];
            if (o = o.slice(t + 1), n) return void i(n, o);
    ...
    ((e, o = "") => {
        ...
        if (0 !== r) {
            ...
            {
                const e = r - 1;
                for (let r = 0; r < e; r++) for (let a = e; a > r; a--) {
                    const e = `${t.slice(r, a).join(".")}.*${o}`;
                    i(e, n, m), i(e, c, l);
                }
            }
        }
