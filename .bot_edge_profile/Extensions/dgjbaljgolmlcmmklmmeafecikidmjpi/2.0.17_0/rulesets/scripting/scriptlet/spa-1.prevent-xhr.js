!function() {
    function e(...e) {
        return function(e = !1, n = "", o = "") {
            ...
            const s = t(), i = e ? "trusted-prevent-xhr" : "prevent-xhr", a = s.makeLogPrefix(i, n, o), c = new WeakMap, p = function(e, r = "") {
                const n = t(), o = new Map;
            ...
            self.XMLHttpRequest = class extends self.XMLHttpRequest {
                open(e, r, ...i) {
                    if (c.delete(this), void 0 !== l && r.startsWith(l)) return super.open(e, r, ...i);
                    const u = {
                        method: e,
                        url: r
                    };
                    if ("" === n && "" === o) return s.uboLog(a, `Called: ${s.JSON_stringify(u, null, 2)}`), 
                    super.open(e, r, ...i);
                    if (function(e, ...r) {
                        const n = t(), o = [];
                ...
                send(...n) {
                    ...
                    switch (this.responseType) {
                      ...
                      default:
                        ...
                        }(e, i.directive), p instanceof Promise ? p = p.then((e => {
                            i.props.response.value = e, i.props.responseText.value = e;
                        })) : (i.props.response.value = p, i.props.responseText.value = p), i.headers["content-type"] = "text/plain";
                    }
                    ...
                    Promise.resolve(p).then((() => i)).then((e => (Object.defineProperties(e.xhr, {
                        readyState: {
                            value: 1,
                            configurable: !0
                        },
                    ...
                    }), u(e.xhr, "readystatechange"), e))).then((e => (i.headers["content-length"] = `${e.props.response.value}`.length, 
                    ...
                    }), u(e.xhr, "readystatechange"), e))).then((e => (Object.defineProperties(e.xhr, {
                        readyState: {
                            value: 3,
                            configurable: !0
                        }
                    }), Object.defineProperties(e.xhr, e.props), u(e.xhr, "readystatechange"), e))).then((e => {
                        Object.defineProperties(e.xhr, {
                            readyState: {
                                value: 4
                            }
                        }), u(e.xhr, "readystatechange"), u(e.xhr, "load"), u(e.xhr, "loadend"), s.uboLog(a, `Prevented with response:\n${e.xhr.response}`);
                    }));
                }
                getResponseHeader(e) {
                    const t = c.get(this);
    ...
    const r = {}, n = [ [ "widgets.outbrain.com" ], [ "widgets.outbrain.com/outbrain.js" ], [ "pagead2.googlesyndication.com" ], [ "securepubads.g.doubleclick.net/pagead/ppub_config" ], [ "popads.net" ], [ "//cdn.taboola.com/libtrc/unpkg/tfa.js" ] ], o = new Map([ [ "file4go.net", 0 ], [ "isekaibrasil.com", 1 ], [ "aqualapp.com", 2 ], [ "raulprietofernandez.net", 2 ], [ "minhaconexao.com.br", 3 ], [ "receitasdaora.online", 4 ], [ "foodiesgallery.com", 4 ], [ "caroloportunidades.com.br", 4 ], [ "dicasgostosas.com", 4 ], [ "drstonebr.com", 5 ], [ "animesonliner4.com", 5 ], [ "coempregos.com.br", 5 ], [ "anitube.us", 5 ], [ "dattebayo-br.com", 5 ], [ "anitube.vip", 5 ] ]), s = new Map([]), i = (e, t, r) => {
        let n = t.get(e);
    ...
    for (const t of p) if (!l.has(t)) try {
        e(...n[t]);
    } catch {}
}();