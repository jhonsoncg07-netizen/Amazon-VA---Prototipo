!function() {
    function t(t = "") {
        ...
        const r = function() {
            ...
            return e;
        }(), o = r.makeLogPrefix("noeval-if", t), i = r.patternToRegex(t);
        e("eval", (function(e) {
            const {callArgs: n} = e, s = String(n[0]);
            if ("" === t || !i.test(s)) return ("" === t || r.logLevel > 1) && r.uboLog(o, "Not prevented:\n", s), 
            e.reflect();
    ...
    const n = {}, r = [ [ "広告" ], [ "hoihoi" ] ], o = new Map([ [ "pokegonews.net", 0 ], [ "ov53i9il.blog.fc2.com", 1 ], [ "mjoato3uion.ky-3.net", 1 ], [ "qaacacthlive.omaww.net", 1 ] ]), i = new Map([]), s = (t, e, n) => {
        let r = e.get(t);
