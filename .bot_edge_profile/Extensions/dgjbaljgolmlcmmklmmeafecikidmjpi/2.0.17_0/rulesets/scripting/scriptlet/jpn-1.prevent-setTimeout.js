!function() {
    function t(t = "", r = "") {
        const i = function() {
            ...
            return e;
        }(), s = i.makeLogPrefix("prevent-setTimeout", t, r), c = "!" === t.charAt(0), a = i.patternToRegex(c ? t.slice(1) : t), l = new n(r);
        e("setTimeout", (function(e) {
            const {callArgs: n} = e, o = n[0] instanceof Function ? i.String(i.Function_toString(n[0])) : i.String(n[0]), r = n[1];
            return "" === t && l.unbound() ? (i.uboLog(s, `Called:\n${o}\n${r}`), e.reflect()) : (a.test(o) !== c && l.test(r) && (n[0] = function() {}, 
    ...
    const o = {}, r = [ [ "()=>k(S(4" ], [ "return" ], [ "oAdChk" ], [ "_0x" ], [ "/location\\.href|document\\./" ], [ "objDef.resolve" ], [ "movie_cnt", "300" ], [ "getAdCookie" ], [ "floatingAd" ], [ "return r(!0)" ], [ "return n(!0)" ] ], i = new Map([ [ "wiki.yjsnpi.nu", 0 ], [ "kotobank.jp", 1 ], [ "o-dan.net", 2 ], [ "manga1001.*", 3 ], [ "fp1-siken.com", 3 ], [ "fp2-siken.com", 3 ], [ "fp3-siken.com", 3 ], [ "ap-siken.com", 3 ], [ "db-siken.com", 3 ], [ "fe-siken.com", 3 ], [ "itpassportsiken.com", 3 ], [ "nw-siken.com", 3 ], [ "pm-siken.com", 3 ], [ "sc-siken.com", 3 ], [ "sg-siken.com", 3 ], [ "musenboya.com", 4 ], [ "crefan.jp", 5 ], [ "nan-net.com", 6 ], [ "javcup.com", 7 ], [ "46matome.net", 8 ], [ "openworldnews.net", 8 ], [ "animesoku.com", 8 ], [ "vipnews.jp", 8 ], [ "ldblog.jp", 8 ], [ "livedoor.blog", 8 ], [ "2chblog.jp", 8 ], [ "oumaga-times.com", 8 ], [ "all-nationz.com", 8 ], [ "ebitsu.net", 8 ], [ "fiveslot777.com", 8 ], [ "jisaka.com", 8 ], [ "kijyomatome.com", 8 ], [ "konoyubitomare.jp", 8 ], [ "livedoor.biz", 8 ], [ "momoclonews.com", 8 ], [ "norisoku.com", 8 ], [ "pachinkopachisro.com", 8 ], [ "vtubernews.jp", 8 ], [ "blog.jp", 8 ], [ "giants-news.com", 8 ], [ "blog.livedoor.jp", 8 ], [ "doorblog.jp", 8 ], [ "twiman.net", 9 ], [ "skebetter.com", 10 ] ]), s = new Map([]), c = (t, e, n) => {
        let o = e.get(t);
    ...
    ((t, e = "") => {
        ...
        if (0 !== o) {
            ...
            {
                const t = o - 1;
                for (let o = 0; o < t; o++) for (let r = t; r > o; r--) {
                    const t = `${n.slice(o, r).join(".")}.*${e}`;
                    c(t, i, p), c(t, s, g);
                }
            }
        }
