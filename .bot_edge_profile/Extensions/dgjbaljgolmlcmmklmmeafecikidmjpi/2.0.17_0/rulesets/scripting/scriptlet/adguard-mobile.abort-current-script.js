!function() {
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", r = "", o = "") {
                ...
                if ("" === e) return;
                const i = t(), s = i.makeLogPrefix("abort-current-script", e, r, o), c = i.patternToRegex(r), a = i.patternToRegex(o), l = i.getExtraArgs(Array.from(arguments), 3), g = document.currentScript, f = i.String_split.call(e, ".");
                let u, d, p = window;
                ...
                const b = function() {
                    ...
                    i.logLevel > 1 && "" !== o && i.uboLog(s, `Matched src\n${e.src}`);
                    const t = O(e);
                    if (!1 !== c.test(t)) throw i.logLevel > 1 && i.uboLog(s, `Matched text\n${t}`), 
                    i.uboLog(s, "Aborted"), new ReferenceError(b);
                };
                try {
    ...
    const n = {}, r = [ [ "$", "exoMobilePop" ], [ "bindPostitial" ], [ "document.getElementsByClassName", "adBlocked" ], [ "jmp", "Math" ], [ "navigator.userAgent", "_rand" ] ], o = new Map([ [ "m.sunporno.com", 0 ], [ "straitstimes.com", 1 ], [ "supleks.jp", 2 ], [ "komaki2.jp", 3 ], [ "seikeidouga.blog.jp", 4 ] ]), i = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
