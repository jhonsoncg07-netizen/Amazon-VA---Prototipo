!function() {
    function e(e = "") {
        ...
        if ("" === e) return;
        const r = t(), o = r.makeLogPrefix("abort-on-property-read", e), n = function() {
            const e = function() {
                const e = t();
            ...
            const o = t.slice(0, r);
            let n = e[o];
            if (t = t.slice(r + 1), n) return void s(n, t);
    ...
    const r = {}, o = [ [ "ads" ], [ "alertadmodal" ], [ "adBlockDetected" ], [ "daau_app" ], [ "Object.prototype.ShouldLoadAds" ], [ "popunder" ], [ "akumtagcc" ], [ "myclick" ] ], n = new Map([ [ "2urs.com", 0 ], [ "caq98i.top", 1 ], [ "1090ys8.com", 2 ], [ "papalah.com", 2 ], [ "youneed.win", 3 ], [ "yfsp.tv", 4 ], [ "aiyifan.tv", 4 ], [ "iyf.tv", 4 ], [ "goodav17.com", 5 ], [ "m.86kl.com", 6 ], [ "axjbt.com", 7 ], [ "avcao.cc", 7 ] ]), i = new Map([]), s = (e, t, r) => {
        let o = t.get(e);
