    ...
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", n = "", r = "") {
                ...
                if ("" === e) return;
                const c = t(), i = c.makeLogPrefix("abort-current-script", e, n, r), s = c.patternToRegex(n), a = c.patternToRegex(r), l = c.getExtraArgs(Array.from(arguments), 3), m = document.currentScript, g = c.String_split.call(e, ".");
                let f, d, p = window;
                for (;f = g.shift(), 0 !== g.length && f in p != 0; ) if (p = p[f], p instanceof Object == 0) return;
                let u = Object.getOwnPropertyDescriptor(p, f);
                u instanceof Object != 0 && u.get instanceof Function != 0 || (d = p[f], u = void 0), 
                function(e) {
                ...
                try {
                    Object.defineProperty(p, f, {
                        get: function() {
                            return O(), u instanceof Object ? u.get.call(p) : d;
                        },
                        set: function(e) {
                            O(), u instanceof Object ? u.set.call(p, e) : d = e;
                        }
                    });
                } catch (e) {
                    c.uboErr(i, `Error: ${e}`);
