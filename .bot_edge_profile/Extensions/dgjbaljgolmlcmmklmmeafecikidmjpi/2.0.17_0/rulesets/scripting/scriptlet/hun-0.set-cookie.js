!function() {
    function e(e = "", o = "", r = "") {
        if ("" === e) return;
        const s = t(), i = s.makeLogPrefix("set-cookie", e, o, r), c = o.toLowerCase(), a = /^("?)(.+)\1$/.exec(c), d = a && a[2] || c;
        ...
        const l = function(e = !1, t = "", o = "", r = "", s = "", i = {}) {
            ...
            const d = n(t) === o;
            return d && i.reload && window.location.reload(), d;
    ...
    const o = {}, r = [ [ "cookie.consent.finished", "1" ], [ "gdpr_level", "1" ], [ "stpdsck", "1" ] ], s = new Map([ [ "fizz.hu", [ 0, 1 ] ], [ "myonlineradio.hu", 2 ] ]), i = new Map([]), c = (e, t, n) => {
        let o = t.get(e);
