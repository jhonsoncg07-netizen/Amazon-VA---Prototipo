!function() {
    function e(e = "", r = "", o = "") {
        ...
        if ("" === e) return;
        const n = t(), s = n.makeLogPrefix("remove-attr", e, r, o), i = n.String_split.call(e, /\s*\|\s*/), a = i.map((e => `${r}[${CSS.escape(e)}]`)).join(",");
    ...
    const r = {}, o = [ [ "jsaction", '#islsp c-wiz a[href^="http"][data-ved][target]', "stay" ], [ "data-cturl", ".searchresults a", "stay" ], [ "data-safe-proxy-url", "a", "stay" ], [ "data-link-id", "a", "stay" ], [ "data-counter", "#search-result > .serp-item a" ] ], n = new Map([ [ "www.google.*", 0 ], [ "search.ukr.net", 1 ], [ "mail.ukr.net", 2 ], [ "mail.yandex.*", 3 ], [ "ya.*", 4 ], [ "yandex.*", 4 ] ]), s = new Map([ [ "yandex.net", [ 4 ] ] ]), i = (e, t, r) => {
        let o = t.get(e);
