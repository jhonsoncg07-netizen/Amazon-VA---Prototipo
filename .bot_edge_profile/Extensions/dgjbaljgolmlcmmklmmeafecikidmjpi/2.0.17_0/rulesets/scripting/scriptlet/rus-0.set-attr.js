!function() {
    function e(e = "", r = "", o = "") {
        ...
        !function(e = !1, r, o = "", n = "", s = "") {
            if ("" === o) return;
            if ("" === n) return;
            const i = t(), c = !1 === e && /^\[.+\]$/.test(s) ? s.slice(1, -1) : "", a = e => "" !== c ? e.getAttribute(c) || "" : s, l = () => {
                let e;
                try {
                ...
                for (const t of e) {
                    const e = t.getAttribute(n), o = a(t);
            ...
            !function(e, r) {
                ...
                const i = t(), c = [ "readystatechange", () => {
                    o(document.readyState) < n || (e(), i.removeEventListener.apply(document, c));
                }, {
                    capture: !0
                } ];
                i.addEventListener.apply(document, c);
            }((() => {
                !1 !== l() && (d = new MutationObserver(u), d.observe(document.body, {
                    subtree: !0,
                    childList: !0
                }));
            }));
    ...
    const r = {}, o = [ [ "._1z_ ._21_", "style", "" ], [ ".comment-media > .andropov-video > video", "controls", "true" ], [ ".media > .andropov-video > video", "controls", "true" ], [ ".owl-item > a > img", "src", "[data-src]" ], [ '[class^="articleBlockVideo_"] video', "controls", "true" ], [ 'img[src="https://overclockers.ru/assets/logo_gray_stub.gif"]', "src", "[data-src]" ], [ "video", "controls", "true" ], [ 'video[controls="controls"]', "controls", "true" ], [ "#progress-value", "data-timer", "25" ] ], n = new Map([ [ "playvillage.ru", 0 ], [ "dtf.ru", [ 1, 2 ] ], [ "vc.ru", [ 1, 2 ] ], [ "eneyida.tv", 3 ], [ "fontanka.ru", 4 ], [ "overclockers.ru", 5 ], [ "joyreactor.cc", 6 ], [ "reactor.cc", 6 ], [ "3dnews.ru", 7 ], [ "howdyho.*", 8 ] ]), s = new Map([]), i = (e, t, r) => {
        let o = t.get(e);
