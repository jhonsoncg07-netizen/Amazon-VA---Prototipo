!function() {
    function e(...e) {
        return function(e = !1, n = "", o = "") {
            if ("string" != typeof n) return;
            const s = t(), i = e ? "trusted-prevent-xhr" : "prevent-xhr", a = s.makeLogPrefix(i, n, o), u = new WeakMap, l = function(e, r = "") {
                const n = t(), o = new Map;
                if (void 0 === e || "" === e) return o;
                const s = {
                    canNegate: !0
                };
                for (const t of n.String_split.call(e, /\s+/)) {
                    let [e, i] = n.String_split.call(t, ":");
                    "" !== e && (void 0 !== i && /[^$\w -]/.test(e) && (e = `${e}:${i}`, i = void 0), 
                    void 0 !== i ? o.set(e, n.initPattern(i, s)) : "" !== r && o.set(r, n.initPattern(e, s)));
                }
                return o;
            }(n, "url"), c = r.warOrigin, p = (e, t) => {
                try {
            ...
            self.XMLHttpRequest = class extends self.XMLHttpRequest {
                open(e, r, ...i) {
                    if (u.delete(this), void 0 !== c && r.startsWith(c)) return super.open(e, r, ...i);
                    const p = {
                        method: e,
                        url: r
                    };
                    if ("" === n && "" === o) return s.uboLog(a, `Called: ${s.JSON_stringify(p, null, 2)}`), 
                    super.open(e, r, ...i);
                    if (function(e, ...r) {
                        const n = t(), o = [];
                    ...
                    return super.open(e, r, ...i);
                }
                send(...n) {
                    const i = u.get(this);
                    if (void 0 === i) return super.send(...n);
                    i.headers.date = (new Date).toUTCString();
                    let l = "";
                    switch (this.responseType) {
                      case "arraybuffer":
                        i.props.response.value = new ArrayBuffer(0), i.headers["content-type"] = "application/octet-stream";
                        break;

                      case "blob":
                        i.props.response.value = new Blob([]), i.headers["content-type"] = "application/octet-stream";
                        break;

                      case "document":
                        {
                            const e = (new DOMParser).parseFromString("", "text/html");
                            i.props.response.value = e, i.props.responseXML.value = e, i.headers["content-type"] = "text/html";
                            break;
                        }

                      case "json":
                        i.props.response.value = {}, i.props.responseText.value = "{}", i.headers["content-type"] = "application/json";
                        break;
                      ...
                      default:
                        ...
                        l = function(e, n) {
                            ...
                            if (n.startsWith("length:")) {
                                ...
                                if (null === e) return "";
                                const t = parseInt(e[1], 10), r = o.Math_max(parseInt(e[2], 10) || 0, t) - t;
                                return s(0 | o.Math_min(t + r * o.Math_random(), 5e5));
                            }
                            return n.startsWith("war:") ? void 0 === r.warOrigin ? "" : new Promise((e => {
                                const t = [ r.warOrigin, "/", n.slice(4) ], s = r.warSecret;
                                void 0 !== s && t.push("?secret=", s);
                                const i = new o.XMLHttpRequest;
                                i.responseType = "text", i.onloadend = t => {
                                    e(t.target.responseText || "");
                                }, i.open("GET", t.join("")), i.send();
                            })).catch((() => "")) : e ? n : "";
                        }(e, i.directive), l instanceof Promise ? l = l.then((e => {
                            i.props.response.value = e, i.props.responseText.value = e;
                        })) : (i.props.response.value = l, i.props.responseText.value = l), i.headers["content-type"] = "text/plain";
                    }
                    if (!1 === i.defer) return i.headers["content-length"] = `${i.props.response.value}`.length, 
                    Object.defineProperties(i.xhr, {
                        readyState: {
                            value: 4
                        },
                        responseURL: {
                    ...
                    }), void Object.defineProperties(i.xhr, i.props);
                    Promise.resolve(l).then((() => i)).then((e => (Object.defineProperties(e.xhr, {
                        readyState: {
                            value: 1,
                            configurable: !0
                        },
                    ...
                    }), p(e.xhr, "readystatechange"), e))).then((e => (i.headers["content-length"] = `${e.props.response.value}`.length, 
                    Object.defineProperties(e.xhr, {
                        ...
                        }), p(e.xhr, "readystatechange"), p(e.xhr, "load"), p(e.xhr, "loadend"), s.uboLog(a, `Prevented with response:\n${e.xhr.response}`);
                    }));
                }
                getResponseHeader(e) {
                    const t = u.get(this);
    ...
    function t() {
        ...
        t.toLogText = (e, ...t) => {
            ...
            return r === o && e === n && Date.now() - s < 5e3 ? void 0 : (n = e, o = r, s = Date.now(), 
            r);
        };
        try {
            const n = new e.BroadcastChannel(r.bcSecret);
            let o = [];
            t.sendToLogger = (e, ...r) => {
                const s = t.toLogText(e, ...r);
                if (void 0 !== s) return void 0 === o ? n.postMessage({
    ...
    const r = {}, n = [ [ "/ad\\.mail|adfox|adhigh|adriver|mc\\.yandex|mediametrics|otm-r|static-mon/" ], [ "/br/" ], [ "/getCode|\\/vast/" ], [ "/hits/event/", "method:POST" ], [ "/m2?_" ], [ "/wl-analytics\\.tsp\\.li/" ], [ "livejournal.com/video/check?recordId=" ], [ "method:GET" ], [ "strm.yandex.ru/get/" ], [ "&pgid=" ] ], o = new Map([ [ "liveinternet.ru", 0 ], [ "motorpage.ru", 1 ], [ "anidub.vip", 2 ], [ "anidubonline.com", 2 ], [ "116.ru", 3 ], [ "14.ru", 3 ], [ "161.ru", 3 ], [ "164.ru", 3 ], [ "173.ru", 3 ], [ "178.ru", 3 ], [ "26.ru", 3 ], [ "29.ru", 3 ], [ "35.ru", 3 ], [ "43.ru", 3 ], [ "45.ru", 3 ], [ "48.ru", 3 ], [ "51.ru", 3 ], [ "53.ru", 3 ], [ "56.ru", 3 ], [ "59.ru", 3 ], [ "60.ru", 3 ], [ "62.ru", 3 ], [ "63.ru", 3 ], [ "68.ru", 3 ], [ "71.ru", 3 ], [ "72.ru", 3 ], [ "74.ru", 3 ], [ "76.ru", 3 ], [ "86.ru", 3 ], [ "89.ru", 3 ], [ "93.ru", 3 ], [ "chita.ru", 3 ], [ "e1.ru", 3 ], [ "ircity.ru", 3 ], [ "izh1.ru", 3 ], [ "mgorsk.ru", 3 ], [ "msk1.ru", 3 ], [ "ngs.ru", 3 ], [ "ngs22.ru", 3 ], [ "ngs24.ru", 3 ], [ "ngs42.ru", 3 ], [ "ngs55.ru", 3 ], [ "ngs70.ru", 3 ], [ "nn.ru", 3 ], [ "sochi1.ru", 3 ], [ "sterlitamak1.ru", 3 ], [ "tolyatty.ru", 3 ], [ "ufa1.ru", 3 ], [ "v1.ru", 3 ], [ "vladivostok1.ru", 3 ], [ "voronezh1.ru", 3 ], [ "www.fontanka.ru", 3 ], [ "4pda.to", 4 ], [ "adme.media", 5 ], [ "livejournal.com", 6 ], [ "sm.news", 7 ], [ "dzen.ru", 8 ], [ "frontend.vh.yandex.ru", 8 ], [ "naydex.net", 8 ], [ "widgets.kinopoisk.ru", 8 ], [ "www.kinopoisk.ru", 8 ], [ "yastatic.net", 8 ], [ "mail.ru", 9 ] ]), s = new Map([ [ "3igames.mail.ru", [ 9 ] ], [ "account.mail.ru", [ 9 ] ], [ "auto.mail.ru", [ 9 ] ], [ "biz.mail.ru", [ 9 ] ], [ "blog.mail.ru", [ 9 ] ], [ "bonus.mail.ru", [ 9 ] ], [ "calendar.mail.ru", [ 9 ] ], [ "calls.mail.ru", [ 9 ] ], [ "cloud.mail.ru", [ 9 ] ], [ "connect.mail.ru", [ 9 ] ], [ "deti.mail.ru", [ 9 ] ], [ "dobro.mail.ru", [ 9 ] ], [ "e.mail.ru", [ 9 ] ], [ "finance.mail.ru", [ 9 ] ], [ "gibdd.mail.ru", [ 9 ] ], [ "health.mail.ru", [ 9 ] ], [ "help.mail.ru", [ 9 ] ], [ "hi-tech.mail.ru", [ 9 ] ], [ "horo.mail.ru", [ 9 ] ], [ "kino.mail.ru", [ 9 ] ], [ "lady.mail.ru", [ 9 ] ], [ "love.mail.ru", [ 9 ] ], [ "mcs.mail.ru", [ 9 ] ], [ "minigames.mail.ru", [ 9 ] ], [ "my.mail.ru", [ 9 ] ], [ "news.mail.ru", [ 9 ] ], [ "o2.mail.ru", [ 9 ] ], [ "octavius.mail.ru", [ 9 ] ], [ "okminigames.mail.ru", [ 9 ] ], [ "otvet.mail.ru", [ 9 ] ], [ "pets.mail.ru", [ 9 ] ], [ "player-smotri.mail.ru", [ 9 ] ], [ "pogoda.mail.ru", [ 9 ] ], [ "top.mail.ru", [ 9 ] ], [ "touch.mail.ru", [ 9 ] ], [ "tv.mail.ru", [ 9 ] ], [ "vfokuse.mail.ru", [ 9 ] ], [ "widgets.mail.ru", [ 9 ] ] ]), i = (e, t, r) => {
        let n = t.get(e);
    ...
    for (const t of l) if (!c.has(t)) try {
        e(...n[t]);
    } catch {}
}();