!function() {
    function e(e, o, ...r) {
        !function(e = "", o = "", r = "") {
            const n = t(), c = n.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), s = n.patternToRegex(e, "i", !0), i = n.patternToRegex(o, "gms"), a = n.getExtraArgs(Array.from(arguments), 3), l = a.includes || a.condition ? n.patternToRegex(a.includes || a.condition, "ms") : null, p = a.excludes ? n.patternToRegex(a.excludes, "ms") : null, u = (e = !0) => {
                e && f(b.takeRecords()), b.disconnect(), n.logLevel > 1 && n.uboLog(c, "Quitting");
            }, m = (() => {
                const e = {
                    createScript: e => e
                }, {trustedTypes: o} = self;
            ...
            const g = e => {
                ...
                if (l && (l.lastIndex = 0, !1 === n.RegExp_test.call(l, t))) return !0;
                if (p && (p.lastIndex = 0, n.RegExp_test.call(p, t))) return !0;
                if (i.lastIndex = 0, !1 === n.RegExp_test.call(i, t)) return !0;
                i.lastIndex = 0;
                const s = "" !== o ? t.replace(i, r) : r;
                return e.textContent = "SCRIPT" === e.nodeName ? m.createScript(s) : s, n.logLevel > 1 && n.uboLog(c, `Text before:\n${t.trim()}`), 
                n.uboLog(c, `Text after:\n${s.trim()}`), 0 === d || 0 != (d -= 1);
            }, f = e => {
                for (const t of e) for (const e of t.addedNodes) if (!1 !== s.test(e.nodeName) && !g(e)) return void u(!1);
            }, b = new MutationObserver(f);
            if (b.observe(document, {
                childList: !0,
                subtree: !0
                ...
                for (;;) {
                    const o = e.nextNode();
                    if (t += 1, null === o) break;
                    if (!1 !== s.test(o.nodeName) && o !== document.currentScript && !g(o)) {
                        u();
                        break;
                    }
                }
                n.uboLog(c, `${t} nodes present before installing mutation observer`);
            }
            a.stay || function(e, o) {
                const r = e => {
                    const t = {
                ...
                const s = t(), i = [ "readystatechange", () => {
                    r(document.readyState) < n || (e(), s.removeEventListener.apply(document, i));
                }, {
                    capture: !0
                } ];
    ...
    function t() {
        ...
        t.toLogText = (e, ...t) => {
            ...
            return o === n && e === r && Date.now() - c < 5e3 ? void 0 : (r = e, n = o, c = Date.now(), 
            o);
        };
        try {
