!function() {
    function e(e, n, r, ...o) {
        !function(e = "", n = "", r = "") {
            const o = t(), i = o.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), s = o.patternToRegex(e, "i", !0), a = o.patternToRegex(n, "gms"), c = o.getExtraArgs(Array.from(arguments), 3), l = c.includes || c.condition ? o.patternToRegex(c.includes || c.condition, "ms") : null, d = c.excludes ? o.patternToRegex(c.excludes, "ms") : null, g = (e = !0) => {
            ...
            const f = e => {
                ...
                if (a.lastIndex = 0, !1 === o.RegExp_test.call(a, t)) return !0;
                a.lastIndex = 0;
                const s = "" !== n ? t.replace(a, r) : r;
                return e.textContent = "SCRIPT" === e.nodeName ? p.createScript(s) : s, o.logLevel > 1 && o.uboLog(i, `Text before:\n${t.trim()}`), 
            ...
            if (x.observe(document, {
                ...
                for (;;) {
                    const n = e.nextNode();
                    if (t += 1, null === n) break;
                    if (!1 !== s.test(n.nodeName) && n !== document.currentScript && !f(n)) {
                        g();
                        break;
                    }
                }
    ...
    const n = {}, r = [ [ "style", ".np{", ".dummy{", "condition", "@media print" ], [ "script", "if(floovy()) {", "if(false) {" ], [ "script", "window.location.reload" ], [ "style", "@media print" ], [ "style", "/\\.novel-box \\*:not\\(a\\)|@media print/g" ] ], o = new Map([ [ "novelpia.com", 0 ], [ "heidisql.com", 1 ], [ "baumbet.ro", 2 ], [ "karsaz-law.com", 3 ], [ "mskmangaz.blogspot.com", 4 ] ]), i = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
