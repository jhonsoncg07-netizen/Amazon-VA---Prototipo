!function() {
    function e(e = "") {
        ...
        if ("" === e) return;
        const r = t(), o = r.makeLogPrefix("abort-on-property-write", e), n = function() {
            const e = function() {
                const e = t();
            ...
            return self.onerror = function(t, ...o) {
                return !("string" != typeof t || !t.includes(e)) || (r instanceof Function ? r.call(this, t, ...o) : void 0);
            }.bind(), e;
        }();
        let i = window;
        for (;;) {
            const t = e.indexOf(".");
            if (-1 === t) break;
            if (i = i[e.slice(0, t)], i instanceof Object == 0) return;
            e = e.slice(t + 1);
        }
        delete i[e], Object.defineProperty(i, e, {
            set: function() {
                throw r.uboLog(o, "Aborted"), new ReferenceError(n);
            }
        });
    }
    function t() {
    ...
    const r = {}, o = [ [ "NiceScroll" ], [ "adsBlocked" ], [ "ai_front" ], [ "disableSelection" ], [ "disable_keystrokes" ], [ "document.oncontextmenu" ], [ "document.ondragstart" ], [ "document.onselectstart" ], [ "fetch" ], [ "keepAdblock" ], [ "window.yaProxy" ], [ "mailruEnabled" ] ], n = new Map([ [ "transkarpatia.net", 0 ], [ "24pdd.ru", 1 ], [ "doctorrouter.ru", 2 ], [ "ranobe-novels.ru", 2 ], [ "tests24.su", 2 ], [ "ufchgu.ru", [ 3, 4 ] ], [ "fssp.gov.ru", [ 5, 6, 7 ] ], [ "southpark.su", [ 5, 6, 7 ] ], [ "turkcinema.org", [ 5, 6, 7 ] ], [ "phys-kids.com", 8 ], [ "gamemag.ru", 9 ], [ "kakprosto.ru", 10 ], [ "ok.ru", 11 ] ]), i = new Map([]), s = (e, t, r) => {
        let o = t.get(e);
