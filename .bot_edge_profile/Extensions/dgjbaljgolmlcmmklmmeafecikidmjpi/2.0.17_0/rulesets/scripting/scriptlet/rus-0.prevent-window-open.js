!function() {
    function t(t = "", r = "", n = "") {
        const s = function() {
            ...
            const t = globalThis, e = {
                ...
                getExtraArgs(t, e = 0) {
                    const o = t.slice(e).reduce(((t, e, o, r) => {
                        if (0 == (1 & o)) {
                            const e = r[o + 1], n = /^\d+$/.test(e) ? parseInt(e, 10) : e;
                            t.push([ r[o], n ]);
                        }
                        return t;
                    }), []);
            ...
            e.toLogText = (t, ...e) => {
                ...
                return o === n && t === r && Date.now() - s < 5e3 ? void 0 : (r = t, n = o, s = Date.now(), 
                o);
            };
            try {
                const r = new t.BroadcastChannel(o.bcSecret);
                let n = [];
                e.sendToLogger = (t, ...o) => {
                ...
                e.sendToLogger = (t, ...o) => {
                    const r = e.toLogText(t, ...o);
                    void 0 !== r && e.log(`uBO ${r}`);
                };
            }
            return e;
        }(), i = s.makeLogPrefix("no-window-open-if", t, r, n), c = !1 === t.startsWith("!");
        !1 === c && (t = t.slice(1));
        const a = s.patternToRegex(t), l = 1e3 * (parseFloat(r) || 0), p = self.setTimeout, g = function(t, e, o) {
            const r = document.createElement(t);
            return r[e] = o, r.style.setProperty("height", "1px", "important"), r.style.setProperty("position", "fixed", "important"), 
            r.style.setProperty("top", "-1px", "important"), r.style.setProperty("width", "1px", "important"), 
            document.body.appendChild(r), p((() => {
                r.remove();
            }), l), r;
        }, u = function() {};
        e("open", (function(e) {
            if ("debug" === t && 0 !== s.logLevel) return e.reflect();
            const {callArgs: o} = e, f = o.join(" ");
            if (a.test(f) !== c) return s.logLevel > 1 && s.uboLog(i, `Allowed (${o.join(", ")})`), 
            e.reflect();
            if (s.uboLog(i, `Prevented (${o.join(", ")})`), "" === r) return null;
            if ("blank" === n) {
                o[0] = "about:blank";
                const t = e.reflect();
                return p((() => {
            ...
            let d = ("obj" === n ? g("object", "data", ...o) : g("iframe", "src", ...o)).contentWindow;
            return "object" == typeof d && null !== d ? Object.defineProperty(d, "closed", {
                value: !1
            }) : d = new Proxy(self, {
                get: function(t, e, ...o) {
                    if ("closed" === e) return !1;
                    const r = Reflect.get(t, e, ...o);
                    return "function" == typeof r ? u : r;
                },
                set: function(...t) {
                    return Reflect.set(...t);
                }
            }), 0 !== s.logLevel && (d = new Proxy(d, {
                get: function(t, e, ...o) {
                    const r = Reflect.get(t, e, ...o);
                    return s.uboLog(i, `popup / get ${e} === ${r}`), "function" == typeof r ? (...e) => r.call(t, ...e) : r;
                },
                set: function(t, e, o, ...r) {
                    return s.uboLog(i, `popup / set ${e} = ${o}`), Reflect.set(t, e, o, ...r);
                }
            })), d;
        }));
    }
    function e(t = "", o = "") {
        let r = globalThis, n = t;
        for (;;) {
            const t = n.indexOf(".");
            if (-1 === t) break;
            if (r = r[n.slice(0, t)], r instanceof Object == 0) return;
            n = n.slice(t + 1);
        }
        const s = r[n];
    ...
    ((t, e = "") => {
        const o = t.split("."), r = o.length;
        if (0 !== r) for (let t = 0; t < r; t++) {
            const r = `${o.slice(t).join(".")}${e}`;
            i(r, n, l), i(r, s, p);
        }
    })(a[0].hn);
    for (const e of l) if (!p.has(e)) try {
        t(...r[e]);
    } catch {}
}();