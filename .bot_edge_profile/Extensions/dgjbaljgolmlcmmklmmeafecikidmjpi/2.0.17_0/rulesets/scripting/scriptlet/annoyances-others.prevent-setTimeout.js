!function() {
    ...
    const o = {}, r = [ [ "_waitingAuth0Counter" ], [ "window.loginStateChange.subscribe" ], [ "custom-modal-create-account-link" ], [ "isOpen" ], [ "loginModal" ] ], i = new Map([ [ "clarin.com", 0 ], [ "tradingview.com", 1 ], [ "tekinvestor.no", 2 ], [ "gadgetizedpanda.com", 3 ], [ "analyticsvidhya.com", 4 ] ]), s = new Map([]), c = (t, e, n) => {
        let o = e.get(t);
