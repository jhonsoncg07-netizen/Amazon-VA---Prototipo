!function() {
    ...
    const t = {}, r = [ [ "browser-ids", "$remove$" ], [ "fdx_enable_new_detail_page", "true" ], [ "plausible_ignore", "true" ] ], n = new Map([ [ "visible.com", 0 ], [ "fedex.com", 1 ], [ "coomer.su", 2 ], [ "kemono.su", 2 ] ]), o = new Map([]), s = (e, t, r) => {
        let n = t.get(e);
