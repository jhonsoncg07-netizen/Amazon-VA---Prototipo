    ...
    function e(e = "", o = "", n = "") {
        ...
        a = !1 === isNaN(a) && isFinite(a) ? Math.min(Math.max(a, .001), 50) : .05, self.setInterval = new Proxy(self.setInterval, {
            apply: function(e, t, o) {
                const [n, r] = o;
                return -1 !== s && r !== s || !i.test(n.toString()) || (o[1] = r * a), e.apply(t, o);
            }
        });
    }
    const t = {}, o = [ [ "i--", "", "0.02" ], [ "Clipboard", "1000", "0.001" ], [ "loadexternal", "1000" ], [ "counter", "1000", "0.001" ], [] ], n = new Map([ [ "bluemediafile.*", 0 ], [ "onlinegiftools.com", 1 ], [ "onlinejpgtools.com", 1 ], [ "onlinepngtools.com", 1 ], [ "onlinestringtools.com", 1 ], [ "onlinetexttools.com", 1 ], [ "onlinetools.com", 1 ], [ "remixsearch.es", 2 ], [ "wallpapercat.com", 3 ], [ "loverslab.com", 4 ] ]), r = new Map([]), i = (e, t, o) => {
        let n = t.get(e);
