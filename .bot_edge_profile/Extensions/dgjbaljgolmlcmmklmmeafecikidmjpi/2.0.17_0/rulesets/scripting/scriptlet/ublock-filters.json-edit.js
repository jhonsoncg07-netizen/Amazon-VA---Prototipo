!function() {
        ...
        !function(t = !1, i = "", o = "") {
            ...
            const n = function() {
                ...
                const t = globalThis, e = {
                    ...
                    getExtraArgs(t, e = 0) {
                        const r = t.slice(e).reduce(((t, e, r, s) => {
                            if (0 == (1 & r)) {
                                const e = s[r + 1], i = /^\d+$/.test(e) ? parseInt(e, 10) : e;
                                t.push([ s[r], i ]);
                            }
                            return t;
                        }), []);
                ...
                e.toLogText = (t, ...e) => {
                    ...
                    return s === i && t === r && Date.now() - o < 5e3 ? void 0 : (r = t, i = s, o = Date.now(), 
                    s);
                };
                try {
                    ...
                    let i = [];
                    e.sendToLogger = (t, ...s) => {
                        const o = e.toLogText(t, ...s);
                        if (void 0 !== o) return void 0 === i ? r.postMessage({
                        ...
                        switch (t.data) {
                          case "iamready!":
                            if (void 0 === i) break;
                            i.forEach((({type: t, text: e}) => r.postMessage({
                                what: "messageToLogger",
                                type: t,
                                text: e
                            }))), i = void 0;
                ...
                return e;
            }(), c = n.makeLogPrefix((t ? "trusted-" : "") + "edit-outbound-object", i, o), a = e.create(o);
            if (!1 === a.valid || void 0 !== a.value && !0 !== t) return n.uboLog(c, "Bad JSONPath query");
            r(i, (function(t) {
                const e = t.reflect();
                return 0 === a.apply(e) || (n.uboLog(c, "Edited"), n.logLevel > 1 && n.uboLog(c, `After edit:\n${n.JSON_stringify(e, null, 2)}`)), 
                e;
            }));
        }(!1, "JSON.parse", t);
    }
    class e {
        ...
        apply(t) {
            ...
            this.#r = t;
            const s = this.#s(this.#t.steps, []), i = s.length;
            let o = i;
            for (;o--; ) {
                const {obj: t, key: i} = this.#i(s[o]);
                void 0 !== r ? "+" === e ? this.#o(t, i, r) : t[i] = r : Array.isArray(t) && "number" == typeof i ? t.splice(i, 1) : delete t[i];
            }
        ...
        #e(t, e) {
            ...
            for (;e !== t.length; ) {
                ...
                if (46 === s) {
                    if (i !== this.#n) return;
                    t.startsWith("..", e) ? (i = this.#h, e += 2) : (i = this.#l, e += 1);
                    continue;
                }
                if (91 !== s) {
                    if (i === this.#n) {
                ...
                if (t.startsWith("[?", e)) {
                    const s = 33 === t.charCodeAt(e + 2), o = e + 2 + (s ? 1 : 0), n = this.#e(t, o);
                    if (void 0 === n) return;
                    if (!1 === t.startsWith("]", n.i)) return;
                    s && (n.steps.at(-1).not = !0), r.push({
                        mv: i || this.#l,
                        steps: n.steps
                    }), e = n.i + 1, i = this.#n;
                    continue;
        ...
        #y(t, e) {
            const r = [];
            for (const s of t) {
                const {value: t} = this.#i(s);
                "*" === e.k ? this.#m(s, e, t, r) : void 0 !== e.k ? this.#b(s, e, t, r) : e.steps && this.#x(s, e, t, r);
            }
            return r;
        }
        #m(t, e, r, s) {
            const i = e.mv === this.#h;
            for (const {path: e} of this.#E(r, i)) s.push([ ...t, ...e ]);
        }
        #b(t, e, r, s) {
            const i = Array.isArray(e.k) ? e.k : [ e.k ];
            for (const o of i) {
                const i = this.#O(e, r, o);
                void 0 !== i && s.push([ ...t, i ]);
            }
            if (e.mv === this.#h) for (const {obj: o, key: n, path: c} of this.#E(r, !0)) for (const r of i) {
                const i = this.#O(e, o[n], r);
                void 0 !== i && s.push([ ...t, ...c, i ]);
            }
        }
        #x(t, e, r, s) {
            const i = e.mv === this.#h;
            if (!1 !== Array.isArray(r) || (0 !== this.#s(e.steps, t).length && s.push(t), !0 === i)) for (const {obj: o, key: n, path: c} of this.#E(r, i)) {
        ...
        #E(t, e) {
            const r = {
                next() {
                    ...
                    const i = this.value.obj[this.value.key];
                    return e && (Array.isArray(i) ? this.stack.push({
                        obj: i,
                        keys: i.keys()
                    }) : "object" == typeof i && null !== i && this.stack.push({
                        obj: i,
                        keys: Object.keys(i).values()
                    })), this;
                },
                path: [],
                value: void 0,
        ...
        #v(t, e) {
            ...
            for (;;) {
                ...
                if (45 === s || s >= 48 && s <= 57) {
                    ...
                    if (null === s) return;
                    const i = parseInt(t.slice(e), 10);
                    r.push(i), e += s[0].length;
                    continue;
                }
                const i = this.#g(t, e);
                if (void 0 === i) return;
        ...
        #O(t, e, r) {
            ...
            const s = this.#N(e, r), i = Object.hasOwn(e, s);
            if (void 0 !== t.op && !1 === i) return;
            const o = !0 !== t.not, n = e[s];
            let c = !1;
            switch (t.op) {
              case "==":
                c = n === t.rval === o;
              ...
              case "^=":
                c = `${n}`.startsWith(t.rval) === o;
                break;

              case "$=":
                c = `${n}`.endsWith(t.rval) === o;
                break;

              case "*=":
                c = `${n}`.includes(t.rval) === o;
                break;
    ...
    function r(t = "", e = "") {
        let s = globalThis, i = t;
        for (;;) {
            const t = i.indexOf(".");
            if (-1 === t) break;
            if (s = s[i.slice(0, t)], s instanceof Object == 0) return;
            i = i.slice(t + 1);
        }
        const o = s[i];
        ...
        const n = o.toString(), c = function() {
            return n;
        }.bind(null), a = {
            apply: (t, s, i) => e(r.ApplyContext.factory(t, s, i)),
    ...
    const s = {}, i = [ [ '..__bbox.result.data.node[?@.*.__typename=="SponsoredData"]' ] ], o = new Map([ [ "web.facebook.com", 0 ], [ "www.facebook.com", 0 ] ]), n = new Map([]), c = (t, e, r) => {
        let s = e.get(t);
        ...
        return t.ancestorOrigins && e.push(...t.ancestorOrigins), e.map(((t, e) => {
            ...
            if (-1 === r) return;
            const s = t.slice(r + 3), i = s.indexOf(":");
            return {
                hn: -1 === i ? s : s.slice(0, i),
                i: e
            };
        })).filter((t => void 0 !== t));
    })();
