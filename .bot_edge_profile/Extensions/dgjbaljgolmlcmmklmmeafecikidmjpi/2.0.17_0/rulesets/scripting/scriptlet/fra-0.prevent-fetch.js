!function() {
    function t(...t) {
        !function(t = !1, o = "", s = "", i = "") {
            const c = n(), a = (t ? "trusted-" : "") + "prevent-fetch", l = c.makeLogPrefix(a, o, s, i), g = [];
            for (const t of c.String_split.call(o, /\s+/)) {
                if ("" === t) continue;
                const e = t.indexOf(":");
                let n, r;
                -1 !== e ? (n = t.slice(0, e), r = t.slice(e + 1)) : (n = "url", r = t), g.push({
                    key: n,
                    pattern: c.initPattern(r, {
                        canNegate: !0
                    })
                });
            }
            ...
            if (/^\{.*\}$/.test(i)) try {
                Object.entries(JSON.parse(i)).forEach((([t, e]) => {
                    void 0 !== p[t] && !1 !== p[t].includes(e) && (f[t] = {
                        value: e
                    });
                }));
            } catch {} else "" !== i && p.type.includes(i) && (f.type = {
                value: i
            });
            e("fetch", (function(e) {
                ...
                try {
                    ...
                    for (const e in a) {
                        ...
                        if ("string" != typeof n) try {
                            n = c.JSON_stringify(n);
                        } catch {}
                        "string" == typeof n && t.set(e, n);
                    }
                    if (c.logLevel > 1 || "" === o && "" === s) {
                    ...
                    p = 0 === g.length;
                    for (const {key: e, pattern: n} of g) if (n.expect && !1 === t.has(e) || !1 === c.testPattern(n, t.get(e))) {
                        p = !0;
                        break;
                    }
                } catch {}
                return p ? e.reflect() : Promise.resolve(function(t, e) {
                    ...
                    if (e.startsWith("length:")) {
                        ...
                        if (null === t) return "";
                        const n = parseInt(t[1], 10), r = o.Math_max(parseInt(t[2], 10) || 0, n) - n;
                        return s(0 | o.Math_min(n + r * o.Math_random(), 5e5));
                    }
                    return e.startsWith("war:") ? void 0 === r.warOrigin ? "" : new Promise((t => {
                        const n = [ r.warOrigin, "/", e.slice(4) ], s = r.warSecret;
                    ...
                    return c.Object_defineProperties(e, n), e;
                }));
            }));
        }(!1, ...t);
    }
    ...
    const r = {}, o = [ [ "/www3\\.doubleclick\\.net|tagger\\.opecloud\\.com|fwmrm\\.net/", "emptyArr" ], [ "tag.min.js" ], [ "fwmrm" ], [ "pagead2.googlesyndication.com" ], [ "js.sddan.com" ], [ "adskeeper.co.uk" ], [ "static.adsafeprotected.com/favicon.ico" ], [ "/^https:\\/\\/ads\\.stickyadstv\\.com\\/$/ method:HEAD" ] ], s = new Map([ [ "rmcbfmplay.com", 0 ], [ "darkino.*", 1 ], [ "france.tv", 2 ], [ "lameteoagricole.net", 3 ], [ "meteo-grenoble.com", 3 ], [ "signal-arnaques.com", 3 ], [ "techno-science.net", 3 ], [ "animationdigitalnetwork.com", 3 ], [ "animationdigitalnetwork.fr", 3 ], [ "animedigitalnetwork.fr", 3 ], [ "malekal.com", 4 ], [ "crunchyscan.fr", 5 ], [ "tf1.fr", [ 6, 7 ] ], [ "tf1info.fr", [ 6, 7 ] ] ]), i = new Map([]), c = (t, e, n) => {
        let r = e.get(t);
