!function() {
    ...
    const t = {}, o = [ [ "tvoid" ], [ "/bltsr|HgGedof|KIykI/" ] ], n = new Map([ [ "yandex.*", 0 ], [ "dzen.ru", 1 ], [ "ya.ru", 1 ] ]), r = new Map([ [ "yandex.net", [ 0 ] ] ]), i = (e, t, o) => {
        let n = t.get(e);
    ...
    ((e, t = "") => {
        ...
        if (0 !== s) {
            ...
            {
                const e = s - 1;
                for (let s = 0; s < e; s++) for (let c = e; c > s; c--) {
                    const e = `${o.slice(s, c).join(".")}.*${t}`;
                    i(e, n, a), i(e, r, d);
                }
            }
        }
