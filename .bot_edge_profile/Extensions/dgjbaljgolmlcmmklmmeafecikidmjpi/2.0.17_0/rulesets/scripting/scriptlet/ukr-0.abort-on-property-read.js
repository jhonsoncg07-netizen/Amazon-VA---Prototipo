!function() {
    function e(e = "") {
        ...
        if ("" === e) return;
        const r = t(), n = r.makeLogPrefix("abort-on-property-read", e), o = function() {
            const e = function() {
                const e = t();
            ...
            throw r.uboLog(n, "Aborted"), new ReferenceError(o);
        }, s = function(e, t) {
            const r = t.indexOf(".");
            if (-1 === r) {
                const r = Object.getOwnPropertyDescriptor(e, t);
                return void (r && r.get === i || Object.defineProperty(e, t, {
                    get: i,
                    set: function() {}
                }));
            }
            const n = t.slice(0, r);
            let o = e[n];
            if (t = t.slice(r + 1), o) return void s(o, t);
            const a = Object.getOwnPropertyDescriptor(e, n);
            a && void 0 !== a.set || Object.defineProperty(e, n, {
                get: function() {
                    return o;
                },
                set: function(e) {
                    o = e, e instanceof Object && s(e, t);
                }
            });
        }, a = window;
        s(a, e);
    ...
    const r = {}, n = [ [ "SIN.AdsLoader" ], [ "adsBlocked" ], [ "wpsite_clickable_data" ], [ "u_global_data" ], [ "ads_script" ], [ "utarget_script" ], [ "parent.window.opener" ] ], o = new Map([ [ "sinoptik.ua", 0 ], [ "prozoro.net.ua", 1 ], [ "classicalmusicnews.ru", 2 ], [ "agroreview.com", 2 ], [ "agronews.ua", 2 ], [ "legion-rus.clan.su", 3 ], [ "narod.ru", 3 ], [ "at.ua", 3 ], [ "clan.su", 3 ], [ "igrul-ka.ru", 3 ], [ "selezen.net", 3 ], [ "my1.ru", 3 ], [ "do.am", 3 ], [ "moy.su", 3 ], [ "jetvis.ru", 3 ], [ "fanofnfs.3dn.ru", [ 3, 4 ] ], [ "kubik3.ru", 3 ], [ "paravozik.tv", 3 ], [ "greenflash.su", 3 ], [ "play-force.ru", 3 ], [ "megomult.ru", 3 ], [ "rub.org.ua", 3 ], [ "elektronika56.ru", 3 ], [ "staroetv.su", 3 ], [ "pro-zakupki.ru", 3 ], [ "kino-torrent.net", 3 ], [ "tc-image.3dn.ru", 3 ], [ "pokatushki-pmr.ru", 3 ], [ "tapochek.net", 4 ], [ "nnmclub.to", 5 ], [ "friends-online.me", 5 ], [ "doramakun.ru", 5 ], [ "kinogo.eu", 5 ], [ "kino-live2.org", 5 ], [ "silf.ua", 6 ] ]), i = new Map([]), s = (e, t, r) => {
        let n = t.get(e);
