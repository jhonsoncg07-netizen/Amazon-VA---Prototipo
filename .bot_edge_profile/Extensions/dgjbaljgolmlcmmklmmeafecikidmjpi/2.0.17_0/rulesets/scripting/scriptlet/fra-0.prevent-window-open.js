!function() {
    ...
    const n = {}, o = [ [] ], r = new Map([ [ "japscan.lol", 0 ], [ "empire-anime.com", 0 ], [ "empire-streamz.fr", 0 ], [ "empire-streaming.*", 0 ], [ "empire-stream.*", 0 ] ]), i = new Map([]), s = (t, e, n) => {
        let o = e.get(t);
    ...
    ((t, e = "") => {
        ...
        if (0 !== o) {
            ...
            {
                const t = o - 1;
                for (let o = 0; o < t; o++) for (let c = t; c > o; c--) {
                    const t = `${n.slice(o, c).join(".")}.*${e}`;
                    s(t, r, a), s(t, i, p);
                }
            }
        }
