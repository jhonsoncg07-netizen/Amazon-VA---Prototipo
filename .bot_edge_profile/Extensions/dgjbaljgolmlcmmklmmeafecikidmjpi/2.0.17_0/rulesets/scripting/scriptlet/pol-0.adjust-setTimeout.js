!function() {
    ...
    const t = {}, r = [ [ "#iwa_source=timeout", "15000", "0.02" ], [], [ "function", "1000", "0.02" ], [ "TheLink" ] ], n = new Map([ [ "www.interia.pl", 0 ], [ "ekino-tv.pl", 1 ], [ "swiatfilmow.com", 2 ], [ "cda-tv.pl", 3 ] ]), o = new Map([]), i = (e, t, r) => {
        let n = t.get(e);
