!function() {
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", r = "", o = "") {
                ...
                if ("" === e) return;
                const i = t(), c = i.makeLogPrefix("abort-current-script", e, r, o), s = i.patternToRegex(r), a = i.patternToRegex(o), l = i.getExtraArgs(Array.from(arguments), 3), g = document.currentScript, u = i.String_split.call(e, ".");
                let f, d, p = window;
                for (;f = u.shift(), 0 !== u.length && f in p != 0; ) if (p = p[f], p instanceof Object == 0) return;
                let h = Object.getOwnPropertyDescriptor(p, f);
                h instanceof Object != 0 && h.get instanceof Function != 0 || (d = p[f], h = void 0), 
                function(e) {
    ...
    const n = {}, r = [ [ "document.createElement", "setTimeout" ], [ "window._ceCTSData", "hirdetések" ], [ "document.head", "currentScript.remove" ], [ "window._ceCTSData", "a2blckLayer" ], [ "document.addEventListener", "ai_run_" ], [ "document.getElementById", "ai_run_" ] ], o = new Map([ [ "napiszar.com", 0 ], [ "24.hu", 1 ], [ "divany.hu", 2 ], [ "totalcar.hu", 2 ], [ "totalbike.hu", 2 ], [ "hazipatika.com", 3 ], [ "magyarhang.org", [ 4, 5 ] ], [ "hang.hu", [ 4, 5 ] ] ]), i = new Map([]), c = (e, t, n) => {
        let r = t.get(e);
