!function() {
    ...
    const o = {}, r = [ [ "modal-open", "body" ], [ "bottom-l", "body", "stay" ], [ "bottom-s", "body", "stay" ], [ "modal-open", "body", "stay" ], [ "darken", "body" ], [ "body", "no_scroll", "complete" ], [ "blurry", "body > :not(.m-fbPopup)", "stay" ], [ "have-ad", "body" ] ], n = new Map([ [ "hetek.hu", 0 ], [ "magyarorszag.hu", [ 1, 2 ] ], [ "mandiner.hu", 3 ], [ "traffihunter.hu", 4 ], [ "otpportalok.hu", 5 ], [ "vezess.hu", 6 ], [ "pcworld.hu", 7 ] ]), s = new Map([]), i = (e, t, o) => {
        let r = t.get(e);
