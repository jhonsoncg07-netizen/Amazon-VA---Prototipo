!function() {
    function t(t = "", o = "", n = "") {
        const i = function() {
            ...
            const t = globalThis, e = {
                ...
                getExtraArgs(t, e = 0) {
                    const r = t.slice(e).reduce(((t, e, r, o) => {
                        if (0 == (1 & r)) {
                            const e = o[r + 1], n = /^\d+$/.test(e) ? parseInt(e, 10) : e;
                            t.push([ o[r], n ]);
                        }
                        return t;
                    }), []);
            ...
            e.toLogText = (t, ...e) => {
                ...
                return r === n && t === o && Date.now() - i < 5e3 ? void 0 : (o = t, n = r, i = Date.now(), 
                r);
            };
            try {
                const o = new t.BroadcastChannel(r.bcSecret);
                let n = [];
                e.sendToLogger = (t, ...r) => {
                    ...
                    switch (t.data) {
                      case "iamready!":
                        if (void 0 === n) break;
                        n.forEach((({type: t, text: e}) => o.postMessage({
                            what: "messageToLogger",
                            type: t,
                            text: e
                        }))), n = void 0;
                ...
                e.sendToLogger = (t, ...r) => {
                    const o = e.toLogText(t, ...r);
                    void 0 !== o && e.log(`uBO ${o}`);
                };
            }
            return e;
        }(), s = i.makeLogPrefix("no-window-open-if", t, o, n), c = !1 === t.startsWith("!");
        !1 === c && (t = t.slice(1));
        const l = i.patternToRegex(t), a = 1e3 * (parseFloat(o) || 0), p = self.setTimeout, g = function(t, e, r) {
            const o = document.createElement(t);
            return o[e] = r, o.style.setProperty("height", "1px", "important"), o.style.setProperty("position", "fixed", "important"), 
            o.style.setProperty("top", "-1px", "important"), o.style.setProperty("width", "1px", "important"), 
            document.body.appendChild(o), p((() => {
                o.remove();
            }), a), o;
        }, u = function() {};
        e("open", (function(e) {
            if ("debug" === t && 0 !== i.logLevel) return e.reflect();
            const {callArgs: r} = e, f = r.join(" ");
            if (l.test(f) !== c) return i.logLevel > 1 && i.uboLog(s, `Allowed (${r.join(", ")})`), 
            e.reflect();
            if (i.uboLog(s, `Prevented (${r.join(", ")})`), "" === o) return null;
            if ("blank" === n) {
                r[0] = "about:blank";
                const t = e.reflect();
                return p((() => {
            ...
            let d = ("obj" === n ? g("object", "data", ...r) : g("iframe", "src", ...r)).contentWindow;
            return "object" == typeof d && null !== d ? Object.defineProperty(d, "closed", {
                value: !1
            }) : d = new Proxy(self, {
                get: function(t, e, ...r) {
            ...
            }), 0 !== i.logLevel && (d = new Proxy(d, {
                get: function(t, e, ...r) {
                    const o = Reflect.get(t, e, ...r);
                    return i.uboLog(s, `popup / get ${e} === ${o}`), "function" == typeof o ? (...e) => o.call(t, ...e) : o;
                },
                set: function(t, e, r, ...o) {
                    return i.uboLog(s, `popup / set ${e} = ${r}`), Reflect.set(t, e, r, ...o);
                }
            })), d;
        }));
    }
    function e(t = "", r = "") {
        let o = globalThis, n = t;
        for (;;) {
            const t = n.indexOf(".");
            if (-1 === t) break;
            if (o = o[n.slice(0, t)], o instanceof Object == 0) return;
            n = n.slice(t + 1);
        }
        const i = o[n];
    ...
    ((t, e = "") => {
        const r = t.split("."), o = r.length;
        if (0 !== o) for (let t = 0; t < o; t++) {
            const o = `${r.slice(t).join(".")}${e}`;
            s(o, n, a), s(o, i, p);
        }
    })(l[0].hn);
    for (const e of a) if (!p.has(e)) try {
        t(...o[e]);
    } catch {}
}();