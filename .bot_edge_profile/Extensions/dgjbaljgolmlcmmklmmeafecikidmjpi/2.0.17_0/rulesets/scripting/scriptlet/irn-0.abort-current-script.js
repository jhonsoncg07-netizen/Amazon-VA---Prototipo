!function() {
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", n = "", o = "") {
                ...
                if ("" === e) return;
                const i = t(), c = i.makeLogPrefix("abort-current-script", e, n, o), s = i.patternToRegex(n), a = i.patternToRegex(o), l = i.getExtraArgs(Array.from(arguments), 3), f = document.currentScript, g = i.String_split.call(e, ".");
                let u, d, p = window;
                for (;u = g.shift(), 0 !== g.length && u in p != 0; ) if (p = p[u], p instanceof Object == 0) return;
                let h = Object.getOwnPropertyDescriptor(p, u);
                h instanceof Object != 0 && h.get instanceof Function != 0 || (d = p[u], h = void 0), 
                function(e) {
                ...
                const m = function() {
                    ...
                    i.uboLog(c, "Aborted"), new ReferenceError(m);
                };
                try {
                    Object.defineProperty(p, u, {
                        get: function() {
                            return x(), h instanceof Object ? h.get.call(p) : d;
                        },
                        set: function(e) {
                            x(), h instanceof Object ? h.set.call(p, e) : d = e;
                        }
                    });
                } catch (e) {
                    i.uboErr(c, `Error: ${e}`);
    ...
    for (const t of l) if (!f.has(t)) try {
        e(...n[t]);
    } catch {}
}();