    ...
    function e(e = "", i = "") {
        const r = function() {
            ...
            t.toLogText = (e, ...t) => {
                ...
                return n === i && e === o && Date.now() - r < 5e3 ? void 0 : (o = e, i = n, r = Date.now(), 
                n);
            };
            try {
                ...
                t.sendToLogger = (e, ...n) => {
                    ...
                    if (void 0 !== r) return void 0 === i ? o.postMessage({
                    ...
                    switch (e.data) {
                      case "iamready!":
                        if (void 0 === i) break;
                        i.forEach((({type: e, text: t}) => o.postMessage({
                            what: "messageToLogger",
                            type: e,
                            text: t
                        }))), i = void 0;
            ...
            return t;
        }(), c = r.makeLogPrefix("prevent-setInterval", e, i), a = "!" === e.charAt(0), s = r.patternToRegex(a ? e.slice(1) : e), l = new o(i);
        t("setInterval", (function(t) {
            const {callArgs: o} = t, n = o[0] instanceof Function ? r.String(r.Function_toString(o[0])) : r.String(o[0]), i = o[1];
            return "" === e && l.unbound() ? (r.uboLog(c, `Called:\n${n}\n${i}`), t.reflect()) : (s.test(n) !== a && l.test(i) && (o[0] = function() {}, 
            r.uboLog(c, `Prevented:\n${n}\n${i}`)), t.reflect());
        }));
    }
    function t(e = "", o = "") {
        let n = globalThis, i = e;
        for (;;) {
            const e = i.indexOf(".");
            if (-1 === e) break;
            if (n = n[i.slice(0, e)], n instanceof Object == 0) return;
            i = i.slice(e + 1);
        }
        const r = n[i];
        ...
        const c = r.toString(), a = function() {
            return c;
        }.bind(null), s = {
            apply: (e, n, i) => o(t.ApplyContext.factory(e, n, i)),
            get: (e, t) => "toString" === t ? a : Reflect.get(e, t)
        };
        r.prototype?.constructor === r && (s.construct = function(e, n) {
        ...
        if (0 !== n) {
            ...
            }
            {
                ...
                for (let n = 0; n < e; n++) for (let i = e; i > n; i--) {
                    const e = `${o.slice(n, i).join(".")}.*${t}`;
                    a(e, r, m), a(e, c, d);
                }
            }
        }
    })(l[0].hn);
    for (const t of m) if (!d.has(t)) try {
        e(...i[t]);
    } catch {}
}();