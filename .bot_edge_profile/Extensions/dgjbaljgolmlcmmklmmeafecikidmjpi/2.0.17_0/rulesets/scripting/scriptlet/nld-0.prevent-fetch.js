!function() {
    ...
    const r = {}, o = [ [ "securepubads.g.doubleclick.net" ], [ "v.fwmrm.net" ], [ "/a[ab]\\.tweakers\\.nl/" ], [ "pubads.g.doubleclick.net/gampad/ads" ] ], s = new Map([ [ "filmvandaag.nl", 0 ], [ "vtmgo.be", 1 ], [ "tweakers.net", 2 ], [ "goplay.be", 3 ] ]), i = new Map([]), c = (t, e, n) => {
        let r = e.get(t);
