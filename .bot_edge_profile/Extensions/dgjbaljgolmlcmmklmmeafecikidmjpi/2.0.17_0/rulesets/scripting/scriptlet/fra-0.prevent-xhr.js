!function() {
    function e(...e) {
        return function(e = !1, n = "", o = "") {
            ...
            const s = t(), i = e ? "trusted-prevent-xhr" : "prevent-xhr", a = s.makeLogPrefix(i, n, o), p = new WeakMap, c = function(e, r = "") {
                const n = t(), o = new Map;
    ...
    const r = {}, n = [ [ "pagead2.googlesyndication.com" ], [ "v.fwmrm.net" ], [ "/ping?token=" ] ], o = new Map([ [ "air-journal.fr", 0 ], [ "systemed.fr", 0 ], [ "empire-streaming.*", 0 ], [ "empire-anime.com", 0 ], [ "ebookdz.com", 0 ], [ "m6.fr", 1 ], [ "app.molotov.tv", 2 ] ]), s = new Map([]), i = (e, t, r) => {
        let n = t.get(e);
