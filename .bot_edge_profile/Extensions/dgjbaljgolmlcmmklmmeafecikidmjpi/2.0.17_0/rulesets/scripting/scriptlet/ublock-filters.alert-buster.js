!function() {
    ...
    const t = [ [] ], e = new Map([ [ "onlineatlas.us", 0 ] ]), o = new Map([]), i = (n, t, e) => {
        let o = t.get(n);
        if (void 0 !== o) if ("number" != typeof o) for (const n of o) e.add(n); else e.add(o);
    }, s = (() => {
        const n = document.location, t = [ n.origin ];
        return n.ancestorOrigins && t.push(...n.ancestorOrigins), t.map(((n, t) => {
            const e = n.lastIndexOf("://");
            if (-1 === e) return;
            const o = n.slice(e + 3), i = o.indexOf(":");
            return {
