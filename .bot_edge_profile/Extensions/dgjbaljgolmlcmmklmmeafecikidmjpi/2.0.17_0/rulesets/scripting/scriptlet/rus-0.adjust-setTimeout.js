    ...
    function e(e = "", r = "", n = "") {
        ...
        a = !1 === isNaN(a) && isFinite(a) ? Math.min(Math.max(a, .001), 50) : .05, self.setTimeout = new Proxy(self.setTimeout, {
            apply: function(e, t, r) {
                const [n, o] = r;
                return -1 !== s && o !== s || !i.test(n.toString()) || (r[1] = o * a), e.apply(t, r);
            }
        });
    }
    const t = {}, r = [ [], [ "()=>r(", "15000" ], [ "", "30000", "0.0001" ], [ "js-article-check-visibility", "2000" ], [ "timer" ], [ "zat_tick" ], [ "{return f(!1)}", "20000" ] ], n = new Map([ [ "autoinfo24.ru", 0 ], [ "dp73.spb.ru", 0 ], [ "dropmefiles.com.ua", 0 ], [ "dropmefiles.net", 0 ], [ "gtavicecity.ru", 0 ], [ "pes-files.ru", 0 ], [ "dzen.ru", 1 ], [ "tv-kanali.online", 2 ], [ "rbc.ru", 3 ], [ "freetp.org", 4 ], [ "freetp.ru", 4 ], [ "online-fix.me", 4 ], [ "4pda.to", 5 ], [ "reshu.by", 6 ], [ "sdamgia.ru", 6 ] ]), o = new Map([]), i = (e, t, r) => {
        let n = t.get(e);
