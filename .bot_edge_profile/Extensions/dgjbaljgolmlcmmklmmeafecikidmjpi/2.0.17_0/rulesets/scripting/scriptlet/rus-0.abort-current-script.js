!function() {
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", r = "", n = "") {
                ...
                if ("" === e) return;
                const a = t(), c = a.makeLogPrefix("abort-current-script", e, r, n), i = a.patternToRegex(r), s = a.patternToRegex(n), u = a.getExtraArgs(Array.from(arguments), 3), l = document.currentScript, m = a.String_split.call(e, ".");
                let d, p, g = window;
                for (;d = m.shift(), 0 !== m.length && d in g != 0; ) if (g = g[d], g instanceof Object == 0) return;
                let f = Object.getOwnPropertyDescriptor(g, d);
                f instanceof Object != 0 && f.get instanceof Function != 0 || (p = g[d], f = void 0), 
                function(e) {
                ...
                const v = function() {
                    ...
                    if (e === l) return;
                    if ("" !== n && !1 === s.test(e.src)) return;
                    a.logLevel > 1 && "" !== n && a.uboLog(c, `Matched src\n${e.src}`);
                    const t = b(e);
                    if (!1 !== i.test(t)) throw a.logLevel > 1 && a.uboLog(c, `Matched text\n${t}`), 
                    a.uboLog(c, "Aborted"), new ReferenceError(v);
                };
                try {
                    Object.defineProperty(g, d, {
                        get: function() {
                            return y(), f instanceof Object ? f.get.call(g) : p;
                        },
                        set: function(e) {
                            y(), f instanceof Object ? f.set.call(g, e) : p = e;
                        }
                    });
                } catch (e) {
                    a.uboErr(c, `Error: ${e}`);
    ...
    function t() {
        ...
        t.toLogText = (e, ...t) => {
            ...
            return o === n && e === r && Date.now() - a < 5e3 ? void 0 : (r = e, n = o, a = Date.now(), 
            o);
        };
        try {
            ...
            t.sendToLogger = (e, ...o) => {
                ...
                if (void 0 !== a) return void 0 === n ? r.postMessage({
