!function() {
    function o(o = "", n = "") {
        const c = t(), i = c.getExtraArgs(Array.from(arguments), 2), r = c.makeLogPrefix("prevent-addEventListener", o, n), s = c.patternToRegex(o, void 0, !0), m = c.patternToRegex(n), l = (function(o) {
            if (o instanceof Object == 0) return !1;
            a.canDebug && o.debug;
        }(i), i.elements || void 0), d = o => {
            if (o instanceof Window) return "window";
            if (o instanceof Document) return "document";
            if (o instanceof Element == 0) return "?";
            const e = [], t = String(o.id);
            "" !== t && e.push(`#${CSS.escape(t)}`);
            for (let t = 0; t < o.classList.length; t++) e.push(`.${CSS.escape(o.classList.item(t))}`);
            for (let t = 0; t < o.attributes.length; t++) {
                const a = o.attributes.item(t);
                "id" !== a.name && "class" !== a.name && e.push(`[${CSS.escape(a.name)}="${a.value}"]`);
            }
            return e.join("");
        }, p = (o, e, t) => {
            const a = c.RegExp_test.call(s, e), n = c.RegExp_test.call(m, t), i = a && n;
            return (!i || void 0 === l || !1 !== (r = o, "window" === l ? r === window : "document" === l ? r === document : !!(r && r.matches && r.matches(l)) || Array.from(document.querySelectorAll(l)).includes(r))) && i;
            var r;
        }, u = function(e) {
            const {callArgs: t, thisArg: a} = e;
            let i, s;
            try {
                i = String(t[0]), "function" == typeof t[1] ? s = String(c.Function_toString(t[1])) : "object" == typeof t[1] && null !== t[1] ? "function" == typeof t[1].handleEvent && (s = String(c.Function_toString(t[1].handleEvent))) : s = String(t[1]);
            } catch {}
            if ("" === o && "" === n) c.uboLog(r, `Called: ${i}\n${s}\n${d(a)}`); else if (p(a, i, s)) return c.uboLog(r, `Prevented: ${i}\n${s}\n${d(a)}`);
            return e.reflect();
        };
        !function(o, e) {
            const a = o => {
                ...
                for (const o of t) {
                    const t = `${o}`;
                    if (!1 !== Object.hasOwn(e, t)) return e[t];
                }
                return 0;
            }, n = a(e);
            if (a(document.readyState) >= n) return void o();
            const i = t(), r = [ "readystatechange", () => {
                a(document.readyState) < n || (o(), i.removeEventListener.apply(document, r));
            }, {
                capture: !0
            } ];
            i.addEventListener.apply(document, r);
        }((() => {
            e("EventTarget.prototype.addEventListener", u), e("document.addEventListener", u);
        }), i.runAt);
    }
    function e(o = "", t = "") {
        let a = globalThis, n = o;
        for (;;) {
            const o = n.indexOf(".");
            if (-1 === o) break;
            if (a = a[n.slice(0, o)], a instanceof Object == 0) return;
            n = n.slice(o + 1);
        }
        const c = a[n];
        ...
        void 0 === e.CtorContext && (e.ctorContexts = [], e.CtorContext = class {
            ...
            init(o, e) {
                return this.callFn = o, this.callArgs = e, this;
            }
            reflect() {
                const o = Reflect.construct(this.callFn, this.callArgs);
                return this.callFn = this.callArgs = this.private = void 0, e.ctorContexts.push(this), 
                o;
            }
            static factory(...o) {
                return 0 !== e.ctorContexts.length ? e.ctorContexts.pop().init(...o) : new e.CtorContext(...o);
            }
            ...
            init(o, e, t) {
                return this.callFn = o, this.thisArg = e, this.callArgs = t, this;
            }
            reflect() {
                const o = Reflect.apply(this.callFn, this.thisArg, this.callArgs);
                return this.callFn = this.thisArg = this.callArgs = this.private = void 0, e.applyContexts.push(this), 
                o;
            }
            static factory(...o) {
                return 0 !== e.applyContexts.length ? e.applyContexts.pop().init(...o) : new e.ApplyContext(...o);
            }
        });
        const i = c.toString(), r = function() {
            return i;
        }.bind(null), s = {
            apply: (o, a, n) => t(e.ApplyContext.factory(o, a, n)),
            get: (o, e) => "toString" === e ? r : Reflect.get(o, e)
        };
        c.prototype?.constructor === c && (s.construct = function(o, a) {
            return t(e.CtorContext.factory(o, a));
        }), a[n] = new Proxy(c, s);
    }
    function t() {
        if (a.safeSelf) return a.safeSelf;
        const o = globalThis, e = {
            ...
            getExtraArgs(o, e = 0) {
                const t = o.slice(e).reduce(((o, e, t, a) => {
                    if (0 == (1 & t)) {
                        const e = a[t + 1], n = /^\d+$/.test(e) ? parseInt(e, 10) : e;
                        o.push([ a[t], n ]);
                    }
                    return o;
                }), []);
        ...
        if (a.safeSelf = e, void 0 === a.bcSecret) return e;
        e.logLevel = a.logLevel || 1;
        let t = "", n = "", c = 0;
        e.toLogText = (o, ...e) => {
            if (0 === e.length) return;
            const a = `[${document.location.hostname || document.location.href}]${e.join(" ")}`;
            return a === n && o === t && Date.now() - c < 5e3 ? void 0 : (t = o, n = a, c = Date.now(), 
            a);
        };
        try {
            const t = new o.BroadcastChannel(a.bcSecret);
            let n = [];
            e.sendToLogger = (o, ...a) => {
                const c = e.toLogText(o, ...a);
                if (void 0 !== c) return void 0 === n ? t.postMessage({
                ...
                switch (o.data) {
                  case "iamready!":
                    if (void 0 === n) break;
                    n.forEach((({type: o, text: e}) => t.postMessage({
                        what: "messageToLogger",
                        type: o,
                        text: e
                    }))), n = void 0;
    ...
    const a = {}, n = [ [ "click", '/event_callback=function\\(\\){window\\.location=t\\.getAttribute\\("href"\\)/' ], [ "click", "Event" ], [ "load", "Object" ], [ "load", "hard_block" ], [ "", "adb" ], [ "click", "ClickHandler" ], [ "load", "IsAdblockRequest" ], [ "load", "onload" ], [ "", "BACK" ], [ "load", "(!o)" ], [ "load", "(!i)" ], [ "", "_0x" ], [ "", "Adblock" ], [ "/^(?:click|mousedown)$/", "bypassEventsInProxies" ], [ "", "open" ], [ "click", "exopop" ], [ "/^(?:load|click)$/", "popMagic" ], [ "mousedown", "popundrInit" ], [ "getexoloader" ], [ "", "pop" ], [ "load", "creativeLoaded-" ], [ "/^load[A-Za-z]{12,}/" ], [ "", "/exo" ], [ "", "_blank" ], [ "mousedown", "preventDefault" ], [ "/^(?:click|mousedown)$/", "_0x" ], [ "load", "advertising" ], [ "click", "preventDefault" ], [ "load", "2000" ], [ "/^(click|mousedown|mousemove|touchstart|touchend|touchmove)/", "system.popunder" ], [ "load", "adb" ], [ "/^(?:click|mousedown|mousemove|touchstart|touchend|touchmove)$/", "system.popunder" ], [ "", "'0x" ], [ "load", "nextFunction" ], [ "/DOMContentLoaded|load/", "y.readyState" ], [ "", "history.go" ], [ "/error|canplay/", "(t)" ], [ "load", "hblocked" ], [ "error", "Adblocker" ], [ "DOMContentLoaded", "adlinkfly" ], [ "DOMContentLoaded", "shortener" ], [ "mousedown", "trigger" ], [ "", "0x" ], [ "", "Pop" ], [ "/^(?:click|mousedown)$/", "popunder" ], [ "DOMContentLoaded", "preventExit" ], [ "mouseup", "_blank" ], [ "click", "pop_under" ], [ "load", "url" ], [ "load", "adverts-top-container" ], [ "", "Date" ], [ "DOMContentLoaded", "&nbsp" ], [ "click", "read_cookie" ], [ "", "midRoll" ], [ "click", "_0x" ], [ "load", "isBlanketFound" ], [ "load", "showModal" ], [ "click", "trigger" ], [ "mouseout", "clientWidth" ], [ "load", "download-wrapper" ], [ "load", "autoRecov" ], [ "popstate", "noPop" ], [ "/^(?:click|mousedown)$/", "ppu" ], [ "click", "native code" ], [ "click", "_blank" ], [ "/^(?:mousedown|mouseup)$/", "0x" ], [ "click", "popundr" ], [ "click" ], [ "DOMContentLoaded", "compupaste" ], [ "mousedown", "!!{});" ], [ "DOMContentLoaded", "/adblock/i" ], [ "keydown" ], [ "/^/", "0x" ], [ "load", "PrivateMode" ], [ "scroll", "_0x" ], [ "DOMContentLoaded", "checkVPN" ], [ "/^(?:click|mousedown|mouseup)$/", "di()" ], [ "", "'\\'" ], [ "popstate" ], [ "click", "my_inter_listen" ], [ "", "window.open" ], [ "load", "appendChild" ], [ "", "bi()" ], [ "", "checkTarget" ], [ "click", "popunder" ], [ "timeupdate" ], [ "scroll", "getElementById" ], [ "load", "undefined" ], [ "DOMContentLoaded", "scriptwz_url" ], [ "load", "0x" ], [ "DOMContentLoaded", "btoa" ], [ "adblockActivated" ], [ "click", "saveLastEvent" ], [ "", "show" ], [ "/.?/", "popMagic" ], [ "", "ads" ], [ "click", "interstitial" ], [ "load", "antiblock" ], [ "DOMContentLoaded", "adsBlocked" ], [ "load", ".appendChild" ], [ "", "btoa" ], [ "DOMContentLoaded", "AdBlock" ], [ "load", "blocker" ], [ "mouseleave", "NativeDisplayAdID" ], [ "mouseover", "event.triggered" ], [ "blur", "stopCountdown" ], [ "load", "htmls" ], [ "blur", "focusOut" ], [ "click", "/handleClick|popup/" ], [ "DOMContentLoaded", "history.go" ], [ "load", "bypass" ], [ "DOMContentLoaded", "antiAdBlockerHandler" ], [ "DOMContentLoaded", "location.href" ], [ "", "popMagic" ], [ "contextmenu", "preventDefault" ], [ "visibilitychange", "remainingSeconds" ], [ "click", "Popunder" ], [ "contextmenu" ], [ "submit", "validateForm" ], [ "blur", "counter" ], [ "load", "doTest" ], [ "DOMContentLoaded", "document.documentElement.lang.toLowerCase" ], [ "click", "maxclick" ], [ "click", "", "elements", "#get-link-button" ], [ "click", "window.open" ], [ "click", "shouldOpenPopUp" ], [ "click", "adForm" ], [ "blur" ], [ "click", "popMagic" ], [ "", "shouldShow" ], [ "", "exopop" ], [ "", "break;case $." ], [ "mousedown", "shown_at" ], [ "/click|mouse/", "[native code]", "elements", "document" ], [ "load", "crakPopInParams" ], [ "", "focus" ], [ "load", "abDetectorPro" ], [ "DOMContentLoaded", "src=atob" ], [ "error", "blocker" ], [ "load", "error-report.com" ], [ "click", "tampilkanUrl" ], [ "load", "/AdBlock/i" ], [ "/^(?:click|mousedown)$/", "latest!==" ], [ "DOMContentLoaded", ".ready" ], [ "load", "script" ], [ "", "/pop|wm|forceClick/" ], [ "load", "block" ], [ "", "/_0x|localStorage\\.getItem/" ], [ "DOMContentLoaded", "adblock" ], [ "click", "open" ], [ "error" ], [ "visibilitychange" ], [ "load", "/showModal|isBlanketFound/" ], [ "click", "shouldShow" ], [ "", "/ads|Modal/" ], [ "load", "Adblock" ], [ "DOMContentLoaded", "window.open" ], [ "DOMContentLoaded", "atob" ], [ "", "vads" ], [ "devtoolschange" ], [ "beforeunload" ], [ "mouseup", "decodeURIComponent" ], [ "/(?:click|touchend)/", "_0x" ], [ "", "removeChild" ], [ "click", "pu_count" ], [ "message" ], [ "", "/pop|_blank/" ], [ "click", "allclick_Public" ], [ "DOMContentLoaded", "/dyn\\.ads|loadAdsDelayed/" ], [ "/touchstart|mousedown|click/", "latest" ], [ "blur", "native code" ], [ "blur", "event.simulate" ], [ "DOMContentLoaded", "0x" ], [ "click", "overlay" ], [ "scroll", "undefined" ], [ "readystatechange", "document.removeEventListener" ], [ "scroll", "detect" ], [ "click", "t(a)" ], [ "mouseup", "catch" ], [ "click", "clickCount" ], [ "scroll", "innerHeight" ], [ "hashchange" ], [ "load", "/nextFunction|2000/" ], [ "load", "player" ], [ "load", "popMagic" ], [ "click", "popurl" ], [ "", "/open.*_blank/" ], [ "scroll" ], [ "", "isBlocking" ], [ "timeupdate", "", "elements", ".quiver-cam-player--ad-not-running.quiver-cam-player--free video" ], [ "", "$" ], [ "/click|mousedown/", "catch" ], [ "adb" ], [ "click", "popName" ], [ "DOMContentLoaded", "clientHeight" ], [ "click", "window.focus" ], [ "click", "event.dispatch" ], [ "load", "adblock" ], [ "", "Math" ], [ "DOMContentLoaded", "popupurls" ], [ "load", "XMLHttpRequest" ], [ "load", "AdBlocker" ], [ "", "showModal" ], [ "", "goog" ], [ "", "document.body" ], [ "", "modal" ], [ "click", "pop" ], [ "click", "adobeModalTestABenabled" ], [ "blur", "console.log" ], [ "DOMContentLoaded", "adsSrc" ], [ "", "AdB" ], [ "load", "adSession" ], [ "DOMContentLoaded", ".textContent" ], [ "np.detect" ], [ "DOMContentLoaded", "document.documentElement.lang" ], [ "DOMContentLoaded", "googlesyndication" ], [ "load", "popunder" ], [ "DOMContentLoaded", ".clientHeight" ], [ "scroll", "function(e)" ], [ "DOMContentLoaded", "adlinkfly_url" ], [ "load", "document.getElementById" ], [ "DOMContentLoaded", "daadb_get_data_fetch" ], [ "click", "popactive" ], [ "DOMContentLoaded", "location.replace" ], [ "load", "modal_blocker" ], [ "click", "isOpened" ], [ "mousedown", "pop.doEvent" ], [ "click", "alink" ], [ "load", "[native code]" ], [ "/adblock/i" ], [ "load", "google-analytics" ], [ "", "sessionStorage" ], [ "click", "/form\\.submit|urlToOpen/" ], [ "DOMContentLoaded", "overlays" ], [ "load", "ads" ], [ "click", "document.createElement" ], [ "click", "ShouldShow" ], [ "click", "", "elements", "a#dlink" ], [ "mousedown", "localStorage" ], [ "", "adsense" ], [ "click", "splashPage" ], [ "load", "detect-modal" ], [ "click", "localStorage" ], [ "DOMContentLoaded", "canRedirect" ], [ "DOMContentLoaded", "adb" ], [ "error", "/\\{[a-z]\\(e\\)\\}/" ], [ "load", ".call(this" ], [ "/touchmove|wheel/", "preventDefault()" ], [ "load", "showcfkModal" ], [ "click", "attached", "elements", 'div[class="share-embed-container"]' ], [ "click", "fp-screen" ], [ "DOMContentLoaded", "leaderboardAd" ], [ "DOMContentLoaded", "fetch" ], [ "click", "openPopupForChapter" ], [ "click", "doThePop" ], [ "DOMContentLoaded", "blockAdBlock" ], [ "click", "openDirectLinkAd" ], [ "load", "detect" ], [ "DOMContentLoaded", "history.pushState" ], [ "DOMContentLoaded", "showPopup" ], [ "click", "PopUnder" ], [ "load", "puHref" ], [ "click", "Ads" ], [ "mouseup", "open" ], [ "DOMContentLoaded", "adBlockNotice" ], [ "DOMContentLoaded", "_0x" ], [ "DOMContentLoaded", "detect" ], [ "DOMContentLoaded", "Promise" ], [ "DOMContentLoaded", "anchor.href" ], [ "click", "popupInterval" ], [ "DOMContentLoaded", "-banner" ], [ "click", "PopURL" ], [ "DOMContentLoaded", "checkAdBlocker" ], [ "DOMContentLoaded", "determineVisibility" ], [ "DOMContentLoaded", "Popunder" ], [ "click", "pingUrl" ], [ "mousedown", "scoreUrl" ], [ "", "Adb" ] ], c = new Map([ [ "cbc.ca", 0 ], [ "io.google", 1 ], [ "newser.com", 2 ], [ "sport1.de", 3 ], [ "timesofindia.indiatimes.com", 4 ], [ "drrtyr.mx", 4 ], [ "pinoyalbums.com", 4 ], [ "multiplayer.it", 4 ], [ "mediafire.com", [ 5, 6 ] ], [ "kingofdown.com", 7 ], [ "radiotormentamx.com", 7 ], [ "limetorrents.*", [ 7, 11 ] ], [ "king-pes.*", 7 ], [ "quelleestladifference.fr", 7 ], [ "depedlps.*", 7 ], [ "otakuworldsite.blogspot.com", 7 ], [ "ad-itech.blogspot.com", 7 ], [ "komikcast.*", 7 ], [ "unlockapk.com", 7 ], [ "mobdi3ips.com", 7 ], [ "socks24.org", 7 ], [ "idedroidsafelink.*", 7 ], [ "links-url.*", 7 ], [ "interviewgig.com", 7 ], [ "javaguides.net", 7 ], [ "almohtarif-tech.net", 7 ], [ "devoloperxda.blogspot.com", 7 ], [ "zwergenstadt.com", 7 ], [ "upxin.net", 7 ], [ "ciudadblogger.com", 7 ], [ "ke-1.com", 7 ], [ "bit-shares.com", 7 ], [ "itdmusics.com", 7 ], [ "aspdotnet-suresh.com", 7 ], [ "tudo-para-android.com", 7 ], [ "zerotopay.com", 7 ], [ "ak4eg.*", 7 ], [ "mawsueaa.com", 7 ], [ "hesgoal-live.io", 7 ], [ "streanplay.*", 8 ], [ "steanplay.*", 8 ], [ "bibme.org", 9 ], [ "citationmachine.net", 9 ], [ "easybib.com", 10 ], [ "pahe.*", 11 ], [ "yts.*", 11 ], [ "tube8.*", 11 ], [ "topeuropix.*", 11 ], [ "vermangasporno.com", 11 ], [ "moviescounter.*", 11 ], [ "imgtorrnt.in", 11 ], [ "picbaron.com", [ 11, 113 ] ], [ "torrent9.*", 11 ], [ "desiremovies.*", 11 ], [ "letmejerk.com", 11 ], [ "letmejerk2.com", 11 ], [ "letmejerk3.com", 11 ], [ "letmejerk4.com", 11 ], [ "letmejerk5.com", 11 ], [ "letmejerk6.com", 11 ], [ "letmejerk7.com", 11 ], [ "movs4u.*", 11 ], [ "uwatchfree.*", 11 ], [ "hydrax.*", 11 ], [ "4movierulz.*", 11 ], [ "projectfreetv.*", 11 ], [ "arabseed.*", 11 ], [ "btdb.*", [ 11, 50 ] ], [ "dlapk4all.com", 11 ], [ "kropic.com", 11 ], [ "pdfindir.net", 11 ], [ "brstej.com", 11 ], [ "topwwnews.com", 11 ], [ "xsanime.com", 11 ], [ "vidlo.us", 11 ], [ "youx.xxx", 11 ], [ "world4ufree.*", 11 ], [ "animeindo.asia", 11 ], [ "streamsport.*", 11 ], [ "rojadirectatvhd.*", 11 ], [ "userload.*", 11 ], [ "badtaste.it", 12 ], [ "adyou.*", 13 ], [ "gotporn.com", 14 ], [ "freepornrocks.com", 14 ], [ "tvhai.org", 14 ], [ "footybite.to", 14 ], [ "rargb.to", 14 ], [ "totalsportek.*", 14 ], [ "totalsportekhd.com", 14 ], [ "xn--mlaregvle-02af.nu", 14 ], [ "realgfporn.com", [ 15, 16 ] ], [ "fxporn69.*", 15 ], [ "thisvid.com", 16 ], [ "xvideos-downloader.net", 16 ], [ "imgspice.com", 17 ], [ "vikiporn.com", 18 ], [ "tnaflix.com", 18 ], [ "pornomico.com", 18 ], [ "yourlust.com", 18 ], [ "hd-easyporn.com", 18 ], [ "hotpornfile.org", 18 ], [ "watchfreexxx.net", 18 ], [ "vintageporntubes.com", 18 ], [ "angelgals.com", 18 ], [ "babesexy.com", 18 ], [ "youlikeboys.com", 18 ], [ "hentaihere.com", 18 ], [ "ganstamovies.com", 18 ], [ "youngleak.com", 18 ], [ "jizzberry.com", 18 ], [ "porndollz.com", 18 ], [ "xnxxvideo.pro", 18 ], [ "xvideosxporn.com", 18 ], [ "filmpornofrancais.fr", 18 ], [ "pictoa.com", [ 18, 42 ] ], [ "pornohirsch.net", 18 ], [ "herzporno.*", 18 ], [ "deinesexfilme.com", 18 ], [ "einfachtitten.com", 18 ], [ "halloporno.*", 18 ], [ "lesbenhd.com", 18 ], [ "milffabrik.com", 18 ], [ "porn-monkey.com", 18 ], [ "porndrake.com", 18 ], [ "pornhubdeutsch.net", 18 ], [ "pornoaffe.com", 18 ], [ "pornodavid.com", 18 ], [ "pornoente.tv", 18 ], [ "pornofisch.com", 18 ], [ "pornofelix.com", 18 ], [ "pornohammer.com", 18 ], [ "pornohelm.com", 18 ], [ "pornoklinge.com", 18 ], [ "pornotom.com", 18 ], [ "pornotommy.com", 18 ], [ "pornovideos-hd.com", 18 ], [ "pornozebra.com", 18 ], [ "xhamsterdeutsch.xyz", 18 ], [ "xnxx-sexfilme.com", 18 ], [ "adultasianporn.com", 18 ], [ "nsfwmonster.com", 18 ], [ "girlsofdesire.org", 18 ], [ "gaytail.com", 18 ], [ "fetish-bb.com", 18 ], [ "rumporn.com", 18 ], [ "soyoungteens.com", 18 ], [ "zubby.com", 18 ], [ "lesbian8.com", 18 ], [ "gayforfans.com", 18 ], [ "reifporn.de", 18 ], [ "javtsunami.com", 18 ], [ "18tube.sex", 18 ], [ "xxxextreme.org", 18 ], [ "amateurs-fuck.com", 18 ], [ "sex-amateur-clips.com", 18 ], [ "hentaiworld.tv", 18 ], [ "dads-banging-teens.com", 18 ], [ "home-xxx-videos.com", 18 ], [ "mature-chicks.com", 18 ], [ "hqbang.com", 18 ], [ "darknessporn.com", 18 ], [ "familyporner.com", 18 ], [ "freepublicporn.com", 18 ], [ "pisshamster.com", 18 ], [ "punishworld.com", 18 ], [ "xanimu.com", 18 ], [ "tubator.com", 18 ], [ "hentai2w.com", [ 18, 128 ] ], [ "pornhd.com", 19 ], [ "cnnamador.com", [ 19, 29 ] ], [ "cle0desktop.blogspot.com", 19 ], [ "turkanime.co", 19 ], [ "rexporn.*", 19 ], [ "movies07.*", 19 ], [ "camclips.tv", [ 19, 43 ] ], [ "blackpornhq.com", 19 ], [ "xsexpics.com", 19 ], [ "ulsex.net", 19 ], [ "wannafreeporn.com", 19 ], [ "ytube2dl.com", 19 ], [ "pornocomics.*", 19 ], [ "multiup.us", 19 ], [ "protege-torrent.com", 19 ], [ "pussyspace.com", [ 20, 21 ] ], [ "pussyspace.net", [ 20, 21 ] ], [ "empflix.com", 22 ], [ "cpmlink.net", 23 ], [ "bdsmstreak.com", 23 ], [ "cutpaid.com", 23 ], [ "pornforrelax.com", 23 ], [ "fatwhitebutt.com", 23 ], [ "pornomoll.*", 23 ], [ "short.pe", 24 ], [ "gsurl.*", 24 ], [ "pinsystem.co.uk", 25 ], [ "ancensored.com", 25 ], [ "ganool.*", 25 ], [ "mp3fiber.com", [ 25, 33 ] ], [ "xrivonet.info", 25 ], [ "pirate.*", 25 ], [ "piratebay.*", 25 ], [ "pirateproxy.*", 25 ], [ "proxytpb.*", 25 ], [ "thepiratebay.*", 25 ], [ "mimaletadepeliculas.*", 26 ], [ "bs.to", 27 ], [ "burningseries.*", 27 ], [ "efukt.com", 27 ], [ "dz4soft.*", 28 ], [ "generacionretro.net", 28 ], [ "nuevos-mu.ucoz.com", 28 ], [ "micloudfiles.com", 28 ], [ "yoututosjeff.*", 28 ], [ "ebookmed.*", 28 ], [ "lanjutkeun.*", 28 ], [ "mimaletamusical.blogspot.com", 28 ], [ "novelasesp.*", 28 ], [ "visionias.net", 28 ], [ "singingdalong.*", 28 ], [ "b3infoarena.in", 28 ], [ "lurdchinexgist.blogspot.com", 28 ], [ "thefreedommatrix.blogspot.com", 28 ], [ "hentai-vl.blogspot.com", 28 ], [ "projetomotog.blogspot.com", 28 ], [ "ktmx.pro", 28 ], [ "lirik3satu.blogspot.com", 28 ], [ "marketmovers.it", 28 ], [ "pharmaguideline.com", 28 ], [ "mixloads.com", 28 ], [ "mangaromance.eu", 28 ], [ "interssh.com", 28 ], [ "freesoftpdfdownload.blogspot.com", 28 ], [ "myadslink.com", 28 ], [ "blackavelic.com", 28 ], [ "doujindesu.*", 28 ], [ "server.satunivers.tv", 28 ], [ "eg-akw.com", 28 ], [ "xn--mgba7fjn.cc", 28 ], [ "flashingjungle.com", 29 ], [ "ma-x.org", 30 ], [ "lavozdegalicia.es", 30 ], [ "ddwloclawek.pl", 30 ], [ "ki24.info", 30 ], [ "xmovies8.*", 31 ], [ "xmovies08.org", 32 ], [ "freecoursesonline.*", 33 ], [ "lordpremium.*", 33 ], [ "schrauben-normen.de", 33 ], [ "avengerinator.blogspot.com", 33 ], [ "novablogitalia.*", 33 ], [ "link-to.net", 33 ], [ "hanimesubth.com", 33 ], [ "gsmturkey.net", 33 ], [ "anisubindo.*", 33 ], [ "adshrink.it", 33 ], [ "presentation-ppt.com", 33 ], [ "mangacanblog.com", 33 ], [ "pekalongan-cits.blogspot.com", 33 ], [ "4tymode.win", 33 ], [ "linkvertise.com", 33 ], [ "reifenrechner.at", 33 ], [ "tire-size-calculator.info", 33 ], [ "linuxsecurity.com", 33 ], [ "itsguider.com", 33 ], [ "cotravinh.blogspot.com", 33 ], [ "itudong.com", 33 ], [ "shortx.net", 33 ], [ "btvsports.*", 33 ], [ "lecturel.com", 33 ], [ "bakai.org", 33 ], [ "nar.k-ba.net", 33 ], [ "eurotruck2.com.br", 33 ], [ "tiroalpaloes.com", 33 ], [ "stream4free.*", 33 ], [ "tiroalpaloes.net", 33 ], [ "flixsix.com", 33 ], [ "tiroalpaloweb.xyz", 33 ], [ "globaldjmix.com", 34 ], [ "desiupload.*", [ 35, 147 ] ], [ "hblinks.pro", 35 ], [ "hubcdn.vip", 35 ], [ "hubdrive.*", 35 ], [ "90fpsconfig.in", 35 ], [ "katdrive.link", 35 ], [ "kmhd.net", 35 ], [ "bollydrive.rest", 35 ], [ "360news4u.net", 35 ], [ "hypershort.com", [ 35, 126 ] ], [ "bollydrive.*", [ 35, 149 ] ], [ "zazzybabes.com", 36 ], [ "haaretz.co.il", 37 ], [ "haaretz.com", 37 ], [ "slate.com", 38 ], [ "megalinks.info", 39 ], [ "megapastes.com", 39 ], [ "mega-mkv.com", [ 39, 40 ] ], [ "mkv-pastes.com", 39 ], [ "zpaste.net", 39 ], [ "zlpaste.net", 39 ], [ "9xlinks.site", 39 ], [ "mega-dvdrip.*", 40 ], [ "peliculas-dvdrip.*", 40 ], [ "desbloqueador.*", 41 ], [ "cine.to", [ 42, 186 ] ], [ "newpelis.*", [ 42, 48 ] ], [ "pelix.*", [ 42, 48 ] ], [ "allcalidad.*", [ 42, 128 ] ], [ "khatrimaza.*", 42 ], [ "kissasia.cc", 42 ], [ "camwhores.*", 43 ], [ "camwhorestv.*", 43 ], [ "digjav.com", 43 ], [ "uproxy.*", 43 ], [ "videoszoofiliahd.com", 44 ], [ "xxxtubezoo.com", 45 ], [ "zooredtube.com", 45 ], [ "uii.io", 46 ], [ "porndoe.com", 47 ], [ "acienciasgalilei.com", 49 ], [ "playrust.io", 50 ], [ "payskip.org", 51 ], [ "short-url.link", 52 ], [ "tubedupe.com", 53 ], [ "mirrorace.*", 54 ], [ "fatgirlskinny.net", 55 ], [ "polska-ie.com", 55 ], [ "windowsmatters.com", 55 ], [ "canaltdt.es", 56 ], [ "masbrooo.com", 56 ], [ "2ndrun.tv", 56 ], [ "oncehelp.com", 57 ], [ "curto.win", 57 ], [ "smallseotools.com", 58 ], [ "mixdrp.*", 59 ], [ "macwelt.de", 60 ], [ "pcwelt.de", 60 ], [ "capital.de", 60 ], [ "geo.de", 60 ], [ "allmomsex.com", 61 ], [ "allnewindianporn.com", 61 ], [ "analxxxvideo.com", 61 ], [ "animalextremesex.com", 61 ], [ "anime3d.xyz", 61 ], [ "animefuckmovies.com", 61 ], [ "animepornfilm.com", 61 ], [ "animesexbar.com", 61 ], [ "animesexclip.com", 61 ], [ "animexxxsex.com", 61 ], [ "animexxxfilms.com", 61 ], [ "anysex.club", 61 ], [ "apetube.asia", 61 ], [ "asianfuckmovies.com", 61 ], [ "asianfucktube.com", 61 ], [ "asianporn.sexy", 61 ], [ "asiansex.*", 61 ], [ "asiansexcilps.com", 61 ], [ "beeg.fund", 61 ], [ "beegvideoz.com", 61 ], [ "bestasiansex.pro", 61 ], [ "bravotube.asia", 61 ], [ "brutalanimalsfuck.com", 61 ], [ "candyteenporn.com", 61 ], [ "daddyfuckmovies.com", 61 ], [ "desifuckonline.com", 61 ], [ "exclusiveasianporn.com", 61 ], [ "exteenporn.com", 61 ], [ "fantasticporn.net", 61 ], [ "fantasticyoungporn.com", 61 ], [ "fineasiansex.com", 61 ], [ "firstasianpussy.com", 61 ], [ "freeindiansextube.com", 61 ], [ "freepornasians.com", 61 ], [ "freerealvideo.com", 61 ], [ "fuck-beeg.com", 61 ], [ "fuck-xnxx.com", 61 ], [ "fuckfuq.com", 61 ], [ "fuckundies.com", 61 ], [ "gojapaneseporn.com", 61 ], [ "golderotica.com", 61 ], [ "goodyoungsex.com", 61 ], [ "goyoungporn.com", 61 ], [ "hardxxxmoms.com", 61 ], [ "hdvintagetube.com", 61 ], [ "hentaiporn.me", 61 ], [ "hentaisexfilms.com", 61 ], [ "hentaisexuality.com", 61 ], [ "hot-teens-movies.mobi", 61 ], [ "hotanimepornvideos.com", 61 ], [ "hotanimevideos.com", 61 ], [ "hotasianpussysex.com", 61 ], [ "hotjapaneseshows.com", 61 ], [ "hotmaturetube.com", 61 ], [ "hotmilfs.pro", 61 ], [ "hotorientalporn.com", 61 ], [ "hotpornyoung.com", 61 ], [ "hotxxxjapanese.com", 61 ], [ "hotxxxpussy.com", 61 ], [ "indiafree.net", 61 ], [ "indianpornvideo.online", 61 ], [ "japanfuck.*", 61 ], [ "japanporn.*", 61 ], [ "japanpornclip.com", 61 ], [ "japanesetube.video", 61 ], [ "japansex.me", 61 ], [ "japanesexxxporn.com", 61 ], [ "japansporno.com", 61 ], [ "japanxxx.asia", 61 ], [ "japanxxxworld.com", 61 ], [ "keezmovies.surf", 61 ], [ "lingeriefuckvideo.com", 61 ], [ "liveanimalporn.zooo.club", 61 ], [ "madhentaitube.com", 61 ], [ "megahentaitube.com", 61 ], [ "megajapanesesex.com", 61 ], [ "megajapantube.com", 61 ], [ "milfxxxpussy.com", 61 ], [ "momsextube.pro", 61 ], [ "momxxxass.com", 61 ], [ "monkeyanimalporn.com", 61 ], [ "moviexxx.mobi", 61 ], [ "newanimeporn.com", 61 ], [ "newjapanesexxx.com", 61 ], [ "nicematureporn.com", 61 ], [ "nudeplayboygirls.com", 61 ], [ "originalindianporn.com", 61 ], [ "originalteentube.com", 61 ], [ "pig-fuck.com", 61 ], [ "plainasianporn.com", 61 ], [ "popularasianxxx.com", 61 ], [ "pornanimetube.com", 61 ], [ "pornasians.pro", 61 ], [ "pornhat.asia", 61 ], [ "pornjapanesesex.com", 61 ], [ "pornvintage.tv", 61 ], [ "primeanimesex.com", 61 ], [ "realjapansex.com", 61 ], [ "realmomsex.com", 61 ], [ "redsexhub.com", 61 ], [ "retroporn.world", 61 ], [ "retrosexfilms.com", 61 ], [ "sex-free-movies.com", 61 ], [ "sexanimesex.com", 61 ], [ "sexanimetube.com", 61 ], [ "sexjapantube.com", 61 ], [ "sexmomvideos.com", 61 ], [ "sexteenxxxtube.com", 61 ], [ "sexxxanimal.com", 61 ], [ "sexyoungtube.com", 61 ], [ "sexyvintageporn.com", 61 ], [ "spicyvintageporn.com", 61 ], [ "sunporno.club", 61 ], [ "tabooanime.club", 61 ], [ "teenextrem.com", 61 ], [ "teenfucksex.com", 61 ], [ "teenhost.net", 61 ], [ "teensex.*", 61 ], [ "teensexass.com", 61 ], [ "tnaflix.asia", 61 ], [ "totalfuckmovies.com", 61 ], [ "totalmaturefuck.com", 61 ], [ "txxx.asia", 61 ], [ "vintagetube.*", 61 ], [ "voyeurpornsex.com", 61 ], [ "warmteensex.com", 61 ], [ "wetasiancreampie.com", 61 ], [ "wildhentaitube.com", 61 ], [ "wowyoungsex.com", 61 ], [ "xhamster-art.com", 61 ], [ "xmovie.pro", 61 ], [ "xnudevideos.com", 61 ], [ "xnxxjapon.com", 61 ], [ "xpics.me", 61 ], [ "xvide.me", 61 ], [ "xxxanimefuck.com", 61 ], [ "xxxanimevideos.com", 61 ], [ "xxxanimemovies.com", 61 ], [ "xxxhentaimovies.com", 61 ], [ "xxxhothub.com", 61 ], [ "xxxjapaneseporntube.com", 61 ], [ "xxxlargeporn.com", 61 ], [ "xxxmomz.com", 61 ], [ "xxxmovies.*", 61 ], [ "xxxpornmilf.com", 61 ], [ "xxxpussyclips.com", 61 ], [ "xxxpussysextube.com", 61 ], [ "xxxretrofuck.com", 61 ], [ "xxxsex.pro", 61 ], [ "xxxsexyjapanese.com", 61 ], [ "xxxteenyporn.com", 61 ], [ "xxxvideo.asia", 61 ], [ "xxxyoungtv.com", 61 ], [ "youjizzz.club", 61 ], [ "youngpussyfuck.com", 61 ], [ "bayimg.com", 62 ], [ "celeb.gate.cc", 63 ], [ "kinoger.re", 64 ], [ "usersdrive.com", 64 ], [ "desi.upn.bio", 64 ], [ "zooqle.*", 65 ], [ "masterplayer.xyz", 66 ], [ "pussy-hub.com", 66 ], [ "porndex.com", 67 ], [ "compucalitv.com", 68 ], [ "hdfull.*", 69 ], [ "diariodenavarra.es", 70 ], [ "mangamanga.*", 71 ], [ "streameast.*", 72 ], [ "thestreameast.*", 72 ], [ "pennlive.com", 73 ], [ "beautypageants.indiatimes.com", 74 ], [ "01fmovies.com", 75 ], [ "vev.*", 76 ], [ "vidop.*", 76 ], [ "lnk2.cc", 77 ], [ "fullhdxxx.com", 78 ], [ "classicpornbest.com", 78 ], [ "www-daftarharga.blogspot.com", [ 78, 135 ] ], [ "1youngteenporn.com", 78 ], [ "miraculous.to", [ 78, 181 ] ], [ "vtube.to", 78 ], [ "zone-telechargement.*", 78 ], [ "xstory-fr.com", 78 ], [ "gosexpod.com", 79 ], [ "tubepornclassic.com", 80 ], [ "shemalez.com", 80 ], [ "otakukan.com", 81 ], [ "xcafe.com", 82 ], [ "pornfd.com", 82 ], [ "venusarchives.com", 82 ], [ "imagehaha.com", 83 ], [ "imagenpic.com", 83 ], [ "imageshimage.com", 83 ], [ "imagetwist.com", 83 ], [ "megalink.*", 84 ], [ "k1nk.co", 84 ], [ "watchasians.cc", 84 ], [ "lulustream.com", 84 ], [ "lulustream.live", 84 ], [ "luluvdo.com", 84 ], [ "vibestreams.*", 84 ], [ "gmx.*", 85 ], [ "web.de", 85 ], [ "news18.com", 86 ], [ "thelanb.com", 87 ], [ "dropmms.com", 87 ], [ "softwaredescargas.com", 88 ], [ "cracking-dz.com", 89 ], [ "mega1080p.*", 90 ], [ "anitube.*", 90 ], [ "gazzetta.it", 91 ], [ "9hentai.*", 92 ], [ "dziennikbaltycki.pl", 93 ], [ "dzienniklodzki.pl", 93 ], [ "dziennikpolski24.pl", 93 ], [ "dziennikzachodni.pl", 93 ], [ "echodnia.eu", 93 ], [ "expressbydgoski.pl", 93 ], [ "expressilustrowany.pl", 93 ], [ "gazetakrakowska.pl", 93 ], [ "gazetalubuska.pl", 93 ], [ "gazetawroclawska.pl", 93 ], [ "gk24.pl", 93 ], [ "gloswielkopolski.pl", 93 ], [ "gol24.pl", 93 ], [ "gp24.pl", 93 ], [ "gra.pl", 93 ], [ "gs24.pl", 93 ], [ "kurierlubelski.pl", 93 ], [ "motofakty.pl", 93 ], [ "naszemiasto.pl", 93 ], [ "nowiny24.pl", 93 ], [ "nowosci.com.pl", 93 ], [ "nto.pl", 93 ], [ "polskatimes.pl", 93 ], [ "pomorska.pl", 93 ], [ "poranny.pl", 93 ], [ "sportowy24.pl", 93 ], [ "strefaagro.pl", 93 ], [ "strefabiznesu.pl", 93 ], [ "stronakobiet.pl", 93 ], [ "telemagazyn.pl", 93 ], [ "to.com.pl", 93 ], [ "wspolczesna.pl", 93 ], [ "courseclub.me", 93 ], [ "azrom.net", 93 ], [ "alttyab.net", 93 ], [ "esopress.com", 93 ], [ "nesiaku.my.id", 93 ], [ "onemanhua.com", 94 ], [ "freeindianporn.mobi", 94 ], [ "dr-farfar.com", 95 ], [ "boyfriendtv.com", 96 ], [ "brandstofprijzen.info", 97 ], [ "netfuck.net", 98 ], [ "gaypornhdfree.*", 98 ], [ "blog24.me", [ 98, 106 ] ], [ "kisahdunia.com", 98 ], [ "cinemakottaga.*", 98 ], [ "privatemoviez.*", 98 ], [ "nulljungle.com", 98 ], [ "oyuncusoruyor.com", 98 ], [ "pbarecap.ph", 98 ], [ "sourds.net", 98 ], [ "teknobalta.com", 98 ], [ "tvinternetowa.info", 98 ], [ "sqlserveregitimleri.com", 98 ], [ "tutcourse.com", 98 ], [ "warddogs.com", 98 ], [ "iimanga.com", 98 ], [ "tinhocdongthap.com", 98 ], [ "tremamnon.com", 98 ], [ "423down.com", 98 ], [ "brizzynovel.com", 98 ], [ "jugomobile.com", 98 ], [ "freecodezilla.net", 98 ], [ "apkmaven.*", 98 ], [ "iconmonstr.com", 98 ], [ "rbxscripts.net", 98 ], [ "comentariodetexto.com", 98 ], [ "wordpredia.com", 98 ], [ "allfaucet.xyz", [ 98, 106 ] ], [ "titbytz.tk", 98 ], [ "replica-watch.info", 98 ], [ "alludemycourses.com", 98 ], [ "kayifamilytv.com", 98 ], [ "interfans.org", 98 ], [ "iir.ai", 99 ], [ "popcornstream.*", 100 ], [ "qpython.club", 101 ], [ "dktechnicalmate.com", 101 ], [ "recipahi.com", 101 ], [ "e9china.net", 102 ], [ "ontools.net", 102 ], [ "marketbeat.com", 103 ], [ "hentaipornpics.net", 104 ], [ "labgame.io", 105 ], [ "ohionowcast.info", 106 ], [ "wiour.com", 106 ], [ "bitzite.com", [ 106, 111, 112 ] ], [ "appsbull.com", 106 ], [ "diudemy.com", 106 ], [ "maqal360.com", [ 106, 114, 115 ] ], [ "bitcotasks.com", 106 ], [ "videolyrics.in", 106 ], [ "manofadan.com", 106 ], [ "cempakajaya.com", 106 ], [ "tagecoin.com", 106 ], [ "naijafav.top", 106 ], [ "ourcoincash.xyz", 106 ], [ "claimcoins.site", 106 ], [ "cryptosh.pro", 106 ], [ "eftacrypto.com", 106 ], [ "fescrypto.com", 106 ], [ "earnhub.net", 106 ], [ "kiddyshort.com", 106 ], [ "tronxminer.com", 106 ], [ "neverdims.com", 106 ], [ "homeairquality.org", 107 ], [ "cety.app", [ 108, 109 ] ], [ "exego.app", 108 ], [ "cutlink.net", 108 ], [ "cutyurls.com", 108 ], [ "cutty.app", 108 ], [ "cutnet.net", 108 ], [ "jixo.online", 108 ], [ "cuty.me", 109 ], [ "exnion.com", 109 ], [ "upfion.com", [ 109, 125 ] ], [ "upfiles.app", [ 109, 125 ] ], [ "upfiles-urls.com", [ 109, 125 ] ], [ "vikingf1le.us.to", 109 ], [ "gamerxyt.com", 109 ], [ "up4stream.com", 109 ], [ "ups2up.fun", 109 ], [ "championdrive.co", 109 ], [ "adcrypto.net", 110 ], [ "admediaflex.com", 110 ], [ "aduzz.com", 110 ], [ "bitcrypto.info", 110 ], [ "cdrab.com", 110 ], [ "datacheap.io", 110 ], [ "hbz.us", 110 ], [ "savego.org", 110 ], [ "owsafe.com", 110 ], [ "sportweb.info", 110 ], [ "gfx-station.com", 111 ], [ "buzzheavier.com", 112 ], [ "flashbang.sh", 112 ], [ "trashbytes.net", 112 ], [ "aiimgvlog.fun", 113 ], [ "6indianporn.com", 113 ], [ "amateurebonypics.com", 113 ], [ "amateuryoungpics.com", 113 ], [ "amigosporn.top", 113 ], [ "cinemabg.net", 113 ], [ "coomer.su", 113 ], [ "desimmshd.com", 113 ], [ "everia.club", 113 ], [ "frauporno.com", 113 ], [ "givemeaporn.com", 113 ], [ "hitomi.la", 113 ], [ "jav-asia.top", 113 ], [ "javf.net", 113 ], [ "javfull.net", 113 ], [ "javideo.net", 113 ], [ "javsunday.com", 113 ], [ "kemono.su", 113 ], [ "kr18plus.com", 113 ], [ "luscious.net", 113 ], [ "missavtv.com", 113 ], [ "pilibook.com", 113 ], [ "pornborne.com", 113 ], [ "porngrey.com", 113 ], [ "pornktube.*", 113 ], [ "pornx.tube", 113 ], [ "qqxnxx.com", 113 ], [ "sexvideos.host", 113 ], [ "submilf.com", 113 ], [ "subtaboo.com", 113 ], [ "tktube.com", 113 ], [ "watchseries.*", 113 ], [ "xfrenchies.com", 113 ], [ "soft98.ir", [ 114, 149 ] ], [ "moderngyan.com", 116 ], [ "sattakingcharts.in", 116 ], [ "bgmi32bitapk.in", 116 ], [ "bankshiksha.in", 116 ], [ "earn.mpscstudyhub.com", 116 ], [ "earn.quotesopia.com", 116 ], [ "money.quotesopia.com", 116 ], [ "best-mobilegames.com", 116 ], [ "learn.moderngyan.com", 116 ], [ "bharatsarkarijobalert.com", 116 ], [ "quotesopia.com", 116 ], [ "creditsgoal.com", 116 ], [ "coingraph.us", 117 ], [ "momo-net.com", 117 ], [ "milfnut.*", 117 ], [ "maxgaming.fi", 117 ], [ "cybercityhelp.in", 118 ], [ "travel.vebma.com", 119 ], [ "cloud.majalahhewan.com", 119 ], [ "crm.cekresi.me", 119 ], [ "ai.tempatwisata.pro", 119 ], [ "pinloker.com", 119 ], [ "sekilastekno.com", 119 ], [ "mrproblogger.com", 120 ], [ "themezon.net", 120 ], [ "dagensnytt.com", 120 ], [ "azmath.info", 121 ], [ "azsoft.*", 121 ], [ "downfile.site", 121 ], [ "downphanmem.com", 121 ], [ "expertvn.com", 121 ], [ "memangbau.com", 121 ], [ "trangchu.news", 121 ], [ "aztravels.net", 121 ], [ "ielts-isa.edu.vn", 121 ], [ "techedubyte.com", [ 121, 228 ] ], [ "jpopsingles.eu", 121 ], [ "aipebel.com", 121 ], [ "link.paid4link.com", [ 122, 123 ] ], [ "driveup.sbs", 124 ], [ "crypt.cybar.xyz", 124 ], [ "dynamicminister.net", 124 ], [ "gofirmware.com", 124 ], [ "national-park.com", 124 ], [ "forgee.xyz", 124 ], [ "gamehub.cam", 124 ], [ "cutyion.com", 125 ], [ "weshare.is", 127 ], [ "file.gocmod.com", 127 ], [ "camarchive.tv", 128 ], [ "crownimg.com", 128 ], [ "flixbaba.*", 128 ], [ "freejav.guru", 128 ], [ "gntai.*", 128 ], [ "grantorrent.*", 128 ], [ "hentai2read.com", 128 ], [ "icyporno.com", 128 ], [ "illink.net", 128 ], [ "javtiful.com", 128 ], [ "m-hentai.net", 128 ], [ "mejortorrent.*", 128 ], [ "mejortorrento.*", 128 ], [ "mejortorrents.*", 128 ], [ "mejortorrents1.*", 128 ], [ "mejortorrentt.*", 128 ], [ "pornblade.com", 128 ], [ "pornfelix.com", 128 ], [ "pornxxxxtube.net", 128 ], [ "redwap.me", 128 ], [ "redwap2.com", 128 ], [ "redwap3.com", 128 ], [ "sunporno.com", 128 ], [ "tubxporn.xxx", 128 ], [ "ver-comics-porno.com", 128 ], [ "ver-mangas-porno.com", 128 ], [ "x-fetish.tube", 128 ], [ "x-tg.tube", 128 ], [ "x-video.tube", 128 ], [ "xanimeporn.com", 128 ], [ "xxxvideohd.net", 128 ], [ "zetporn.com", 128 ], [ "gofile.download", 128 ], [ "simpcity.su", 129 ], [ "gameofporn.com", 130 ], [ "0dramacool.net", 131 ], [ "0gomovie.*", 131 ], [ "0gomovies.*", 131 ], [ "185.53.88.104", 131 ], [ "185.53.88.204", 131 ], [ "185.53.88.15", 131 ], [ "123moviefree.*", 131 ], [ "123movies4k.net", 131 ], [ "1kmovies.*", 131 ], [ "1madrasdub.*", 131 ], [ "1primewire.*", 131 ], [ "1rowsports.com", 131 ], [ "2embed.*", 131 ], [ "2madrasdub.*", 131 ], [ "2umovies.*", 131 ], [ "4anime.*", 131 ], [ "4share-mp3.net", 131 ], [ "9animetv.to", 131 ], [ "720pstream.me", 131 ], [ "aagmaal.com", 131 ], [ "abysscdn.com", 131 ], [ "adblockplustape.*", 131 ], [ "ajkalerbarta.com", 131 ], [ "altadefinizione01.*", 131 ], [ "androidapks.biz", 131 ], [ "androidsite.net", 131 ], [ "animeonlinefree.org", 131 ], [ "animesite.net", 131 ], [ "animespank.com", 131 ], [ "aniworld.to", 131 ], [ "apkmody.io", 131 ], [ "appsfree4u.com", 131 ], [ "atomixhq.*", 131 ], [ "audioz.download", 131 ], [ "awafim.tv", 131 ], [ "beastlyprints.com", 131 ], [ "beinmatch.*", 131 ], [ "bengalisite.com", 131 ], [ "brmovies.*", 131 ], [ "ch-play.com", 131 ], [ "cima4u.*", 131 ], [ "clickforhire.com", 131 ], [ "clicknupload.*", 131 ], [ "cloudy.pk", 131 ], [ "cmovies.*", 131 ], [ "computercrack.com", 131 ], [ "coolcast2.com", 131 ], [ "crackedsoftware.biz", 131 ], [ "crackfree.org", 131 ], [ "cricfree.*", 131 ], [ "crichd.*", 131 ], [ "cryptoblog24.info", 131 ], [ "cuatrolatastv.blogspot.com", 131 ], [ "cydiasources.net", 131 ], [ "decmelfot.xyz", 131 ], [ "dirproxy.com", 131 ], [ "dood.*", 131 ], [ "dopebox.to", 131 ], [ "downloadapk.info", 131 ], [ "downloadapps.info", 131 ], [ "downloadgames.info", 131 ], [ "downloadmusic.info", 131 ], [ "downloadsite.org", 131 ], [ "downloadwella.com", 131 ], [ "ebooksite.org", 131 ], [ "educationtips213.blogspot.com", 131 ], [ "egyup.live", 131 ], [ "elgoles.pro", 131 ], [ "embed.meomeo.pw", 131 ], [ "embed.scdn.to", 131 ], [ "emulatorsite.com", 131 ], [ "essaysharkwriting.club", 131 ], [ "exploreera.net", 131 ], [ "extrafreetv.com", 131 ], [ "f1stream.*", 131 ], [ "fakedetail.com", 131 ], [ "faselhd.*", 131 ], [ "fbstream.*", 131 ], [ "fclecteur.com", 131 ], [ "filemoon.*", 131 ], [ "filepress.*", [ 131, 208 ] ], [ "files.im", 131 ], [ "filmlinks4u.*", 131 ], [ "filmpertutti.*", 131 ], [ "filmyzilla.*", 131 ], [ "flexyhit.com", 131 ], [ "fmoviefree.net", 131 ], [ "fmovies24.com", 131 ], [ "fmovies.*", 131 ], [ "freeflix.info", 131 ], [ "freemoviesu4.com", 131 ], [ "freeplayervideo.com", 131 ], [ "freesoccer.net", 131 ], [ "french-stream.*", 131 ], [ "fseries.org", 131 ], [ "fzlink.*", 131 ], [ "gamefast.org", 131 ], [ "gamesite.info", 131 ], [ "gettapeads.com", 131 ], [ "gmanga.me", 131 ], [ "gocast123.me", 131 ], [ "gofilms4u.*", 131 ], [ "gogoanime.*", 131 ], [ "gogohd.net", 131 ], [ "gogoplay5.com", 131 ], [ "gomoviz.*", 131 ], [ "gooplay.net", 131 ], [ "gostreamon.net", 131 ], [ "happy2hub.org", 131 ], [ "harimanga.com", 131 ], [ "hdmoviefair.*", 131 ], [ "hdmovies4u.*", 131 ], [ "hdmovies50.*", 131 ], [ "hdmoviesfair.*", 131 ], [ "healthnewsreel.com", 131 ], [ "hexupload.net", 131 ], [ "hh3dhay.*", 131 ], [ "hinatasoul.com", 131 ], [ "hindilinks4u.*", 131 ], [ "hindisite.net", 131 ], [ "holymanga.net", 131 ], [ "hotmasti.*", 131 ], [ "hurawatch.*", 131 ], [ "hxfile.co", 131 ], [ "isosite.org", 131 ], [ "iv-soft.com", 131 ], [ "januflix.expert", 131 ], [ "jewelry.com.my", 131 ], [ "johnwardflighttraining.com", 131 ], [ "kabarportal.com", 131 ], [ "klmanga.*", 131 ], [ "klubsports.*", 131 ], [ "kstorymedia.com", 131 ], [ "la123movies.org", 131 ], [ "lespassionsdechinouk.com", 131 ], [ "libertestreamvf.*", 131 ], [ "lilymanga.net", 131 ], [ "linksdegrupos.com.br", 131 ], [ "linkz.wiki", 131 ], [ "livetvon.*", 131 ], [ "livestreamtv.pk", 131 ], [ "macsite.info", 131 ], [ "manga1000.*", 131 ], [ "manga1001.*", 131 ], [ "mangaraw.*", 131 ], [ "mangarawjp.*", 131 ], [ "mangasite.org", 131 ], [ "manhuascan.com", 131 ], [ "megamovies.org", 131 ], [ "membed.net", 131 ], [ "mlbstream.*", 131 ], [ "moddroid.com", 131 ], [ "motogpstream.*", 131 ], [ "movi.pk", [ 131, 158 ] ], [ "moviefree2.com", 131 ], [ "movierulz.*", 131 ], [ "movies123.*", 131 ], [ "movies-watch.com.pk", 131 ], [ "movies2watch.*", 131 ], [ "moviesden.*", 131 ], [ "moviesite.app", 131 ], [ "moviesonline.fm", 131 ], [ "moviesx.org", 131 ], [ "moviezaddiction.*", 131 ], [ "msmoviesbd.com", 131 ], [ "musicsite.biz", 131 ], [ "myfernweh.com", 131 ], [ "myviid.com", 131 ], [ "nazarickol.com", 131 ], [ "nbastream.*", 131 ], [ "netcine.*", 131 ], [ "nflstream.*", 131 ], [ "nhlstream.*", 131 ], [ "noob4cast.com", 131 ], [ "nsw2u.com", [ 131, 277 ] ], [ "oko.sh", 131 ], [ "onlinewatchmoviespk.*", 131 ], [ "orangeink.pk", 131 ], [ "pahaplayers.click", 131 ], [ "patchsite.net", 131 ], [ "pctfenix.*", 131 ], [ "pctnew.*", 131 ], [ "pdfsite.net", 131 ], [ "pksmovies.*", 131 ], [ "play1002.com", 131 ], [ "player-cdn.com", 131 ], [ "plyjam.*", 131 ], [ "plylive.*", 131 ], [ "pogolinks.*", 131 ], [ "popcorntime.*", 131 ], [ "poscitech.*", 131 ], [ "productkeysite.com", 131 ], [ "projectfreetv.one", 131 ], [ "romsite.org", 131 ], [ "rufiguta.com", 131 ], [ "rugbystreams.*", 131 ], [ "rytmp3.io", 131 ], [ "send.cm", 131 ], [ "seriesite.net", 131 ], [ "seriezloaded.com.ng", 131 ], [ "serijehaha.com", 131 ], [ "shahed4u.*", 131 ], [ "sflix.*", 131 ], [ "shrugemojis.com", 131 ], [ "siteapk.net", 131 ], [ "siteflix.org", 131 ], [ "sitegames.net", 131 ], [ "sitekeys.net", 131 ], [ "sitepdf.com", 131 ], [ "sitesunblocked.*", 131 ], [ "sitetorrent.com", 131 ], [ "softwaresite.net", 131 ], [ "solarmovies.*", 131 ], [ "sportbar.live", 131 ], [ "sportcast.*", 131 ], [ "sportskart.*", 131 ], [ "sports-stream.*", 131 ], [ "ssyoutube.com", 131 ], [ "stardima.com", 131 ], [ "stream4free.live", 131 ], [ "streaming-french.*", 131 ], [ "streamers.*", 131 ], [ "streamingcommunity.*", [ 131, 193 ] ], [ "superapk.org", 131 ], [ "supermovies.org", 131 ], [ "t20cup.*", 131 ], [ "tainio-mania.online", 131 ], [ "talaba.su", 131 ], [ "tamilguns.org", 131 ], [ "tatabrada.tv", 131 ], [ "techtrendmakers.com", 131 ], [ "tennisstreams.*", 131 ], [ "thememypc.net", 131 ], [ "thripy.com", 131 ], [ "torrentdosfilmes.*", 131 ], [ "toonanime.*", 131 ], [ "travelplanspro.com", 131 ], [ "turcasmania.com", 131 ], [ "tusfiles.com", 131 ], [ "tvonlinesports.com", 131 ], [ "tvply.*", 131 ], [ "ufcstream.*", 131 ], [ "ultramovies.org", 131 ], [ "uploadbank.com", 131 ], [ "uptomega.*", 131 ], [ "uqload.*", 131 ], [ "urdubolo.pk", 131 ], [ "vudeo.*", 131 ], [ "vidoo.*", 131 ], [ "vidspeeds.com", 131 ], [ "vipboxtv.*", 131 ], [ "viprow.*", 131 ], [ "warezsite.net", 131 ], [ "watchmovies2.com", 131 ], [ "watchmoviesforfree.org", 131 ], [ "watchofree.com", 131 ], [ "watchsite.net", 131 ], [ "watchsouthpark.tv", 131 ], [ "watchtvch.club", 131 ], [ "web.livecricket.is", 131 ], [ "webseries.club", 131 ], [ "worldcupstream.pm", 131 ], [ "y2mate.com", 131 ], [ "yesmovies.*", 131 ], [ "yomovies.*", 131 ], [ "yomovies1.*", 131 ], [ "youapk.net", 131 ], [ "youtube4kdownloader.com", 131 ], [ "yt2mp3s.*", 131 ], [ "yts-subs.com", 131 ], [ "kat.*", 131 ], [ "katbay.*", 131 ], [ "kickass.*", 131 ], [ "kickasshydra.*", 131 ], [ "kickasskat.*", 131 ], [ "kickass2.*", 131 ], [ "kickasstorrents.*", 131 ], [ "kat2.*", 131 ], [ "kattracker.*", 131 ], [ "thekat.*", 131 ], [ "thekickass.*", 131 ], [ "kickassz.*", 131 ], [ "kickasstorrents2.*", 131 ], [ "topkickass.*", 131 ], [ "kickassgo.*", 131 ], [ "kkickass.*", 131 ], [ "kkat.*", 131 ], [ "kickasst.*", 131 ], [ "kick4ss.*", 131 ], [ "cineb.rs", 132 ], [ "moviesjoyhd.to", 132 ], [ "rawkuma.com", [ 132, 175 ] ], [ "nekolink.site", 133 ], [ "foxhq.com", 134 ], [ "adelsfun.com", 136 ], [ "advantien.com", 136 ], [ "bailbondsfinder.com", 136 ], [ "bg-gledai.*", 136 ], [ "bigpiecreative.com", 136 ], [ "childrenslibrarylady.com", 136 ], [ "classifarms.com", 136 ], [ "comtasq.ca", 136 ], [ "crone.es", 136 ], [ "ctrmarketingsolutions.com", 136 ], [ "dropnudes.com", 136 ], [ "ftuapps.dev", 136 ], [ "gendatabase.com", 136 ], [ "genzsport.com", 136 ], [ "ghscanner.com", 136 ], [ "gledaitv.*", 136 ], [ "grsprotection.com", 136 ], [ "gruporafa.com.br", 136 ], [ "inmatefindcalifornia.com", 136 ], [ "inmatesearchidaho.com", 136 ], [ "itsonsitetv.com", 136 ], [ "mfmfinancials.com", 136 ], [ "myproplugins.com", 136 ], [ "nurulislam.org", 136 ], [ "onehack.us", 136 ], [ "ovester.com", 136 ], [ "paste.bin.sx", 136 ], [ "privatenudes.com", 136 ], [ "renoconcrete.ca", 136 ], [ "richieashbeck.com", 136 ], [ "sat.technology", 136 ], [ "short1ink.com", 136 ], [ "stpm.co.uk", 136 ], [ "wegotcookies.co", 136 ], [ "mathcrave.com", 136 ], [ "vip-box.app", 136 ], [ "filmyzones.com", 137 ], [ "pornflixhd.com", 137 ], [ "androidpolice.com", 138 ], [ "cbr.com", 138 ], [ "gamerant.com", 138 ], [ "howtogeek.com", 138 ], [ "thegamer.com", 138 ], [ "winfuture.de", 139 ], [ "komikdewasa.art", 140 ], [ "flight-report.com", 141 ], [ "vulture.com", 142 ], [ "megaplayer.bokracdn.run", 143 ], [ "hentaistream.com", 144 ], [ "siteunblocked.info", 145 ], [ "larvelfaucet.com", 146 ], [ "feyorra.top", 146 ], [ "claimtrx.com", 146 ], [ "pagalmovies.*", 147 ], [ "7starhd.*", 147 ], [ "jalshamoviez.*", 147 ], [ "moviesyug.net", 147 ], [ "9xupload.*", 147 ], [ "bdupload.*", 147 ], [ "rdxhd1.*", 147 ], [ "parispi.net", 148 ], [ "hentaicloud.com", 149 ], [ "nuvid.*", 149 ], [ "tio.ch", 150 ], [ "lavanguardia.com", 150 ], [ "news.bg", [ 150, 223 ] ], [ "tu.no", 150 ], [ "paperzonevn.com", 151 ], [ "dailyvideoreports.net", 152 ], [ "lewd.ninja", 153 ], [ "systemnews24.com", 154 ], [ "niusdiario.es", 155 ], [ "playporngames.com", 156 ], [ "descargatepelis.com", 156 ], [ "javx.*", 156 ], [ "kungfutv.net", 156 ], [ "freemagazines.top", 157 ], [ "freepreset.net", 157 ], [ "moviessources.*", 159 ], [ "cutesexyteengirls.com", 160 ], [ "haho.moe", 161 ], [ "nicy-spicy.pw", 162 ], [ "novelmultiverse.com", 163 ], [ "mylegalporno.com", 164 ], [ "embedsports.me", 165 ], [ "embedstream.me", 165 ], [ "jumbtv.com", 165 ], [ "reliabletv.me", 165 ], [ "guardaserie.*", 166 ], [ "cine-calidad.*", 167 ], [ "xnxx.com", 168 ], [ "xvideos.*", 168 ], [ "thecut.com", 169 ], [ "novelism.jp", 170 ], [ "alphapolis.co.jp", 171 ], [ "game3rb.com", 172 ], [ "javhub.net", 172 ], [ "thotvids.com", 173 ], [ "tokuzl.net", 173 ], [ "berklee.edu", 174 ], [ "imeteo.sk", 176 ], [ "youtubemp3donusturucu.net", 177 ], [ "videovard.*", 178 ], [ "cluset.com", 179 ], [ "homemoviestube.com", 179 ], [ "sexseeimage.com", 179 ], [ "alueviesti.fi", 180 ], [ "kiuruvesilehti.fi", 180 ], [ "lempaala.ideapark.fi", 180 ], [ "olutposti.fi", 180 ], [ "urjalansanomat.fi", 180 ], [ "tainhanhvn.com", 182 ], [ "titantv.com", 183 ], [ "cocomanga.com", 184 ], [ "animelatinohd.com", 184 ], [ "buondua.com", 185 ], [ "m.liputan6.com", 187 ], [ "stardewids.com", [ 187, 204 ] ], [ "ingles.com", 188 ], [ "spanishdict.com", 188 ], [ "surfline.com", 189 ], [ "rureka.com", 190 ], [ "amateur8.com", 191 ], [ "freeporn8.com", 191 ], [ "maturetubehere.com", 191 ], [ "corriere.it", 192 ], [ "oggi.it", 192 ], [ "apkcombo.com", 194 ], [ "sponsorhunter.com", 195 ], [ "novelssites.com", 196 ], [ "haxina.com", 197 ], [ "scimagojr.com", 197 ], [ "dramafren.net", 197 ], [ "torrentmac.net", 198 ], [ "udvl.com", 199 ], [ "dlpanda.com", 200 ], [ "einrichtungsbeispiele.de", 201 ], [ "weadown.com", 202 ], [ "molotov.tv", 203 ], [ "commands.gg", 204 ], [ "smgplaza.com", 205 ], [ "emturbovid.com", 206 ], [ "findjav.com", 206 ], [ "javggvideo.xyz", 206 ], [ "mmtv01.xyz", 206 ], [ "stbturbo.xyz", 206 ], [ "streamsilk.com", 206 ], [ "freepik.com", 207 ], [ "sportnews.to", 209 ], [ "soccershoes.blog", 209 ], [ "shineads.*", 209 ], [ "diyphotography.net", 210 ], [ "bitchesgirls.com", 211 ], [ "cdn.bg-gledai.*", 212 ], [ "explorecams.com", 213 ], [ "minecraft.buzz", 213 ], [ "hiraethtranslation.com", 214 ], [ "programmingeeksclub.com", 215 ], [ "diendancauduong.com", 216 ], [ "androidadult.com", 217 ], [ "parentcircle.com", 218 ], [ "h-game18.xyz", 219 ], [ "wheelofgold.com", 220 ], [ "davescomputertips.com", 221 ], [ "historyofroyalwomen.com", 221 ], [ "motchill.*", 222 ], [ "lifestyle.bg", 223 ], [ "topsport.bg", 223 ], [ "webcafe.bg", 223 ], [ "freepikdownloader.com", 224 ], [ "freepasses.org", 225 ], [ "iusedtobeaboss.com", 226 ], [ "blogtruyenmoi.com", 227 ], [ "repretel.com", 229 ], [ "tubereader.me", 229 ], [ "graphicget.com", 230 ], [ "qiwi.gg", [ 231, 232 ] ], [ "sonixgvn.net", 233 ], [ "alliptvlinks.com", 234 ], [ "smashyplayer.top", 235 ], [ "upns.*", 235 ], [ "xvideos.com", 236 ], [ "xvideos2.com", 236 ], [ "katfile.com", 237 ], [ "readcomiconline.*", 238 ], [ "nekopoi.*", 239 ], [ "ukchat.co.uk", 240 ], [ "hivelr.com", 241 ], [ "koyso.*", 242 ], [ "skidrowcodex.net", 243 ], [ "takimag.com", 244 ], [ "digi.no", 245 ], [ "th.gl", 246 ], [ "twi-fans.com", 247 ], [ "learn-cpp.org", 248 ], [ "terashare.co", 249 ], [ "pornwex.tv", 250 ], [ "smithsonianmag.com", 251 ], [ "homesports.net", 252 ], [ "realmoasis.com", 253 ], [ "javfc2.xyz", 254 ], [ "gobankingrates.com", 255 ], [ "hiddenleaf.to", 256 ], [ "ronorp.net", 257 ], [ "gdflix.*", 258 ], [ "a1movies.*", 259 ], [ "videovak.com", 260 ], [ "a-lohas.jp", 261 ], [ "akirabox.com", 262 ], [ "purplex.app", 263 ], [ "maggotdrowning.com", 264 ], [ "bilinovel.com", 265 ], [ "esportstales.com", 266 ], [ "streamup.ws", 267 ], [ "pagalfree.com", 268 ], [ "pagalworld.us", 268 ], [ "pornharlot.net", 269 ], [ "umatechnology.org", 270 ], [ "rarbg.how", 271 ], [ "4live.online", 272 ], [ "friv.com", 273 ], [ "rlxoff.com", 274 ], [ "idnes.cz", [ 275, 276 ] ] ]), i = new Map([ [ "forum.soft98.ir", [ 114, 149 ] ] ]), r = (o, e, t) => {
        ...
        return o.ancestorOrigins && e.push(...o.ancestorOrigins), e.map(((o, e) => {
            ...
            if (-1 === t) return;
            const a = o.slice(t + 3), n = a.indexOf(":");
            return {
                hn: -1 === n ? a : a.slice(0, n),
                i: e
            };
        })).filter((o => void 0 !== o));
    })();
    ...
    ((o, e = "") => {
        ...
        if (0 !== a) {
            ...
            {
                const o = a - 1;
                for (let a = 0; a < o; a++) for (let n = o; n > a; n--) {
                    const o = `${t.slice(a, n).join(".")}.*${e}`;
                    r(o, c, l), r(o, i, d);
                }
            }
        }
    })(m[0].hn);
    for (const e of l) if (!d.has(e)) try {
        o(...n[e]);
    } catch {}
}();