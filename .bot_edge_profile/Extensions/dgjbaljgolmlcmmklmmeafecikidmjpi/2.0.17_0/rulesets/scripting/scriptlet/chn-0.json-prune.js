!function() {
    function e(e = "", r = "", o = "") {
        const i = n(), s = i.makeLogPrefix("json-prune", e, r, o), c = i.initPattern(o, {
            canNegate: !0
        }), a = i.getExtraArgs(Array.from(arguments), 3);
        JSON.parse = new Proxy(JSON.parse, {
            apply: function(n, o, l) {
                const f = Reflect.apply(n, o, l);
    ...
    function t(e, o, i, s = {
        ...
        const a = n(), l = "" !== o ? a.String_split.call(o, / +/) : [], f = 0 !== l.length && "" !== i ? a.String_split.call(i, / +/) : [];
        ...
        let g = "nomatch";
        if (t.mustProcess(e, f)) for (const t of l) r(e, t, !0) && (g = "match");
    ...
    function r(e, t, o = !1) {
        ...
        for (;;) {
            ...
            const t = c.slice(0, e), n = c.slice(e + 1);
            let a = !1;
            if ("[-]" === t && Array.isArray(s)) {
                let e = s.length;
                for (;e--; ) !1 !== r(s[e], n) && (s.splice(e, 1), a = !0);
                return a;
            }
            if ("{-}" === t && s instanceof Object) {
                for (const e of Object.keys(s)) !1 !== r(s[e], n) && (delete s[e], a = !0);
                return a;
            }
            if ("[]" === t && Array.isArray(s) || "{}" === t && s instanceof Object || "*" === t && s instanceof Object) {
                for (const e of Object.keys(s)) !1 !== r(s[e], n, o) && (a = !0);
                return a;
            }
    ...
    const o = {}, i = [ [ "*.*", "adFeedbackData adType adServedUrls" ], [ "*", "list.*.link.ad list.*.link.kicker" ], [ "configs.*.properties.slideshowWCSettings.interstitialNativeAds configs.*.properties.fullScreenSlideshowSettings.interstitialNativeAds properties.componentConfigs.slideshowConfigs.interstitialNativeAds properties.componentConfigs.slideshowConfigs.slideshowSettings.interstitialNativeAds" ], [ "data.template.tabs.*.blocks.*.data.data.videos.*.ad" ], [ "ads" ], [ "ad" ], [ "data.cm_info.ads" ] ], s = new Map([ [ "msn.cn", [ 0, 1, 2 ] ], [ "iqiyi.com", 3 ], [ "sports.qq.com", 4 ], [ "news.qq.com", 4 ], [ "www.qq.com", 4 ], [ "v.qq.com", 4 ], [ "new.qq.com", 4 ], [ "qq.com", 5 ], [ "bilibili.com", 6 ] ]), c = new Map([ [ "sports.qq.com", [ 5 ] ], [ "work.weixin.qq.com", [ 5 ] ] ]), a = (e, t, n) => {
        let r = t.get(e);
    ...
    for (const t of g) if (!d.has(t)) try {
        e(...i[t]);
    } catch {}
}();