!function() {
    function e(e = "", r = "") {
        const o = n(), s = o.makeLogPrefix("json-prune-fetch-response", e, r), i = o.getExtraArgs(Array.from(arguments), 2), c = function(e, t = "") {
            const r = n(), o = new Map;
        ...
        self.fetch = new Proxy(self.fetch, {
            apply: function(f, u, g) {
                ...
                return p.then((n => n.clone().json().then((c => {
                    if ("object" != typeof c) return n;
                    if (l) return o.uboLog(s, o.JSON_stringify(c, null, 2)), n;
                    const f = t(c, e, r, a, i);
                ...
                })).catch((e => (o.uboErr(s, "Error:", e), n))))).catch((e => (o.uboErr(s, "Error:", e), 
                p)));
            }
        });
    }
    function t(e, o, s, i = {
        ...
        let u = "nomatch";
        if (t.mustProcess(e, f)) for (const t of l) r(e, t, !0) && (u = "match");
    ...
    function r(e, t, o = !1) {
        ...
        for (;;) {
            ...
            if ("[-]" === t && Array.isArray(i)) {
                let e = i.length;
                for (;e--; ) !1 !== r(i[e], n) && (i.splice(e, 1), a = !0);
                return a;
            }
            if ("{-}" === t && i instanceof Object) {
                for (const e of Object.keys(i)) !1 !== r(i[e], n) && (delete i[e], a = !0);
                return a;
            }
            if ("[]" === t && Array.isArray(i) || "{}" === t && i instanceof Object || "*" === t && i instanceof Object) {
                for (const e of Object.keys(i)) !1 !== r(i[e], n, o) && (a = !0);
                return a;
            }
    ...
    const o = {}, s = [ [ "autoplay", "", "propsToMatch", "url:ljsp.lwcdn.com" ], [ "playbackItem.isStitched", "", "propsToMatch", "url:a2d.tv/play" ] ], i = new Map([ [ "lwcdn.com", 0 ], [ "alingsastidning.se", 0 ], [ "bohuslaningen.se", 0 ], [ "gp.se", 0 ], [ "hallandsposten.se", 0 ], [ "hn.se", 0 ], [ "stromstadstidning.se", 0 ], [ "ttela.se", 0 ], [ "kungsbackaposten.se", 0 ], [ "kungalvsposten.se", 0 ], [ "molndalsposten.se", 0 ], [ "partilletidning.se", 0 ], [ "sttidningen.se", 0 ], [ "markposten.se", 0 ], [ "harrydaposten.se", 0 ], [ "mellerudsnyheter.se", 0 ], [ "tv4play.se", 1 ], [ "tv4.se", 1 ], [ "fotbollskanalen.se", 1 ], [ "koket.se", 1 ] ]), c = new Map([]), a = (e, t, n) => {
        let r = t.get(e);
