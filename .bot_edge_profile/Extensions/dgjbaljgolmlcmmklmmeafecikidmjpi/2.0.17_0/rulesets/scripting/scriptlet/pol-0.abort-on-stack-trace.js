!function() {
    function e(e = "", o = "") {
        ...
        const a = function(e, r) {
            ...
            if (-1 === o) {
                let o = e[r];
                return void Object.defineProperty(e, r, {
                    get: function() {
                        const e = i.logLevel > 1 ? "all" : "match";
                        if (n(s, e)) throw new ReferenceError(t());
                        return o;
                    },
                    set: function(e) {
                        const r = i.logLevel > 1 ? "all" : "match";
                        if (n(s, r)) throw new ReferenceError(t());
                        o = e;
                    }
                });
            }
            const c = r.slice(0, o);
            let l = e[c];
            if (r = r.slice(o + 1), l) return void a(l, r);
            const p = Object.getOwnPropertyDescriptor(e, c);
            p && void 0 !== p.set || Object.defineProperty(e, c, {
                get: function() {
                    return l;
                },
                set: function(e) {
                    l = e, e instanceof Object && a(e, r);
                }
            });
        }, l = window;
        a(l, e);
    ...
    function n(e, n = "") {
        const o = r(), i = t(), s = new o.Error(i), c = new URL(self.location.href);
        c.hash = "";
        const a = /(.*?@)?(\S+)(:\d+):\d+\)?$/, l = [];
        for (let e of o.String_split.call(s.stack, /[\n\r]+/)) {
            ...
            if (null === t) continue;
            let n = t[2];
            n.startsWith("(") && (n = n.slice(1)), n === c.href ? n = "inlineScript" : n.startsWith("<anonymous>") && (n = "injectedScript");
        ...
        const p = l.join("\t"), g = !0 !== e.matchAll && o.testPattern(e, p);
        return ("all" === n || "match" === n && g || "nomatch" === n && !g) && o.uboLog(p.replace(/\t/g, "\n")), 
        g;
    }
    function r() {
    ...
    for (const t of g) if (!f.has(t)) try {
        e(...i[t]);
    } catch {}
}();