!function() {
    function e(e = "", n = "", r = "") {
        if ("" === e) return;
        const s = t(), i = s.makeLogPrefix("set-cookie", e, n, r), c = n.toLowerCase(), a = /^("?)(.+)\1$/.exec(c), l = a && a[2] || c;
        ...
        const d = function(e = !1, t = "", n = "", r = "", s = "", i = {}) {
        ...
        }(!1, e, n, "", r, s.getExtraArgs(Array.from(arguments), 3));
        d && s.uboLog(i, "Done");
    }
    function t() {
    ...
    const n = {}, r = [ [ "cookielaw_accepted", "1", "", "reload", "1" ], [ "cookiebot-consent--necessary", "1" ], [ "cookiebot-consent--preferences", "1" ], [ "cookiebot-consent--marketing", "0" ], [ "cookiebot-consent--statistics", "0" ], [ "tek-cookie-agreed", "2" ] ], s = new Map([ [ "srk.fi", 0 ], [ "aalto.fi", [ 1, 2, 3, 4 ] ], [ "www.tek.fi", 5 ] ]), i = new Map([]), c = (e, t, o) => {
        let n = t.get(e);
