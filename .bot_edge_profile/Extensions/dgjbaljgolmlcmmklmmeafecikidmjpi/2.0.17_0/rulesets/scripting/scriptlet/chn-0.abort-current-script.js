    ...
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", o = "", r = "") {
                ...
                if ("" === e) return;
                const c = t(), i = c.makeLogPrefix("abort-current-script", e, o, r), s = c.patternToRegex(o), a = c.patternToRegex(r), l = c.getExtraArgs(Array.from(arguments), 3), g = document.currentScript, d = c.String_split.call(e, ".");
                let u, f, p = window;
                for (;u = d.shift(), 0 !== d.length && u in p != 0; ) if (p = p[u], p instanceof Object == 0) return;
                let m = Object.getOwnPropertyDescriptor(p, u);
                m instanceof Object != 0 && m.get instanceof Function != 0 || (f = p[u], m = void 0), 
                function(e) {
                ...
                const h = function() {
                    ...
                    c.logLevel > 1 && "" !== r && c.uboLog(i, `Matched src\n${e.src}`);
                    const t = y(e);
        ...
        if (0 !== o) {
            ...
            }
            {
                ...
                for (let o = 0; o < e; o++) for (let s = e; s > o; s--) {
                    const e = `${n.slice(o, s).join(".")}.*${t}`;
                    i(e, r, l), i(e, c, g);
                }
            }
        }
    })(a[0].hn);
    for (const t of l) if (!g.has(t)) try {
        e(...o[t]);
    } catch {}
}();