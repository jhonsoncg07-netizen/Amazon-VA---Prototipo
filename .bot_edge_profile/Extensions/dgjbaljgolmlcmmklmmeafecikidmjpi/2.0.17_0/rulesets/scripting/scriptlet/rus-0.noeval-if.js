!function() {
    function t(t = "") {
        ...
        const n = function() {
            ...
            return e;
        }(), o = n.makeLogPrefix("noeval-if", t), i = n.patternToRegex(t);
        e("eval", (function(e) {
            const {callArgs: r} = e, s = String(r[0]);
            if ("" === t || !i.test(s)) return ("" === t || n.logLevel > 1) && n.uboLog(o, "Not prevented:\n", s), 
            e.reflect();
    ...
    const r = {}, n = [ [ "ShadowRoot" ], [ "adsBlocked" ] ], o = new Map([ [ "otzovik.com", 0 ], [ "kvadratmetr.uz", 1 ], [ "oligarx.uz", 1 ], [ "tehnar.net.ua", 1 ] ]), i = new Map([]), s = (t, e, r) => {
        let n = e.get(t);
