!function() {
    function e(e = "", o = "", r = "") {
        ...
        if ("" === e) return;
        const n = t(), s = n.makeLogPrefix("remove-attr", e, o, r), i = n.String_split.call(e, /\s*\|\s*/), a = i.map((e => `${o}[${CSS.escape(e)}]`)).join(",");
        n.logLevel > 1 && n.uboLog(s, `Target selector:\n\t${a}`);
        const l = /\basap\b/.test(r);
        let c;
        const d = () => {
            void 0 !== c && (n.offIdle(c), c = void 0);
            try {
                const e = document.querySelectorAll(a);
                for (const t of e) for (const e of i) !1 !== t.hasAttribute(e) && (t.removeAttribute(e), 
                n.uboLog(s, `Removed attribute '${e}'`));
            } catch {}
        }, f = e => {
            if (void 0 !== c) return;
            let t = !0;
        ...
        !function(e, o) {
            ...
            const i = t(), a = [ "readystatechange", () => {
                r(document.readyState) < n || (e(), i.removeEventListener.apply(document, a));
            }, {
                capture: !0
            } ];
            i.addEventListener.apply(document, a);
        }((() => {
            d(), !1 !== /\bstay\b/.test(r) && new MutationObserver(f).observe(document, {
                attributes: !0,
                attributeFilter: i,
                childList: !0,
                subtree: !0
            });
        }), n.String_split.call(r, /\s+/));
    }
    function t() {
