!function() {
    function e(e = "") {
        ...
        const o = function() {
            ...
            return o;
        }(), n = o.patternToRegex(e), r = o.getExtraArgs(Array.from(arguments), 1), i = (e, t = 500) => {
        ...
        let c = r.domain;
        if (c && /^\/.+\//.test(c)) {
            const e = new RegExp(c.slice(1, -1)).exec(s.hostname);
            c = e ? e[0] : void 0;
        }
        const a = () => {
            o.String_split.call(document.cookie, ";").forEach((e => {
                ...
                const r = o + "=", i = `; domain=${s.hostname}`, a = `; domain=.${s.hostname}`;
                let l, d;
                if (c) l = `; domain=${c}`, d = `; domain=.${c}`; else if (document.domain) {
                    const e = document.domain;
                    e !== s.hostname && (l = `; domain=.${e}`), e.startsWith("www.") && (d = `; domain=${e.replace("www", "")}`);
                }
                const g = "; path=/", p = "; Max-Age=-1000; expires=Thu, 01 Jan 1970 00:00:00 GMT";
                document.cookie = r + p, document.cookie = r + i + p, document.cookie = r + a + p, 
                document.cookie = r + g + p, document.cookie = r + i + g + p, document.cookie = r + a + g + p, 
                void 0 !== l && (document.cookie = r + l + g + p), void 0 !== d && (document.cookie = r + d + g + p);
            }));
        };
        if (a(), window.addEventListener("beforeunload", a), "string" != typeof r.when) return;
        const l = [ "scroll", "keydown" ], d = o.String_split.call(r.when, /\s/);
        for (const e of d) !1 !== l.includes(e) && document.addEventListener(e, (() => {
            i(a);
        }), {
            passive: !0
        });
    }
    const t = {}, o = [ [ "blaize_session" ], [ "blaize_tracking_id" ], [ "pay_ent_pass" ], [ "pay_ent_msmp" ], [ "kpwc" ], [ "/articlesLimit|articlesRead|previousPage/", "when", "scroll keydown" ], [ "_ngViCo-SupporterPromo" ] ], n = new Map([ [ "theverge.com", [ 0, 1 ] ], [ "bonappetit.com", [ 2, 3 ] ], [ "technologyreview.jp", 4 ], [ "androidpolice.com", 5 ], [ "makeuseof.com", 5 ], [ "movieweb.com", 5 ], [ "xda-developers.com", 5 ], [ "thegamer.com", 5 ], [ "cbr.com", 5 ], [ "gamerant.com", 5 ], [ "screenrant.com", 5 ], [ "howtogeek.com", 5 ], [ "thethings.com", 5 ], [ "simpleflying.com", 5 ], [ "dualshockers.com", 5 ], [ "newgrounds.com", 6 ] ]), r = new Map([]), i = (e, t, o) => {
        let n = t.get(e);
    ...
    ((e, t = "") => {
        const o = e.split("."), s = o.length;
        if (0 !== s) for (let e = 0; e < s; e++) {
            const s = `${o.slice(e).join(".")}${t}`;
            i(s, n, a), i(s, r, l);
        }
    })(c[0].hn);
