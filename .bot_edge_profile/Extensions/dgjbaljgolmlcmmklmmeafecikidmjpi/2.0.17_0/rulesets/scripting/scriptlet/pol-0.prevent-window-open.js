!function() {
    function t(t = "", o = "", r = "") {
        const s = function() {
            ...
            e.toLogText = (t, ...e) => {
                ...
                return n === r && t === o && Date.now() - s < 5e3 ? void 0 : (o = t, r = n, s = Date.now(), 
                n);
            };
            try {
            ...
            return e;
        }(), i = s.makeLogPrefix("no-window-open-if", t, o, r), c = !1 === t.startsWith("!");
        !1 === c && (t = t.slice(1));
        const l = s.patternToRegex(t), a = 1e3 * (parseFloat(o) || 0), p = self.setTimeout, g = function(t, e, n) {
        ...
        e("open", (function(e) {
            ...
            if (l.test(u) !== c) return s.logLevel > 1 && s.uboLog(i, `Allowed (${n.join(", ")})`), 
            e.reflect();
            if (s.uboLog(i, `Prevented (${n.join(", ")})`), "" === o) return null;
            if ("blank" === r) {
                n[0] = "about:blank";
                const t = e.reflect();
                return p((() => {
            ...
            let d = ("obj" === r ? g("object", "data", ...n) : g("iframe", "src", ...n)).contentWindow;
            return "object" == typeof d && null !== d ? Object.defineProperty(d, "closed", {
                ...
                get: function(t, e, ...n) {
                    const o = Reflect.get(t, e, ...n);
                    return s.uboLog(i, `popup / get ${e} === ${o}`), "function" == typeof o ? (...e) => o.call(t, ...e) : o;
                },
                set: function(t, e, n, ...o) {
                    return s.uboLog(i, `popup / set ${e} = ${n}`), Reflect.set(t, e, n, ...o);
                }
            })), d;
        }));
    }
    function e(t = "", n = "") {
        ...
        s.prototype?.constructor === s && (l.construct = function(t, o) {
            return n(e.CtorContext.factory(t, o));
        }), o[r] = new Proxy(s, l);
    }
    const n = {}, o = [ [ "_blank" ], [] ], r = new Map([ [ "otomoto.pl", 0 ], [ "ebd.cda.pl", 1 ] ]), s = new Map([]), i = (t, e, n) => {
        let o = e.get(t);
