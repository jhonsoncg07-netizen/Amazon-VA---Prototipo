!function() {
    ...
    const o = {}, i = [ [ "require.0.3.0.__bbox.define.[].2.is_linkshim_supported require.0.3.0.__bbox.define.[].2.click_ids" ], [ "auxiliaryUi.messageRenderers.upsellDialogRenderer" ] ], s = new Map([ [ "www.facebook.com", 0 ], [ "m.youtube.com", 1 ], [ "music.youtube.com", 1 ], [ "tv.youtube.com", 1 ], [ "www.youtube.com", 1 ], [ "youtubekids.com", 1 ] ]), c = new Map([]), a = (e, t, r) => {
        let n = t.get(e);
