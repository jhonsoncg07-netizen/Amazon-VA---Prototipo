!function() {
    function e(e = "") {
        ...
        const o = function() {
            ...
            return o;
        }(), r = o.makeLogPrefix("prevent-refresh", e), n = e => {
            window.stop(), o.uboLog(r, `Prevented "${e}"`);
        };
        self.addEventListener("load", (() => {
            const t = document.querySelector('meta[http-equiv="refresh" i][content]');
            if (null === t) return;
            const o = t.getAttribute("content") || "", r = "" === e ? 500 * Math.max(parseFloat(o) || 0, 0) : 0;
            0 === r ? n(o) : setTimeout((() => {
                n(o);
            }), r);
        }), {
