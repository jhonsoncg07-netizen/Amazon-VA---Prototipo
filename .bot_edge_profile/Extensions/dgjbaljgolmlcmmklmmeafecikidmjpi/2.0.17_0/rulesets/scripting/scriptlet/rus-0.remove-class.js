!function() {
    function e(e = "", r = "", o = "") {
        ...
        if ("" === e) return;
        const n = t(), s = n.makeLogPrefix("remove-class", e, r, o), i = n.String_split.call(e, /\s*\|\s*/), a = i.map((e => `${r}.${CSS.escape(e)}`)).join(",");
        ...
        const g = () => {
            ...
            c || "complete" === document.readyState && d.disconnect();
    ...
    const r = {}, o = [ [ "b-global-branding", "html" ], [ "noscroll", "body" ], [ "has-fullscreen-banner|has-right-direct", ".public__root", "stay" ] ], n = new Map([ [ "mag.relax.by", 0 ], [ "motorpage.ru", 1 ], [ "disk.yandex.ru", 2 ], [ "disk.yandex.*", 2 ] ]), s = new Map([]), i = (e, t, r) => {
        let o = t.get(e);
