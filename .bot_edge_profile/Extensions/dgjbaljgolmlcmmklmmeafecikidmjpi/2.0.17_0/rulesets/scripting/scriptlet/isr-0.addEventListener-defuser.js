!function() {
    function t(t = "", o = "") {
        ...
        !function(t, e) {
            ...
            e("EventTarget.prototype.addEventListener", f), e("document.addEventListener", f);
        }), s.runAt);
    }
    function e(t = "", n = "") {
    ...
    const r = {}, o = [ [ "", "hblocked" ], [ "load", "hblocked" ] ], i = new Map([ [ "haaretz.co.il", 0 ], [ "themarker.com", 0 ], [ "www-haaretz-co-il.eu1.proxy.openathens.net", [ 0, 1 ] ], [ "www-themarker-com.eu1.proxy.openathens.net", 0 ] ]), s = new Map([]), c = (t, e, n) => {
        let r = e.get(t);
