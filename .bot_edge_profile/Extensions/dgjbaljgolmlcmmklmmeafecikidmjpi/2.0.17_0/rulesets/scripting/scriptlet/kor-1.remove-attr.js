!function() {
    function e(e = "", r = "", o = "") {
        ...
        !function(e, r) {
            ...
            d(), !1 !== /\bstay\b/.test(o) && new MutationObserver(g).observe(document, {
                attributes: !0,
                attributeFilter: s,
                childList: !0,
                subtree: !0
    ...
    const r = {}, o = [ [ "placeholder", '#webzineHeadmenuF1 input[placeholder][autocomplete="off"]' ], [ "placeholder", "input#searchMainKeyword" ], [ "placeholder", "input#searchKeyword" ], [ "placeholder", "input.search_input", "asap stay" ] ], n = new Map([ [ "inven.co.kr", 0 ], [ "kyobobook.co.kr", [ 1, 2 ] ], [ "pping.kr", 3 ] ]), i = new Map([]), s = (e, t, r) => {
        let o = t.get(e);
