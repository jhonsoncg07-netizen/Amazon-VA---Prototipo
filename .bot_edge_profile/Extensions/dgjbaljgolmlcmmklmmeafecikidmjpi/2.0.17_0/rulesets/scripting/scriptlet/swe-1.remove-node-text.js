!function() {
    function e(e, n, ...r) {
        !function(e = "", n = "", r = "") {
            const o = t(), s = o.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), i = o.patternToRegex(e, "i", !0), c = o.patternToRegex(n, "gms"), a = o.getExtraArgs(Array.from(arguments), 3), l = a.includes || a.condition ? o.patternToRegex(a.includes || a.condition, "ms") : null, d = a.excludes ? o.patternToRegex(a.excludes, "ms") : null, g = (e = !0) => {
                e && m(x.takeRecords()), x.disconnect(), o.logLevel > 1 && o.uboLog(s, "Quitting");
            }, p = (() => {
                const e = {
                    createScript: e => e
                }, {trustedTypes: n} = self;
                return n instanceof Object && "function" == typeof n.getPropertyType && "TrustedScript" === n.getPropertyType("script", "textContent") ? n.createPolicy(function() {
                    const e = t();
            ...
            if (x.observe(document, {
                ...
                for (;;) {
                    const n = e.nextNode();
                    if (t += 1, null === n) break;
                    if (!1 !== i.test(n.nodeName) && n !== document.currentScript && !f(n)) {
                        g();
                        break;
                    }
                }
    ...
    const n = {}, r = [ [ "script", "contextmenu" ], [ "script", "e.keyCode" ], [ "noscript" ], [ "script", "/wccp_pro/" ], [ "script", "e.preventDefault" ], [ "script", "decodeURIComponent" ], [ "script", "request_ads_to_display" ], [ "script", "event.target.tagName" ] ], o = new Map([ [ "byggipedia.se", [ 0, 1 ] ], [ "dinbyggare.se", [ 2, 3 ] ], [ "internetodontologi.se", 4 ], [ "skrattsajten.com", 4 ], [ "norpan.se", 4 ], [ "pilsner.nu", 5 ], [ "medibok.se", 5 ], [ "kandisvarlden.com", 5 ], [ "web-tools.se", 6 ], [ "bio-link.se", 6 ], [ "spelhubben.se", 7 ] ]), s = new Map([]), i = (e, t, n) => {
        let r = t.get(e);
