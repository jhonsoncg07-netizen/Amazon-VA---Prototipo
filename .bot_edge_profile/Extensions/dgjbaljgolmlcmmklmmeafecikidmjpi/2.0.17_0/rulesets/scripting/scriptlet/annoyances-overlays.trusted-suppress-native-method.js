!function() {
    function t(t = "", r = "", o = "", i = "") {
        if ("" === t) return;
        const s = n(), c = s.makeLogPrefix("trusted-suppress-native-method", t, r, o, i), a = s.String_split.call(r, /\s*\|\s*/).map((t => /^".*"$/.test(t) ? {
            type: "pattern",
            re: s.patternToRegex(t.slice(1, -1))
        } : /^\/.+\/$/.test(t) ? {
            type: "pattern",
            re: s.patternToRegex(t)
        } : "false" === t ? {
            type: "exact",
            value: !1
        } : "true" === t ? {
            ...
            type: "exact",
            value: void 0
        } : void 0)), l = s.initPattern(i, {
            canNegate: !0
        });
        e(t, (function(t) {
            const {callArgs: e} = t;
            if ("" === r) return s.uboLog(c, `Arguments:\n${e.join("\n")}`), t.reflect();
            for (let n = 0; n < a.length; n++) {
                const r = a[n];
                if (void 0 === r) continue;
                const o = n < e.length ? e[n] : void 0;
                if ("exact" === r.type && o !== r.value) return t.reflect();
                if ("pattern" === r.type && !1 === s.RegExp_test.call(r.re, o)) return t.reflect();
            }
            if (!0 !== l.matchAll) {
                const e = s.logLevel > 1 ? "all" : "";
                if (!1 === function(t, e = "") {
                    ...
                    }(), i = new r.Error(o), s = new URL(self.location.href);
                    s.hash = "";
                    const c = /(.*?@)?(\S+)(:\d+):\d+\)?$/, a = [];
                    for (let t of r.String_split.call(i.stack, /[\n\r]+/)) {
                    ...
                    const l = a.join("\t"), p = !0 !== t.matchAll && r.testPattern(t, l);
                    return ("all" === e || "match" === e && p || "nomatch" === e && !p) && r.uboLog(l.replace(/\t/g, "\n")), 
                    p;
                }(l, e)) return t.reflect();
            }
            if ("debug" === o) return t.reflect();
            if (s.uboLog(c, `Suppressed:\n${e.join("\n")}`), "abort" === o) throw new ReferenceError;
        }));
    }
    function e(t = "", n = "") {
    ...
    const r = {}, o = [ [ "Function.prototype.constructor", '"debugger"', "abort" ], [ "RegExp.prototype.test", '"contact@foxteller.com"', "abort" ] ], i = new Map([ [ "ate60vs7zcjhsjo5qgv8.com", 0 ], [ "autoembed.cc", 0 ], [ "jetv.xyz", 0 ], [ "t.17track.net", 0 ], [ "embasic.pro", 0 ], [ "dlions.pro", 0 ], [ "foxteller.com", 1 ] ]), s = new Map([]), c = (t, e, n) => {
        let r = e.get(t);
