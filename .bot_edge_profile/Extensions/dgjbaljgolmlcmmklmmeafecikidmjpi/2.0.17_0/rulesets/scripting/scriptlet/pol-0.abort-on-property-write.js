!function() {
    ...
    const r = {}, o = [ [ "ads" ], [ "ub_ct_load" ], [ "iaqExt" ], [ "detectAB" ], [ "_yhbog" ], [ "yafaIt" ] ], n = new Map([ [ "playpuls.pl", 0 ], [ "autocentrum.pl", 1 ], [ "demotywatory.pl", 1 ], [ "dziennik.pl", 1 ], [ "facetemjestem.pl", 1 ], [ "gala.pl", 1 ], [ "garnek.pl", 1 ], [ "gry-online.pl", 1 ], [ "jegostrona.pl", 1 ], [ "joemonster.org", 1 ], [ "kobieta.pl", 1 ], [ "komixxy.pl", 1 ], [ "transfery.info", 1 ], [ "v10.pl", 1 ], [ "facet.wp.pl", 2 ], [ "gwiazdy.wp.pl", 2 ], [ "teleshow.wp.pl", 2 ], [ "bankier.pl", 3 ], [ "filiser.tv", 4 ], [ "eurogamer.pl", 5 ] ]), i = new Map([]), s = (e, t, r) => {
        let o = t.get(e);
