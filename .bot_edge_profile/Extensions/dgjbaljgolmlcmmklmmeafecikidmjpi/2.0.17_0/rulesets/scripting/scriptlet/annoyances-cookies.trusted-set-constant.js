!function() {
    ...
    const n = {}, r = [ [ "dataLayer", '{"value":[{"signals":["remixd"]},{"event":"remixd_gtm_fire"}]}' ], [ "cmp_importvendors", '{"value": ["s23","s2564"]}' ] ], o = new Map([ [ "radiox.co.uk", 0 ], [ "octopusenergy.de", 1 ] ]), i = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
