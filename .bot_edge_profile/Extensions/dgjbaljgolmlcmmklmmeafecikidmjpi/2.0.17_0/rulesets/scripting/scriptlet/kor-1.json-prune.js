!function() {
    function e(e = "", r = "", o = "") {
        const s = n(), i = s.makeLogPrefix("json-prune", e, r, o), c = s.initPattern(o, {
            canNegate: !0
        }), a = s.getExtraArgs(Array.from(arguments), 3);
        JSON.parse = new Proxy(JSON.parse, {
            apply: function(n, o, l) {
                const f = Reflect.apply(n, o, l);
                "" === e && s.uboLog(i, s.JSON_stringify(f, null, 2));
                const g = t(f, e, r, c, a);
                return void 0 === g ? f : (s.uboLog(i, "Pruned"), s.logLevel > 1 && s.uboLog(i, `After pruning:\n${s.JSON_stringify(g, null, 2)}`), 
                g);
            }
        });
    }
    ...
    const o = {}, s = [ [ "tpl apply", "tpl.[].c" ], [ "data", "data.getBannerAdExchange" ], [ "powerLink", "powerLink.ads" ], [ "adRecommend.adUnits.[]" ], [ "data.BrandAd" ], [ "data.supertopADNos" ], [ "ads" ] ], i = new Map([ [ "m.fmkorea.com", 0 ], [ "doctornow.co.kr", 1 ], [ "search.11st.co.kr", 2 ], [ "msearch.shopping.naver.com", 3 ], [ "search.shopping.naver.com", 4 ], [ "enuri.com", 5 ], [ "shoppinghow.kakao.com", 6 ] ]), c = new Map([]), a = (e, t, n) => {
        let r = t.get(e);
