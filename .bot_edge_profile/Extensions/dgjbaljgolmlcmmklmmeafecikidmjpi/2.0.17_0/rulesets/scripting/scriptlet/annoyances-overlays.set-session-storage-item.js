!function() {
    function e(e = "", n = "") {
        !function(e = "local", n = !1, r = "", o = "") {
            ...
            if (n) o.includes("$now$") && (o = o.replaceAll("$now$", Date.now())), o.includes("$currentDate$") && (o = o.replaceAll("$currentDate$", `${Date()}`)), 
            o.includes("$currentISODate$") && (o = o.replaceAll("$currentISODate$", (new Date).toISOString())); else {
                const e = o.toLowerCase(), t = /^("?)(.+)\1$/.exec(e), n = t && t[2] || e;
                if (!1 === s.includes(n)) {
            ...
            try {
                ...
                if ("$remove$" === o) {
                    ...
                    for (const e of s) n.removeItem(e);
                } else n.setItem(r, `${o}`);
            } catch {}
        }("session", !1, e, n);
    }
    const t = {}, n = [ [ "floating-sign-up-dismissed", "true" ], [ "emailSignupModal_isShown", "true" ], [ "banner_session", "true" ], [ "enews_popup_session", "1" ], [ "fs.adb.dis", "1" ], [ "adblock", "true" ] ], r = new Map([ [ "semafor.com", 0 ], [ "virginvoyages.com", 1 ], [ "sears.com", 2 ], [ "bcliquorstores.com", 3 ], [ "270towin.com", 4 ], [ "getemoji.com", 4 ], [ "afterclass.io", 5 ] ]), o = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
