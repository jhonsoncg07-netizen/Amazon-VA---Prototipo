!function() {
    function e(e = "", r = "", o = "") {
        ...
        if ("" === e) return;
        const n = t(), i = n.makeLogPrefix("remove-attr", e, r, o), s = n.String_split.call(e, /\s*\|\s*/), a = s.map((e => `${r}[${CSS.escape(e)}]`)).join(",");
        n.logLevel > 1 && n.uboLog(i, `Target selector:\n\t${a}`);
        const c = /\basap\b/.test(o);
        let l;
        const d = () => {
            void 0 !== l && (n.offIdle(l), l = void 0);
            try {
                const e = document.querySelectorAll(a);
                for (const t of e) for (const e of s) !1 !== t.hasAttribute(e) && (t.removeAttribute(e), 
                n.uboLog(i, `Removed attribute '${e}'`));
            } catch {}
        }, p = e => {
            if (void 0 !== l) return;
            let t = !0;
            for (let r = 0; r < e.length && t; r++) {
                const {type: o, addedNodes: n, removedNodes: i} = e[r];
                "attributes" === o && (t = !1);
        ...
        !function(e, r) {
            ...
            d(), !1 !== /\bstay\b/.test(o) && new MutationObserver(p).observe(document, {
                attributes: !0,
                attributeFilter: s,
                childList: !0,
                subtree: !0
            });
        }), n.String_split.call(o, /\s+/));
    }
    function t() {
    ...
    const r = {}, o = [ [ "href", 'a[style*="display:"][href^="https://al.dmm.co.jp"]', "stay" ], [ "style", ".js-reward-target[style]", "stay" ], [ "id", "#div-gpt-ad-sidebottom" ], [ "id", "#div-gpt-ad-footer" ], [ "id", "#div-gpt-ad-pagebottom" ], [ "id", "#div-gpt-ad-relatedbottom-1" ], [ "class", 'article[itemprop="articleBody"]', "stay" ], [ "href", '.cps-post-main > a[href^="https://www.amazon.co.jp"]' ], [ "data-popup-url" ], [ "onclick", "span > a[onclick]" ] ], n = new Map([ [ "exploader.net", 0 ], [ "jprime.jp", 1 ], [ "rocketnews24.com", [ 2, 3, 4, 5 ] ], [ "youpouch.com", [ 2, 3, 4, 5 ] ], [ "coron.tech", 6 ], [ "lifematome.blog", 7 ], [ "wav.tv", 8 ], [ "380cc.cc", 9 ] ]), i = new Map([]), s = (e, t, r) => {
        let o = t.get(e);
