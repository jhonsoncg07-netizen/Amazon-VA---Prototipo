!function() {
    function t(t = "", o = "", r = "") {
        const i = function() {
            ...
            return e;
        }(), s = i.makeLogPrefix("no-window-open-if", t, o, r), c = !1 === t.startsWith("!");
        !1 === c && (t = t.slice(1));
        const l = i.patternToRegex(t), a = 1e3 * (parseFloat(o) || 0), p = self.setTimeout, g = function(t, e, n) {
            const o = document.createElement(t);
            return o[e] = n, o.style.setProperty("height", "1px", "important"), o.style.setProperty("position", "fixed", "important"), 
        ...
        e("open", (function(e) {
            ...
            const {callArgs: n} = e, u = n.join(" ");
            if (l.test(u) !== c) return i.logLevel > 1 && i.uboLog(s, `Allowed (${n.join(", ")})`), 
            e.reflect();
            if (i.uboLog(s, `Prevented (${n.join(", ")})`), "" === o) return null;
            if ("blank" === r) {
                n[0] = "about:blank";
                const t = e.reflect();
                return p((() => {
            ...
            let h = ("obj" === r ? g("object", "data", ...n) : g("iframe", "src", ...n)).contentWindow;
            return "object" == typeof h && null !== h ? Object.defineProperty(h, "closed", {
                value: !1
            }) : h = new Proxy(self, {
                get: function(t, e, ...n) {
    ...
    const n = {}, o = [ [], [ "/bit\\.ly|kbtv/" ], [ "0", "qciss.net" ], [ "88p2p.com" ] ], r = new Map([ [ "embedrise.com", 0 ], [ "88files.net", 0 ], [ "freejavbt.com", 0 ], [ "vikacg.com", 0 ], [ "iwatchme2u.com", 1 ], [ "qciss.net", 2 ], [ "5278.cc", 3 ] ]), i = new Map([]), s = (t, e, n) => {
        let o = e.get(t);
