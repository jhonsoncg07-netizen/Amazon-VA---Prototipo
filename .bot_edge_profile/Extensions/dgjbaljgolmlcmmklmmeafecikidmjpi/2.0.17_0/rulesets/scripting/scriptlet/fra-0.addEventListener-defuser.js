!function() {
    function t(t = "", o = "") {
        const i = n(), s = i.getExtraArgs(Array.from(arguments), 2), c = i.makeLogPrefix("prevent-addEventListener", t, o), a = i.patternToRegex(t, void 0, !0), l = i.patternToRegex(o), g = (function(t) {
            ...
            if ("" === t && "" === o) i.uboLog(c, `Called: ${s}\n${a}\n${p(r)}`); else if (u(r, s, a)) return i.uboLog(c, `Prevented: ${s}\n${a}\n${p(r)}`);
            return e.reflect();
        };
        !function(t, e) {
            const r = t => {
    ...
    const r = {}, o = [ [ "DOMContentLoaded", "adblock" ], [ "load", "isAdblock" ], [ "DOMContentLoaded", "adsbygoogle" ], [ "click", "Popup" ], [ "DOMContentLoaded", "interstitial" ] ], i = new Map([ [ "nicematin.com", 0 ], [ "cyclismactu.net", 1 ], [ "lecourrier-du-soir.com", 2 ], [ "player.melaniezettofrais.online", 3 ], [ "macg.co", 4 ] ]), s = new Map([]), c = (t, e, n) => {
        let r = e.get(t);
