!function() {
    ...
    const t = {}, n = [ [ "contextual-sign-in-modal-cool-off-hidden", "$now$" ], [ "halfSheetAppBannerDismissed", '{"halfSheetAppBannerDismissed":{"expiration":2000000000000,"data":true}}' ], [ "lastViewTime", "$currentDate$" ], [ "reference_offer", '__q_objt|{"offer_type":"PROMOTION"}' ], [ "show_offer", "__q_bool|0" ], [ "show_offer_timestamp", "__q_numb|9999999999999" ], [ "adblockNotice", '{"dismissed":true,"impressionCount":1}' ] ], r = new Map([ [ "linkedin.com", 0 ], [ "patreon.com", 1 ], [ "cu.tbs.co.jp", 2 ], [ "bitchute.com", [ 3, 4, 5 ] ], [ "duckduckgo.com", 6 ] ]), o = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
