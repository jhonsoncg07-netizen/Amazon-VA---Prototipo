!function() {
    function e(e = "", n = "", o = "") {
        ...
        JSON.parse = new Proxy(JSON.parse, {
            apply: function(r, o, l) {
                ...
                const g = t(f, e, n, c, a);
                return void 0 === g ? f : (i.uboLog(s, "Pruned"), i.logLevel > 1 && i.uboLog(s, `After pruning:\n${i.JSON_stringify(g, null, 2)}`), 
                g);
            }
        });
    }
    function t(e, o, i, s = {
        ...
        let g = "nomatch";
        if (t.mustProcess(e, f)) for (const t of l) n(e, t, !0) && (g = "match");
        return "match" === g ? e : void 0;
    }
    function r() {
    ...
    const o = {}, i = [ [ "Blocks" ], [ "direct rtb seatbid data.*.attributes.blockId" ] ], s = new Map([ [ "avtorambler.*", 0 ], [ "championat.*", 0 ], [ "eda.*", 0 ], [ "gazeta.ru", 0 ], [ "lenta.*", 0 ], [ "letidor.*", 0 ], [ "moslenta.*", 0 ], [ "motor.*", 0 ], [ "passion.*", 0 ], [ "quto.*", 0 ], [ "rambler.*", 0 ], [ "wmj.*", 0 ], [ "www.afisha.*", 0 ], [ "dzen.*", 1 ], [ "ya.*", 1 ], [ "yandex.*", 1 ] ]), c = new Map([ [ "id.rambler.ru", [ 0 ] ], [ "quiz.rambler.ru", [ 0 ] ], [ "vp.rambler.ru", [ 0 ] ], [ "yandex.net", [ 1 ] ] ]), a = (e, t, r) => {
        let n = t.get(e);
