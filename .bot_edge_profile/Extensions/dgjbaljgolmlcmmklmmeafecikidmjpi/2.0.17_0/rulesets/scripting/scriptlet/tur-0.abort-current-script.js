!function() {
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", r = "", o = "") {
                ...
                if ("" === e) return;
                const i = t(), c = i.makeLogPrefix("abort-current-script", e, r, o), s = i.patternToRegex(r), a = i.patternToRegex(o), l = i.getExtraArgs(Array.from(arguments), 3), g = document.currentScript, d = i.String_split.call(e, ".");
                let u, f, p = window;
                ...
                try {
                    Object.defineProperty(p, u, {
                        get: function() {
                            return O(), m instanceof Object ? m.get.call(p) : f;
                        },
                        set: function(e) {
                            O(), m instanceof Object ? m.set.call(p, e) : f = e;
                        }
                    });
                } catch (e) {
                    i.uboErr(c, `Error: ${e}`);
    ...
    const n = {}, r = [ [ "EventTarget.prototype.addEventListener", ".height();" ], [ "document.addEventListener", "/abisuq/" ], [ "$", "adblock" ], [ "$", "!document.getElementById(btoa" ], [ "EventTarget.prototype.addEventListener", "arlinablock" ], [ "EventTarget.prototype.addEventListener", "ad_killer" ], [ "document.write", "_blank" ], [ "document.write", ".hit.gemius." ], [ "$", "#myModal" ], [ "loadBrands" ], [ "sessionStorage.getItem", "reklam" ], [ "$", "/ads/" ], [ "EventTarget.prototype.addEventListener", "Popunder" ], [ "document.addEventListener", "popupInterval" ], [ "doOpen", "edsiga.com" ], [ "document.createElement", "/\\.src=[\\s\\S]*?getElementsByTagName/" ] ], o = new Map([ [ "dizifon.com", 0 ], [ "birasyadizi.com", 0 ], [ "azsekerlik.blogspot.com", 1 ], [ "vknsorgula.net", 1 ], [ "okultanitimi.net", 2 ], [ "otopark.com", 3 ], [ "turkrock.com", 3 ], [ "osxinfo.net", 3 ], [ "kampanyatakip.blogspot.com", 4 ], [ "mordefter.com", 5 ], [ "dizigom1.tv", 6 ], [ "ulketv.com.tr", 7 ], [ "kenttv.net", 8 ], [ "ulker.com.tr", 9 ], [ "duzcetv.com", 10 ], [ "bizimyaka.com", 11 ], [ "animeler.me", 12 ], [ "cizgivedizi.com", 13 ], [ "asyaanimeleri.com", 14 ], [ "sinefil.tv", 15 ] ]), i = new Map([]), c = (e, t, n) => {
        let r = t.get(e);
