!function() {
    function e(e = "", r = "") {
        const c = o(), s = c.getExtraArgs(Array.from(arguments), 2), i = c.makeLogPrefix("prevent-addEventListener", e, r), a = c.patternToRegex(e, void 0, !0), l = c.patternToRegex(r), m = (function(e) {
            ...
            const t = [], o = String(e.id);
            "" !== o && t.push(`#${CSS.escape(o)}`);
            for (let o = 0; o < e.classList.length; o++) t.push(`.${CSS.escape(e.classList.item(o))}`);
            for (let o = 0; o < e.attributes.length; o++) {
                const n = e.attributes.item(o);
                "id" !== n.name && "class" !== n.name && t.push(`[${CSS.escape(n.name)}="${n.value}"]`);
            }
            return t.join("");
        }, p = (e, t, o) => {
            const n = c.RegExp_test.call(a, t), r = c.RegExp_test.call(l, o), s = n && r;
            return (!s || void 0 === m || !1 !== (i = e, "window" === m ? i === window : "document" === m ? i === document : !!(i && i.matches && i.matches(m)) || Array.from(document.querySelectorAll(m)).includes(i))) && s;
            var i;
        }, u = function(t) {
            const {callArgs: o, thisArg: n} = t;
            let s, a;
            try {
                s = String(o[0]), "function" == typeof o[1] ? a = String(c.Function_toString(o[1])) : "object" == typeof o[1] && null !== o[1] ? "function" == typeof o[1].handleEvent && (a = String(c.Function_toString(o[1].handleEvent))) : a = String(o[1]);
            } catch {}
            if ("" === e && "" === r) c.uboLog(i, `Called: ${s}\n${a}\n${g(n)}`); else if (p(n, s, a)) return c.uboLog(i, `Prevented: ${s}\n${a}\n${g(n)}`);
            return t.reflect();
        };
        !function(e, t) {
            const n = e => {
    ...
    function t(e = "", o = "") {
        ...
        const s = c.toString(), i = function() {
            return s;
        }.bind(null), a = {
            apply: (e, n, r) => o(t.ApplyContext.factory(e, n, r)),
            get: (e, t) => "toString" === t ? i : Reflect.get(e, t)
        };
        c.prototype?.constructor === c && (a.construct = function(e, n) {
    ...
    function o() {
        ...
        t.toLogText = (e, ...t) => {
            ...
            return n === r && e === o && Date.now() - c < 5e3 ? void 0 : (o = e, r = n, c = Date.now(), 
            n);
        };
        try {
            ...
            t.sendToLogger = (e, ...n) => {
                ...
                if (void 0 !== c) return void 0 === r ? o.postMessage({
    ...
    for (const t of m) if (!g.has(t)) try {
        e(...r[t]);
    } catch {}
}();