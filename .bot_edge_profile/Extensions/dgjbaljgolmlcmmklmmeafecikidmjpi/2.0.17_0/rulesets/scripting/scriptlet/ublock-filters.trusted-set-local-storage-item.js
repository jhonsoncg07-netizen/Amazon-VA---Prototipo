!function() {
    function e(e = "", r = "") {
        !function(e = "local", r = !1, n = "", o = "") {
            if ("" === n) return;
            "emptyArr" === o ? o = "[]" : "emptyObj" === o && (o = "{}");
            ...
            if (r) o.includes("$now$") && (o = o.replaceAll("$now$", Date.now())), o.includes("$currentDate$") && (o = o.replaceAll("$currentDate$", `${Date()}`)), 
            o.includes("$currentISODate$") && (o = o.replaceAll("$currentISODate$", (new Date).toISOString())); else {
                const e = o.toLowerCase(), t = /^("?)(.+)\1$/.exec(e), r = t && t[2] || e;
                if (!1 === s.includes(r)) {
    ...
    const t = {}, r = [ [ "google_tg_rep", '["n",16000]' ], [ "google_tg_rep_date", "2030-03-18T02:00:00" ], [ "google_tg_rep_attr7", '[1,"user1",1900000000000,3131]' ], [ "superberb_disable_date", "$now$" ] ], n = new Map([ [ "pvpoke-re.com", [ 0, 1, 2 ] ], [ "fapeza.com", 3 ] ]), o = new Map([]), s = (e, t, r) => {
        let n = t.get(e);
