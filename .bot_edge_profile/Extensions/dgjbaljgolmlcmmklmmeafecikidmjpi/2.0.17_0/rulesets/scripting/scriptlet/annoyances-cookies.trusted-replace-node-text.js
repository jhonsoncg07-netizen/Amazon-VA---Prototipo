    ...
    function e(e, n, r, ...o) {
        !function(e = "", n = "", r = "") {
            ...
            const p = e => {
                ...
                for (const t of e) for (const e of t.addedNodes) if (!1 !== i.test(e.nodeName) && !p(e)) return void g(!1);
            ...
            if (x.observe(document, {
                ...
                for (;;) {
                    const n = e.nextNode();
                    if (t += 1, null === n) break;
                    if (!1 !== i.test(n.nodeName) && n !== document.currentScript && !p(n)) {
                        g();
                        break;
                    }
                }
