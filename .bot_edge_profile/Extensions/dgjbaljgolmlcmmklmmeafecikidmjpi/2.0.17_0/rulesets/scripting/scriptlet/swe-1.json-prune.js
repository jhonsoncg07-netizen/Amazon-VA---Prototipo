!function() {
    function e(e = "", r = "", s = "") {
        const o = n(), i = o.makeLogPrefix("json-prune", e, r, s), a = o.initPattern(s, {
            canNegate: !0
        }), l = o.getExtraArgs(Array.from(arguments), 3);
        JSON.parse = new Proxy(JSON.parse, {
            apply: function(n, s, c) {
                const g = Reflect.apply(n, s, c);
                "" === e && o.uboLog(i, o.JSON_stringify(g, null, 2));
                const f = t(g, e, r, a, l);
                return void 0 === f ? g : (o.uboLog(i, "Pruned"), o.logLevel > 1 && o.uboLog(i, `After pruning:\n${o.JSON_stringify(f, null, 2)}`), 
                f);
            }
        });
    }
    function t(e, s, o, i = {
        ...
        const l = n(), c = "" !== s ? l.String_split.call(s, / +/) : [], g = 0 !== c.length && "" !== o ? l.String_split.call(o, / +/) : [];
        if (!0 !== i.matchAll && !1 === function(e, t = "") {
            const r = n(), s = function() {
                const e = function() {
                    const e = n();
            ...
            }(), o = new r.Error(s), i = new URL(self.location.href);
            i.hash = "";
            const a = /(.*?@)?(\S+)(:\d+):\d+\)?$/, l = [];
            for (let e of r.String_split.call(o.stack, /[\n\r]+/)) {
                ...
                let o = void 0 !== t[1] ? t[1].slice(0, -1) : e.slice(0, t.index).trim();
                o.startsWith("at") && (o = o.slice(2).trim());
                let c = t[3];
                l.push(" " + `${o} ${n}${c}:1`.trim());
            }
            l[0] = "stackDepth:" + (l.length - 1);
            const c = l.join("\t"), g = !0 !== e.matchAll && r.testPattern(e, c);
            return ("all" === t || "match" === t && g || "nomatch" === t && !g) && r.uboLog(c.replace(/\t/g, "\n")), 
            g;
        }(i, a.logstack)) return;
        ...
        let f = "nomatch";
        if (t.mustProcess(e, g)) for (const t of c) r(e, t, !0) && (f = "match");
    ...
    function n() {
        ...
        t.toLogText = (e, ...t) => {
            ...
            return s === r && e === n && Date.now() - o < 5e3 ? void 0 : (n = e, r = s, o = Date.now(), 
            s);
        };
        try {
            const n = new e.BroadcastChannel(s.bcSecret);
            let r = [];
            t.sendToLogger = (e, ...s) => {
                const o = t.toLogText(e, ...s);
                if (void 0 !== o) return void 0 === r ? n.postMessage({
    ...
    function r(e, t, s = !1) {
        ...
        for (;;) {
            ...
            const e = a.indexOf(".");
            if (-1 === e) {
                if (!1 === s) return o.Object_hasOwn(i, a);
                let e = !1;
                if ("*" === a) for (const t in i) !1 !== o.Object_hasOwn(i, t) && (delete i[t], 
                e = !0); else o.Object_hasOwn(i, a) && (delete i[a], e = !0);
                return e;
            }
    ...
    const s = {}, o = [ [ "autoplay" ], [ "payload.ads campaigns.*" ] ], i = new Map([ [ "expressen.se", 0 ], [ "di.se", 0 ], [ "nsk.se", 0 ], [ "skd.se", 0 ], [ "nvp.se", 0 ], [ "nuiosteraker.se", 0 ], [ "barometern.se", 0 ], [ "blt.se", 0 ], [ "bt.se", 0 ], [ "kristianstadsbladet.se", 0 ], [ "olandsbladet.se", 0 ], [ "smp.se", 0 ], [ "sydostran.se", 0 ], [ "trelleborgsallehanda.se", 0 ], [ "ut.se", 0 ], [ "ystadsallehanda.se", 0 ], [ "corren.se", 0 ], [ "folkbladet.se", 0 ], [ "mvt.se", 0 ], [ "nt.se", 0 ], [ "vt.se", 0 ], [ "klt.nu", 0 ], [ "vimmerbytidning.se", 0 ], [ "kuriren.nu", 0 ], [ "nsd.se", 0 ], [ "norran.se", 0 ], [ "pt.se", 0 ], [ "ekuriren.se", 0 ], [ "strengnastidning.se", 0 ], [ "kkuriren.se", 0 ], [ "sn.se", 0 ], [ "eposten.se", 0 ], [ "unt.se", 0 ], [ "helagotland.se", 0 ], [ "folkbladet.nu", 0 ], [ "vasterastidning.se", 0 ], [ "mitti.se", 0 ], [ "thelocal.se", 0 ], [ "byrum.se", 0 ], [ "sverigespringer.se", 0 ], [ "recept.se", 0 ], [ "viivilla.se", 0 ], [ "automotorsport.se", 0 ], [ "babyhjalp.se", 0 ], [ "fragbite.se", 0 ], [ "ibnytt.se", 0 ], [ "realtid.se", 0 ], [ "cafe.se", 0 ], [ "kingmagazine.se", 0 ], [ "vaxjobladet.se", 0 ], [ "alekuriren.se", 0 ], [ "nyheter24.se", 0 ], [ "svenskgolf.se", 0 ], [ "golfing.se", 0 ], [ "familjeliv.se", 0 ], [ "praktisktbatagande.se", 0 ], [ "norrahalland.se", 0 ], [ "lokalti.se", 0 ], [ "lchfarkivet.se", 0 ], [ "alltforforaldrar.se", 0 ], [ "idrottensaffarer.se", 0 ], [ "vf.se", 0 ], [ "hjotidning.se", 0 ], [ "kt.se", 0 ], [ "kt-kuriren.se", 0 ], [ "sla.se", 0 ], [ "mariestadstidningen.se", 0 ], [ "filipstadstidning.se", 0 ], [ "fryksdalsbygden.se", 0 ], [ "nwt.se", 0 ], [ "arvikanyheter.se", 0 ], [ "nkp.se", 0 ], [ "saffletidningen.se", 0 ], [ "provinstidningen.se", 0 ], [ "dalslanningen.se", 0 ], [ "nlt.se", 0 ], [ "skaraborgsbygden.se", 0 ], [ "matspar.se", 1 ] ]), a = new Map([]), l = (e, t, n) => {
        ...
        return e.ancestorOrigins && t.push(...e.ancestorOrigins), t.map(((e, t) => {
            ...
            if (-1 === n) return;
            const r = e.slice(n + 3), s = r.indexOf(":");
            return {
