!function() {
    function t(t = "") {
        ...
        const n = function() {
            ...
            return e;
        }(), o = n.makeLogPrefix("noeval-if", t), s = n.patternToRegex(t);
        e("eval", (function(e) {
            const {callArgs: r} = e, i = String(r[0]);
            if ("" === t || !s.test(i)) return ("" === t || n.logLevel > 1) && n.uboLog(o, "Not prevented:\n", i), 
            e.reflect();
            n.uboLog(o, "Prevented:\n", i);
        }));
    }
    function e(t = "", r = "") {
    ...
    const r = {}, n = [ [ "oncontextmenu" ], [ "disable_copy" ], [ "AdBlocker" ], [ "alert" ], [ "String.fromCharCode" ], [ "debugger" ] ], o = new Map([ [ "runmods.com", 0 ], [ "magesy.blog", 1 ], [ "romviet.com", 2 ], [ "isekaipalace.com", 3 ], [ "seriesperu.com", 4 ], [ "sportea.online", 5 ], [ "freetvsports.xyz", 5 ], [ "movie-web.app", 5 ] ]), s = new Map([]), i = (t, e, r) => {
        let n = e.get(t);
