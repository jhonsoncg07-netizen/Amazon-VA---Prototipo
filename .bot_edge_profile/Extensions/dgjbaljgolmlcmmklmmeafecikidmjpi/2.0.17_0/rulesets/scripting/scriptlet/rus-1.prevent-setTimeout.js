!function() {
    function t(t = "", o = "") {
        const i = function() {
            ...
            return e;
        }(), s = i.makeLogPrefix("prevent-setTimeout", t, o), c = "!" === t.charAt(0), a = i.patternToRegex(c ? t.slice(1) : t), l = new n(o);
    ...
    const r = {}, o = [ [ "/ d[0-9]{1}/" ], [ "Ya.Rum.getSetting", "15" ], [ "removeAttr", "setTimeout" ] ], i = new Map([ [ "online-fix.me", 0 ], [ "yandex.*", 1 ], [ "4pda.*", 2 ] ]), s = new Map([ [ "mail.yandex.*", [ 1 ] ], [ "vh.yandex.ru", [ 1 ] ], [ "yandex.net", [ 1 ] ] ]), c = (t, e, n) => {
        let r = e.get(t);
