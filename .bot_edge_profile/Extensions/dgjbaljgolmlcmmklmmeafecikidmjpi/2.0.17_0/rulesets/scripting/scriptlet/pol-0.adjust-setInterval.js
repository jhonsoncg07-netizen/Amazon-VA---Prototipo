!function() {
    ...
    const t = {}, r = [ [], [ "redirectId" ] ], n = new Map([ [ "filmowakraina.tv", 0 ], [ "auto-motor-i-sport.pl", 1 ], [ "menshealth.pl", 1 ], [ "motocykl-online.pl", 1 ], [ "runners-world.pl", 1 ], [ "womenshealth.pl", 1 ] ]), o = new Map([]), s = (e, t, r) => {
        let n = t.get(e);
