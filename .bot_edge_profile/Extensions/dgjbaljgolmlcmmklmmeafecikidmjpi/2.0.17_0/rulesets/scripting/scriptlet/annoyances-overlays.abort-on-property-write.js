!function() {
    function e(e = "") {
        ...
        if ("" === e) return;
        const t = o(), r = t.makeLogPrefix("abort-on-property-write", e), n = function() {
            const e = function() {
                const e = o();
        ...
        for (;;) {
            const o = e.indexOf(".");
            if (-1 === o) break;
            if (i = i[e.slice(0, o)], i instanceof Object == 0) return;
            e = e.slice(o + 1);
        }
        delete i[e], Object.defineProperty(i, e, {
            set: function() {
    ...
    function o() {
        ...
        o.toLogText = (e, ...o) => {
            ...
            return t === n && e === r && Date.now() - i < 5e3 ? void 0 : (r = e, n = t, i = Date.now(), 
            t);
        };
        try {
        ...
        if (0 !== r) {
            ...
            }
            {
                ...
                for (let r = 0; r < e; r++) for (let c = e; c > r; c--) {
                    const e = `${t.slice(r, c).join(".")}.*${o}`;
                    a(e, n, l), a(e, i, m);
                }
            }
        }
    })(s[0].hn);
    for (const o of l) if (!m.has(o)) try {
        e(...r[o]);
    } catch {}
}();