!function() {
    function e(e, n, r, s, ...i) {
        !function(e = "", n = "", r = "", s = "") {
            ...
            let l = "";
            if ("" !== r) {
                if ("1day" === r) a.setDate(a.getDate() + 1); else if ("1year" === r) a.setFullYear(a.getFullYear() + 1); else {
                    if (!1 === /^\d+$/.test(r)) return;
                    a.setSeconds(a.getSeconds() + parseInt(r, 10));
                }
                l = a.toUTCString();
            }
            const g = function(e = !1, t = "", n = "", r = "", s = "", i = {}) {
    ...
    const n = {}, r = [ [ "cookieConsent", "onlyNeeded" ], [ "cookies_confirm", "true" ], [ "CookiesControl", '{"necessary":true,"performance":false}' ] ], s = new Map([ [ "filen.io", 0 ], [ "cockta.eu", 1 ], [ "customuse.com", 2 ] ]), i = new Map([ [ "app.filen.io", [ 0 ] ] ]), c = (e, t, o) => {
        let n = t.get(e);
