!function() {
    function e(e, r, ...o) {
        !function(e = "", r = "", o = "") {
            const n = t(), i = n.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), s = n.patternToRegex(e, "i", !0), c = n.patternToRegex(r, "gms"), a = n.getExtraArgs(Array.from(arguments), 3), l = a.includes || a.condition ? n.patternToRegex(a.includes || a.condition, "ms") : null, d = a.excludes ? n.patternToRegex(a.excludes, "ms") : null, g = (e = !0) => {
                e && m(h.takeRecords()), h.disconnect(), n.logLevel > 1 && n.uboLog(i, "Quitting");
            }, p = (() => {
                const e = {
                    createScript: e => e
                }, {trustedTypes: r} = self;
            ...
            const f = e => {
                ...
                if (c.lastIndex = 0, !1 === n.RegExp_test.call(c, t)) return !0;
                c.lastIndex = 0;
                const s = "" !== r ? t.replace(c, o) : o;
                return e.textContent = "SCRIPT" === e.nodeName ? p.createScript(s) : s, n.logLevel > 1 && n.uboLog(i, `Text before:\n${t.trim()}`), 
    ...
    const r = {}, o = [ [ "script", "/decodeURIComponent\\(escape|fairAdblock/" ], [ "script", "adblock" ], [ "script", "hargamenu" ], [ "script", "modalAdsPopup" ], [ "script", "replaceState", "condition", "shope.ee" ], [ "script", "showModal" ] ], n = new Map([ [ "3gpterbaru.com", 0 ], [ "duniaseksi.com", 0 ], [ "almaftuchin.com", 1 ], [ "wisatalova.com", 2 ], [ "katadata.co.id", 3 ], [ "gramedia.com", 4 ], [ "carisinyal.com", 5 ] ]), i = new Map([]), s = (e, t, r) => {
        let o = t.get(e);
