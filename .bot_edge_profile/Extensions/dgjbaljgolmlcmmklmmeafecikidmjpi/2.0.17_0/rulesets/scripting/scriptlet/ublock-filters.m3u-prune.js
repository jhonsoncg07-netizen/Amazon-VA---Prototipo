!function() {
    function e(e = "", n = "") {
        ...
        const r = function() {
            ...
            return n;
        }(), o = r.makeLogPrefix("m3u-prune", e, n), s = [], i = e => {
            if ("" === e) return /^/;
            const t = /^\/(.+)\/([gms]*)$/.exec(e);
            if (null !== t) {
                let e = t[2] || "";
        ...
        }, c = i(e), a = i(n), l = (e, t) => !1 !== e[t].startsWith('#EXT-X-CUE:TYPE="SpliceOut"') && (s.push(`\t${e[t]}`), 
        ...
        e[t] = void 0, t += 1), !0), g = t => {
            ...
            if ("" === e) return r.uboLog(` Content:\n${t}`), t;
            if (c.multiline) {
                for (c.lastIndex = 0; ;) {
                    const e = c.exec(t);
                    if (null === e) break;
                    let n = e[0], o = t.slice(0, e.index);
                    if (!1 === /^[\n\r]+/.test(n) && !1 === /[\n\r]+$/.test(o)) {
                        const e = /[^\n\r]+$/.exec(o);
                        null !== e && (o = o.slice(0, e.index), n = e[0] + n);
                    }
                    let i = t.slice(e.index + e[0].length);
                    if (!1 === /[\n\r]+$/.test(n) && !1 === /^[\n\r]+/.test(i)) {
                        const e = /^[^\n\r]+/.exec(i);
                        null !== e && (i = i.slice(e.index), n += n + e[0]);
                    }
                    if (t = o.trim() + "\n" + i.trim(), c.lastIndex = o.length + 1, s.push("Discarding", ...r.String_split.call(n, /\n+/).map((e => `\t${e}`))), 
                    !1 === c.global) break;
                }
                return t;
            }
            const n = r.String_split.call(t, /\n\r|\n|\r/);
        ...
        self.fetch = new Proxy(self.fetch, {
            apply: function(e, t, n) {
                return !1 === a.test(u(n[0])) ? Reflect.apply(e, t, n) : f(...n).then((e => e.text().then((t => {
                    const n = new Response(g(t), {
                        status: e.status,
            ...
            apply: async (e, t, n) => (!1 === a.test(u(n[1])) || t.addEventListener("readystatechange", (function() {
                if (4 !== t.readyState) return;
                const e = t.responseType;
                if ("" !== e && "text" !== e) return;
                const n = t.responseText, i = g(n);
    ...
    const t = {}, n = [ [ "lura.live/prod/", "/prog.m3u8" ], [ "/^https?:\\/\\/redirector\\.googlevideo\\.com.*/", "/.*m3u8/" ], [ "/,ad\\n.+?(?=#UPLYNK-SEGMENT)/gm", "/uplynk\\.com\\/.*?\\.m3u8/" ], [ "/#EXT-X-DISCONTINUITY.{1,100}#EXT-X-DISCONTINUITY/gm", "mixed.m3u8" ], [ "tvessaiprod.nbcuni.com", "/theplatform\\.com\\/.*?\\.m3u8/" ], [ "/^\\w{11}[1-9]\\d+\\.ts/", ".m3u8" ], [ "dclk_video_ads", ".m3u8" ] ], r = new Map([ [ "vix.com", 0 ], [ "10.com.au", 1 ], [ "10play.com.au", 1 ], [ "fox.com", 2 ], [ "foxsports.com", 2 ], [ "mephimtv.cc", 3 ], [ "player.theplatform.com", 4 ], [ "phim1080.in", 5 ], [ "sbs.com.au", 6 ] ]), o = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
