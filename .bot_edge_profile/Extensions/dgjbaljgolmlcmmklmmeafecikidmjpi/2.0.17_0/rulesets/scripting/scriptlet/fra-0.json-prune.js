!function() {
    function e(e = "", r = "", o = "") {
        const s = n(), i = s.makeLogPrefix("json-prune", e, r, o), a = s.initPattern(o, {
            canNegate: !0
        }), c = s.getExtraArgs(Array.from(arguments), 3);
    ...
    function t(e, o, s, i = {
        ...
        const c = n(), l = "" !== o ? c.String_split.call(o, / +/) : [], f = 0 !== l.length && "" !== s ? c.String_split.call(s, / +/) : [];
    ...
    const o = {}, s = [ [ "siteParams.aabMessage" ], [ "adParams siteParams.aabMessage" ], [ "ads.enableAntiAdBlocking" ], [ "ads.*.default ads.*.url ads.enableMidrolls", "ads" ], [ "applaunch.data.player.features.ad.enabled applaunch.data.player.features.ad.dai.enabled", "appName" ] ], i = new Map([ [ "journaldesfemmes.fr", 0 ], [ "journaldunet.com", 0 ], [ "commentcamarche.net", 0 ], [ "linternaute.com", 1 ], [ "canalplus.com", [ 2, 3 ] ], [ "rtlplay.be", 4 ] ]), a = new Map([]), c = (e, t, n) => {
        let r = t.get(e);
