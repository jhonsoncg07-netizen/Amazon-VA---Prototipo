!function() {
    function e(e = "", r = "", n = "") {
        !function(e = !1, r, n = "", o = "", s = "") {
            ...
            const i = t(), a = !1 === e && /^\[.+\]$/.test(s) ? s.slice(1, -1) : "", c = e => "" !== a ? e.getAttribute(a) || "" : s, l = () => {
                ...
                for (const t of e) {
                    const e = t.getAttribute(o), n = c(t);
                    n !== e && ("" !== n && /^on/i.test(o) && o.toLowerCase() in t || (t.setAttribute(o, n), 
                    i.uboLog(r, `${o}="${n}"`)));
                }
                return !0;
            };
            ...
            !function(e, r) {
                ...
                !1 !== l() && (g = new MutationObserver(f), g.observe(document.body, {
                    subtree: !0,
                    childList: !0
                }));
            }));
        }(!0, t().makeLogPrefix("trusted-set-attr", e, r, n), e, r, n);
    }
    function t() {
    ...
    const r = {}, n = [ [ ".navbar-nav > li#navpromo2.nav-item > a", "onclick", "let a=function(){};return false;" ], [ 'frameset[rows="95,30,*"]', "rows", "0,30,*" ] ], o = new Map([ [ "japscan.lol", 0 ], [ "mt-soft.sakura.ne.jp", 1 ] ]), s = new Map([]), i = (e, t, r) => {
        let n = t.get(e);
