!function() {
    function e(e = "") {
        ...
        const r = function() {
            ...
            return r;
        }(), n = r.makeLogPrefix("prevent-refresh", e), o = e => {
            window.stop(), r.uboLog(n, `Prevented "${e}"`);
        };
        self.addEventListener("load", (() => {
            const t = document.querySelector('meta[http-equiv="refresh" i][content]');
            if (null === t) return;
            const r = t.getAttribute("content") || "", n = "" === e ? 500 * Math.max(parseFloat(r) || 0, 0) : 0;
            0 === n ? o(r) : setTimeout((() => {
                o(r);
            }), n);
        }), {
    ...
    const t = {}, r = [ [] ], n = new Map([ [ "tipskerja.com", 0 ] ]), o = new Map([]), s = (e, t, r) => {
        let n = t.get(e);
