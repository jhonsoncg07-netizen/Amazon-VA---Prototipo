!function() {
    function e(e = "", r = "", o = "") {
        ...
        !function(e, r) {
            ...
            g(), !1 !== /\bstay\b/.test(o) && new MutationObserver(f).observe(document, {
                attributes: !0,
                attributeFilter: s,
                childList: !0,
                subtree: !0
    ...
    const r = {}, o = [ [ "href", "a[href]#clickfakeplayer" ], [ "href", 'li[onclick^="go_to_player"] > a[target="_blank"][href]' ], [ "href", "#frm > a[href][onclick]" ], [ "href", "#fakeplayer > a" ], [ "href", 'a.elementor-icon[target="_blank"][rel][href]' ], [ "href", 'a[xhref="javascript:void(0)"][target="_blank"]' ] ], n = new Map([ [ "megafilmeshd.si", 0 ], [ "pobreflix.do", 0 ], [ "redecanais.in", 0 ], [ "cinelatino.net", 0 ], [ "paraveronline.org", 0 ], [ "verpelis.gratis", 0 ], [ "cineplus123.org", 0 ], [ "cinemitas.org", 0 ], [ "assistirfilmeshdgratis.*", 0 ], [ "animesgratis.org", 0 ], [ "serieslatinoamerica.tv", 0 ], [ "pepeliculas.org", 0 ], [ "cinetux.to", 0 ], [ "latinohentai.vip", 0 ], [ "latinohentai.com", 0 ], [ "gnula.club", 1 ], [ "peliseries.xyz", 2 ], [ "pobreflix.foo", 3 ], [ "anime-latino.com", 4 ], [ "peliculasyserieslatino.me", 5 ] ]), i = new Map([]), s = (e, t, r) => {
        let o = t.get(e);
