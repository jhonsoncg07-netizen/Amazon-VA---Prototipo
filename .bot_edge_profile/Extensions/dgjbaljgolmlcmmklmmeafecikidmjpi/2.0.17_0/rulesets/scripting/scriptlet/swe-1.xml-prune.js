!function() {
    function e(e = "", r = "", n = "") {
        ...
        const o = function() {
            ...
            return r;
        }(), s = o.makeLogPrefix("xml-prune", e, r, n), i = o.patternToRegex(n), a = o.getExtraArgs(Array.from(arguments), 3), c = t => {
            try {
                if ("" !== r && null === t.querySelector(r)) return t;
                if (a.logdoc) {
        ...
        self.fetch = new Proxy(self.fetch, {
            apply: function(e, t, r) {
                ...
                return !1 === i.test(p(r[0])) ? n : n.then((e => e.clone().text().then((t => {
            ...
            apply: async (e, t, r) => (!1 === i.test(p(r[1])) || t.addEventListener("readystatechange", (function() {
    ...
    const t = {}, r = [ [ "Ad", "", "/fwmrm.net\\/ad\\/g/" ] ], n = new Map([ [ "tv4play.se", 0 ], [ "tv4.se", 0 ], [ "fotbollskanalen.se", 0 ], [ "koket.se", 0 ], [ "embed.viaplay.com", 0 ] ]), o = new Map([]), s = (e, t, r) => {
        let n = t.get(e);
