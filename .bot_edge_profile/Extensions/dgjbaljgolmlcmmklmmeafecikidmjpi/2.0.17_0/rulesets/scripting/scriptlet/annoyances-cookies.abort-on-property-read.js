!function() {
    function e(e = "") {
        ...
        if ("" === e) return;
        const o = t(), n = o.makeLogPrefix("abort-on-property-read", e), r = function() {
            const e = function() {
                const e = t();
            ...
            throw o.uboLog(n, "Aborted"), new ReferenceError(r);
        }, c = function(e, t) {
            const o = t.indexOf(".");
            if (-1 === o) {
            ...
            s && void 0 !== s.set || Object.defineProperty(e, n, {
                get: function() {
                    return r;
                },
                set: function(e) {
    ...
    const o = {}, n = [ [ "__cmpGdprAppliesGlobally" ], [ "cookieconsent.Popup" ] ], r = new Map([ [ "al.com", 0 ], [ "allkpop.com", 0 ], [ "calendarpedia.co.uk", 0 ], [ "ccn.com", 0 ], [ "cinemablend.com", 0 ], [ "cleveland.com", 0 ], [ "comicsands.com", 0 ], [ "duffelblog.com", 0 ], [ "foxvalleyfoodie.com", 0 ], [ "gamepur.com", 0 ], [ "gamerevolution.com", 0 ], [ "interestingengineering", 0 ], [ "keengamer.com", 0 ], [ "listenonrepeat.com", 0 ], [ "mandatory.com", 0 ], [ "merriam-webster.com", 0 ], [ "mlive.com", 0 ], [ "musicfeeds.com.au", 0 ], [ "newatlas.com", 0 ], [ "pgatour.com", 0 ], [ "playstationlifestyle.net", 0 ], [ "readlightnovel.org", 0 ], [ "secondnexus.com", 0 ], [ "sevenforums.com", 0 ], [ "sport24.co.za", 0 ], [ "sportsnaut.com", 0 ], [ "superherohype.com", 0 ], [ "thefashionspot.com", 0 ], [ "theodysseyonline.com", 0 ], [ "toledoblade.com", 0 ], [ "totalbeauty.com", 0 ], [ "westernjournal.com", 0 ], [ "windows101tricks.com", 0 ], [ "claritin.ca", 1 ] ]), i = new Map([]), c = (e, t, o) => {
        let n = t.get(e);
