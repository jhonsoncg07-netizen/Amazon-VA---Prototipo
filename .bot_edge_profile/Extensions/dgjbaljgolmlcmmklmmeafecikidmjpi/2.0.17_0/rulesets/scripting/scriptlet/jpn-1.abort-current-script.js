    ...
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", n = "", r = "") {
                ...
                if ("" === e) return;
                const c = t(), i = c.makeLogPrefix("abort-current-script", e, n, r), s = c.patternToRegex(n), a = c.patternToRegex(r), l = c.getExtraArgs(Array.from(arguments), 3), g = document.currentScript, d = c.String_split.call(e, ".");
                let u, p, f = window;
                for (;u = d.shift(), 0 !== d.length && u in f != 0; ) if (f = f[u], f instanceof Object == 0) return;
