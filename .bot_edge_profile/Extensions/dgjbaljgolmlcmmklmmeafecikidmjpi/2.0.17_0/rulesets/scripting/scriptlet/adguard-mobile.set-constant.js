!function() {
    function e(...e) {
        !function(e = !1, n = "", r = "") {
            if ("" === n) return;
            const o = t(), i = o.makeLogPrefix("set-constant", n, r), s = o.getExtraArgs(Array.from(arguments), 3);
            function c(n, r) {
                const c = (() => {
                ...
                const d = function(t) {
                    ...
                    const s = o.Object_getOwnPropertyDescriptor(e, t);
                    let c, a;
                    s instanceof o.Object && (e[t] = u, s.get instanceof Function && (c = s.get), s.set instanceof Function && (a = s.set));
                    try {
                    ...
                    const r = t.slice(0, n), s = e[r];
                    t = t.slice(n + 1), s instanceof o.Object || "object" == typeof s && null !== s ? g(s, t) : p(e, r, !0, {
                        v: void 0,
                        init: function(e) {
                            return this.v = e, !0;
                        },
    ...
    const n = {}, r = [ [ "mobiles", "" ], [ "inviewstitial_fired", "true" ], [ "add_h2023", "noopFunc" ], [ "abp1", "0" ], [ "player.postitialTimeout", "0" ], [ "adformtag", "[]" ], [ "customAdlistMob", "[]" ], [ "InfCustomSTAMobileFunc", "noopFunc" ], [ "initializeInterstitial", "noopFunc" ], [ "PopUnder.bindEvent", "noopFunc" ], [ "exoUrl", "undefined" ], [ "organicPop", "undefined" ], [ "showme", "false" ], [ "pcc", "1" ], [ "Object.prototype.vastOptions", "{}" ] ], o = new Map([ [ "erozine.jp", 0 ], [ "oreno3d.com", 1 ], [ "m.efuxs.com", 2 ], [ "pornhub.com", 3 ], [ "pornhub.org", 3 ], [ "pornhub.net", 3 ], [ "m.viptube.com", 4 ], [ "m.nuvid.*", 4 ], [ "m.hd21.com", 4 ], [ "delfi.lt", 5 ], [ "m.hellporno.com", 6 ], [ "mediafire.com", 7 ], [ "moneycontrol.com", 8 ], [ "gotporn.com", 9 ], [ "m.tnaflix.com", [ 10, 11 ] ], [ "m.minixiaoshuow.com", [ 12, 13 ] ], [ "redd.tube", 14 ] ]), i = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
