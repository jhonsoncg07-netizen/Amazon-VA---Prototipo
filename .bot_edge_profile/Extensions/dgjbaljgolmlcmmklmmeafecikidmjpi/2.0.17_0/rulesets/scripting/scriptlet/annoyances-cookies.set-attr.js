!function() {
    function e(e = "", r = "", n = "") {
        const o = t().makeLogPrefix("set-attr", e, r, n);
        if (!1 === [ "", "false", "true" ].includes(n.toLowerCase())) if (/^\d+$/.test(n)) {
            const e = parseInt(n, 10);
            if (e >= 32768) return;
            n = `${e}`;
        } else if (!1 === /^\[.+\]$/.test(n)) return;
    ...
    const r = {}, n = [ [ 'img.js-lazy-img[src^="data:image/"]', "src", "[data-src]" ] ], o = new Map([ [ "salzburg.info", 0 ] ]), s = new Map([]), i = (e, t, r) => {
        let n = t.get(e);
