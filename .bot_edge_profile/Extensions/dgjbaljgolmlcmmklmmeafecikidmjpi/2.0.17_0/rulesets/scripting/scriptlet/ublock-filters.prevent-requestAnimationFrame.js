!function() {
    function t(t = "") {
        const r = function() {
            ...
            return e;
        }(), o = r.makeLogPrefix("prevent-requestAnimationFrame", t), s = "!" === t.charAt(0), i = r.patternToRegex(s ? t.slice(1) : t);
        e("requestAnimationFrame", (function(e) {
            const {callArgs: n} = e, c = n[0] instanceof Function ? r.String(r.Function_toString(n[0])) : r.String(n[0]);
            return "" === t ? r.uboLog(o, `Called:\n${c}`) : i.test(c) !== s && (n[0] = function() {}, 
    ...
    const n = {}, r = [ [ "/^/" ], [ "exoframe" ], [ "style.opacity" ], [ ".innerHTML" ] ], o = new Map([ [ "japscan.lol", 0 ], [ "news.bg", 0 ], [ "pussyspace.com", 1 ], [ "pussyspace.net", 1 ], [ "dudestream.com", 2 ], [ "needrom.com", 3 ] ]), s = new Map([]), i = (t, e, n) => {
        let r = e.get(t);
