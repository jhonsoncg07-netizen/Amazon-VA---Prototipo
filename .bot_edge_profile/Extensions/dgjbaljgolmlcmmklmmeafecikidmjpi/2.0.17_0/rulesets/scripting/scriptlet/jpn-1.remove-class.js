!function() {
    ...
    const o = {}, r = [ [ "visited", "#oRslt li a.visited", "stay" ], [ "with-ad", "section.main" ], [ "has-topbanner", "body > header.has-topbanner" ], [ "is-collaboration-jack", "body" ] ], n = new Map([ [ "o-dan.net", 0 ], [ "video.laxd.com", 1 ], [ "phileweb.com", 2 ], [ "gamewith.jp", 3 ] ]), s = new Map([]), i = (e, t, o) => {
        let r = t.get(e);
