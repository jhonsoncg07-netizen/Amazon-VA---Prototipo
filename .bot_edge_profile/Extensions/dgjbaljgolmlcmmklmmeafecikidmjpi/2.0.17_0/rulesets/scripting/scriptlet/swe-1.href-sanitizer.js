!function() {
    function e(e = "", n = "") {
        ...
        if ("" === e) return;
        const o = t(), s = o.makeLogPrefix("href-sanitizer", e, n);
        "" === n && (n = "text");
        const i = (e, t) => {
            let r = [];
            try {
            ...
            const r = t.includes("?", 1), n = r ? t.indexOf("?", 1) : t.length;
            try {
                let o = new URL(e, document.location).searchParams.get(t.slice(1, n));
                return null === o ? e : r ? c(o, t.slice(n)) : o;
            } catch {}
            return e;
        }, l = (e, t) => {
            ...
            const n = t.replace(/(\S)\?/g, "\\1?").split(/\s+/), o = 1 === n.length ? c(e.href, t) : r(e.href, !1, n);
            return void 0 !== o ? o.replace(/ /g, "%20") : void 0;
        }, f = () => {
            let t = [];
            try {
            ...
            for (const e of t) {
                ...
                const t = e.getAttribute("href"), r = l(e, n), c = a(r);
                if ("" === c) continue;
                if (c === t) continue;
                e.setAttribute("href", c);
                const f = i(t, c);
                o.uboLog(s, `Sanitized ${f + 1} links to\n${c}`);
            }
            return !0;
        };
        let u, d;
        ...
        !function(e, r) {
            ...
            const i = t(), a = [ "readystatechange", () => {
                n(document.readyState) < o || (e(), i.removeEventListener.apply(document, a));
            }, {
                capture: !0
            } ];
            i.addEventListener.apply(document, a);
        }((() => {
            !1 !== f() && (u = new MutationObserver(g), u.observe(document.body, {
                subtree: !0,
                childList: !0
            }));
        }));
    ...
    function r(e, t, n, o = {}) {
        try {
            let s = !1, i = e;
            for (const e of n) {
                const t = i, n = e.charCodeAt(0);
                if (35 !== n || "#" !== e) if (38 !== n) if (43 !== n || "+https" !== e) {
                    if (45 === n) {
                        if ("-base64" === e) {
                            i = self.atob(t);
                            continue;
                        ...
                        if ("-safebase64" === e) {
                            void 0 === r.safeBase64Replacer && (r.safeBase64Map = {
                                "-": "+",
                                _: "/"
                            }, r.safeBase64Replacer = e => r.safeBase64Map[e]), i = t.replace(/[-_]/g, r.safeBase64Replacer), 
                            i = self.atob(i);
                            continue;
                        }
                        if ("-uricomponent" === e) {
                    ...
                    if (47 !== n) {
                        if (63 !== n) return;
                        if (i = new URL(t).searchParams.get(e.slice(1)), null === i) return;
                        i.includes(" ") && (i = i.replace(/ /g, "%20"));
                    } else {
                        const r = o.cache ?? new RegExp(e.slice(1, -1));
                        null === o.cache && (o.cache = r);
                        const n = r.exec(t);
                        if (null === n) return;
                    ...
                    if (r < 0) return;
                    const n = new URL(t);
                    if (r >= n.searchParams.size) return;
                    const o = Array.from(n.searchParams.keys());
                    i = decodeURIComponent(o[r]);
                } else {
                    const e = t.indexOf("#");
                    i = -1 !== e ? t.slice(e + 1) : "";
                }
            ...
            const a = new URL(i);
            if ("https:" !== a.protocol && "http:" !== a.protocol) return;
            if (t && !0 !== s) return;
            return i;
        } catch {}
    }
    const n = {}, o = [ [ 'a[href*="/t?a="]', "?url" ], [ 'a[href*=".io/c/"]', "?u" ], [ 'a[href*="/click"]', "?url" ], [ 'a[href*="/idg.digidip.net/"]', "?url" ] ], s = new Map([ [ "aftonbladet.se", 0 ], [ "godare.se", 0 ], [ "byggahus.se", 0 ], [ "expressen.se", [ 0, 2 ] ], [ "elle.se", [ 0, 1, 2 ] ], [ "femina.se", [ 0, 1 ] ], [ "svenskdam.se", [ 0, 1 ] ], [ "galamagasin.se", 0 ], [ "rodeo.net", 0 ], [ "familjeliv.se", 0 ], [ "vitaestilo.se", 0 ], [ "veckorevyn.com", 0 ], [ "golflivet.se", 0 ], [ "allas.se", 1 ], [ "hant.se", 1 ], [ "mabra.com", 1 ], [ "residencemagazine.se", 1 ], [ "motherhood.se", 1 ], [ "m3.se", 3 ], [ "pcforalla.se", 3 ], [ "macworld.se", 3 ] ]), i = new Map([]), a = (e, t, r) => {
        let n = t.get(e);
    ...
    for (const t of f) if (!u.has(t)) try {
        e(...o[t]);
    } catch {}
}();