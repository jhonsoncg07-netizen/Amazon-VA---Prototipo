!function() {
    function e(e = "", o = "", n = "") {
        ...
        if ("" === e) return;
        const r = t(), s = r.makeLogPrefix("remove-class", e, o, n), a = r.String_split.call(e, /\s*\|\s*/), i = a.map((e => `${o}.${CSS.escape(e)}`)).join(",");
        r.logLevel > 1 && r.uboLog(s, `Target selector:\n\t${i}`);
        const c = /\bstay\b/.test(n);
        let l;
        const d = () => {
            l = void 0;
            try {
                const e = document.querySelectorAll(i);
                for (const t of e) t.classList.remove(...a), r.uboLog(s, "Removed class(es)");
            } catch {}
        ...
        }), /\bcomplete\b/.test(n) ? "idle" : "loading");
    }
    function t() {
