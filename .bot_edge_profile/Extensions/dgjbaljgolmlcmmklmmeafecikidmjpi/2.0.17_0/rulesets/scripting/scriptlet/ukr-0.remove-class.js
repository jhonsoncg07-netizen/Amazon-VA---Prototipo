!function() {
    function e(e = "", r = "", o = "") {
        ...
        if ("" === e) return;
        const n = t(), a = n.makeLogPrefix("remove-class", e, r, o), s = n.String_split.call(e, /\s*\|\s*/), i = s.map((e => `${r}.${CSS.escape(e)}`)).join(",");
        ...
        const l = () => {
            ...
            for (let r = 0; r < e.length && t; r++) {
                const {type: o, addedNodes: n, removedNodes: a} = e[r];
                "attributes" === o && (t = !1);
