!function() {
    function e(e = "", o = "", r = "") {
        ...
        if ("" === e) return;
        const n = t(), s = n.makeLogPrefix("remove-class", e, o, r), i = n.String_split.call(e, /\s*\|\s*/), a = i.map((e => `${o}.${CSS.escape(e)}`)).join(",");
    ...
    const o = {}, r = [ [ "banners-brand", "#page_content" ], [ "fixed_ad", "#header.fixed_ad" ], [ "hasStickyHead", "body.hasStickyHead" ], [ "pt-[100px]", "#main-container" ], [ "mobile-sticky-ad-is-active", "body" ], [ "branding", 'body[id="pagebody"]' ], [ "branding", "body" ], [ "has-adhesion", ".header-placeholder.has-adhesion" ] ], n = new Map([ [ "m.7days.ru", 0 ], [ "thestudentroom.co.uk", 1 ], [ "lepoint.fr", 2 ], [ "mumsnet.com", 3 ], [ "liquipedia.net", 4 ], [ "www.ixbt.com", 5 ], [ "slovoidilo.ua", 6 ], [ "accuweather.com", 7 ] ]), s = new Map([]), i = (e, t, o) => {
        let r = t.get(e);
