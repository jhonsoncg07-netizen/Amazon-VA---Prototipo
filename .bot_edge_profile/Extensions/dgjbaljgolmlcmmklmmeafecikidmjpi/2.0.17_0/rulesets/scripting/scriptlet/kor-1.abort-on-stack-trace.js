!function() {
    ...
    const o = {}, i = [ [ "$.prototype.html", "_boom" ], [ "String.prototype.substring", "/checkCookie.+main\\.do/" ], [ "alert", "chk_adBlock" ] ], s = new Map([ [ "m.humoruniv.com", 0 ], [ "www.cultureland.co.kr", 1 ], [ "errornight.com", 2 ] ]), c = new Map([]), a = (e, t, r) => {
        let n = t.get(e);
