!function() {
    function e(e = "") {
        ...
        let o = "";
        /^\/.*\/$/.test(e) ? o = window.location.href : "" !== e && (o = `${window.location.pathname}${window.location.search}`);
        try {
            r.patternToRegex(e).test(o) && window.close();
        } catch (e) {}
    }
    const t = {}, r = [ [ "/protect?" ], [ "/link-" ], [ "/telephone-service" ], [ "/^/" ], [ "/soft98" ] ], o = new Map([ [ "norton.com", 0 ], [ "soft98.ir", 1 ], [ "sysban.ir", 2 ], [ "smostafa.ir", 3 ], [ "coffeete.ir", 4 ] ]), n = new Map([ [ "forum.soft98.ir", [ 1 ] ] ]), i = (e, t, r) => {
        let o = t.get(e);
