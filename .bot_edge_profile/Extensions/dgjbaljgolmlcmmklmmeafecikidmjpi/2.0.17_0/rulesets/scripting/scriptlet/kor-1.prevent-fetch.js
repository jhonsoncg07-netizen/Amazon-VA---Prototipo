!function() {
    function t(...t) {
        !function(t = !1, o = "", s = "", i = "") {
            const c = n(), a = (t ? "trusted-" : "") + "prevent-fetch", l = c.makeLogPrefix(a, o, s, i), p = [];
            for (const t of c.String_split.call(o, /\s+/)) {
                if ("" === t) continue;
                const e = t.indexOf(":");
                let n, r;
                -1 !== e ? (n = t.slice(0, e), r = t.slice(e + 1)) : (n = "url", r = t), p.push({
                    key: n,
            ...
            e("fetch", (function(e) {
                ...
                try {
                    ...
                    g = 0 === p.length;
                    for (const {key: e, pattern: n} of p) if (n.expect && !1 === t.has(e) || !1 === c.testPattern(n, t.get(e))) {
                        g = !0;
                        break;
                    }
                } catch {}
    ...
    const r = {}, o = [ [ "/^https.\\/\\/videoads\\.kakao\\.com\\/adserver\\/api\\/v[0-9]{1", "2}\\/vmap$/" ], [ "imasdk.googleapis.com/js/sdkloader/ima3.js" ], [ "pagead2.googlesyndication.com/pagead/js/adsbygoogle.js" ], [ "www3.doubleclick.net" ], [ "adblockanalytics.com" ], [ "adsbygoogle.js" ], [ "doubleclick.net" ], [ "adManager.js" ] ], s = new Map([ [ "tv.kakao.com", 0 ], [ "play-tv.kakao.com", 0 ], [ "kakaotv.daum.net", 0 ], [ "spotvnow.co.kr", [ 1, 2 ] ], [ "namechart.kr", 3 ], [ "eftlibrary.com", 3 ], [ "blackkiwi.net", 3 ], [ "hub.weirdhost.xyz", [ 4, 5 ] ], [ "srank.kr", 6 ], [ "hasha.in", 7 ] ]), i = new Map([]), c = (t, e, n) => {
        let r = e.get(t);
