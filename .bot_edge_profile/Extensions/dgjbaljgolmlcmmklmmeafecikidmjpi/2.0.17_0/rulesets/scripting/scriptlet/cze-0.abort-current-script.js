!function() {
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", r = "", o = "") {
                ...
                if ("" === e) return;
                const c = t(), i = c.makeLogPrefix("abort-current-script", e, r, o), s = c.patternToRegex(r), a = c.patternToRegex(o), l = c.getExtraArgs(Array.from(arguments), 3), g = document.currentScript, f = c.String_split.call(e, ".");
                let d, u, p = window;
                for (;d = f.shift(), 0 !== f.length && d in p != 0; ) if (p = p[d], p instanceof Object == 0) return;
                let h = Object.getOwnPropertyDescriptor(p, d);
                h instanceof Object != 0 && h.get instanceof Function != 0 || (u = p[d], h = void 0), 
                function(e) {
                ...
                const b = function() {
                    ...
                    c.uboLog(i, "Aborted"), new ReferenceError(b);
                };
                try {
                    Object.defineProperty(p, d, {
                        get: function() {
                            return x(), h instanceof Object ? h.get.call(p) : u;
                        },
                        set: function(e) {
                            x(), h instanceof Object ? h.set.call(p, e) : u = e;
                        }
                    });
                } catch (e) {
                    c.uboErr(i, `Error: ${e}`);
    ...
    const n = {}, r = [ [ "$", "Ads" ], [ "$", "fancyBanner" ], [ "$", "PartnerRedirectAction" ], [ "window.addEventListener", ":visible" ], [ "document.createElement", "adbDetect" ], [ "HTMLIFrameElement.prototype.contentWindow" ] ], o = new Map([ [ "csfd.cz", 0 ], [ "csfd.sk", 0 ], [ "drbna.cz", 1 ], [ "onlajny.com", 2 ], [ "zive.cz", [ 3, 4 ] ], [ "idnes.cz", [ 4, 5 ] ], [ "novinky.cz", 4 ], [ "aktualne.cz", 4 ], [ "reflex.cz", 4 ], [ "e15.cz", 4 ], [ "blesk.cz", 4 ], [ "ahaonline.cz", 4 ], [ "super.cz", 4 ], [ "auto.cz", 4 ], [ "maminka.cz", 4 ], [ "autorevue.cz", 4 ], [ "osobnosti.cz", 4 ], [ "lidovky.cz", 4 ], [ "iprima.cz", 4 ], [ "kupi.cz", 4 ], [ "kinobox.cz", 4 ], [ "cnews.cz", 4 ], [ "zeny.cz", 4 ], [ "expres.cz", 4 ], [ "tiscali.cz", 4 ], [ "extra.cz", 4 ], [ "onetv.cz", 4 ], [ "dama.cz", 4 ], [ "g.cz", 4 ], [ "mojecelebrity.cz", 4 ], [ "spisovatele.cz", 4 ], [ "modnipeklo.cz", 4 ], [ "karaoketexty.cz", 4 ], [ "emimino.cz", 4 ], [ "vitalion.cz", 4 ], [ "mojezdravi.cz", 4 ], [ "abicko.cz", 4 ], [ "arome.cz", 4 ], [ "labuznik.cz", 4 ], [ "fights.cz", 4 ], [ "nasepenize.cz", 4 ] ]), c = new Map([]), i = (e, t, n) => {
        let r = t.get(e);
