!function() {
    function e(e, r, ...n) {
        !function(e = "", r = "", n = "") {
            ...
            const f = e => {
                ...
                return e.textContent = "SCRIPT" === e.nodeName ? u.createScript(i) : i, o.logLevel > 1 && o.uboLog(s, `Text before:\n${t.trim()}`), 
    ...
    const r = {}, n = [ [ "script", "!function(r,n,t,e)" ], [ "script", ",mr=function(r," ] ], o = new Map([ [ "www.ukr.net", 0 ], [ "pravda.com.ua", 1 ] ]), s = new Map([]), i = (e, t, r) => {
        let n = t.get(e);
