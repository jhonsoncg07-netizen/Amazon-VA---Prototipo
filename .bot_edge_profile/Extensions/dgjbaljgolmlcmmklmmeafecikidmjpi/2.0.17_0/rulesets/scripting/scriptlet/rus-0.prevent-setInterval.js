!function() {
    ...
    const r = {}, o = [ [ "(clearInterval(e)" ], [ "clientHeight" ], [ "move_string" ], [ "replaceWith" ], [ "debugger" ] ], i = new Map([ [ "websdr.su", 0 ], [ "fatcatslim.ru", 1 ], [ "anime-chan.me", 2 ], [ "volyninfo.com", 3 ], [ "aniu.ru", 4 ], [ "liveball.*", 4 ] ]), s = new Map([]), c = (t, e, n) => {
        let r = e.get(t);
