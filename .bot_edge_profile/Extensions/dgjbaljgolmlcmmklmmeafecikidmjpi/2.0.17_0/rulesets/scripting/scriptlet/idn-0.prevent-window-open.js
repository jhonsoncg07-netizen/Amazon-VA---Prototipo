!function() {
    function t(t = "", n = "", r = "") {
        const i = function() {
            ...
            return e;
        }(), s = i.makeLogPrefix("no-window-open-if", t, n, r), c = !1 === t.startsWith("!");
        !1 === c && (t = t.slice(1));
        const l = i.patternToRegex(t), a = 1e3 * (parseFloat(n) || 0), p = self.setTimeout, g = function(t, e, o) {
        ...
        e("open", (function(e) {
            ...
            if (l.test(f) !== c) return i.logLevel > 1 && i.uboLog(s, `Allowed (${o.join(", ")})`), 
            e.reflect();
            ...
            let d = ("obj" === r ? g("object", "data", ...o) : g("iframe", "src", ...o)).contentWindow;
            return "object" == typeof d && null !== d ? Object.defineProperty(d, "closed", {
                ...
                get: function(t, e, ...o) {
                    const n = Reflect.get(t, e, ...o);
                    return i.uboLog(s, `popup / get ${e} === ${n}`), "function" == typeof n ? (...e) => n.call(t, ...e) : n;
                },
                set: function(t, e, o, ...n) {
                    return i.uboLog(s, `popup / set ${e} = ${o}`), Reflect.set(t, e, o, ...n);
                }
            })), d;
        }));
    }
    function e(t = "", o = "") {
        ...
        i.prototype?.constructor === i && (l.construct = function(t, n) {
            return o(e.CtorContext.factory(t, n));
        }), n[r] = new Proxy(i, l);
    }
    const o = {}, n = [ [] ], r = new Map([ [ "anichin.top", 0 ], [ "animekompi.vip", 0 ], [ "indobo.com", 0 ], [ "jurnalistekno.id", 0 ], [ "kimcilonly.site", 0 ], [ "kiryuu.id", 0 ], [ "kiryuu.org", 0 ], [ "kiryuu01.com", 0 ], [ "komikcast02.com", 0 ], [ "njavtv.com", 0 ], [ "subindojav.cc", 0 ] ]), i = new Map([]), s = (t, e, o) => {
        let n = e.get(t);
