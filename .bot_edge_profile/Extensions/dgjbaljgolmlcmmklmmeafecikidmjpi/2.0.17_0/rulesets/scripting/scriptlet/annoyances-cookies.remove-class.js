!function() {
    function e(e = "", o = "", r = "") {
        ...
        if ("" === e) return;
        const n = t(), a = n.makeLogPrefix("remove-class", e, o, r), s = n.String_split.call(e, /\s*\|\s*/), i = s.map((e => `${o}.${CSS.escape(e)}`)).join(",");
        n.logLevel > 1 && n.uboLog(a, `Target selector:\n\t${i}`);
        ...
        const d = () => {
            ...
            try {
                ...
                for (const t of e) t.classList.remove(...s), n.uboLog(a, "Removed class(es)");
            } catch {}
            c || "complete" === document.readyState && m.disconnect();
        }, m = new MutationObserver((e => {
            if (void 0 !== l) return;
            let t = !0;
            for (let o = 0; o < e.length && t; o++) {
                const {type: r, addedNodes: n, removedNodes: a} = e[o];
                "attributes" === r && (t = !1);
