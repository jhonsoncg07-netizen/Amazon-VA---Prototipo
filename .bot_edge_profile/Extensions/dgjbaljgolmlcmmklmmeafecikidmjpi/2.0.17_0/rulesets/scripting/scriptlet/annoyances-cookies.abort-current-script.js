!function() {
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", n = "", o = "") {
                ...
                if ("" === e) return;
                const i = t(), c = i.makeLogPrefix("abort-current-script", e, n, o), s = i.patternToRegex(n), a = i.patternToRegex(o), l = i.getExtraArgs(Array.from(arguments), 3), g = document.currentScript, f = i.String_split.call(e, ".");
                let u, d, p = window;
                for (;u = f.shift(), 0 !== f.length && u in p != 0; ) if (p = p[u], p instanceof Object == 0) return;
                let m = Object.getOwnPropertyDescriptor(p, u);
                m instanceof Object != 0 && m.get instanceof Function != 0 || (d = p[u], m = void 0), 
                function(e) {
                ...
                const h = function() {
                    ...
                    i.logLevel > 1 && "" !== o && i.uboLog(c, `Matched src\n${e.src}`);
                    const t = O(e);
                ...
                try {
                    Object.defineProperty(p, u, {
                        get: function() {
                            return v(), m instanceof Object ? m.get.call(p) : d;
                        },
                        set: function(e) {
                            v(), m instanceof Object ? m.set.call(p, e) : d = e;
                        }
                    });
                } catch (e) {
                    i.uboErr(c, `Error: ${e}`);
    ...
    const r = {}, n = [ [ "document.createElement", "admiral" ] ], o = new Map([ [ "titantv.com", 0 ], [ "musicfeeds.com.au", 0 ], [ "minecraftalpha.net", 0 ], [ "worldpopulationreview.com", 0 ], [ "boston.com", 0 ], [ "britannica.com", 0 ], [ "download.mokeedev.com", 0 ], [ "freep.com", 0 ], [ "ijr.com", 0 ], [ "inquirer.net", 0 ], [ "legacy.com", 0 ], [ "nationalreview.com", 0 ], [ "nofilmschool.com", 0 ], [ "order-order.com", 0 ], [ "savvytime.com", 0 ], [ "techlicious.com", 0 ], [ "technicpack.net", 0 ], [ "thedraftnetwork.com", 0 ], [ "wrestlezone.com", 0 ] ]), i = new Map([]), c = (e, t, r) => {
        let n = t.get(e);
