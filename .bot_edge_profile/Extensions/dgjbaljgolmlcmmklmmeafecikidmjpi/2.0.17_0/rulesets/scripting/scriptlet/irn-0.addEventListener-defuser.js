!function() {
    function e(e = "", o = "") {
        const i = n(), s = i.getExtraArgs(Array.from(arguments), 2), c = i.makeLogPrefix("prevent-addEventListener", e, o), a = i.patternToRegex(e, void 0, !0), l = i.patternToRegex(o), u = (function(e) {
            if (e instanceof Object == 0) return !1;
            r.canDebug && e.debug;
        }(s), s.elements || void 0), p = e => {
            ...
            const r = i.RegExp_test.call(a, t), o = i.RegExp_test.call(l, n), s = r && o;
            return (!s || void 0 === u || !1 !== (c = e, "window" === u ? c === window : "document" === u ? c === document : !!(c && c.matches && c.matches(u)) || Array.from(document.querySelectorAll(u)).includes(c))) && s;
            var c;
        }, d = function(t) {
            ...
            if ("" === e && "" === o) i.uboLog(c, `Called: ${s}\n${a}\n${p(r)}`); else if (g(r, s, a)) return i.uboLog(c, `Prevented: ${s}\n${a}\n${p(r)}`);
            return t.reflect();
        };
        !function(e, t) {
            const r = e => {
    ...
    function t(e = "", n = "") {
        ...
        i.prototype?.constructor === i && (a.construct = function(e, r) {
    ...
    const r = {}, o = [ [ "scroll", 'return"undefined"' ], [ "load", "contextmenu" ], [ "/contextmenu|copy|cut/", 'return"undefined"' ], [ "contextmenu", "preventDefault" ], [ "DOMContentLoaded", "ajax_tptn_tracker" ], [ "contextmenu" ], [ "", "t.preventDefault" ], [ "contextmenu", "preventDefault", "elements", "div#rmpPlayer" ], [ "click", "720" ], [ "copy", "throw" ], [ "/contextmenu|keydown|dragstart|mousemove/", 'return"undefined"' ], [ "DOMContentLoaded", "videojs.ads" ] ], i = new Map([ [ "autosafkar.com", 0 ], [ "behtaraneh.ir", 1 ], [ "javan-musics.com", 1 ], [ "tabanmusic.com", 1 ], [ "texahang.org", 1 ], [ "iran-music.com", 1 ], [ "bizma.ir", 2 ], [ "app.blubank.com", 3 ], [ "downloadha.com", 4 ], [ "elmefarda.com", 5 ], [ "s-moshaver.com", 5 ], [ "ganjipakhsh.com", 6 ], [ "lenz.ir", 7 ], [ "mopon.ir", 8 ], [ "noorlib.ir", 9 ], [ "rebec.ir", 10 ], [ "saednews.com", 11 ] ]), s = new Map([]), c = (e, t, n) => {
        let r = t.get(e);
    ...
    for (const t of u) if (!p.has(t)) try {
        e(...o[t]);
    } catch {}
}();