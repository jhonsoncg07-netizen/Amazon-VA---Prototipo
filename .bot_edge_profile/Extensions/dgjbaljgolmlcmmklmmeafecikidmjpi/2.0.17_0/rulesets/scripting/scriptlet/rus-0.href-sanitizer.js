!function() {
    function e(e = "", o = "") {
        ...
        const a = (e, t) => {
            ...
            try {
                ...
                return null === n ? e : r ? c(n, t.slice(o)) : n;
            } catch {}
            return e;
        }, l = (e, t) => {
            ...
            const o = t.replace(/(\S)\?/g, "\\1?").split(/\s+/), n = 1 === o.length ? c(e.href, t) : r(e.href, !1, o);
            ...
            for (const e of t) {
                ...
                const t = e.getAttribute("href"), r = l(e, o), c = s(r);
                if ("" === c) continue;
                if (c === t) continue;
                e.setAttribute("href", c);
                const f = a(t, c);
                n.uboLog(i, `Sanitized ${f + 1} links to\n${c}`);
            }
            return !0;
        };
        let u, p;
        ...
        !function(e, r) {
            ...
            const a = t(), s = [ "readystatechange", () => {
                o(document.readyState) < n || (e(), a.removeEventListener.apply(document, s));
            }, {
                capture: !0
            } ];
            a.addEventListener.apply(document, s);
        }((() => {
            !1 !== f() && (u = new MutationObserver(h), u.observe(document.body, {
                subtree: !0,
                childList: !0
            }));
        }));
        ...
        try {
            ...
            for (const e of o) {
                ...
                if (35 !== o || "#" !== e) if (38 !== o) if (43 !== o || "+https" !== e) {
                    if (45 === o) {
                        ...
                        if ("-safebase64" === e) {
                            void 0 === r.safeBase64Replacer && (r.safeBase64Map = {
                                "-": "+",
                                _: "/"
                            }, r.safeBase64Replacer = e => r.safeBase64Map[e]), a = t.replace(/[-_]/g, r.safeBase64Replacer), 
                            a = self.atob(a);
                            continue;
                        }
                        if ("-uricomponent" === e) {
                    ...
                    if (47 !== o) {
                        if (63 !== o) return;
                        if (a = new URL(t).searchParams.get(e.slice(1)), null === a) return;
                        a.includes(" ") && (a = a.replace(/ /g, "%20"));
                    } else {
    ...
    const o = {}, n = [ [ '[href*="?url=https"]', "?url" ], [ 'a[href*="&link=https://"]', "?link" ], [ 'a[href*=".php?go="]', "?go" ], [ 'a[href*="/away.php?"]', "?to" ], [ 'a[href*="/away?"]', "?to" ], [ 'a[href*="/bitrix/rk.php?goto=https"]', "?goto" ], [ 'a[href*="/go.php"]', "?url" ], [ 'a[href*="/redir.php?r="]', "?r" ], [ 'a[href*="/redir/"]', "?exturl" ], [ 'a[href*="/redir/"]', "?vzurl" ], [ 'a[href*="/redirect?to="]', "?to" ], [ 'a[href*="://click.opennet.ru/cgi-bin/"]', "?to" ], [ 'a[href*="?goto=https"]', "?goto" ], [ 'a[href*="deeplink="]', "?deeplink" ], [ 'a[href][rel*="sponsored"][target="_blank"]', "?goto" ], [ 'a[href][target="_blank"]', "?ulp" ], [ 'a[href^="//www.ixbt.com/click/?c="]', "[title]" ], [ 'a[href^="/engine/dwn"]', "?xf" ], [ 'a[href^="https://go.2038.pro/"][href*="?dl="]', "?dl" ], [ 'a[href^="https://pikabu.ru/"][href*="?u=http"]', "?u" ], [ 'a[href^="https://www.google.com/url?q="]' ], [ 'a[href^="https://www.youtube.com/redirect?event="][href*="&q=http"]', "?q" ], [ '[href^="https://checklink.mail.ru/proxy?"]', "?url" ], [ '[href^="https://click.mail.ru/redir?u="]', "?u" ], [ '[data-cke-saved-href^="https://checklink.mail.ru/proxy?"]' ] ], i = new Map([ [ "mp3party.net", 0 ], [ "portalvirtualreality.ru", 1 ], [ "softoroom.org", 2 ], [ "vk.com", 3 ], [ "vk.ru", 3 ], [ "vkvideo.ru", 3 ], [ "dzen.ru", 4 ], [ "freehat.cc", 5 ], [ "lalapaluza.ru", 5 ], [ "game4you.top", 6 ], [ "innal.top", 6 ], [ "naylo.top", 6 ], [ "rustorka.com", 6 ], [ "rustorka.net", 6 ], [ "rustorka.top", 6 ], [ "rustorkacom.lib", 6 ], [ "stalkermods.ru", 7 ], [ "vz.ru", [ 8, 9 ] ], [ "dtf.ru", 10 ], [ "vc.ru", [ 10, 18 ] ], [ "opennet.me", 11 ], [ "opennet.ru", 11 ], [ "appleinsider.ru", 12 ], [ "kluchikipro.ru", 13 ], [ "lifehacker.ru", 14 ], [ "hot.game", 15 ], [ "www.ixbt.com", 16 ], [ "wotspeak.org", 17 ], [ "pikabu.ru", 19 ], [ "nsportal.ru", 20 ], [ "youtube.com", 21 ], [ "light.mail.ru", [ 22, 23 ] ], [ "e.mail.ru", 24 ], [ "octavius.mail.ru", 24 ] ]), a = new Map([]), s = (e, t, r) => {
        let o = t.get(e);
