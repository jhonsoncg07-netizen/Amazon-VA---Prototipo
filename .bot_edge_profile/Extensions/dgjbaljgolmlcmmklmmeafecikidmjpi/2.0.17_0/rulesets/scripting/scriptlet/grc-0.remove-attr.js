!function() {
    function e(e = "", o = "", r = "") {
        ...
        !function(e, o) {
            ...
            g(), !1 !== /\bstay\b/.test(r) && new MutationObserver(d).observe(document, {
                attributes: !0,
                attributeFilter: i,
                childList: !0,
                subtree: !0
    ...
    const o = {}, r = [ [ "oncopy", "body", "complete" ], [ "onselectstart|oncopy", "body", "complete" ], [ "onselectstart|oncopy|oncontextmenu", "body", "complete" ] ], n = new Map([ [ "arcadiaportal.gr", 0 ], [ "kavalanews.gr", 1 ], [ "kolydas.gr", 2 ] ]), s = new Map([]), i = (e, t, o) => {
        let r = t.get(e);
