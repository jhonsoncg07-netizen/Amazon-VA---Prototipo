!function() {
    ...
    const o = {}, r = [ [ "warnadb", "1" ], [ "p_view", "true" ], [ "q_pop_noel", "true" ], [ "mpf_popup_desktop", "true" ] ], s = new Map([ [ "pianoweb.fr", 0 ], [ "jeune-gay.fr", 1 ], [ "lexpress.fr", 2 ], [ "monpetitforfait.com", 3 ] ]), i = new Map([]), c = (e, t, n) => {
        let o = t.get(e);
