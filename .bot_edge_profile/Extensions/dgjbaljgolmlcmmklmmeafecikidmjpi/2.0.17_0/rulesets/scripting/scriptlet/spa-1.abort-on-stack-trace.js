!function() {
    ...
    function n(e, n = "") {
        ...
        return ("all" === n || "match" === n && f || "nomatch" === n && !f) && o.uboLog(g.replace(/\t/g, "\n")), 
        f;
    }
    function r() {
    ...
    const o = {}, i = [ [ "atob", "wp-content/" ], [ "alert", "eval" ], [ "history.go", "eval" ], [ "JSON.parse", "showPopup" ] ], s = new Map([ [ "yomucomics.com", 0 ], [ "netcine.*", [ 1, 2 ] ], [ "toonscrab.com", 3 ] ]), c = new Map([]), a = (e, t, n) => {
        let r = t.get(e);
    ...
    ((e, t = "") => {
        ...
        if (0 !== r) {
            ...
            {
                const e = r - 1;
                for (let r = 0; r < e; r++) for (let o = e; o > r; o--) {
                    const e = `${n.slice(r, o).join(".")}.*${t}`;
                    a(e, s, f), a(e, c, p);
                }
            }
        }
