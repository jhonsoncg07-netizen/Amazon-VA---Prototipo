!function() {
    function e(e = "", n = "", o = "") {
        const i = r(), s = i.makeLogPrefix("json-prune", e, n, o), a = i.initPattern(o, {
            canNegate: !0
        }), c = i.getExtraArgs(Array.from(arguments), 3);
    ...
    function t(e, o, i, s = {
        ...
        const c = r(), l = "" !== o ? c.String_split.call(o, / +/) : [], f = 0 !== l.length && "" !== i ? c.String_split.call(i, / +/) : [];
        if (!0 !== s.matchAll && !1 === function(e, t = "") {
            ...
            const l = c.join("\t"), f = !0 !== e.matchAll && n.testPattern(e, l);
    ...
    function n(e, t, o = !1) {
        ...
        for (;;) {
            ...
            const e = a.indexOf(".");
            if (-1 === e) {
                if (!1 === o) return i.Object_hasOwn(s, a);
                let e = !1;
                if ("*" === a) for (const t in s) !1 !== i.Object_hasOwn(s, t) && (delete s[t], 
                e = !0); else i.Object_hasOwn(s, a) && (delete s[a], e = !0);
                return e;
            }
            const t = a.slice(0, e), r = a.slice(e + 1);
            let c = !1;
            if ("[-]" === t && Array.isArray(s)) {
                let e = s.length;
                for (;e--; ) !1 !== n(s[e], r) && (s.splice(e, 1), c = !0);
                return c;
            }
            if ("{-}" === t && s instanceof Object) {
                for (const e of Object.keys(s)) !1 !== n(s[e], r) && (delete s[e], c = !0);
                return c;
            }
            if ("[]" === t && Array.isArray(s) || "{}" === t && s instanceof Object || "*" === t && s instanceof Object) {
                for (const e of Object.keys(s)) !1 !== n(s[e], r, o) && (c = !0);
                return c;
            }
    ...
    const o = {}, i = [ [ "props.children.[].props.children.[].props.children.props.advertisment" ], [ "trace data.vast_url data.ads" ], [ "result.commercialUrl result.watermark" ], [ "result.adsText result.adsLink" ], [ "data.geocampaigns" ], [ "data", "data.vast data.content data.ad_id" ], [ "body.productStatus" ] ], s = new Map([ [ "fam.ir", 0 ], [ "filmnet.ir", 1 ], [ "play.namava.ir", 2 ], [ "skyroom.online", 3 ], [ "app.snapp.taxi", 4 ], [ "tmk.ir", 5 ], [ "player.telewebion.com", 6 ] ]), a = new Map([]), c = (e, t, r) => {
        let n = t.get(e);
