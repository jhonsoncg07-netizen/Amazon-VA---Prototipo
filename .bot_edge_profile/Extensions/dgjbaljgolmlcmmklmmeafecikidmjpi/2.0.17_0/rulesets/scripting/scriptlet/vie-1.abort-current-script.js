    ...
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", o = "", r = "") {
                ...
                if ("" === e) return;
                const i = t(), c = i.makeLogPrefix("abort-current-script", e, o, r), s = i.patternToRegex(o), a = i.patternToRegex(r), l = i.getExtraArgs(Array.from(arguments), 3), u = document.currentScript, d = i.String_split.call(e, ".");
                let m, p, g = window;
                for (;m = d.shift(), 0 !== d.length && m in g != 0; ) if (g = g[m], g instanceof Object == 0) return;
                let f = Object.getOwnPropertyDescriptor(g, m);
                f instanceof Object != 0 && f.get instanceof Function != 0 || (p = g[m], f = void 0), 
                function(e) {
                ...
                const h = function() {
                    ...
                    return self.onerror = function(t, ...o) {
                        return !("string" != typeof t || !t.includes(e)) || (n instanceof Function ? n.call(this, t, ...o) : void 0);
                    }.bind(), e;
                }(), v = new WeakMap, y = e => {
                    let t = e.textContent;
                    if ("" !== t.trim()) return t;
                    ...
                    i.uboLog(c, "Aborted"), new ReferenceError(h);
                };
                try {
                    Object.defineProperty(g, m, {
                        get: function() {
                            return b(), f instanceof Object ? f.get.call(g) : p;
                        },
                        set: function(e) {
                            b(), f instanceof Object ? f.set.call(g, e) : p = e;
                        }
                    });
                } catch (e) {
                    i.uboErr(c, `Error: ${e}`);
