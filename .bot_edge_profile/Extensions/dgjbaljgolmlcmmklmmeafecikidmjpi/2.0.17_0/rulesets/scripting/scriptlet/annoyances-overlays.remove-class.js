!function() {
    function e(e = "", o = "", r = "") {
        ...
        if ("" === e) return;
        const n = t(), s = n.makeLogPrefix("remove-class", e, o, r), c = n.String_split.call(e, /\s*\|\s*/), i = c.map((e => `${o}.${CSS.escape(e)}`)).join(",");
        n.logLevel > 1 && n.uboLog(s, `Target selector:\n\t${i}`);
        ...
        const p = () => {
            ...
            try {
                ...
                for (const t of e) t.classList.remove(...c), n.uboLog(s, "Removed class(es)");
            } catch {}
            a || "complete" === document.readyState && m.disconnect();
        ...
        !function(e, o) {
            ...
            const c = t(), i = [ "readystatechange", () => {
                r(document.readyState) < n || (e(), c.removeEventListener.apply(document, i));
            }, {
                capture: !0
            } ];
            c.addEventListener.apply(document, i);
        }((() => {
            p(), m.observe(document, {
                attributes: !0,
