!function() {
    function t(t = "", r = "") {
        const i = function() {
            ...
            return e;
        }(), s = i.makeLogPrefix("prevent-setInterval", t, r), c = "!" === t.charAt(0), a = i.patternToRegex(c ? t.slice(1) : t), l = new o(r);
