!function() {
    function t(t = "", o = "") {
        const i = n(), s = i.getExtraArgs(Array.from(arguments), 2), c = i.makeLogPrefix("prevent-addEventListener", t, o), a = i.patternToRegex(t, void 0, !0), l = i.patternToRegex(o), g = (function(t) {
            if (t instanceof Object == 0) return !1;
            r.canDebug && t.debug;
        }(s), s.elements || void 0), u = t => {
            ...
            const r = i.RegExp_test.call(a, e), o = i.RegExp_test.call(l, n), s = r && o;
            return (!s || void 0 === g || !1 !== (c = t, "window" === g ? c === window : "document" === g ? c === document : !!(c && c.matches && c.matches(g)) || Array.from(document.querySelectorAll(g)).includes(c))) && s;
            var c;
        }, d = function(e) {
            ...
            if ("" === t && "" === o) i.uboLog(c, `Called: ${s}\n${a}\n${u(r)}`); else if (p(r, s, a)) return i.uboLog(c, `Prevented: ${s}\n${a}\n${u(r)}`);
            return e.reflect();
        };
        !function(t, e) {
            const r = t => {
            ...
            const s = n(), c = [ "readystatechange", () => {
                r(document.readyState) < o || (t(), s.removeEventListener.apply(document, c));
            }, {
                capture: !0
            } ];
    ...
    function e(t = "", n = "") {
        ...
        i.prototype?.constructor === i && (a.construct = function(t, r) {
    ...
    function n() {
        ...
        e.toLogText = (t, ...e) => {
            ...
            return r === o && t === n && Date.now() - i < 5e3 ? void 0 : (n = t, o = r, i = Date.now(), 
            r);
        };
        try {
    ...
    const r = {}, o = [ [ "DOMContentLoaded", "check" ], [ "error", "event.target.tagName" ], [ "DOMContentLoaded", "adBlock" ], [ "", "showRemoveAdBlocker" ], [ "DOMContentLoaded", "document.createElement" ], [ "touchend", "clientheight" ] ], i = new Map([ [ "xchina.co", 0 ], [ "rjno1.com", 1 ], [ "linovelib.com", 2 ], [ "xiebruce.top", 3 ], [ "85tube.com", 4 ], [ "wap.yushuwu.cloud", 5 ] ]), s = new Map([]), c = (t, e, n) => {
        let r = e.get(t);
    ...
    for (const e of g) if (!u.has(e)) try {
        t(...o[e]);
    } catch {}
}();