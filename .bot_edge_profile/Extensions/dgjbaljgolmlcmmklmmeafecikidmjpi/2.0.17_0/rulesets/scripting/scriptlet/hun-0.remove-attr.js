!function() {
    function e(e = "", r = "", o = "") {
        ...
        !function(e, r) {
            ...
            g(), !1 !== /\bstay\b/.test(o) && new MutationObserver(d).observe(document, {
                attributes: !0,
                attributeFilter: s,
                childList: !0,
                subtree: !0
    ...
    const r = {}, o = [ [ "style", "body", "stay" ], [ "oncontextmenu" ], [ "href", '[href*="ad.adverticum.net"]' ], [ "class", 'section[class="life-section l-section-main article-section l-section-article"]' ], [ "style", "body" ] ], n = new Map([ [ "blikk.hu", 0 ], [ "lifestory.hu", 1 ], [ "mindmegette.hu", 2 ], [ "life.hu", 3 ], [ "sorozatwiki.hu", 4 ] ]), i = new Map([]), s = (e, t, r) => {
        let o = t.get(e);
