    ...
    function e(e = "", r = "", n = "") {
        ...
        a = !1 === isNaN(a) && isFinite(a) ? Math.min(Math.max(a, .001), 50) : .05, self.setTimeout = new Proxy(self.setTimeout, {
            apply: function(e, t, r) {
                const [n, o] = r;
                return -1 !== i && o !== i || !s.test(n.toString()) || (r[1] = o * a), e.apply(t, r);
            }
        });
    }
    const t = {}, r = [ [ "/userConsentProcess|this===/", "*", "0.001" ], [ "return t()", "*", "0.001" ], [ "userConsentProcessEnded", "*", "0.001" ], [ "setTimeoutIds_", "*", "0.001" ], [ '/userConsentProcessEnded|\\[0\\]\\+"With"/', "*", "0.001" ] ], n = new Map([ [ "marieclaire.fr", 0 ], [ "sudouest.fr", 1 ], [ "magicmaman.com", 2 ], [ "lessentiel.lu", 3 ], [ "20min.ch", 3 ], [ "cosmopolitan.fr", 4 ] ]), o = new Map([]), s = (e, t, r) => {
        let n = t.get(e);
