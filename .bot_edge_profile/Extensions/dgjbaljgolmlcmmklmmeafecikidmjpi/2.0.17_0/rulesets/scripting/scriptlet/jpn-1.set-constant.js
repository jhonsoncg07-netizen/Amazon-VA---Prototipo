!function() {
    function e(...e) {
        !function(e = !1, n = "", r = "") {
            ...
            function s(n, r) {
                ...
                let f = !1;
                const d = function(t) {
                    return !e && (!!f || (f = null != t && null != l && typeof t != typeof l, f && o.uboLog(i, `Aborted because value set to ${t}`), 
                    f));
                }, p = function(e, t, n, r) {
    ...
    const n = {}, r = [ [ "navigator.brave", "undefined" ], [ "google_tag_manager", "{}" ], [ "adsbygoogle.pageState", "1" ], [ "myFunc", "noopFunc" ], [ "adBlockerDetected", "false" ], [ "all520dddaaa2022ccc", "true" ], [ "flgDisplay", "false" ], [ "adsbygoogle.loaded", "true" ], [ "gptScriptLoaded", "true" ], [ "adBlockDetected", "noopFunc" ], [ "pum_vars", "undefined" ], [ "ads_data", "{}" ], [ "document.write", "noopFunc" ], [ "adPopupStatus", "false" ], [ "endInterstitialShow", "true" ], [ "geparams.custom.enableYdn", "" ], [ "PREMIUM", "true" ], [ "geoAvailable", "true" ], [ "FIRST_DELAY", "0" ], [ "NEXT_DELAY", "0" ], [ "sec", "0" ], [ "univresalP", "noopFunc" ], [ "isGGSurvey", "true" ], [ "enable_dl_after_countdown", "true" ], [ "SU_Api.AdsTimer", "-1" ], [ "TagProvider.cleanup", "noopFunc" ] ], o = new Map([ [ "rkd3.dev", 0 ], [ "aimomo.net", [ 1, 2 ] ], [ "in-jpn.com", 3 ], [ "oninet.ne.jp", 3 ], [ "xth.jp", 3 ], [ "egotter.com", 4 ], [ "520call.me", 5 ], [ "520cc.cc", 5 ], [ "coolpan.net", 6 ], [ "g-pc.info", 7 ], [ "intaa.net", 8 ], [ "h-ken.net", 9 ], [ "pictab.art", 10 ], [ "onagazou.info", 10 ], [ "fashionpost.jp", 11 ], [ "jav380.com", 12 ], [ "sukima.me", [ 13, 14, 15, 16 ] ], [ "sonae.sankei.co.jp", 17 ], [ "ponta.abstractpainting.work", [ 18, 19 ] ], [ "dotti2.jp", 20 ], [ "pochitto2.jp", 20 ], [ "gotouchi.jp", 20 ], [ "cmnw.jp", 20 ], [ "ddd-smart.net", 21 ], [ "ac-illust.com", [ 22, 23 ] ], [ "photo-ac.com", [ 22, 23 ] ], [ "silhouette-ac.com", [ 22, 23 ] ], [ "azby.fmworld.net", 24 ], [ "famitsu.com", 25 ] ]), i = new Map([]), c = (e, t, n) => {
        let r = t.get(e);
