!function() {
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", r = "", o = "") {
                ...
                if ("" === e) return;
                const s = t(), i = s.makeLogPrefix("abort-current-script", e, r, o), a = s.patternToRegex(r), c = s.patternToRegex(o), l = s.getExtraArgs(Array.from(arguments), 3), g = document.currentScript, d = s.String_split.call(e, ".");
                let f, u, p = window;
                for (;f = d.shift(), 0 !== d.length && f in p != 0; ) if (p = p[f], p instanceof Object == 0) return;
                let h = Object.getOwnPropertyDescriptor(p, f);
                h instanceof Object != 0 && h.get instanceof Function != 0 || (u = p[f], h = void 0), 
                function(e) {
                ...
                const b = function() {
                    ...
                    if (e === g) return;
                    if ("" !== o && !1 === c.test(e.src)) return;
                    s.logLevel > 1 && "" !== o && s.uboLog(i, `Matched src\n${e.src}`);
                    const t = v(e);
                    if (!1 !== a.test(t)) throw s.logLevel > 1 && s.uboLog(i, `Matched text\n${t}`), 
                    s.uboLog(i, "Aborted"), new ReferenceError(b);
                };
                try {
                    Object.defineProperty(p, f, {
                        get: function() {
                            return O(), h instanceof Object ? h.get.call(p) : u;
                        },
                        set: function(e) {
                            O(), h instanceof Object ? h.set.call(p, e) : u = e;
                        }
                    });
                } catch (e) {
                    s.uboErr(i, `Error: ${e}`);
    ...
    const n = {}, r = [ [ "disableEnterKey" ], [ "document.ondragstart" ], [ "advads_passive_placements" ], [ "document.oncontextmenu" ], [ "chp_adblock_browser" ], [ "monsterinsights_frontend" ], [ "advads" ], [ "advanced_ads" ] ], o = new Map([ [ "discoveringtheplanet.com", [ 0, 1 ] ], [ "kandisvarlden.com", [ 0, 3 ] ], [ "hejaolika.se", 2 ], [ "spelhubben.se", 3 ], [ "husbilsplats.se", 3 ], [ "temadagar.se", 4 ], [ "zeinaskitchen.se", 5 ], [ "trafiksakerhet.se", 5 ], [ "boktugg.se", 5 ], [ "lakartidningen.se", 5 ], [ "villalivet.se", [ 5, 6, 7 ] ], [ "matsafari.nu", 5 ], [ "forexgruppen.se", 5 ], [ "fastighetsvarlden.se", 5 ], [ "aktieskolan.se", 5 ], [ "alekuriren.se", [ 6, 7 ] ], [ "rocknytt.net", [ 6, 7 ] ], [ "upphandling24.se", [ 6, 7 ] ], [ "datormagazin.se", [ 6, 7 ] ], [ "polistidningen.se", [ 6, 7 ] ], [ "densistavilan.se", [ 6, 7 ] ], [ "classicmotor.se", [ 6, 7 ] ], [ "tidningenhalsa.se", [ 6, 7 ] ], [ "husohem.se", [ 6, 7 ] ], [ "guiden.se", [ 6, 7 ] ], [ "nyadagbladet.se", [ 6, 7 ] ], [ "enkelteknik.se", [ 6, 7 ] ], [ "vadhanderisverige.se", [ 6, 7 ] ], [ "passioneffect.se", [ 6, 7 ] ], [ "livsmedelsnyheter.se", [ 6, 7 ] ] ]), s = new Map([]), i = (e, t, n) => {
        let r = t.get(e);
