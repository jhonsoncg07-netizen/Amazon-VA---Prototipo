!function() {
    function e(e = "") {
        ...
        const a = () => {
            o.String_split.call(document.cookie, ";").forEach((e => {
                ...
                let d, l;
                if (c) d = `; domain=${c}`, l = `; domain=.${c}`; else if (document.domain) {
                ...
                void 0 !== d && (document.cookie = r + d + g + p), void 0 !== l && (document.cookie = r + l + g + p);
            }));
        };
        if (a(), window.addEventListener("beforeunload", a), "string" != typeof r.when) return;
        const d = [ "scroll", "keydown" ], l = o.String_split.call(r.when, /\s/);
    ...
    const t = {}, o = [ [ "/^ev_did|ev_sid/" ], [ "article_count" ], [ "read_articles" ], [ "wordpress_sezz_id" ] ], n = new Map([ [ "synonymer.se", 0 ], [ "tidningensyre.se", [ 1, 2, 3 ] ], [ "landetsfria.nu", [ 1, 2, 3 ] ], [ "fempers.se", [ 1, 2, 3 ] ], [ "tidningenglobal.se", [ 1, 2, 3 ] ] ]), r = new Map([]), i = (e, t, o) => {
        let n = t.get(e);
    ...
    for (const t of a) if (!d.has(t)) try {
        e(...o[t]);
    } catch {}
}();