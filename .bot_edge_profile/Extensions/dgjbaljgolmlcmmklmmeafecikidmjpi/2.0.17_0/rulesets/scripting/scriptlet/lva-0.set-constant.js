!function() {
    ...
    const n = {}, r = [ [ "window.LIEPAJNIEKIEM_ADBLOCK", "null" ], [ "window.LIEPAJNIEKIEM_ADBLOCK_COUNTER", "999" ], [ "window.LIEPAJNIEKIEM_HAS_ADBLOCK", "0" ], [ "window.liepajniekiemStats.event", "function() {}" ] ], o = new Map([ [ "liepajniekiem.lv", [ 0, 1, 2, 3 ] ] ]), i = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
