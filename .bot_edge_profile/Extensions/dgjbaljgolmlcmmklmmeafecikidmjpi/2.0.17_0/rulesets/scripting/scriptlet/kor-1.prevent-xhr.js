!function() {
    function e(...e) {
        return function(e = !1, n = "", o = "") {
            ...
            const s = t(), a = e ? "trusted-prevent-xhr" : "prevent-xhr", i = s.makeLogPrefix(a, n, o), p = new WeakMap, c = function(e, r = "") {
                const n = t(), o = new Map;
                ...
                for (const t of n.String_split.call(e, /\s+/)) {
                    let [e, a] = n.String_split.call(t, ":");
                    "" !== e && (void 0 !== a && /[^$\w -]/.test(e) && (e = `${e}:${a}`, a = void 0), 
                    void 0 !== a ? o.set(e, n.initPattern(a, s)) : "" !== r && o.set(r, n.initPattern(e, s)));
                }
                return o;
            ...
            self.XMLHttpRequest = class extends self.XMLHttpRequest {
                open(e, r, ...a) {
                    if (p.delete(this), void 0 !== l && r.startsWith(l)) return super.open(e, r, ...a);
                    const u = {
                        method: e,
                        url: r
                    };
                    if ("" === n && "" === o) return s.uboLog(i, `Called: ${s.JSON_stringify(u, null, 2)}`), 
                    super.open(e, r, ...a);
                    if (function(e, ...r) {
                        const n = t(), o = [];
                ...
                send(...n) {
                      ...
                      default:
                        ...
                        c = function(e, n) {
                            ...
                            return n.startsWith("war:") ? void 0 === r.warOrigin ? "" : new Promise((e => {
                                ...
                                const a = new o.XMLHttpRequest;
                                a.responseType = "text", a.onloadend = t => {
                                    e(t.target.responseText || "");
                                }, a.open("GET", t.join("")), a.send();
                            })).catch((() => "")) : e ? n : "";
                        }(e, a.directive), c instanceof Promise ? c = c.then((e => {
                            a.props.response.value = e, a.props.responseText.value = e;
                        })) : (a.props.response.value = c, a.props.responseText.value = c), a.headers["content-type"] = "text/plain";
                    }
                    ...
                    Promise.resolve(c).then((() => a)).then((e => (Object.defineProperties(e.xhr, {
                        readyState: {
                            value: 1,
                            configurable: !0
                        },
                    ...
                    }), u(e.xhr, "readystatechange"), e))).then((e => (a.headers["content-length"] = `${e.props.response.value}`.length, 
                    Object.defineProperties(e.xhr, {
                        ...
                        }), u(e.xhr, "readystatechange"), u(e.xhr, "load"), u(e.xhr, "loadend"), s.uboLog(i, `Prevented with response:\n${e.xhr.response}`);
                    }));
                }
                getResponseHeader(e) {
                    const t = p.get(this);
