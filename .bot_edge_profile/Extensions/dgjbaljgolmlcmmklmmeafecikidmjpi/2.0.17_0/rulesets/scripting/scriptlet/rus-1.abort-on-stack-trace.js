!function() {
    function e(e = "", o = "") {
        ...
        const i = n(), s = i.initPattern(o, {
            canNegate: !0
        }), c = i.getExtraArgs(Array.from(arguments), 2);
        "" === o && (c.log = "all");
        const a = function(e, n) {
            ...
            if (-1 === o) {
                ...
                return void Object.defineProperty(e, n, {
                    get: function() {
                        ...
                        if (r(s, e)) throw new ReferenceError(t());
                        return o;
                    },
                    set: function(e) {
                        const n = i.logLevel > 1 ? "all" : "match";
                        if (r(s, n)) throw new ReferenceError(t());
                        o = e;
                    }
                });
            }
            const c = n.slice(0, o);
            let l = e[c];
            if (n = n.slice(o + 1), l) return void a(l, n);
            const g = Object.getOwnPropertyDescriptor(e, c);
            g && void 0 !== g.set || Object.defineProperty(e, c, {
                get: function() {
                    return l;
                },
                set: function(e) {
    ...
    function r(e, r = "") {
        const o = n(), i = t(), s = new o.Error(i), c = new URL(self.location.href);
        c.hash = "";
        const a = /(.*?@)?(\S+)(:\d+):\d+\)?$/, l = [];
        for (let e of o.String_split.call(s.stack, /[\n\r]+/)) {
            if (e.includes(i)) continue;
            e = e.trim();
            const t = o.RegExp_exec.call(a, e);
            if (null === t) continue;
            let r = t[2];
            r.startsWith("(") && (r = r.slice(1)), r === c.href ? r = "inlineScript" : r.startsWith("<anonymous>") && (r = "injectedScript");
        ...
        const g = l.join("\t"), f = !0 !== e.matchAll && o.testPattern(e, g);
        return ("all" === r || "match" === r && f || "nomatch" === r && !f) && o.uboLog(g.replace(/\t/g, "\n")), 
        f;
    }
    function n() {
    ...
    const o = {}, i = [ [ "document.head.appendChild", "inlineScript" ], [ "Object.prototype.getBaseFingerprint", "inlineScript" ] ], s = new Map([ [ "game4you.top", 0 ], [ "innal.top", 0 ], [ "naylo.top", 0 ], [ "rustorka.com", 0 ], [ "rustorka.net", 0 ], [ "rustorka.top", 0 ], [ "rustorkacom.lib", 0 ], [ "avtorambler.*", 1 ], [ "championat.*", 1 ], [ "eda.*", 1 ], [ "gazeta.ru", 1 ], [ "lenta.*", 1 ], [ "letidor.*", 1 ], [ "moslenta.*", 1 ], [ "motor.*", 1 ], [ "passion.*", 1 ], [ "quto.*", 1 ], [ "rambler.*", 1 ], [ "wmj.*", 1 ], [ "www.afisha.*", 1 ] ]), c = new Map([ [ "id.rambler.ru", [ 1 ] ], [ "mail.rambler.*", [ 1 ] ], [ "quiz.rambler.ru", [ 1 ] ], [ "vp.rambler.ru", [ 1 ] ] ]), a = (e, t, r) => {
        let n = t.get(e);
    ...
    for (const t of f) if (!p.has(t)) try {
        e(...i[t]);
    } catch {}
}();