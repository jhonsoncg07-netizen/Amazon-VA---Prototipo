!function() {
    function e(e = "", n = "", r = "") {
        const i = function() {
            ...
            return t;
        }(), s = i.makeLogPrefix("no-window-open-if", e, n, r), c = !1 === e.startsWith("!");
        !1 === c && (e = e.slice(1));
        const l = i.patternToRegex(e), a = 1e3 * (parseFloat(n) || 0), p = self.setTimeout, g = function(e, t, o) {
        ...
        t("open", (function(t) {
            if ("debug" === e && 0 !== i.logLevel) return t.reflect();
            const {callArgs: o} = t, u = o.join(" ");
            if (l.test(u) !== c) return i.logLevel > 1 && i.uboLog(s, `Allowed (${o.join(", ")})`), 
            t.reflect();
            if (i.uboLog(s, `Prevented (${o.join(", ")})`), "" === n) return null;
            if ("blank" === r) {
                o[0] = "about:blank";
                const e = t.reflect();
                return p((() => {
            ...
            let h = ("obj" === r ? g("object", "data", ...o) : g("iframe", "src", ...o)).contentWindow;
            return "object" == typeof h && null !== h ? Object.defineProperty(h, "closed", {
                value: !1
            }) : h = new Proxy(self, {
                get: function(e, t, ...o) {
                    if ("closed" === t) return !1;
                    const n = Reflect.get(e, t, ...o);
                    return "function" == typeof n ? f : n;
                },
                set: function(...e) {
                ...
                get: function(e, t, ...o) {
                    const n = Reflect.get(e, t, ...o);
                    return i.uboLog(s, `popup / get ${t} === ${n}`), "function" == typeof n ? (...t) => n.call(e, ...t) : n;
                },
                set: function(e, t, o, ...n) {
                    return i.uboLog(s, `popup / set ${t} = ${o}`), Reflect.set(e, t, o, ...n);
                }
            })), h;
        }));
    }
    function t(e = "", o = "") {
        ...
        i.prototype?.constructor === i && (l.construct = function(e, n) {
            return o(t.CtorContext.factory(e, n));
        }), n[r] = new Proxy(i, l);
    }
    const o = {}, n = [ [], [ "bit.ly" ] ], r = new Map([ [ "erosfilmizle.*", 0 ], [ "rcjza2fzqyr4.buzz", 0 ], [ "breakingbadizle.*", 0 ], [ "elzemfilm.org", 0 ], [ "jetfilmizle.*", 0 ], [ "movietube32.xyz", 0 ], [ "turkerotikfilm.com", 0 ], [ "izleorg3.org", 0 ], [ "youtubemp3.us", 0 ], [ "epikplayer.xyz", 0 ], [ "animeler.me", 0 ], [ "player.filmizle.in", 0 ], [ "tranimaci.com", 0 ], [ "izlekolik.org", 0 ], [ "4kfilmizlesene.*", 0 ], [ "pchocasi.com.tr", 1 ] ]), i = new Map([]), s = (e, t, o) => {
        let n = t.get(e);
    ...
    for (const t of a) if (!p.has(t)) try {
        e(...n[t]);
    } catch {}
}();