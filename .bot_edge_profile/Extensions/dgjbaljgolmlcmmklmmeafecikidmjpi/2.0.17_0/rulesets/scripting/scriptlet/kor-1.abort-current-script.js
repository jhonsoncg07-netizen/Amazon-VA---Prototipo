    ...
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", n = "", r = "") {
                ...
                if ("" === e) return;
                const c = t(), i = c.makeLogPrefix("abort-current-script", e, n, r), s = c.patternToRegex(n), a = c.patternToRegex(r), l = c.getExtraArgs(Array.from(arguments), 3), g = document.currentScript, p = c.String_split.call(e, ".");
                let u, d, f = window;
                for (;u = p.shift(), 0 !== p.length && u in f != 0; ) if (f = f[u], f instanceof Object == 0) return;
                let m = Object.getOwnPropertyDescriptor(f, u);
                m instanceof Object != 0 && m.get instanceof Function != 0 || (d = f[u], m = void 0), 
                function(e) {
                ...
                try {
                    Object.defineProperty(f, u, {
                        get: function() {
                            return O(), m instanceof Object ? m.get.call(f) : d;
                        },
                        set: function(e) {
                            O(), m instanceof Object ? m.set.call(f, e) : d = e;
                        }
                    });
                } catch (e) {
                    c.uboErr(i, `Error: ${e}`);
