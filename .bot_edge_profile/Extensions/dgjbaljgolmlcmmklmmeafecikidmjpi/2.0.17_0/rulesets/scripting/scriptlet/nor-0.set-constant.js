!function() {
    ...
    const n = {}, r = [ [ "showAd", "false" ], [ "adblock", "false" ], [ "adblockEnabled", "noopFunc" ], [ "trackAdblock", "noopFunc" ], [ "adblockerAlert", "noopFunc" ], [ "__INITIAL_STATE__.features.should-show-snow", "false" ], [ "ads", "emptyObj" ] ], o = new Map([ [ "blogg.no", 0 ], [ "techstart.dk", 1 ], [ "gamereactor.*", [ 2, 3 ] ], [ "connery.dk", 4 ], [ "spleis.no", 5 ], [ "gamer.no", 6 ] ]), i = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
