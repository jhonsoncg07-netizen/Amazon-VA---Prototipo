!function() {
    function e(e, n, ...r) {
        !function(e = "", n = "", r = "") {
            const o = t(), i = o.makeLogPrefix("replace-node-text.fn", ...Array.from(arguments)), s = o.patternToRegex(e, "i", !0), c = o.patternToRegex(n, "gms"), a = o.getExtraArgs(Array.from(arguments), 3), l = a.includes || a.condition ? o.patternToRegex(a.includes || a.condition, "ms") : null, d = a.excludes ? o.patternToRegex(a.excludes, "ms") : null, g = (e = !0) => {
            ...
            const f = e => {
                ...
                c.lastIndex = 0;
                const s = "" !== n ? t.replace(c, r) : r;
                return e.textContent = "SCRIPT" === e.nodeName ? u.createScript(s) : s, o.logLevel > 1 && o.uboLog(i, `Text before:\n${t.trim()}`), 
    ...
    const n = {}, r = [ [ "script", "ad_block" ], [ "#text", "reklam_linki" ], [ "script", "pbrk" ], [ "script", "openRandomSite" ] ], o = new Map([ [ "birsenaltuntas.com", 0 ], [ "bugunkibris.com", 1 ], [ "sinema.*", 2 ], [ "efullizle.com", 3 ] ]), i = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
