!function() {
    function e(e, r, n, ...s) {
        !function(e = "", r = "", n = "") {
            if ("" === e) return;
            const s = t(), i = s.makeLogPrefix("set-cookie", e, r, n), c = r.toLowerCase(), a = /^("?)(.+)\1$/.exec(c), d = a && a[2] || c;
            ...
            const l = function(e = !1, t = "", r = "", n = "", s = "", i = {}) {
    ...
    for (const t of l) if (!h.has(t)) try {
        e(...n[t]);
    } catch {}
}();