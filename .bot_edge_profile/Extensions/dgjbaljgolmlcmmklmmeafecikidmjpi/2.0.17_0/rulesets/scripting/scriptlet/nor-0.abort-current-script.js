!function() {
    ...
    const r = {}, n = [ [ "dfpConfig", "loadAds" ], [ "adblockDetector" ], [ "AdsReloadConfig" ], [ "EventTarget.prototype.addEventListener", "window.TextDecoder" ] ], o = new Map([ [ "gamer.no", 0 ], [ "tu.no", 0 ], [ "tv2.no", 1 ], [ "gamereactor.*", 2 ], [ "bold.dk", 3 ] ]), i = new Map([]), c = (e, t, r) => {
        let n = t.get(e);
