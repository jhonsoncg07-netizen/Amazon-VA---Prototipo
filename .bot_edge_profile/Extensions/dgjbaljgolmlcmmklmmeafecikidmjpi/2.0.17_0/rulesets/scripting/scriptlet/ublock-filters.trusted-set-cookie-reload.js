!function() {
    function e(e, r, n, s, ...i) {
        !function(e = "", r = "", n = "", s = "") {
            if ("" === e) return;
            const i = t(), c = i.makeLogPrefix("set-cookie", e, r, s), a = new Date;
            r.includes("$now$") && (r = r.replaceAll("$now$", a.getTime())), r.includes("$currentDate$") && (r = r.replaceAll("$currentDate$", a.toUTCString())), 
            r.includes("$currentISODate$") && (r = r.replaceAll("$currentISODate$", a.toISOString()));
            let l = "";
            if ("" !== n) {
                if ("1day" === n) a.setDate(a.getDate() + 1); else if ("1year" === n) a.setFullYear(a.getFullYear() + 1); else {
                    if (!1 === /^\d+$/.test(n)) return;
                    a.setSeconds(a.getSeconds() + parseInt(n, 10));
                }
                l = a.toUTCString();
            }
            const g = function(e = !1, t = "", r = "", n = "", s = "", i = {}) {
            ...
            }(!0, e, r, l, s, t().getExtraArgs(Array.from(arguments), 4));
            g && i.uboLog(c, "Done");
        }(e, r, n, s, "reload", "1", ...i);
    }
    function t() {
    ...
    const r = {}, n = [ [ "godbayadblock", "godbayadblock" ] ], s = new Map([ [ "game4you.top", 0 ], [ "innal.top", 0 ], [ "naylo.top", 0 ], [ "rustorka.com", 0 ], [ "rustorka.net", 0 ], [ "rustorka.top", 0 ], [ "rustorkacom.lib", 0 ] ]), i = new Map([]), c = (e, t, o) => {
        let r = t.get(e);
