!function() {
    function e(e = "") {
        ...
        if ("" === e) return;
        const r = t(), n = r.makeLogPrefix("abort-on-property-write", e), o = function() {
            const e = function() {
                const e = t();
    ...
    const r = {}, n = [ [ "checkAdsStatus" ], [ "adregain_wall" ], [ "adblock" ], [ "ai_front" ], [ "redirectpage" ], [ "exopop" ], [ "protData" ], [ "pUrlArray" ], [ "pfcu1" ], [ "anuncioConfig" ], [ "setRandomBanner" ] ], o = new Map([ [ "firepaste.com", 0 ], [ "tunovelaligera.com", 1 ], [ "manga-mx.com", 2 ], [ "meuwindows.com", 3 ], [ "animesbr.cc", 4 ], [ "superhq.net", [ 5, 6 ] ], [ "hentaikai.com", 6 ], [ "raulprietofernandez.net", 7 ], [ "mrpiracy.top", 8 ], [ "dragonball.sullca.com", [ 9, 10 ] ] ]), i = new Map([]), s = (e, t, r) => {
        let n = t.get(e);
