!function() {
    function e(...e) {
        !function(e) {
            ...
            !function(e = "", r = "", o = "") {
                ...
                if ("" === e) return;
                const i = t(), c = i.makeLogPrefix("abort-current-script", e, r, o), s = i.patternToRegex(r), a = i.patternToRegex(o), l = i.getExtraArgs(Array.from(arguments), 3), g = document.currentScript, f = i.String_split.call(e, ".");
                let d, p, u = window;
                for (;d = f.shift(), 0 !== f.length && d in u != 0; ) if (u = u[d], u instanceof Object == 0) return;
                let h = Object.getOwnPropertyDescriptor(u, d);
                h instanceof Object != 0 && h.get instanceof Function != 0 || (p = u[d], h = void 0), 
                function(e) {
                ...
                try {
                    Object.defineProperty(u, d, {
                        get: function() {
                            return x(), h instanceof Object ? h.get.call(u) : p;
                        },
                        set: function(e) {
                            x(), h instanceof Object ? h.set.call(u, e) : p = e;
                        }
                    });
                } catch (e) {
                    i.uboErr(c, `Error: ${e}`);
    ...
    const n = {}, r = [ [ "decodeURIComponent", "newAdblockBoardDisplayed" ], [ "addEventListener", "/faBar[\\s\\S]*?insertAdjacentElement/" ], [ "$", "/loadData|halfpage|welcome|screening|placement|adtitle/" ], [ "billboard750" ], [ "jQuery", "#sdWelcomeScreen" ], [ "$", "#AdPopup" ], [ "document.querySelectorAll", "popMagic" ], [ "Math.random" ] ], o = new Map([ [ "filmweb.pl", [ 0, 1 ] ], [ "naekranie.pl", 2 ], [ "czasdzieci.pl", 3 ], [ "hdtvpolska.com", 4 ], [ "tubagliwic.pl", 5 ], [ "tubawyszkowa.pl", 5 ], [ "filmy69.pl", 6 ], [ "otube.pl", 7 ] ]), i = new Map([]), c = (e, t, n) => {
        let r = t.get(e);
