!function() {
    ...
    const o = {}, r = [ [ "DOMContentLoaded", "/window\\.getComputedStyle|adblock-/" ], [ "adBlockerOn" ], [ "load", "banner-ads" ], [ "load", "detect-modal" ], [ "", "_0x" ], [ "detectAdBlock" ], [ "load", "daadb_get_data" ], [ "DOMContentLoaded", "document.write" ], [ "", "popunder" ], [ "click", "loadXMLDoc" ], [ "mousedown", "touchend" ], [ "load", "/_0x[\\s\\S]*?parentNode[\\s\\S]*?appendChild/" ], [ "DOMContentLoaded", "videoTag" ], [ "click", "Popunder" ], [ "", "/abrirVentanasEmergentes|abrirNuevaVentana|Popunder/" ], [ "click", "manejar" ], [ "click", "window.open" ] ], i = new Map([ [ "guiavidaesaude.com", 0 ], [ "canal12.com.sv", 1 ], [ "depor.com", 2 ], [ "softwareany.net", 3 ], [ "xerifetech.com", 4 ], [ "guideautoweb.com", 5 ], [ "empregoestagios.com", 6 ], [ "satcesc.com", 6 ], [ "g37.com.br", 7 ], [ "desenhosanimados.site", 8 ], [ "mundohentaioficial.com", 8 ], [ "descargarhentaimf.xyz", 9 ], [ "superflix.net", 10 ], [ "irmaosdotados.net", 11 ], [ "comandotorrents.org", 12 ], [ "animeonline.lat", 13 ], [ "megafire.net", 14 ], [ "firepaste.com", 14 ], [ "seriesperu.com", 15 ], [ "peliculas8k.com", 15 ], [ "allcalidad.pro", 16 ] ]), s = new Map([]), a = (e, t, n) => {
        let o = t.get(e);
