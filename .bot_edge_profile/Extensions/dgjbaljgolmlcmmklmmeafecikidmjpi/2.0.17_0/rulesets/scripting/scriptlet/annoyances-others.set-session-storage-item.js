!function() {
    ...
    const t = {}, n = [ [ "sem30_popup_shown", "1" ], [ "signUpBannerDismissed", "true" ], [ "shouldShowAuthBannerAfterQuery", "false" ], [ "oai/apps/noAuthHasDismissedSoftRateLimitModal", "true" ], [ "modalViewed", "true" ] ], r = new Map([ [ "semrush.com", 0 ], [ "perplexity.ai", [ 1, 2 ] ], [ "chatgpt.com", 3 ], [ "fantasyfootballhub.co.uk", 4 ] ]), o = new Map([]), s = (e, t, n) => {
        let r = t.get(e);
