!function() {
    var dependencies, resolveDependencies, getArguments, factory, CSS_common = "/*! normalize.css v3.0.1 | MIT License | git.io/normalize */html{font-family:sans-serif;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%}body{margin:0}article,aside,details,figcaption,figure,footer,header,hgroup,main,nav,section,summary{display:block}audio,canvas,progress,video{display:inline-block;vertical-align:baseline}audio:not([controls]){display:none;height:0}[hidden],template{display:none}a{background:0 0}a:active,a:hover{outline:0}abbr[title]{border-bottom:1px dotted}b,strong{font-weight:700}dfn{font-style:italic}h1{font-size:2em;margin:.67em 0}mark{background:#ff0;color:#000}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sup{top:-.5em}sub{bottom:-.25em}img{border:0}svg:not(:root){overflow:hidden}figure{margin:1em 40px}hr{box-sizing:content-box;height:0}pre{overflow:auto}code,kbd,pre,samp{font-family:monospace,monospace;font-size:1em}button,input,optgroup,select,textarea{color:inherit;font:inherit;margin:0}button{overflow:visible}button,select{text-transform:none}button,html input[type=button],input[type=reset],input[type=submit]{-webkit-appearance:button;cursor:pointer}button[disabled],html input[disabled]{cursor:default}button::-moz-focus-inner,input::-moz-focus-inner{border:0;padding:0}input{line-height:normal}input[type=checkbox],input[type=radio]{box-sizing:border-box;padding:0}input[type=number]::-webkit-inner-spin-button,input[type=number]::-webkit-outer-spin-button{height:auto}input[type=search]{-webkit-appearance:textfield;box-sizing:content-box}input[type=search]::-webkit-search-cancel-button,input[type=search]::-webkit-search-decoration{-webkit-appearance:none}fieldset{border:1px solid silver;margin:0 2px;padding:.35em .625em .75em}legend{border:0;padding:0}textarea{overflow:auto}optgroup{font-weight:700}table{border-collapse:collapse;border-spacing:0}td,th{padding:0}*{box-sizing:border-box}:after,:before{box-sizing:border-box}html{font-size:10px;-webkit-tap-highlight-color:transparent}body{position:relative;background:#fff;font-size:1.3rem;line-height:1.428571429;color:#282828;background-color:#e6e6e6;font-family:\"Open Sans\",Arial,sans-serif;font-weight:400;overflow-y:hidden}button,input,select,textarea{font-family:inherit;font-size:inherit;line-height:inherit;outline:0;border-radius:0;box-shadow:none}a{color:#36ba53;text-decoration:underline;outline:0}a:hover{color:#257f39;text-decoration:underline}figure{margin:0}img{vertical-align:middle;max-width:100%}form{margin:0}fieldset{padding:0;margin:0;border:0;min-width:0}legend{display:block;width:100%;padding:0;margin-bottom:1.57142857;font-size:21px;line-height:inherit;border:0}label{display:inline-block}input[type=search]{box-sizing:border-box}input[type=checkbox],input[type=radio]{display:none}input[type=checkbox]:focus,input[type=file]:focus,input[type=radio]:focus{outline:thin dotted;outline:5px auto -webkit-focus-ring-color;outline-offset:-2px}.form-control{display:block;width:100%;height:40px;padding:6px 15px 4px;font-size:14px;line-height:22px;color:#333;background:#fff;border:1px solid #e6e6e6;box-shadow:inset 0 3px 3px rgba(0,0,0,.04)}.form-control:focus{border-color:#8c8c8c;outline:0}.form-control::-moz-placeholder{color:#777;opacity:1}.form-control:-ms-input-placeholder{color:#777}.form-control::-webkit-input-placeholder{color:#777}.form-control[disabled],.form-control[readonly],fieldset[disabled] .form-control{cursor:not-allowed;background-color:#fff;opacity:1}textarea.form-control{height:auto}input[type=search]{-webkit-appearance:none}input[type=date],input[type=datetime-local],input[type=month],input[type=time]{line-height:22px}.form-group{margin:23px 0 0}.form-group:first-child{margin-top:0}fieldset[disabled] input[type=checkbox],fieldset[disabled] input[type=radio],input[type=checkbox].disabled,input[type=checkbox][disabled],input[type=radio].disabled,input[type=radio][disabled]{cursor:not-allowed}@font-face{font-family:'Open Sans';src:url(data:application/font-woff;base64,) format('woff');font-weight:400;font-style:normal}@font-face{font-family:'Open Sans';src:url(data:application/font-woff;base64,) format('woff');font-weight:600;font-style:normal}@font-face{font-family:'Open Sans';src:url(data:application/font-woff;base64,) format('woff');font-weight:700;font-style:normal}.weight-regular{font-family:\"Open Sans\",Arial,sans-serif;font-weight:400}.weight-medium{font-family:\"Open Sans\",Arial,sans-serif;font-weight:600}.weight-bold{font-family:\"Open Sans\",Arial,sans-serif;font-weight:700}.form-ui{position:relative;display:inline-block;vertical-align:top;margin:0;line-height:20px;font-weight:400;cursor:pointer}.form-ui-control{position:absolute;top:-9999px;left:-9999px;width:0;height:0;overflow:hidden;clip:rect(0,0,0,0);outline:0 none}.form-ui-txt{position:relative;display:inline-block;vertical-align:top;padding:2px 0 0 30px}.form-ui-txt:before{content:'';position:absolute;top:0;left:0;width:22px;height:22px}.form-ui-txt:after{content:'';position:absolute}input[type=radio]+.form-ui .form-ui-txt:before{border:1px solid #cfcfcf;border-radius:50%;background:#fff}input[type=radio]+.form-ui .form-ui-txt:after{top:7px;left:7px;width:8px;height:8px;border-radius:50%}input[type=radio]:checked+.form-ui .form-ui-txt:after{background:#36ba53}input[type=radio]:disabled+.form-ui .form-ui-txt:before{background:#f2f2f2;opacity:.6}input[type=radio]:disabled+.form-ui .form-ui-txt:after{opacity:.6}input[type=checkbox]+.form-ui .form-ui-txt:before{border:1px solid #cfcfcf;background:#fff}input[type=checkbox]+.form-ui .form-ui-txt:after{top:7px;left:5px;width:13px;height:6px;border-bottom:2px solid transparent;border-left:2px solid transparent;-ms-transform:rotate(-45deg);transform:rotate(-45deg)}input[type=checkbox]:checked+.form-ui .form-ui-txt:before{border:1px solid #36ba53;background:#36ba53}input[type=checkbox]:checked+.form-ui .form-ui-txt:after{border-bottom-color:#fff;border-left-color:#fff}input[type=checkbox]:disabled+.form-ui .form-ui-txt:before{opacity:.6}input[type=checkbox]:disabled+.form-ui .form-ui-txt:after{opacity:.6}.btn{display:inline-block;margin-bottom:0;padding:10px 20px;font-size:13px;line-height:18px;text-align:center;text-decoration:none;vertical-align:middle;cursor:pointer;background-image:none;border:1px solid transparent;white-space:nowrap;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.btn:hover{color:#000;text-decoration:none}.btn.active,.btn:active{outline:0}.btn:focus{outline:0;box-shadow:inset 0 0 0 1px #fff}.btn.disabled,.btn[disabled]{cursor:default;box-shadow:none;opacity:.5;pointer-events:none}.btn-default{border-color:#58595b;background:#58595b;color:#fff}.btn-default:hover{border-color:#717275;background:#717275;color:#fff}.btn-default.active,.btn-default:active{border-color:#717275;background:#717275}.btn-default.disabled,.btn-default[disabled]{border-color:#58595b;background:#58595b}.btn-primary{border-color:#36ba53;background:#36ba53;color:#fff}.btn-primary:hover{border-color:#30a64a;background:#30a64a;color:#fff}.btn-primary.active,.btn-primary:active{border-color:#30a64a;background:#30a64a}.btn-primary.disabled,.btn-primary[disabled]{border-color:#36ba53;background:#36ba53}@media (max-width:320px){.btn-another-el{font-size:9px;padding-left:0;padding-right:0;background-color:transparent;border:0;color:#000}.btn-another-el:hover{border-color:transparent;background:0 0;color:#000}}.btn-cancel{border-color:#f3523d;background:#f3523d;color:#fff}.btn-cancel:hover{border-color:#ee290f;background:#ee290f;color:#fff}.btn-cancel.active,.btn-cancel:active{border-color:#ee290f;background:#ee290f}.btn-cancel.disabled,.btn-cancel[disabled]{border-color:#f3523d;background:#f3523d}.btn-lg{font-size:20px;padding:14px 24px 12px}.btn-sm{font-size:16px;padding-top:14px;padding-bottom:14px}.btn-xs{font-size:14px;padding-top:12px;padding-bottom:12px}.btn-block{display:block;width:100%;padding-left:0;padding-right:0}.btn-block+.btn-block{margin-top:5px}input[type=button].btn-block,input[type=reset].btn-block,input[type=submit].btn-block{width:100%}.btn-upload{position:relative;overflow:hidden}.btn-upload input[type=file]{position:absolute;top:0;right:0;margin:0;font-size:600%;line-height:600%;width:auto;height:auto;opacity:0;cursor:pointer}", CSS_button = ':host{display:block!important;position:relative!important;width:0!important;height:0!important;margin:0!important;padding:0!important;z-index:2147483647!important}:host ::after,:host ::before{display:none!important}.adguard-assistant-button-main-logo{background-image:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0A%3Csvg%20viewBox%3D%220%200%2035%2036%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%0A%20%20%20%20%3Cg%20stroke%3D%22none%22%20stroke-width%3D%221%22%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%20transform%3D%22translate(-164.000000%2C%20-219.000000)%22%3E%0A%20%20%20%20%20%20%20%20%3Cg%20id%3D%223%22%20transform%3D%22translate(40.000000%2C%20190.000000)%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cg%20transform%3D%22translate(124.500000%2C%2029.414062)%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cg%20transform%3D%22translate(0.453656%2C%200.226828)%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cg%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cg%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20d%3D%22M16.7157492%2C0%20C11.4909195%2C0%205.18846877%2C1.26558351%205.12620114e-06%2C4.05122239%20C5.12620114e-06%2C10.0674495%20-0.0716136324%2C25.0556925%2016.7157492%2C35.2966798%20C33.503483%2C25.0556925%2033.4322354%2C10.0674495%2033.4322354%2C4.05122239%20C28.2434006%2C1.26558351%2021.9409499%2C0%2016.7157492%2C0%20L16.7157492%2C0%20Z%22%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20id%3D%22Path%22%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20fill%3D%22%2368BC71%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%20d%3D%22M16.6986743%2C35.2862582%20C-0.0715650605%2C25.0455268%205.12620113e-06%2C10.0654091%205.12620113e-06%2C4.05122239%20C5.18281802%2C1.26861734%2011.4771929%2C0.00275849124%2016.6986743%2C4.50378311e-06%20L16.6986743%2C35.2862617%20Z%22%20id%3D%22Combined-Shape%22%20fill%3D%22%2367B279%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20d%3D%22M16.1060247%2C23.551094%20L26.2143155%2C9.51801869%20C25.4736005%2C8.90647249%2024.8238876%2C9.33808916%2024.4662281%2C9.672244%20L24.4531774%2C9.67331501%20L16.0248987%2C18.7044208%20L12.8493477%2C14.7681053%20C11.3344091%2C12.96524%209.27486866%2C14.3404157%208.79375662%2C14.7038448%20L16.1060247%2C23.551094%22%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20id%3D%22Fill-11%22%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20fill%3D%22%23FFFFFF%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%3C%2Fg%3E%0A%3C%2Fsvg%3E%0A")!important}.adguard-alert{cursor:pointer;left:0;top:0;position:fixed!important;z-index:2147483647!important;width:40px!important;height:40px!important;zoom:1!important;display:inline-block!important;margin:0!important;border:0!important;padding:0!important;will-change:transform;opacity:1;touch-action:none;-ms-touch-action:none;visibility:visible!important;min-height:auto!important;max-height:auto!important;min-width:auto!important;max-width:auto!important;background-size:21px!important;background-position:center center!important;background-repeat:no-repeat!important;background-color:#fff!important;border:none!important;box-shadow:0 0 10px 3px rgba(162,161,161,.3)!important;border-radius:100%!important;transition:background-color .3s ease}.adguard-alert.sg_hide_element{display:none!important}.adguard-alert.logo-small{width:24px!important;height:24px!important;background-position:50% 6px!important;background-size:14px!important}.adguard-alert:hover{background-color:#ccf0d4!important}@media print{.adguard-alert{display:none!important}}.adguard-assistant-button-right{left:auto;right:0}.adguard-assistant-button-left{left:0;right:auto}.adguard-assistant-button-top{top:0;bottom:auto}.adguard-assistant-button-bottom{top:auto;bottom:0}.adguard-assistant-button-top.adguard-assistant-button-left{left:0;right:auto;transform:translate3d(10px,10px,0)}.adguard-assistant-button-top.adguard-assistant-button-right{left:auto;right:0;transform:translate3d(-10px,10px,0)}.adguard-assistant-button-bottom.adguard-assistant-button-left{left:0;right:auto;transform:translate3d(10px,-10px,0)}.adguard-assistant-button-bottom.adguard-assistant-button-right{left:auto;right:0;transform:translate3d(-10px,-10px,0)}.adguard-assistant-button-bottom.adguard-assistant-button-respect-vk{transform:translate3d(-70px,-5px,0)}.adguard-assistant-button-bottom.adguard-assistant-button-respect-fb{transform:translate3d(-5px,-40px,0)}', CSS_iframe = '.close{position:absolute;top:10px;right:10px;display:inline-block;vertical-align:top;width:1em;font-size:12px;line-height:1;background:url(data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22utf-8%22%3F%3E%0A%3Csvg%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%20100%20100%22%3E%0A%20%20%20%20%3Cline%20fill%3D%22none%22%20stroke%3D%22%23000000%22%20stroke-width%3D%2220%22%20x1%3D%225%22%20y1%3D%225%22%20x2%3D%2295%22%20y2%3D%2295%22%2F%3E%0A%20%20%20%20%3Cline%20fill%3D%22none%22%20stroke%3D%22%23000000%22%20stroke-width%3D%2220%22%20x1%3D%2295%22%20y1%3D%225%22%20x2%3D%225%22%20y2%3D%2295%22%2F%3E%0A%3C%2Fsvg%3E%0A) no-repeat 0 0/cover;opacity:.2;cursor:pointer}.close:before{content:"\\00a0"}.close:hover{opacity:.5}@media (max-width:320px){.close{font-size:15px;top:18px;right:14px}}.a-logo{display:inline-block;vertical-align:top;width:40px;height:40px;padding:10px 0 0;font-size:20px;text-align:center;border:1px solid #cdcdcd;border-radius:50%;background:#fff}.a-logo__small{width:24px;height:24px;font-size:12px;padding:6px 0 0}.tooltip{position:relative}.tooltip:before{display:none;content:attr(data-title);position:absolute;top:100%;left:50%;width:170px;margin:7px 0 0 -85px;padding:6px 0 5px;font-size:10px;font-style:normal;font-weight:500;color:#fff;text-align:center;white-space:nowrap;border-radius:4px;background:rgba(0,0,0,.8)}.tooltip:after{display:none;content:\'\';position:absolute;top:100%;left:50%;margin:3px 0 0 -4px;border-bottom:4px solid rgba(0,0,0,.8);border-left:4px solid transparent;border-right:4px solid transparent}.tooltip:hover:after,.tooltip:hover:before{display:block}.main{position:relative;background:#fff}.head{padding:18px 20px;cursor:move}.head_title{font-size:16px;font-weight:700;color:#343434}.head_text{margin:4px 0 0;font-size:12px;color:#343434}.content{border-top:1px solid #e0dfdb}.foot{padding:20px;border-top:1px solid #e0dfdb}.foot_action{float:right}.foot_action_btn{font-size:0}.foot_action_btn .btn+.btn{margin-left:10px}.foot .cf{clear:right}.element-rule{padding:20px}.element-rule_slider{margin:5px 0 7px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}@media (max-width:320px){.element-rule_slider{display:none}}.element-rule_expand-link{font-size:12px;line-height:15px;font-weight:500;cursor:pointer}.element-rule_expand-link_txt{display:inline-block;vertical-align:top;color:#36ba53;border-bottom:1px solid #ccf0d4}.element-rule_expand-link_arr{display:inline-block;vertical-align:top;width:5px;height:5px;margin:3px 0 0 3px;border-bottom:1px solid #91a795;border-left:1px solid #91a795;-ms-transform:rotate(-45deg);transform:rotate(-45deg);transition:.2s}.element-rule_expand-link:hover .element-rule_expand-link_txt{color:#257f39;border-bottom-color:#91dfa2}.element-rule_expand-link.active .element-rule_expand-link_arr{margin-top:5px;-ms-transform:rotate(-225deg);transform:rotate(-225deg)}.element-rule_form{height:0;margin:0 -20px;overflow:hidden}.element-rule_form.open{height:auto;margin-bottom:-20px}@media (max-width:320px){.element-rule_form.open{padding:20px;padding-top:0}}.element-rule_form-cont{margin:4px 0 0;padding:20px;border-top:1px solid #e0dfdb;background:#f4f4ef}@media (max-width:320px){.element-rule_form-cont{margin-top:0}}.element-rule_fieldset{margin:10px 0 0}.element-rule_fieldset:first-child{margin:0}.element-rule_more--mobile{display:none}@media (max-width:320px){.element-rule_more--mobile{display:block}.element-rule_more--mobile .element-rule_expand-link{display:none}.element-rule_more--mobile #adg-cancel{width:106px;padding:10px 7px}.element-rule_more--mobile #adg-accept{padding:10px 6px}}.adg-slide{position:relative;width:500px;height:44px;margin:auto;transform:translate3d(0,0,0)}.adg-slide-clue-max,.adg-slide-clue-min{position:absolute;top:14px;left:-35px;width:30px;font-size:12px;font-weight:500;color:#8f9b92;cursor:pointer}.adg-slide-clue-min{left:auto;right:-40px;text-align:right}.adg-slide-btns{display:none}.adg-slide-btn{position:relative;width:36px;height:36px;border:2px solid #e2e2e2;border-radius:2px}.adg-slide-btn:after{content:"";position:absolute;left:8px;top:15.3px;width:18px;height:2px;background-color:#4e4e4e;border-radius:2px}.adg-slide-btn--plus{margin-left:9px}.adg-slide-btn--plus:before{content:"";position:absolute;left:16px;top:8px;height:17px;width:2px;background-color:#4e4e4e;border-radius:2px}.ui-slider-handle{position:absolute;top:22px;z-index:2;cursor:pointer}.ui-slider-handle:before{content:\'\';position:absolute;top:50%;left:50%;width:30px;height:30px;margin:-15px 0 0 -15px;background:rgba(0,0,0,.1);border-radius:50%;transition:.2s}.ui-slider-handle:after{content:\'\';position:absolute;top:50%;left:50%;width:20px;height:20px;margin:-10px 0 0 -10px;background:#36ba53;border-radius:50%}.ui-slider-handle:hover:active,.ui-slider-handle:hover:before{background:rgba(0,0,0,.15)}.tick{position:absolute;height:44px;border:20px solid #fff;border-left:1px solid #fff;border-right:1px solid #fff}.settings_fieldset{padding:20px;border-top:1px solid #e0dfdb}.settings_fieldset:first-child{border:0}.settings_fieldset_lbl{float:left;width:126px;margin:1px 0 0;font-weight:500}.settings_fieldset_lbl__pos{margin-top:21px}.settings_fieldset_val{margin:0 0 0 126px}.choice-size{position:relative;font-size:14px}.choice-size_field{margin:10px 0 0}.choice-size_field:first-child{margin:0}.choice-size_logo{display:none;position:absolute;top:10px;right:15px;width:40px;height:40px;background-size:21px;background-position:50% 11px;background-repeat:no-repeat;background-color:#fff;border:none;box-shadow:0 0 10px 3px rgba(162,161,161,.3);border-radius:100%}.choice-size_logo.logo__small{top:15px;right:20px;width:24px;height:24px;background-position:50% 6px;background-size:14px}.choice-size_input:checked~.choice-size_logo{display:block}[class^=s-position-arr-]{display:block;width:11px;height:11px;background:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22utf-8%22%3F%3E%0A%3Csvg%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%0A%20%20%20%20%20width%3D%22400%22%20height%3D%22200%22%20viewBox%3D%220%200%20400%20200%22%3E%0A%20%20%20%20%3Cdefs%3E%0A%20%20%20%20%20%20%20%20%3Cg%20id%3D%22arr%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cpolygon%20points%3D%2218.8%2C84.5%2018.8%2C32%2086.7%2C100%20100%2C86.7%2032%2C18.8%2084.5%2C18.8%2084.5%2C0%2018.8%2C0%200%2C0%200%2C18.8%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%200%2C84.5%20%09%22%2F%3E%0A%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%3C%2Fdefs%3E%0A%0A%20%20%20%20%3Cuse%20xlink%3Ahref%3D%22%23arr%22%20fill%3D%22%23ababab%22%2F%3E%0A%20%20%20%20%3Cuse%20xlink%3Ahref%3D%22%23arr%22%20fill%3D%22%23ababab%22%20transform%3D%22rotate(90%20100%20100)%22%2F%3E%0A%20%20%20%20%3Cuse%20xlink%3Ahref%3D%22%23arr%22%20fill%3D%22%23ababab%22%20transform%3D%22rotate(180%20100%20100)%22%2F%3E%0A%20%20%20%20%3Cuse%20xlink%3Ahref%3D%22%23arr%22%20fill%3D%22%23ababab%22%20transform%3D%22rotate(270%20100%20100)%22%2F%3E%0A%0A%20%20%20%20%3Cuse%20xlink%3Ahref%3D%22%23arr%22%20fill%3D%22%23fff%22%20x%3D%22200%22%2F%3E%0A%20%20%20%20%3Cuse%20xlink%3Ahref%3D%22%23arr%22%20fill%3D%22%23fff%22%20y%3D%22-200%22%20transform%3D%22rotate(90%20100%20100)%22%2F%3E%0A%20%20%20%20%3Cuse%20xlink%3Ahref%3D%22%23arr%22%20fill%3D%22%23fff%22%20x%3D%22-200%22%20transform%3D%22rotate(180%20100%20100)%22%2F%3E%0A%20%20%20%20%3Cuse%20xlink%3Ahref%3D%22%23arr%22%20fill%3D%22%23fff%22%20y%3D%22200%22%20transform%3D%22rotate(270%20100%20100)%22%2F%3E%0A%3C%2Fsvg%3E%0A") no-repeat;background-size:44px 22px}.s-position-arr-top-left{background-position:0 0}.s-position-arr-top-right{background-position:-11px 0}.s-position-arr-bottom-left{background-position:0 -11px}.s-position-arr-bottom-right{background-position:-11px -11px}.change-position{position:relative;display:inline-block;vertical-align:top;width:70px;margin:-3px 0 0 -3px}.change-position_i{float:left;margin:3px 0 0 3px}.change-position_input:checked+.change-position_label{border-color:#36ba53;background:#36ba53}.change-position_input:checked+.change-position_label .s-position-arr-top-left{background-position:-22px 0}.change-position_input:checked+.change-position_label .s-position-arr-top-right{background-position:-33px 0}.change-position_input:checked+.change-position_label .s-position-arr-bottom-left{background-position:-22px -11px}.change-position_input:checked+.change-position_label .s-position-arr-bottom-right{background-position:-33px -11px}.change-position_input:checked~.change-position_val{display:block}.change-position_label{display:block;width:32px;height:32px;margin:0;padding:9px 0 0 9px;border:1px solid #dfdedb;cursor:pointer}.change-position_val{display:none;position:absolute;top:27px;left:82px;font-size:12px;white-space:nowrap}.position-save .position-save_field{margin-bottom:10px}.wot-indicator{display:inline-block;vertical-align:top;margin-right:5px}#WotDescriptionText{white-space:pre-line}#WotDescriptionText #WotLogo{cursor:pointer}.adg-wot{width:18px;height:18px;display:block;border:5px solid #000;border-radius
045%2C11.9%2021.771%2C11.9%20z%22%20fill%3D%22%2374B03E%22%2F%3E%0A%20%20%20%20%3Cpath%20d%3D%22M16.751%2C0.642%20L17.031%2C0%20L14.063%2C0%20L11.27%2C8%20L8.648%2C0%20L8.272%2C0%20L5.65%2C8%20L3%2C0%20L0.031%2C0%20L4.9%2C13.486%20C4.9%2C13.486%205.078%2C13.86%205.275%2C13.86%20C5.451%2C13.86%205.649%2C13.486%205.649%2C13.486%20L8.445%2C6.406%20L11.269%2C13.486%20C11.269%2C13.486%2011.455%2C13.86%2011.643%2C13.86%20C11.829%2C13.86%2012.018%2C13.486%2012.018%2C13.486%20L13.614%2C9.067%20C13.445%2C8.433%2013.345%2C7.773%2013.345%2C7.089%20C13.346%2C4.453%2014.686%2C2.118%2016.751%2C0.642%20z%22%20fill%3D%22%23EE3428%22%2F%3E%0A%20%20%20%20%3Cpath%20d%3D%22M27.031%2C0%20L27.031%2C0.613%20C27.944%2C1.258%2028.715%2C2.067%2029.295%2C3%20L31.031%2C3%20L31.031%2C14%20L34.031%2C14%20L34.031%2C3%20L38.031%2C3%20L38.031%2C0%20L27.031%2C0%20z%22%20fill%3D%22%23F08615%22%2F%3E%0A%3C%2Fsvg%3E%0A) no-repeat 0 0/cover;margin-top:3px}.wot-hide{display:none}iframe#adguard-assistant-dialog{position:fixed;clip:auto;border-radius:3px;box-shadow:0 0 10px 3px rgba(162,161,161,.3);z-index:2147483647;display:block!important}.sg_hide_element{display:none!important}img.adguard_sg_selected{border:5px solid #0f0!important}#_sg_div.sg_top{top:5px!important}#_sg_div.sg_bottom{bottom:5px!important}#_sg_div input{margin-right:10px!important;font-size:15px!important}#_sg_path_field{width:400px!important}#_sg_div .sg_new_line{clear:both!important}#_sg_div .sg_option{float:left!important}#_sg_div .adguard_sg_selected_option{text-decoration:underline}.adguard-placeholder{background-image:url(data:image/png;base64,)}.adguard-placeholder-icon{background-image:url(data:image/png;base64,);background-position:center center;background-repeat:no-repeat;height:100%}.adguard-placeholder-domain{background:#778b7c;color:#fff;left:0;top:0;padding:2px 4px;position:relative}@media print{#adguard-assistant-dialog,.adguard-alert{display:none!important;opacity:0!important;visibility:hidden!important}}.menu-head{padding:18px 20px;cursor:move;touch-action:none;-ms-touch-action:none}.menu-head_title{font-size:16px;font-weight:700;color:#343434}.menu-head_name{display:inline-block;vertical-align:top;text-overflow:ellipsis;overflow:hidden;white-space:nowrap;max-width:260px;line-height:26px;margin:0 10px 5px 0}.menu-head_text{margin:4px 10px 0 0;font-size:12px;color:#343434}.menu-filter{width:100%;display:table;padding:20px;border-top:1px solid #e0dfdb}.menu-filter_lbl{display:table-cell;vertical-align:middle}.menu-filter_val{display:table-cell;vertical-align:middle}.menu-filter_label{position:relative;width:30px;height:12px;border-radius:25px;background-color:#ed7865;cursor:pointer;transition:all .3s ease;float:right}.menu-filter_label:after{content:"";cursor:pointer;border-radius:100%;position:absolute;left:-3px;top:-4px;box-shadow:0 0 10px 3px rgba(162,161,161,.3);width:20px;height:20px;background-color:#e85037;transition:all .3s ease}.menu-filter_handle{position:absolute;width:20px;height:20px;top:1px;left:1px;border-radius:4px;background:#fff}.menu-filter_input:checked+.menu-filter_label{background-color:#bde5c1}.menu-filter_input:checked+.menu-filter_label:after{left:12px;background-color:#68bc72}.menu{border-top:1px solid #e0dfdb}.menu__btn{position:relative;cursor:pointer;line-height:45px;height:45px;background-repeat:no-repeat;background-position:20px 50%;transition:.3s ease;padding:0 20px 0 60px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.menu__btn:hover{background-color:rgba(104,188,113,.2)}.menu__btn--clock{background-image:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0A%3Csvg%20viewBox%3D%220%200%2017%2017%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%0A%20%20%20%20%3Cg%20id%3D%22Artboard%22%20stroke%3D%22none%22%20stroke-width%3D%221%22%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%20transform%3D%22translate(-22.000000%2C%20-144.000000)%22%3E%0A%20%20%20%20%20%20%20%20%3Cg%20id%3D%22Group-2%22%20transform%3D%22translate(23.000000%2C%20141.000000)%22%20stroke%3D%22%23979797%22%20stroke-width%3D%221.35%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Ccircle%20id%3D%22Oval%22%20cx%3D%227.87036133%22%20cy%3D%2211.2759766%22%20r%3D%227.37885742%22%3E%3C%2Fcircle%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cpolyline%20id%3D%22Line-2%22%20stroke-linecap%3D%22square%22%20points%3D%227.76796875%207.46328125%207.76796875%2011.9632812%2011.3679687%2011.9632812%22%3E%3C%2Fpolyline%3E%0A%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%3C%2Fg%3E%0A%3C%2Fsvg%3E%0A");background-size:16px 19px}.menu__btn--landscape{background-image:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0A%3Csvg%20viewBox%3D%220%200%2019%2017%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%0A%20%20%20%20%3Cdefs%3E%0A%20%20%20%20%20%20%20%20%3Crect%20id%3D%22path-1%22%20x%3D%220.76796875%22%20y%3D%220.980664063%22%20width%3D%2218%22%20height%3D%2215.8805176%22%20rx%3D%221.8%22%3E%3C%2Frect%3E%0A%20%20%20%20%3C%2Fdefs%3E%0A%20%20%20%20%3Cg%20stroke%3D%22none%22%20stroke-width%3D%221%22%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%20transform%3D%22translate(-20.000000%2C%20-184.000000)%22%3E%0A%20%20%20%20%20%20%20%20%3Cg%20id%3D%22Group-3%22%20transform%3D%22translate(20.000000%2C%20184.000000)%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cg%20id%3D%22Rectangle%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cuse%20fill-rule%3D%22evenodd%22%20xlink%3Ahref%3D%22%23path-1%22%3E%3C%2Fuse%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Crect%20stroke%3D%22%23979797%22%20stroke-width%3D%221.35%22%20x%3D%221.44296875%22%20y%3D%221.65566406%22%20width%3D%2216.65%22%20height%3D%2214.5305176%22%20rx%3D%221.8%22%3E%3C%2Frect%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cpolyline%20id%3D%22Line-3%22%20stroke%3D%22%23979797%22%20stroke-width%3D%221.35%22%20stroke-linecap%3D%22square%22%20points%3D%221.62666016%2013.0713379%205.22666016%209.47133789%208.17407227%2012.1155273%2012.929834%206.72827148%2017.8679687%2012.3330566%22%3E%3C%2Fpolyline%3E%0A%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%3C%2Fg%3E%0A%3C%2Fsvg%3E%0A");background-size:19px 17px}.menu__btn--report{background-image:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0A%3Csvg%20viewBox%3D%220%200%2017%2018%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%0A%20%20%20%20%3Cg%20stroke%3D%22none%22%20stroke-width%3D%221%22%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%20transform%3D%22translate(-22.000000%2C%20-224.000000)%22%3E%0A%20%20%20%20%20%20%20%20%3Cpath%20d%3D%22M22.8175781%2C234.417455%20L22.8175781%2C240.559747%20L36.896066%2C232.723089%20L22.8175781%2C225.699121%20L22.8175781%2C231.080572%20L25.9788363%2C232.657771%20L22.8175781%2C234.417455%20Z%22%20id%3D%22Combined-Shape%22%20stroke%3D%22%23979797%22%20stroke-width%3D%221.35%22%3E%3C%2Fpath%3E%0A%20%20%20%20%3C%2Fg%3E%0A%3C%2Fsvg%3E%0A");background-size:16px 17px}.menu__btn--security{background-image:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0A%3Csvg%20viewBox%3D%220%200%2018%2018%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%0A%20%20%20%20%3Cg%20stroke%3D%22none%22%20stroke-width%3D%221%22%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%20transform%3D%22translate(-21.000000%2C%20-263.000000)%22%3E%0A%20%20%20%20%20%20%20%20%3Cpath%20d%3D%22M30.0235895%2C280.119024%20C29.9710016%2C280.119024%2029.9183625%2C280.110898%2029.8676655%2C280.094647%20C28.1635915%2C279.548785%2026.7127981%2C278.501779%2025.5555057%2C276.982759%20C24.6443903%2C275.786831%2023.914854%2C274.298373%2023.3872881%2C272.558729%20C22.4973305%2C269.624485%2022.4871094%2C267.010522%2022.4871094%2
20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20id%3D%22Combined-Shape%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Ccircle%20id%3D%22Oval-15%22%20cx%3D%229.03867188%22%20cy%3D%229.11030273%22%20r%3D%221.8%22%3E%3C%2Fcircle%3E%0A%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%3C%2Fg%3E%0A%3C%2Fsvg%3E%0A");background-size:19px}.menu__btn.hidden{display:none}:host{display:block!important;position:relative!important;width:0!important;height:0!important;margin:0!important;padding:0!important;z-index:2147483647!important}:host ::after,:host ::before{display:none!important}', CSS_selector = "iframe#adguard-assistant-dialog{position:fixed;clip:auto;border-radius:3px;box-shadow:0 0 10px 3px rgba(162,161,161,.3);z-index:2147483647;display:block!important}.sg_hide_element{display:none!important}img.adguard_sg_selected{border:5px solid #0f0!important}#_sg_div.sg_top{top:5px!important}#_sg_div.sg_bottom{bottom:5px!important}#_sg_div input{margin-right:10px!important;font-size:15px!important}#_sg_path_field{width:400px!important}#_sg_div .sg_new_line{clear:both!important}#_sg_div .sg_option{float:left!important}#_sg_div .adguard_sg_selected_option{text-decoration:underline}.adguard-placeholder{background-image:url(data:image/png;base64,)}.adguard-placeholder-icon{background-image:url(data:image/png;base64,);background-position:center center;background-repeat:no-repeat;height:100%}.adguard-placeholder-domain{background:#778b7c;color:#fff;left:0;top:0;padding:2px 4px;position:relative}@media print{#adguard-assistant-dialog,.adguard-alert{display:none!important;opacity:0!important;visibility:hidden!important}}", CSS_mobile = ':host{display:block!important;position:relative!important;width:0!important;height:0!important;margin:0!important;padding:0!important;z-index:2147483647!important}:host ::after,:host ::before{display:none!important}body{padding:1vw;background:0 0}.main{position:relative;padding:8vw 3vw;background:#fff}.main .footer{letter-spacing:3vw}.main-version{position:absolute;bottom:0;right:7px;color:#eee;font-size:5vw}.main-popup{text-align:center;display:-ms-flexbox;display:flex;-ms-flex-direction:column;flex-direction:column;-ms-flex-align:center;align-items:center;margin:5vw;box-shadow:0 0 5vw 0 rgba(0,0,0,.2)}.main-popup__logo{width:11vw;height:11vw}.main-popup__logo.adguard-assistant-button-main-logo{background-image:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0A%3Csvg%20viewBox%3D%220%200%2035%2036%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%0A%20%20%20%20%3Cg%20stroke%3D%22none%22%20stroke-width%3D%221%22%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%20transform%3D%22translate(-164.000000%2C%20-219.000000)%22%3E%0A%20%20%20%20%20%20%20%20%3Cg%20id%3D%223%22%20transform%3D%22translate(40.000000%2C%20190.000000)%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cg%20transform%3D%22translate(124.500000%2C%2029.414062)%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cg%20transform%3D%22translate(0.453656%2C%200.226828)%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cg%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cg%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20d%3D%22M16.7157492%2C0%20C11.4909195%2C0%205.18846877%2C1.26558351%205.12620114e-06%2C4.05122239%20C5.12620114e-06%2C10.0674495%20-0.0716136324%2C25.0556925%2016.7157492%2C35.2966798%20C33.503483%2C25.0556925%2033.4322354%2C10.0674495%2033.4322354%2C4.05122239%20C28.2434006%2C1.26558351%2021.9409499%2C0%2016.7157492%2C0%20L16.7157492%2C0%20Z%22%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20id%3D%22Path%22%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20fill%3D%22%2368BC71%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%20d%3D%22M16.6986743%2C35.2862582%20C-0.0715650605%2C25.0455268%205.12620113e-06%2C10.0654091%205.12620113e-06%2C4.05122239%20C5.18281802%2C1.26861734%2011.4771929%2C0.00275849124%2016.6986743%2C4.50378311e-06%20L16.6986743%2C35.2862617%20Z%22%20id%3D%22Combined-Shape%22%20fill%3D%22%2367B279%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20d%3D%22M16.1060247%2C23.551094%20L26.2143155%2C9.51801869%20C25.4736005%2C8.90647249%2024.8238876%2C9.33808916%2024.4662281%2C9.672244%20L24.4531774%2C9.67331501%20L16.0248987%2C18.7044208%20L12.8493477%2C14.7681053%20C11.3344091%2C12.96524%209.27486866%2C14.3404157%208.79375662%2C14.7038448%20L16.1060247%2C23.551094%22%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20id%3D%22Fill-11%22%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20fill%3D%22%23FFFFFF%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%3C%2Fg%3E%0A%3C%2Fsvg%3E%0A");background-repeat:no-repeat}.main-popup__title{font-size:6vw;margin:3vw 0}.main-popup__content{font-size:5vw;padding:0 3vw;margin-bottom:5vw}.main-popup__btn{font-size:5vw;padding:2vh 8vw;border:1px solid #dedede;border-radius:3px;background:#fff;letter-spacing:normal}.main-popup__btn:hover{background-color:#f6f6f6}.main-popup__btn--green{color:#fff;border:1px solid #66b574;background-color:#66b574;box-shadow:none}.main-popup__btn--green:hover{background-color:#5ea76b;color:#fff}.main-popup__btn:focus{box-shadow:none}.main-menu{margin:4vw;padding:4vw;display:-ms-flexbox;display:flex;-ms-flex-pack:justify;justify-content:space-between;border-radius:2px;box-shadow:0 0 4vw -2px rgba(0,0,0,.3)}.main-menu__btn{font-size:0;width:12vw;height:12vw;border:1px solid #dedede;border-radius:3px;background-repeat:no-repeat;background-position:50%;background-size:40%;position:relative;background-color:#fff}.main-menu__btn:hover{background-color:#d0f0d6}.main-menu__btn.active,.main-menu__btn:active{background-color:#66b574;box-shadow:inset 2px 2px 3px 0 rgba(92,92,92,.5)}.main-menu__btn--accept{background-image:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0A%3Csvg%20width%3D%2215px%22%20height%3D%2213px%22%20viewBox%3D%220%200%2015%2013%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%0A%20%20%20%20%3Cg%20stroke%3D%22none%22%20stroke-width%3D%221%22%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%20transform%3D%22translate(-68.000000%2C%20-570.000000)%22%20stroke-linecap%3D%22round%22%3E%0A%20%20%20%20%20%20%20%20%3Cpolyline%20stroke%3D%22%23000%22%20stroke-width%3D%221.8%22%20points%3D%2269.202002%20576.814758%2072.8587101%20581.202808%2081.4776855%20571.551098%22%3E%3C%2Fpolyline%3E%0A%20%20%20%20%3C%2Fg%3E%0A%3C%2Fsvg%3E%0A")}.main-menu__btn--preview{background-image:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0A%3Csvg%20width%3D%2220px%22%20height%3D%2217px%22%20viewBox%3D%220%200%2020%2017%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%0A%20%20%20%20%3Cg%20stroke%3D%22none%22%20stroke-width%3D%221%22%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%20transform%3D%22translate(-117.000000%2C%20-568.000000)%22%3E%0A%20%20%20%20%20%20%20%20%3Cg%20id%3D%22Group%22%20transform%3D%22translate(119.000000%2C%20570.000000)%22%20stroke%3D%22%23555555%22%20stroke-width%3D%221.8%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20d%3D%22M-0.423860131%2C6.17779517%20C0.450400003%2C2.324936%203.88851808%2C-0.454193941%207.890625%2C-0.454193941%20C11.8927319%2C-0.454193941%2015.33085%2C2.324936%2016.2051101%2C6.17779517%20L16.2503015%2C6.37695313%20L16.2051101%2C6.57611108%20C15.33085%2C10.4289703%2011.8927319%2C13.2081002%207.890625%2C13.2081002%20C3.88851808%2C13.2081002%200.450400003%2C10.4289703%20-0.423860131%2C6.57611108%20L-0.46905147%2C6.37695313%20L-0.423860131%2C6.17779517%20Z%22%0A%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20id%3D%22Combined-Shape%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Ccircle%20id%3D%22Oval-5%22%20cx%3D%227.890625%22%20cy%3D%226.37695312%22%20r%3D%222.54192017%22%3E%3C%2Fcircle%3E%0A%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%3C%2Fg%3E%0A%3C%2Fsvg%3E%0A")}.main-menu__btn--preview.active,.main-menu__btn--preview:active{background-image:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0A%3Csvg%20width%3D%2220px%22%20height%3D%2217px%22%20viewBox%3D%220%200%2020%2017%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%0A%20%20%20%20%3Cg%20stroke%3D%22none%22%20stroke-width%3D%221%22%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%20transform%3D%22translate(-117.000000%2C%20-568.000000)%22%3E%0A%20%20%20%20%20%20%20%20%3Cg%20id%3D%22Group-3%22%20transform%3D%22translate(119.000000%2C%20570.000000)%22%20stroke%3D%22%23FFFFFF%22%20stroke-width%3D%221.8%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%20d%3D%22M-0.423860131%2C6.17779517%20C0.450400003%2C2.324936%203.88851808%2C-0.454193941%207.890625%2C-0.454193941%20C11.8927319%2C-0.454193941%2015.33085%2C2.324936%2016.2051101%2C6.17779517%20L16.2503015%2C6.37695313%20L16.2051101%2C6.57611108%20C15.33085%2C10.4289703%2011.8927319%2C13.2081002%207.890625%2C13.2081002%20C3.88851808%2C13.2081002%200.450400003%2C10.4289703%20-0.423860131%2C6.57611108%20L-0.46905147%2C6.37695313%20L-0.423860131%2C6.17779517%20Z%22%20id%3D%22Combined-Shape%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Ccircle%20id%3D%22Oval-5%22%20cx%3D%227.890625%22%20cy%3D%226.37695312%22%20r%3D%222.54192017%22%3E%3C%2Fcircle%3E%0A%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%3C%2Fg%3E%0A%3C%2Fsvg%3E%0A")}.main-menu__btn--plus{background-image:url(data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0D%0A%3Csvg%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%20x%3D%220px%22%20y%3D%220px%22%20viewBox%3D%220%200%20512%20512%22%20style%3D%22enable-background%3Anew%200%200%20512%20512%3B%22%3E%3Cpath%20d%3D%22M492%2C236H276V20c0-11.046-8.954-20-20-20c-11.046%2C0-20%2C8.954-20%2C20v216H20c-11.046%2C0-20%2C8.954-20%2C20s8.954%2C20%2C20%2C20h216v216c0%2C11.046%2C8.954%2C20%2C20%2C20s20-8.954%2C20-20V276h216c11.046%2C0%2C20-8.954%2C20-20C512%2C244.954%2C503.046%2C236%2C492%2C236z%22%2F%3E%3C%2Fsvg%3E%0D%0A)}.main-menu__btn--plus:active{background-image:url(data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0D%0A%3Csvg%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%20x%3D%220px%22%20y%3D%220px%22%20viewBox%3D%220%200%20512%20512%22%20style%3D%22enable-background%3Anew%200%200%20512%20512%3B%22%3E%3Cpath%20d%3D%22M492%2C236H276V20c0-11.046-8.954-20-20-20c-11.046%2C0-20%2C8.954-20%2C20v216H20c-11.046%2C0-20%2C8.954-20%2C20s8.954%2C20%2C20%2C20h216v216c0%2C11.046%2C8.954%2C20%2C20%2C20s20-8.954%2C20-20V276h216c11.046%2C0%2C20-8.954%2C20-20C512%2C244.954%2C503.046%2C236%2C492%2C236z%22%2F%3E%3C%2Fsvg%3E%0D%0A)}.main-menu__btn--minus{background-image:url(data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0D%0A%3Csvg%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%20x%3D%220px%22%20y%3D%220px%22%20viewBox%3D%220%200%20409.6%20409.6%22%20style%3D%22enable-background%3Anew%200%200%20409.6%20409.6%3B%22%3E%3Cpath%20d%3D%22M392.533%2C187.733H17.067C7.641%2C187.733%2C0%2C195.374%2C0%2C204.8s7.641%2C17.067%2C17.067%2C17.067h375.467c9.426%2C0%2C17.067-7.641%2C17.067-17.067S401.959%2C187.733%2C392.533%2C187.733z%22%2F%3E%3C%2Fsvg%3E%0D%0A)}.main-menu__btn--minus:active{background-image:url(data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0D%0A%3Csvg%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%20x%3D%220px%22%20y%3D%220px%22%20viewBox%3D%220%200%20409.6%20409.6%22%20style%3D%22enable-background%3Anew%200%200%20409.6%20409.6%3B%22%3E%3Cpath%20d%3D%22M392.533%2C187.733H17.067C7.641%2C187.733%2C0%2C195.374%2C0%2C204.8s7.641%2C17.067%2C17.067%2C17.067h375.467c9.426%2C0%2C17.067-7.641%2C17.067-17.067S401.959%2C187.733%2C392.533%2C187.733z%22%2F%3E%3C%2Fsvg%3E%0D%0A)}.main-menu__btn--close{background-image:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0A%3Csvg%20width%3D%2213px%22%20height%3D%2213px%22%20viewBox%3D%220%200%2013%2013%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%0A%20%20%20%20%3Cg%20stroke%3D%22none%22%20stroke-width%3D%221%22%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%20transform%3D%22translate(-276.000000%2C%20-570.000000)%22%20stroke-linecap%3D%22round%22%3E%0A%20%20%20%20%20%20%20%20%3Cg%20id%3D%22Group-7%22%20transform%3D%22translate(281.890625%2C%20576.376953)%20rotate(-315.000000)%20translate(-281.890625%2C%20-576.376953)%20translate(274.264864%2C%20568.327539)%22%20stroke%3D%22%23555555%22%20stroke-width%3D%221.8%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%20d%3D%22M7.86654787%2C0.599072332%20L7.86654787%2C15.0032866%22%20id%3D%22Line-3%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%20d%3D%22M15.068655%2C7.80117948%20L0.664440722%2C7.80117948%22%20id%3D%22Line-3%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%3C%2Fg%3E%0A%3C%2Fsvg%3E%0A")}.main-menu__btn--close:active{background-image:url("data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22UTF-8%22%3F%3E%0A%3Csvg%20width%3D%2213px%22%20height%3D%2213px%22%20viewBox%3D%220%200%2013%2013%22%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%3E%0A%20%20%20%20%3Cg%20stroke%3D%22none%22%20stroke-width%3D%221%22%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%20transform%3D%22translate(-276.000000%2C%20-570.000000)%22%20stroke-linecap%3D%22round%22%3E%0A%20%20%20%20%20%20%20%20%3Cg%20id%3D%22Group-2%22%20transform%3D%22translate(275.000000%2C%20570.000000)%22%20stroke%3D%22%23FFFFFF%22%20stroke-width%3D%221.8%22%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%20d%3D%22M7.2364156%2C-0.830419873%20L7.2364156%2C13.5737944%22%20id%3D%22Line-3%22%20transform%3D%22translate(7.236416%2C%206.371687)%20rotate(-315.000000)%20translate(-7.236416%2C%20-6.371687)%20%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%20%20%20%20%3Cpath%20d%3D%22M14.1389546%2C6.24760208%20L-0.26525972%2C6.24760208%22%20id%3D%22Line-3%22%20transform%3D%22translate(6.936847%2C%206.671255)%20rotate(-315.000000)%20translate(-6.936847%2C%20-6.671255)%20%22%3E%3C%2Fpath%3E%0A%20%20%20%20%20%20%20%20%3C%2Fg%3E%0A%20%20%20%20%3C%2Fg%3E%0A%3C%2Fsvg%3E%0A")}.main-menu__btn:disabled{background-color:#efefef}.main-menu__btn:disabled:after,.main-menu__btn:disabled:before{opacity:.7}', HTML_detailed_menu = '<div class="main"><div class="close"></div><div class="menu-head"><div class="menu-head_title"><span class="menu-head_name"></span><div class="confidence-indication wot-hide"><a class="wot-indicator wot-hide" target="_blank" href="http://adguard.com/wot-scorecard.html?domain=habrahabr.ru"><i id="WotIndication" class="adg-wot tooltip" data-title="Site reputation indicator"></i> </a><i id="ConfidenceIndication" class="adg-wot-confidence tooltip" data-title="Reputation Confidence Level"></i></div></div><div class="menu-head_text wot-hide" id="WotDescriptionText"></div></div><div class="menu-filter"><div i18n="menu_filtration_status" class="menu-filter_lbl"></div><div class="menu-filter_val"><input type="checkbox" class="menu-filter_input" id="is-filter"> <label for="is-filter" class="menu-filter_label"></label></div></div><div class="menu"><div id="do-not-block-30-sec" class="menu__btn menu__btn--clock" i18n="menu_do_not_filter_30_sec"></div><div id="block-ad" class="menu__btn menu__btn--landscape" i18n="menu_block_ad_on_site"></div><div id="report-abuse" class="menu__btn menu__btn--report" i18n="menu_report_abuse"></div><div id="site-report" class="menu__btn menu__btn--security" i18n="menu_site_report"></div><div id="assistant-settings" class="menu__btn menu__btn--settings" i18n="menu_settings"></div></div></div>', HTML_selector_menu = '<div class="main adguard_sg_ignore"><div class="close adg-close" id="close-button"></div><div class="head" id="drag-handle"><div i18n="assistant_select_element" class="head_title"></div><div i18n="assistant_select_element_ext" class="head_text"></div></div><div class="foot"><button i18n="assistant_select_element_cancel" type="button" class="btn btn-default" id="cancel-select-mode"></button></div></div>', HTML_settings_menu = '<div class="main"><div class="close"></div><div class="head"><div i18n="assistant_settings" class="head_title"></div><div i18n="settings_choose_size_and_position" class="head_text head_text--mobile-h"></div></div><div class="content"><div class="settings settings__horizontal"><div class="settings_fieldset"><div i18n="settings_position_save" class="settings_fieldset_lbl"></div><div class="settings_fieldset_val"><div class="position-save"><div class="position-save_group"><div class="position-save_field"><input class="form-ui-control" id="all-site" type="radio" name="position-save"> <label class="form-ui" for="all-site"><span i18n="settings_position_save_all" class="form-ui-txt"></span></label></div><div class="position-save_field"><input class="form-ui-control" id="this-site" type="radio" name="position-save"> <label class="form-ui" for="this-site"><span i18n="settings_position_save_this" class="form-ui-txt"></span></label></div></div></div></div></div><div class="settings_fieldset"><div i18n="settings_icon_size" class="settings_fieldset_lbl"></div><div class="settings_fieldset_val"><div class="choice-size"><div class="choice-size_group"><div class="choice-size_field"><input class="choice-size_input form-ui-control" id="size-small" type="radio" name="radio"> <label class="form-ui" for="size-small"><span i18n="settings_small" class="form-ui-txt"></span></label><div class="adguard-assistant-button-main-logo choice-size_logo logo__small"></div></div><div class="choice-size_field"><input class="choice-size_input form-ui-control" id="size-big" type="radio" name="radio"> <label class="form-ui" for="size-big"><span i18n="settings_big" class="form-ui-txt"></span></label><div class="adguard-assistant-button-main-logo choice-size_logo"></div></div></div></div></div></div><div class="settings_fieldset"><div i18n="settings_position" class="settings_fieldset_lbl settings_fieldset_lbl__pos"></div><div class="settings_fieldset_val"><div class="change-position"><div class="change-position_i"><input type="radio" name="position" class="change-position_input" id="position-top-left"> <label class="change-position_label" for="position-top-left"><span class="s-position-arr-top-left"></span></label><div i18n="settings_left_top" class="change-position_val"></div></div><div class="change-position_i"><input type="radio" name="position" class="change-position_input" id="position-top-right"> <label class="change-position_label" for="position-top-right"><span class="s-position-arr-top-right"></span></label><div i18n="settings_right_top" class="change-position_val"></div></div><div class="change-position_i"><input type="radio" name="position" class="change-position_input" id="position-bottom-left"> <label class="change-position_label" for="position-bottom-left"><span class="s-position-arr-bottom-left"></span></label><div i18n="settings_left_bottom" class="change-position_val"></div></div><div class="change-position_i"><input type="radio" name="position" class="change-position_input" id="position-bottom-right"> <label class="change-position_label" for="position-bottom-right"><span class="s-position-arr-bottom-right"></span></label><div i18n="settings_right_bottom" class="change-position_val"></div></div></div></div></div></div></div><div class="foot"><div class="foot_action"><div class="foot_action_btn"><button i18n="settings_cancel" class="btn btn-default" type="button" id="cancel"></button> <button i18n="settings_save" class="btn btn-primary" type="button" id="save-settings"></button></div></div><div class="cf"></div></div></div>', HTML_slider_menu = '<div class="main"><div class="close adg-close"></div><div class="head head--slider"><div class="head_in head_in--slider"><div i18n="assistant_block_element" class="head_title head_title--slider" id="head_title"></div><div class="element-rule_more element-rule_more--mobile"><span class="element-rule_expand-link" id="ExtendedSettingsText"></span> <button i18n="assistant_block" type="button" class="btn btn-cancel" id="adg-accept"></button> <button i18n="assistant_another_element" type="button" class="btn btn-default" id="adg-cancel"></button></div></div><div class="adg-slide-btns"><div class="adg-slide-btn adg-slide-btn--minus"></div><div class="adg-slide-btn adg-slide-btn--plus"></div></div><div i18n="assistant_block_element_explain" class="head_text head_text--mobile-h" id="head_text"></div></div><div class="content" id="slider-area"><div class="element-rule element-rule--slider"><div i18n="assistant_slider_explain" class="element-rule_text element-rule_text--slider"></div><div class="element-rule_slider"><div class="adg-slide" id="slider"><div i18n="assistant_slider_max" class="adg-slide-clue-max"></div><div i18n="assistant_slider_min" class="adg-slide-clue-min"></div></div></div><div class="element-rule_more"><span class="element-rule_expand-link" id="ExtendedSettingsText"><span i18n="assistant_extended_settings" class="element-rule_expand-link_txt"></span> <span class="element-rule_expand-link_arr"></span></span></div><div class="element-rule_form" id="adv-settings"><div class="element-rule_form-cont"><div class="element-rule_fieldset" id="one-domain-checkbox-block"><input class="form-ui-control" id="one-domain-checkbox" type="checkbox"> <label for="one-domain-checkbox" class="form-ui"><span i18n="assistant_apply_rule_to_all_sites" class="form-ui-txt"></span></label></div><div style="display:none" class="element-rule_fieldset" id="block-by-url-checkbox-block"><input class="form-ui-control" id="block-by-url-checkbox" type="checkbox"> <label for="block-by-url-checkbox" class="form-ui"><span i18n="assistant_block_by_reference" class="form-ui-txt"></span></label></div><div style="display:none" class="element-rule_fieldset" id="block-similar-checkbox-block"><input class="form-ui-control" id="block-similar-checkbox" type="checkbox"> <label for="block-similar-checkbox" class="form-ui"><span i18n="assistant_block_similar" class="form-ui-txt"></span></label></div><div class="element-rule_fieldset"><input class="form-control" id="filter-rule" type="text"></div></div></div></div></div><div class="foot foot--slider"><button i18n="assistant_another_element" type="button" class="btn btn-default btn-another-el" id="adg-cancel"></button><div class="foot_action"><div class="foot_action_btn"><button i18n="assistant_preview" type="button" class="btn btn-primary" id="adg-preview"></button> <button i18n="assistant_block" type="button" class="btn btn-cancel" id="adg-accept"></button></div></div></div></div>', HTML_preview = '<div class="main"><div class="close"></div><div class="head"><div i18n="assistant_preview_header" class="head_title"></div><div i18n="assistant_preview_header_info" class="head_text"></div></div><div class="foot"><button i18n="assistant_another_element" class="btn btn-default" id="select-another-element" type="button"></button><div class="foot_action"><div class="foot_action_btn"><button i18n="assistant_preview_end" class="btn btn-primary" id="end-preview" type="button"></button> <button i18n="assistant_block" class="btn btn-cancel" id="block-element" type="button"></button></div></div></div></div>', HTML_popup = '<div class="main mobile main-popup"><div class="main-popup__logo adguard-assistant-button-main-logo"></div><h2 class="mobile-title main-popup__title" i18n="assistant_select_element"></h2><div class="content main-popup__content" i18n="assistant_select_element_text"></div><div class="footer"><button i18n="assistant_select_element_start" class="btn btn-active start-select-mode main-popup__btn main-popup__btn--green"></button> <button i18n="assistant_select_element_cancel" class="btn cancel-select-mode main-popup__btn"></button></div><i class="main-version">v4.3.4</i></div>', HTML_mobile_menu = '<div class="main mobile main-menu"><button i18n-title="assistant_block" class="adg-accept main-menu__btn main-menu__btn--accept">accept</button> <button i18n-title="assistant_preview" class="adg-preview main-menu__btn main-menu__btn--preview">preview</button> <button i18n-title="plus" class="adg-plus main-menu__btn main-menu__btn--plus">plus</button> <button i18n-title="minus" class="adg-minus main-menu__btn main-menu__btn--minus">minus</button> <button i18n-title="close" class="adg-close main-menu__btn main-menu__btn--close">close</button></div>', en = {
        ...
        settings_choose_size_and_position: {
            message: "Adjust AdAway Assistant size and position"
        },
        settings_icon_size: {
            message: "Icon size:"
        },
        ...
        settings_choose_size_and_position: {
            message: "Настройте размер и положение помощника AdAway"
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "Налаштуйте розмір і положення помічника AdAway"
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "Dostosuj rozmiar i pozycję Asystenta AdAwaya"
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "Anpassen der Größe und Position des AdAway-Assistenten"
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "Regola dimensione e posizione di Assistente AdAway"
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "تنظیم اندازه و موقعیت دستیار AdAway"
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "AdAway Assistant'ın boyut ve konumunu ayarla"
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "AdAwayアシスタントのサイズと位置を調整する"
        },
        settings_icon_size: {
            message: "アイコンの大きさ:"
        },
        ...
        settings_choose_size_and_position: {
            message: "Ajuste el tamaño y la posición del Asistente de AdAway"
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "Ajuste o tamanho e posição do AdAway Assistente"
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "Ajustar o tamanho e a posição do Assistente do AdAway"
        },
        settings_icon_size: {
            message: "Tamanho do ícone:"
        },
        ...
        settings_choose_size_and_position: {
            message: "ضبط حجم مساعد AdAway وموضعه"
        },
        settings_icon_size: {
            message: "حجم الرمز:"
        },
        ...
        settings_choose_size_and_position: {
            message: "AdAway 도우미의 크기와 위치를 조정합니다."
        },
        settings_icon_size: {
            message: "아이콘 크기:"
        },
        ...
        settings_choose_size_and_position: {
            message: "Prispôsobiť veľkosť a polohu AdAway asistenta"
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "Juster størrelsen og posisjonen til AdAway-assistent"
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "Juster AdAway Assistent størrelse og position"
        },
        settings_icon_size: {
            message: "Ikonstørrelse:"
        },
        ...
        settings_choose_size_and_position: {
            message: "Affiner la taille et la position de l'assistant AdAway "
        },
        settings_icon_size: {
        ...
        settings_choose_size_and_position: {
            message: "Atur ukuran dan posisi AdAway Assistant"
        },
        settings_icon_size: {
            message: "Ukuran ikon:"
        },
        ...
        settings_choose_size_and_position: {
            message: "Anpassas storlek och läge för AdAwayassistenten"
        },
        settings_icon_size: {
            message: "Ikonstorlek"
        },
        ...
        settings_choose_size_and_position: {
            message: "Podesite veličinu i poziciju AdAway pomoćnika"
        },
        settings_icon_size: {
    ...
    }, ProtectedApi = function() {
        var win = window, functionPType = Function.prototype, originalGetOwnPropertyDescriptor = Object.getOwnPropertyDescriptor, documentMode = document.documentMode, originalAppendChild = document.appendChild, originalJSON = win.JSON, functionApply = functionPType.apply, functionBind = functionPType.bind, originalAttachShadow = document.documentElement.attachShadow, apply = "undefined" != typeof Reflect ? Reflect.apply : function(target, _this, _arguments) {
            return functionApply.call(target, _this, _arguments);
        }, noop = function() {}, methodCallerFactory = function(owner, prop) {
            if (!owner) return noop;
            var method = owner[prop];
            return function() {
                if (method) return apply(method, owner, arguments);
            };
        }, getReadyState = function() {
            if (void 0 === originalGetOwnPropertyDescriptor(Document.prototype, "readyState")) return function() {
                return "complete";
            };
        ...
        }(), addListenerToWindow = methodCallerFactory(win, "addEventListener"), removeListenerFromWindow = methodCallerFactory(win, "removeEventListener"), querySelector = methodCallerFactory(document, "querySelector"), appendChildToElement = function(elem, child) {
            apply(originalAppendChild, elem, [ child ]);
        }, createElement = function(markup) {
            var doc = document.implementation.createHTMLDocument("");
            return markup && "<" !== markup[0] && (markup = "<" + markup + "></" + markup + ">"), 
            doc.body.innerHTML = markup, doc.body.firstChild;
        }, json = {
        ...
        return {
            ...
            json: json,
            createStylesElement: function(styles, nonce, id) {
                if (id && querySelector("#" + id)) return !1;
                var tagNode = createElement("style");
                return tagNode.setAttribute("type", "text/css"), id && tagNode.setAttribute("id", id), 
                tagNode.setAttribute("nonce", nonce), tagNode.styleSheet ? tagNode.styleSheet.cssText = styles : appendChildToElement(tagNode, document.createTextNode(styles)), 
                tagNode;
            },
            checkShadowDomSupport: function() {
                return void 0 !== originalAttachShadow && !/^((?!chrome|android).)*safari/i.test(navigator.userAgent);
            }
        };
    }, cssEscape = function(root) {
        if (root.CSS && root.CSS.escape) return root.CSS.escape;
        var cssEscape = function(value) {
            if (0 === arguments.length) throw new TypeError("`CSS.escape` requires an argument.");
            for (var codeUnit, string = String(value), length = string.length, index = -1, result = "", firstCodeUnit = string.charCodeAt(0); ++index < length; ) 0 !== (codeUnit = string.charCodeAt(index)) ? result += codeUnit >= 1 && codeUnit <= 31 || 127 == codeUnit || 0 === index && codeUnit >= 48 && codeUnit <= 57 || 1 == index && codeUnit >= 48 && codeUnit <= 57 && 45 == firstCodeUnit ? "\\" + codeUnit.toString(16) + " " : 0 === index && 1 == length && 45 == codeUnit || !(codeUnit >= 128 || 45 == codeUnit || 95 == codeUnit || codeUnit >= 48 && codeUnit <= 57 || codeUnit >= 65 && codeUnit <= 90 || codeUnit >= 97 && codeUnit <= 122) ? "\\" + string.charAt(index) : string.charAt(index) : result += "�";
            return result;
        };
        return root.CSS || (root.CSS = {}), root.CSS.escape = cssEscape, cssEscape;
    }(this), Ioc = (dependencies = {}, resolveDependencies = function(func) {
        for (var args = getArguments(func), resolved = [], i = 0; i < args.length; i++) {
            var depName = args[i].trim();
            if (!dependencies[depName]) throw "Can't find dependency: " + depName;
            resolved.push(dependencies[depName]);
        }
        return resolved;
    }, getArguments = function(func) {
        var args = func.toString().match(/^function\s*[^\(]*\(\s*([^\)]*)\)/m)[1].split(",");
        return "" === args[0] ? [] : args;
    }, {
        ...
        get: function(func) {
            if ("string" == typeof func) {
                ...
                if (!resolved) throw "Can't resolve " + func;
                return resolved;
            }
            ...
            return FuncWrapper.prototype = func.prototype, new FuncWrapper;
        }
    }), Log = function() {
        var LogLevels = {
            ERROR: 1,
            ...
            INFO: 3,
            DEBUG: 4
        }, print = function(level, method, args) {
            var formatted;
            if (!(LogLevels.ERROR < LogLevels[level]) && (args && 0 !== args.length && args[0])) if ("object" == typeof args[0]) formatted = args[0]; else {
                var str = args[0] + "";
                if (args = Array.prototype.slice.call(args, 1), formatted = str.replace(/{(\d+)}/g, (function(match, number) {
                    return void 0 !== args[number] ? args[number] : match;
                })), LogLevels[level] >= LogLevels.ERROR) formatted = (new Date).toISOString() + ": " + formatted;
            }
        };
        return {
            warn: function() {
                print("WARN", 0, arguments);
            },
            info: function() {
                print("INFO", 0, arguments);
            },
            debug: function() {
                print("DEBUG", 0, arguments);
            },
            error: function() {
                print("ERROR", 0, arguments);
            }
        };
    };
    factory = function() {
        ...
        }, Promise.prototype.finally = promiseFinally, Promise.all = function(arr) {
        ...
        globalNS.Promise ? globalNS.Promise.prototype.finally || (globalNS.Promise.prototype.finally = promiseFinally) : globalNS.Promise = Promise;
    ...
    var UpgradeHelper = function(log, protectedApi) {
        var Constants_BUTTON_POSITION_ITEM_NAME = "__adbpos";
        return {
            upgradeGmStorage: function(settings, version) {
                return settings.personal = {}, settings.scriptVersion = version, settings.personalConfig = !0, 
                settings;
            },
            upgradeLocalStorage: function(settings, sitename) {
                var position = function() {
                    try {
                        if (userPosition = localStorage.getItem(Constants_BUTTON_POSITION_ITEM_NAME), userPosition) return protectedApi.json.parse(userPosition);
                    } catch (ex) {
                        return log.error(ex), null;
                    }
                }();
                return position && (settings.personal[sitename] || (settings.personal[sitename] = {}), 
                settings.personal[sitename].position = position, settings.personal[sitename].largeIcon = settings.largeIcon), 
                function() {
                    try {
                        localStorage.removeItem(Constants_BUTTON_POSITION_ITEM_NAME);
                    } catch (ex) {
                        return log.error(ex), null;
                    }
                }(), settings;
    ...
    }, balalaika = function(window, document, fn, nsRegAndEvents, id, s_EventListener, s_MatchesSelector, i, j, k, l, $) {
        return ($ = function(s, context) {
            return new $.i(s, context);
        }).i = function(s, context) {
            var st;
            s ? s.nodeType || s == window ? st = [ s ] : "string" == typeof s ? /</.test(s) ? ((i = document.createElement(context || "q")).innerHTML = s, 
            st = i.children) : st = (context && $(context)[0] || document).querySelectorAll(s) : st = /f/.test(typeof s) ? /c/.test(document.readyState) ? s() : $(document).on("DOMContentLoaded", s) : s : st = fn, 
            st = [].slice.call(st), fn.push.apply(this, st);
        }, $.i[l = "prototype"] = ($.extend = function(obj) {
            for (k = arguments, i = 1; i < k.length; i++) if (l = k[i]) for (j in l) obj[j] = l[j];
            return obj;
        })($.fn = $[l] = fn, {
            on: function(n, f) {
                return n = n.split(nsRegAndEvents), this.map((function(item) {
                    n.map((function(ev) {
                        item.addEventListener(ev, f);
                    }));
                })), this;
            },
            off: function(n, f) {
                return n = n.split(nsRegAndEvents), l = "removeEventListener", this.map((function(item) {
                    n.map((function(ev) {
                        item[l](ev, f);
                    }));
                })), this;
            ...
            is: function(s) {
                return ((i = this[0]).matches || i.webkitMatchesSelector || i.mozMatchesSelector || i.msMatchesSelector || i.oMatchesSelector).call(i, s);
            }
        }), $;
    }(window, window.document, [], /\.| /);
    balalaika.fn.hasClass = function(className) {
        return !!this[0] && null != this[0].classList && this[0].classList.contains(className);
        ...
        return this.forEach((function(item) {
            if (window.CustomEvent) var event = new CustomEvent(eventName, {
                detail: options
            }); else (event = document.createEvent("CustomEvent")).initCustomEvent(eventName, !0, !0, options);
            item.dispatchEvent(event);
        })), this;
    };
    var Settings = function(log, gmApi, UpgradeHelper, protectedApi) {
        var DefaultConfig = {
            buttonPositionTop: !1,
            ...
            scriptVersion: 2,
            personal: {}
        }, wotData = null, Config = null, adguardSettings = null, SITENAME = window.location.host, saveSettings = function(config) {
            config && (Config = config), log.debug("Update settings..."), log.debug(Config), 
            gmApi.setValue("settings", Config), CommonUtils.bypassCache();
            ...
            if (!settings) return log.error("Invalid settings object"), !1;
            for (var prop in settings) if (settings.hasOwnProperty(prop)) {
                var property = DefaultConfig[prop];
                if (property && typeof property != typeof settings[prop]) return log.error("Invalid settings object"), 
                !1;
            }
            return settings.scriptVersion > DefaultConfig.scriptVersion ? (log.error("Invalid settings object"), 
            !1) : (settings.scriptVersion < DefaultConfig.scriptVersion && (log.info("Settings object is outdated. Updating..."), 
        ...
        return {
            ...
            loadSettings: function(showButton) {
                log.debug("Trying to get settings"), getSettings().then((function(config) {
                    var checkedConfig = config && validateSettings(config);
                    checkedConfig ? (Config = checkedConfig, log.debug("Settings parsed successfully")) : (Config = DefaultConfig, 
                    log.debug("No settings found")), showButton();
                }));
            },
            getWotData: function() {
                return wotData;
            },
            setWotData: function(data) {
                wotData = data;
            },
            saveSettings: saveSettings,
            getUserPositionForButton: function() {
                var userPosition;
                return Config.personalConfig ? Config.personal && Config.personal[SITENAME] && (userPosition = Config.personal[SITENAME].position) : userPosition = Config.position, 
                userPosition || null;
            },
            getButtonSide: function() {
                var config = Config;
                return config.personalConfig && config.personal && config.personal[SITENAME] ? {
            ...
            setIconSize: function(smallIcon) {
                Config.personalConfig ? Config.personal[SITENAME].smallIcon = smallIcon : Config.smallIcon = smallIcon;
            },
            setUserPositionForButton: function(position) {
                Config.personalConfig ? (Config.personal[SITENAME] || (Config.personal[SITENAME] = {}), 
                Config.personal[SITENAME].position = position) : Config.position = position, saveSettings(Config);
            },
            setAdguardSettings: function(settings) {
                void 0 !== typeof settings ? adguardSettings = settings : log.info("No Adguard API Found");
            },
            setPersonalParam: function(personalConfig) {
                Config.personalConfig = personalConfig, Config.personalConfig && !Config.personal && (Config.personal = {}), 
                Config.personalConfig && !Config.personal[SITENAME] && (Config.personal[SITENAME] = {}, 
                Config.personal[SITENAME].position = Config.position), !Config.personalConfig && Config.personal && (Config.position = Config.personal[SITENAME] && Config.personal[SITENAME].position, 
                delete Config.personal);
            },
            setButtonSide: function(buttonSides) {
                Config.personalConfig ? (delete Config.personal[SITENAME].position, Config.personal[SITENAME].buttonPositionTop = buttonSides.top, 
                Config.personal[SITENAME].buttonPositionLeft = buttonSides.left) : (delete Config.position, 
                Config.buttonPositionTop = buttonSides.top, Config.buttonPositionLeft = buttonSides.left);
            },
            getAdguardSettings: function() {
                return adguardSettings;
            },
            getIconSize: function() {
                return Config.personalConfig && Config.personal && Config.personal[SITENAME] ? Config.personal[SITENAME].smallIcon : Config.smallIcon;
            },
            getPersonalConfig: function() {
                return Config.personalConfig;
            }
        };
    }, UIUtils = function($, protectedApi) {
        var elWidth, elHeight, windowWidth, windowHeight, storedAnchor = {}, outsidePosition = {
            top: function(pos) {
        ...
        }, moveElementTo = function(el, x, y) {
            var transform = "translate3d(" + x + "px," + y + "px, 0px)";
            el.style.webkitTransform = transform, el.style.mozTransform = transform, el.style.msTransform = transform, 
            el.style.oTransform = transform, el.style.transform = transform;
        }, getOriginalEvent = function(e) {
            return e.targetTouches ? e.targetTouches[0] : e;
        }, setAnchorPosition = {
            positionY: function(element, anchor) {
                storedAnchor.top = anchor, storedAnchor.top ? ($(element).addClass("adguard-assistant-button-top"), 
                $(element).removeClass("adguard-assistant-button-bottom")) : ($(element).addClass("adguard-assistant-button-bottom"), 
                $(element).removeClass("adguard-assistant-button-top"));
            },
            positionX: function(element, anchor) {
                storedAnchor.left = anchor, storedAnchor.left ? ($(element).addClass("adguard-assistant-button-left"), 
                $(element).removeClass("adguard-assistant-button-right")) : ($(element).addClass("adguard-assistant-button-right"), 
        ...
        return {
            makeElementDraggable: function(element, onDragEnd, onClick) {
                var coords, shiftX, shiftY, onMouseMove = function(e) {
                    pauseEvent(e), function(e) {
                        var position = {
                            x: getOriginalEvent(e).pageX - shiftX,
                            y: getOriginalEvent(e).pageY - shiftY
                        };
                        outsidePosition.top(position) || outsidePosition.left(position) || outsidePosition.bottom(position) || outsidePosition.right(position) ? onMouseUp(e, !0) : moveElementTo(element, position.x, position.y);
                    }(e);
                    ...
                    return e.stopPropagation(), e.preventDefault(), e.cancelBubble = !0, e.returnValue = !1, 
                    !1;
                }, preventedEvent = function(e) {
                    e.preventDefault();
                }, onMouseUp = function(e, doNotOpenIframe) {
                    e.stopPropagation(), CommonUtils.events.remove(document.documentElement, "wheel mousewheel", preventedEvent);
                    var lastX, lastY, lastCoords = getCoords(element), topHalf = lastCoords.top < windowHeight / 2, leftHalf = lastCoords.left < windowWidth / 2;
                    (setAnchorPosition.positionY(element, topHalf), setAnchorPosition.positionX(element, leftHalf), 
                    lastY = topHalf ? lastCoords.top : lastCoords.bottom - windowHeight, lastX = leftHalf ? lastCoords.left : lastCoords.right - windowWidth, 
                    moveElementTo(element, lastX, lastY), Math.abs(coords.left - lastCoords.left) > 5 || Math.abs(coords.top - lastCoords.top) > 5) ? onDragEnd && onDragEnd({
                        x: lastX,
                        y: lastY,
                        storedAnchor: storedAnchor
                    }) : onClick && !doNotOpenIframe && onClick(e);
                ...
                CommonUtils.events.add(element, "mousedown touchstart", protectedApi.functionBind.call((function(e) {
                    pauseEvent(e), CommonUtils.events.add(document.documentElement, "wheel mousewheel", preventedEvent), 
                    e.button > 0 || (elWidth = element.clientWidth, elHeight = element.clientWidth, 
                    windowWidth = getWindowSize().width, windowHeight = getWindowSize().height, coords = getCoords(element), 
                    shiftY = storedAnchor.top ? getOriginalEvent(e).pageY - coords.top : windowHeight - (coords.bottom - getOriginalEvent(e).pageY), 
                    shiftX = storedAnchor.left ? getOriginalEvent(e).pageX - coords.left : windowWidth - (coords.right - getOriginalEvent(e).pageX), 
                ...
                }), this)), CommonUtils.events.add(element, "dragstart", (function() {}));
            },
            makeIframeDraggable: function(iframe, handleElement) {
                var iframeDoc = iframe.contentDocument, offset = Object.create(null), cancelIFrameSelection = function(e) {
                    e.preventDefault(), e.stopPropagation();
                }, onMouseMove = function(e) {
                    var x, y, eventPosition = getOriginalEvent(e);
                    x = eventPosition.screenX + offset.x, y = eventPosition.screenY + offset.y, iframe.style.left = x + "px", 
                ...
                document.addEventListener("visibilitychange", onMouseUp), CommonUtils.events.add(handleElement, "mousedown touchstart", (function(e) {
                    var eventPosition = getOriginalEvent(e), rect = iframe.getBoundingClientRect();
                    offset.x = rect.left + handleElement.offsetLeft - eventPosition.screenX, offset.y = rect.top + handleElement.offsetTop - eventPosition.screenY, 
            ...
            checkElementPosition: function(element, pos) {
                windowWidth = getWindowSize().width, windowHeight = getWindowSize().height, elWidth = element.clientWidth, 
                elHeight = element.clientHeight, outsidePosition.top(pos) && (pos.y = windowHeight - 60), 
                outsidePosition.bottom(pos) && (pos.y = 60 - windowHeight), outsidePosition.left(pos) && (pos.x = windowWidth - 60), 
                outsidePosition.right(pos) && (pos.x = 60 - windowWidth), moveElementTo(element, pos.x, pos.y);
            }
        };
    }, UIValidationUtils = function(settings, log) {
        var document = window.document, getViewPort = function() {
            return {
        ...
        return {
            checkVisibleAreaSize: function() {
                var viewPort = getViewPort(), visibleAreaSize = viewPort.height > settings.Constants.MINIMUM_VISIBLE_HEIGHT_TO_SHOW_BUTTON;
                return visibleAreaSize || log.error("Viewport height is too small: " + viewPort.height), 
                visibleAreaSize;
            },
            validateBrowser: function() {
                ...
                return valid || log.error("IE version is " + document.documentMode), valid;
            },
            validatePage: function() {
                return window.window === window.top || (log.error("Page is iframe: " + window.location.href), 
                !1);
            },
            getViewPort: getViewPort
        };
    }, StringUtils_format = function(format) {
        for (var i = 1; i < arguments.length; i++) format = format.replace("{" + (i - 1) + "}", arguments[i]);
        return format;
    }, CommonUtils = {
        getParentsLevel: function(element) {
            for (var parent = element, parentArr = []; (parent = parent.parentNode) && "BODY" !== this.getNodeName(parent); ) parentArr.push(parent);
            return parentArr;
        },
        ...
        getAllChildren: function(element) {
            for (var childArray = [], child = element; child = this.getSingleChildren(child); ) childArray.push(child);
            return childArray;
        },
        getSingleChildren: function(element) {
            ...
            if (children) {
                var child, i, count = 0;
                for (i = 0; i < children.length; i++) 1 === children[i].nodeType && (child = children[i], 
                count++);
                return 1 === count ? child : null;
            }
        },
        ...
        bypassCache: function(callback) {
            ...
            xhr.open("GET", window.location.href, !0), xhr.setRequestHeader("Pragma", "no-cache"), 
            xhr.setRequestHeader("Expires", "-1"), xhr.setRequestHeader("Cache-Control", "no-cache"), 
            xhr.onreadystatechange = function() {
                4 === xhr.readyState && callback && callback();
            }, xhr.send();
        },
        objectAssign: function() {
            for (var from, to = {}, s = 0; s < arguments.length; s++) if (null != (from = Object(arguments[s]))) for (var key in from) hasOwnProperty.call(from, key) && (to[key] = from[key]);
            return to;
        },
        events: {
            add: function(elements, events, eventHandler, useCapture) {
                this.addRemoveEvents(!0, elements, events, eventHandler, useCapture);
            },
            remove: function(elements, events, eventHandler, useCapture) {
                this.addRemoveEvents(!1, elements, events, eventHandler, useCapture);
            },
            addRemoveEvents: function(add, elements, events, eventHandler, useCapture) {
                if (!elements || !events || !eventHandler) return !1;
                var eventList = events.split(" ");
                if (!eventList || eventList.length < 1) return !1;
                elements.length || (elements = new Array(elements));
                for (var el = 0; el < elements.length; el++) for (var evt = 0; evt < eventList.length; evt++) eventList[evt] && eventList[evt].length && (add ? elements[el].addEventListener(eventList[evt], eventHandler, !!useCapture) : elements[el].removeEventListener(eventList[evt], eventHandler, !!useCapture));
            }
        }
        ...
        return {
            ...
            notify: function(args) {
                for (var i = 0; i < listeners.length; i++) listeners[i](args);
            }
        };
    }, AdguardSelectorLib = function(api, $, protectedApi) {
        var selectionRenderer, placeholdedElements = null, transparentPlaceholdedElement = null, restrictedElements = null, IGNORED_CLASS = "adguard_sg_ignore", unbound = !0, onElementSelectedHandler = null, ignoreTouchEvent = 0, removeClassName = function(className) {
            $("." + className).removeClass(className);
        }, px = function(p) {
            return p + "px";
        }, getOffsetExtended = function(elem) {
            var bodyRect = document.documentElement.getBoundingClientRect(), elemRect = elem.getBoundingClientRect();
            return {
        ...
        }, BorderSelectionRenderer = function(api) {
            var BORDER_CSS = {
                position: "absolute",
                background: "white",
                margin: "0px",
            ...
            return api.init = function() {
                if (!borderTop) {
                    var width = px(5), bottomHeight = px(11);
                    ...
                    api.borderTop = borderTop[0], api.borderBottom = borderBottom[0], api.borderLeft = borderLeft[0], 
                    api.borderRight = borderRight[0], Object.keys(BORDER_CSS).forEach((function(item) {
                        borderTop[0].style[item] = BORDER_CSS[item], borderBottom[0].style[item] = BORDER_CSS[item], 
                        borderLeft[0].style[item] = BORDER_CSS[item], borderRight[0].style[item] = BORDER_CSS[item];
                    })), Object.keys(BORDER_BOTTOM_CSS).forEach((function(item) {
                        borderBottom[0].style[item] = BORDER_BOTTOM_CSS[item];
                    })), document.documentElement.appendChild(borderTop.get(0)), document.documentElement.appendChild(borderBottom.get(0)), 
                    document.documentElement.appendChild(borderLeft.get(0)), document.documentElement.appendChild(borderRight.get(0));
                }
            }, api.finalize = function() {
                !function() {
                    if (borderTop && borderTop.get(0)) {
                        var parent = borderTop.get(0).parentNode;
                        parent && (parent.removeChild(borderTop.get(0)), parent.removeChild(borderBottom.get(0)), 
                        parent.removeChild(borderLeft.get(0)), parent.removeChild(borderRight.get(0)));
                    }
                    borderTop = borderBottom = borderRight = borderLeft = null;
                }();
            }, api.add = function(element) {
                if (api.remove(), element) {
                    var p = getOffsetExtended(element), top = p.top, left = p.left, width = p.outerWidth, height = p.outerHeight;
                    borderTop.css("width", px(width + 4 + 10)).css("height", px(5)).css("top", px(top - 5 - 2)).css("left", px(left - 2 - 5)), 
                    borderBottom.css("width", px(width + 4 + 5)).css("height", px(12)).css("top", px(top + height + 2)).css("left", px(left - 2 - 5)), 
                    borderLeft.css("height", px(height + 4)).css("width", px(5)).css("top", px(top - 2)).css("left", px(left - 2 - 5)), 
                    borderRight.css("height", px(height + 4)).css("width", px(5)).css("top", px(top - 2)).css("left", px(left + width + 2)), 
                    borderBottom.get(0).textContent = function(element) {
                        return element.parentNode ? element.parentNode.tagName.toLowerCase() + " " + element.tagName.toLowerCase() : element.tagName.toLowerCase();
                    }(element), borderRight.get(0).target_elem = borderLeft.get(0).target_elem = borderTop.get(0).target_elem = borderBottom.get(0).target_elem = element, 
                    borderTop && borderBottom && borderLeft && borderRight && (borderTop.show(), borderBottom.show(), 
                    borderLeft.show(), borderRight.show());
                }
            }, api.remove = function() {
                borderTop && borderBottom && borderLeft && borderRight && (borderTop.hide(), borderBottom.hide(), 
                borderLeft.hide(), borderRight.hide());
            }, api;
        }(BorderSelectionRenderer || {}), linkHelper = protectedApi.createElement("a"), makePlaceholderImage = function(element) {
            var placeHolder = protectedApi.createElement("div"), style = window.getComputedStyle(element);
            placeHolder.style.height = style.height, placeHolder.style.width = style.width, 
            placeHolder.style.position = style.position, placeHolder.style.top = style.top, 
            placeHolder.style.bottom = style.bottom, placeHolder.style.left = style.left, placeHolder.style.right = style.right, 
            placeHolder.className += "adguard-placeholder " + IGNORED_CLASS;
            var icon = protectedApi.createElement("div");
            icon.className += "adguard-placeholder-icon " + IGNORED_CLASS;
            var url, domain = protectedApi.createElement("div");
            return domain.textContent = (url = element.src) ? (linkHelper.href = url, linkHelper.hostname) : "", 
            domain.className += "adguard-placeholder-domain " + IGNORED_CLASS, icon.appendChild(domain), 
            placeHolder.appendChild(icon), placeHolder;
        }, removePlaceholders = function() {
            if (removeElementToPreventEvents(), placeholdedElements) {
                for (var elements = placeholdedElements, i = 0; i < elements.length; i++) {
                    var current = elements[i], placeHolder = $("#" + ("adguard-placeholder" + i)).get(0);
                    if (placeHolder) {
                        var parent = placeHolder.parentNode;
                        parent && parent.replaceChild(current, placeHolder);
                    }
                }
                placeholdedElements = null;
            }
        }, placeholderClick = function(element) {
            selectionRenderer.remove(), removePlaceholders(), onElementSelectedHandler(element);
        }, removeElementToPreventEvents = function() {
            if (!transparentPlaceholdedElement) return !1;
        ...
        }, sgMouseoverHandler = function(e) {
            if (e.stopPropagation(), unbound) return !0;
            if (this == document.documentElement || this == document.documentElement.parentNode) return !1;
            var parent = function(element) {
                if ($(element).hasClass("adguard_sg_selected")) return element;
                for (;element.parentNode && (element = element.parentNode); ) if (-1 == restrictedElements.indexOf(element) && $(element).hasClass("adguard_sg_selected")) return element;
                return null;
            }(this);
            return null != parent && parent != this ? selectionRenderer.add(parent) : selectionRenderer.add(this), 
            !1;
        }, sgMouseoutHandler = function() {
            return !!unbound || (this == document.documentElement || this == document.documentElement.parentNode || selectionRenderer.remove(), 
            !1);
        }, sgMousedownHandler = function(e) {
            if (e && !1 === e.isTrusted) return !1;
            if ($(e.target).hasClass(IGNORED_CLASS)) return !1;
            if (e.preventDefault(), e.stopImmediatePropagation(), unbound) return !0;
            var elem = e.target;
            return (elem == selectionRenderer.borderTop[0] || elem == selectionRenderer.borderLeft[0] || elem == selectionRenderer.borderRight[0] || elem == selectionRenderer.borderBottom[0]) && (elem = elem.target_elem || elem), 
            elem != document.documentElement && elem != document.documentElement.parentNode ? (selectionRenderer.remove(), 
            onElementSelectedHandler(elem), !1) : void 0;
        }, touchElementSelectHandler = function(e) {
            e.preventDefault(), e.stopImmediatePropagation(), sgMouseoverHandler.call(this, e), 
            sgMousedownHandler.call(this, e);
        }, needIgnoreTouchEvent = function() {
            return ignoreTouchEvent > 0 && (ignoreTouchEvent--, !0);
        }, elementTouchendHandler = function(e) {
            return !$(e.target).hasClass(IGNORED_CLASS) && (e.stopPropagation(), !!needIgnoreTouchEvent() || (touchElementSelectHandler.call(this, e), 
            !1));
        }, emptyEventHandler = function(e) {
            return e.stopPropagation(), !1;
        }, gestureEndHandler = function() {
            return ignoreTouchEvent = 2, !0;
        }, touchMoveHandler = function() {
            return ignoreTouchEvent = 1, !0;
        }, setupEventHandlers = function() {
            !function() {
                for (var elements = placeholdedElements = $("iframe:not(.adguard_sg_ignore),embed,object").filter((function(elem) {
                    var isVisible = "none" != elem.style.display, isHaveSize = 0 != elem.offsetWidth && 0 != elem.offsetHeight;
                    return isVisible && isHaveSize;
                })), i = 0; i < elements.length; i++) !function(current) {
                    var placeHolder = makePlaceholderImage(current), id = "adguard-placeholder" + i;
                    placeHolder.setAttribute("id", id);
                    var parent = current.parentNode;
                    parent && (parent.replaceChild(placeHolder, current), $(placeHolder).on("gestureend", gestureEndHandler), 
                    $(placeHolder).on("touchmove", touchMoveHandler), $(placeHolder).on("touchend", (function(e) {
                        if (e.preventDefault(), needIgnoreTouchEvent()) return !0;
                        placeholderClick(current);
                    })), $("#" + id).on("click", (function(e) {
                        e.preventDefault(), placeholderClick(current);
                    })));
                }(elements[i]);
            }(), $("body *:not(.adguard_sg_ignore)").forEach((function(el) {
                el.addEventListener("gestureend", gestureEndHandler), el.addEventListener("touchmove", touchMoveHandler), 
                el.addEventListener("touchend", elementTouchendHandler, !0), el.addEventListener("touchstart", emptyEventHandler), 
                el.addEventListener("mouseover", sgMouseoverHandler), el.addEventListener("mouseout", sgMouseoutHandler), 
                el.addEventListener("click", sgMousedownHandler, !0);
            }));
        };
        return selectionRenderer = BorderSelectionRenderer, api.init = function(onElementSelected, selectionRenderImpl) {
            onElementSelectedHandler = onElementSelected, selectionRenderImpl && "object" == typeof selectionRenderImpl && (selectionRenderer = selectionRenderImpl), 
            restrictedElements = [ "html", "body", "head", "base" ].map((function(selector) {
                return $(selector).get(0);
            })), selectionRenderer.init(), setupEventHandlers(), unbound = !1;
        }, api.reset = function() {
            removeElementToPreventEvents(), [], [], removeClassName("adguard_sg_selected"), 
            removeClassName("adguard_sg_rejected"), selectionRenderer.remove();
        }, api.close = function() {
            unbound = !0, selectionRenderer.finalize(), removePlaceholders(), $("body *").forEach((function(el) {
                el.removeEventListener("gestureend", gestureEndHandler), el.removeEventListener("touchmove", touchMoveHandler), 
                el.removeEventListener("touchend", elementTouchendHandler, !0), el.removeEventListener("touchstart", emptyEventHandler), 
                el.removeEventListener("mouseover", sgMouseoverHandler), el.removeEventListener("mouseout", sgMouseoutHandler), 
                el.removeEventListener("click", sgMousedownHandler, !0);
            }));
        }, api.selectElement = function(element) {
            selectionRenderer.add(element), removePlaceholders(), unbound = !0, function(element) {
                var placeHolder = protectedApi.createElement("div"), style = getOffsetExtended(element);
                placeHolder.style.height = px(style.outerHeight), placeHolder.style.width = px(style.outerWidth), 
                placeHolder.style.top = px(style.top), placeHolder.style.left = px(style.left), 
                placeHolder.style.background = "transparent", placeHolder.style.position = "absolute", 
                placeHolder.style["pointer-events"] = "all", placeHolder.style["box-sizing"] = "content-box", 
                placeHolder.style["z-index"] = "2147483646", placeHolder.className += IGNORED_CLASS, 
                transparentPlaceholdedElement = placeHolder, $(placeHolder).on("click touchstart pointerdown", touchElementSelectHandler), 
                document.documentElement.appendChild(placeHolder);
            }(element);
        }, api.ignoreClassName = function() {
            return IGNORED_CLASS;
        }, api;
    }, AdguardRulesConstructorLib = function(api, protectedApi) {
        var URLBLOCK_ATTRIBUTES = [ "src", "data" ], linkHelper = protectedApi.createElement("a"), makeDefaultCssFilter = function(element, classList, excludeTagName, excludeId) {
            var cssSelector = excludeTagName ? "" : element.tagName.toLowerCase();
            return element.id && !excludeId && (cssSelector += "#" + cssEscape(element.id)), 
            cssSelector += constructClassCssSelectorByAND(classList || element.classList);
        }, makeCssNthChildFilter = function(element, options) {
            for (var classList = (options = options || {}).classList, excludeTagNameOverride = ("excludeTagName" in options), excludeTagName = options.excludeTagName, excludeIdOverride = ("excludeId" in options), excludeId = options.excludeId, path = [], el = element; el.parentNode; ) {
                if ("BODY" === (el && el.nodeName ? el.nodeName.toUpperCase() : "")) break;
                if (el.id) {
                    var cssSelector = "";
                    cssSelector = el === element ? makeDefaultCssFilter(el, classList || [], !excludeTagNameOverride || excludeTagName, !!excludeIdOverride && excludeId) : makeDefaultCssFilter(el, [], !0, !1), 
                    path.unshift(cssSelector);
                    break;
                }
                for (var c = 1, e = el; e.previousSibling; e = e.previousSibling) 1 === e.previousSibling.nodeType && c++;
                for (var ch, cldCount = 0, i = 0; el.parentNode && i < el.parentNode.childNodes.length; i++) cldCount += 1 === el.parentNode.childNodes[i].nodeType ? 1 : 0;
                if (ch = 0 === cldCount || 1 === cldCount ? "" : 1 === c ? ":first-child" : c === cldCount ? ":last-child" : ":nth-child(" + c + ")", 
                el === element) {
                    var p = makeDefaultCssFilter(el, classList, !!excludeTagNameOverride && excludeTagName, excludeId);
                    p += ch, path.unshift(p);
                } else path.unshift(makeDefaultCssFilter(el, el.classList, !1, !1) + ch);
                el = el.parentNode;
            }
            return path.join(" > ");
        }, constructCssRuleText = function(element, options) {
            if (element) {
                var selector;
                switch ((options = options || {}).cssSelectorType || "STRICT_FULL") {
                  case "STRICT_FULL":
                  ...
                  case "SIMILAR":
                    selector = function(element, classList) {
                        return constructClassCssSelectorByOR(classList || element.classList);
                    }(element, options.classList);
                }
                return selector ? "##" + selector : "";
            }
        }, getUrlBlockAttribute = function(element) {
            if (!element || !element.getAttribute) return null;
            for (var i = 0; i < URLBLOCK_ATTRIBUTES.length; i++) {
                var attr = URLBLOCK_ATTRIBUTES[i], value = element.getAttribute(attr);
                if (isValidUrl(value)) return value;
            }
            return null;
        }, haveUrlBlockParameter = function(element) {
            var value = getUrlBlockAttribute(element);
            return value && "" !== value;
        }, haveClassAttribute = function(element) {
            return element.classList && element.classList.length > 0;
        }, haveIdAttribute = function(element) {
            ...
            return !(!value || (linkHelper.href = value, !linkHelper.hostname));
        }, constructClassCssSelectorByAND = function(classList) {
            var selectors = [];
            if (classList) for (var i = 0; i < classList.length; i++) selectors.push("." + cssEscape(classList[i]));
            return selectors.join("");
        }, constructClassCssSelectorByOR = function(classList) {
            var selectors = [];
            if (classList) for (var i = 0; i < classList.length; i++) selectors.push("." + cssEscape(classList[i]));
            return selectors.join(", ");
        };
        return api.makeCssNthChildFilter = makeCssNthChildFilter, api.getElementInfo = function(element) {
            var attributes = [], elementAttributes = element.attributes;
            if (elementAttributes) for (var i = 0; i < elementAttributes.length; i++) {
            ...
            var index = ruleText.indexOf("##"), optionsIndex = ruleText.indexOf("$");
            if (index >= 0) return ruleText.substring(index + "##".length, optionsIndex >= 0 ? optionsIndex : ruleText.length);
            var s = ruleText.substring(0, optionsIndex);
            return s = s.replace(/[\|]|[\^]/g, ""), isValidUrl(s) ? '[src*="' + s + '"]' : null;
        }, api.constructRuleText = function(element, options) {
            var url, result, croppedDomain = (url = options.url, getUrl(url).host.replace("www.", "").replace(/:\d+/, "")), ruleType = options.ruleType;
            if ("URL" === ruleType) {
                var blockUrlRuleText = function(element, urlBlockAttribute, oneDomain, domain) {
                    if (!urlBlockAttribute) return null;
                    var blockUrlRuleText = urlBlockAttribute.replace(/^http:\/\/(www\.)?/, "||");
                    return 0 === blockUrlRuleText.indexOf(".") && (blockUrlRuleText = blockUrlRuleText.substring(1)), 
                    oneDomain || (blockUrlRuleText = blockUrlRuleText + "$domain=" + domain), blockUrlRuleText;
                }(0, options.urlMask, options.isBlockOneDomain, croppedDomain);
                if (blockUrlRuleText) return blockUrlRuleText;
            }
            return "CSS" === ruleType && (result = constructCssRuleText(element, options), options.attributes && (result = (result || "##" + result) + options.attributes)), 
            options.isBlockOneDomain || (result = croppedDomain + result), result;
        }, api;
    }, IframeController = function($, settings, uiUtils, gmApi, log, selector, uiValidationUtils, localization, protectedApi) {
        var iframe = null, iframeAnchor = null, currentItem = null, menuMaxWidth = 668, settingsMaxWidth = 458, buttonPosition = null, views = {};
        views[settings.MenuItemsNames.DetailedMenu] = HTML_detailed_menu, views[settings.MenuItemsNames.SelectorMenu] = HTML_selector_menu, 
        views[settings.MenuItemsNames.SliderMenu] = HTML_slider_menu, views[settings.MenuItemsNames.BlockPreview] = HTML_preview, 
        views[settings.MenuItemsNames.SettingsMenu] = HTML_settings_menu, window.innerWidth < menuMaxWidth && (menuMaxWidth = window.innerWidth), 
        window.innerWidth < settingsMaxWidth && (settingsMaxWidth = window.innerWidth);
        var onCloseMenu = new CustomEvent, onShowMenuItem = new CustomEvent, createShadowRootElement = function(iframeAnchor) {
            var shadowiframeAnchor = iframeAnchor.attachShadow({
                mode: "closed"
            }), stylesElement = protectedApi.createStylesElement(CSS_common + CSS_iframe, getStyleNonce());
            return shadowiframeAnchor.appendChild(stylesElement), shadowiframeAnchor;
        }, getStyleNonce = function() {
            var adgSettings = settings.getAdguardSettings();
            return null === adgSettings ? "" : adgSettings.nonce;
        }, showMenuItem = function(viewName, controller, width, height, options) {
            if (log.debug(StringUtils_format("Showing menu item: {0}", viewName)), currentItem !== viewName) {
                var onIframeLoad = function() {
                    var frameElement = iframe, view = protectedApi.createElement(views[viewName]), stylesElement = protectedApi.createStylesElement(CSS_common + CSS_button + CSS_iframe, getStyleNonce());
                    view.appendChild(stylesElement), appendContent(view), localize(), options || (options = {}), 
                    options.iframeAnchor = iframeAnchor, controller.init(frameElement, options), currentItem = viewName, 
                    onShowMenuItem.notify(), options.dragElement && uiUtils.makeIframeDraggable(iframe, iframe.contentDocument.querySelector(options.dragElement)), 
                    resizeIframe(width, height);
                    var viewPort, iframePosition = function() {
                        var viewPort = uiValidationUtils.getViewPort();
                        if (!buttonPosition) return {
                            left: iframe.offsetLeft <= 0 ? window.innerWidth : iframe.offsetLeft,
                            top: parseInt(iframe.style.top) || 20
                        };
                        for (var defaultPosition = {
                            left: buttonPosition.left,
                            top: buttonPosition.top
                        }, sides = [ {
                            left: buttonPosition.left - 320 - 20,
                            top: buttonPosition.top - 407 - 20
                        }, {
                            left: buttonPosition.left + 20,
                            checkLeft: buttonPosition.left + 320 + 20,
                            top: buttonPosition.top - 407 - 20
                        }, {
                            left: buttonPosition.left + 20,
                            checkLeft: buttonPosition.left + 320 + 20,
                            checkTop: buttonPosition.top + 407 + 20,
                            top: buttonPosition.top + 20
                        }, {
                            left: buttonPosition.left - 320 - 20,
                            checkTop: buttonPosition.top + 407 + 20,
                            top: buttonPosition.top + 20
                        } ], i = 0; i < sides.length; i++) {
                            var currentSide = sides[i], left = currentSide.checkLeft ? currentSide.checkLeft : currentSide.left, top = currentSide.checkTop ? currentSide.checkTop : currentSide.top;
                            if (!(left < 0 || left > viewPort.width || top < 0 || top > viewPort.height)) return currentSide;
                        }
                        return defaultPosition;
                    }();
                    iframe.style.left = iframePosition.left + "px", iframe.style.top = iframePosition.top + "px", 
                    viewPort = uiValidationUtils.getViewPort(), iframe.offsetLeft + iframe.offsetWidth > viewPort.width && (iframe.style.left = Math.max(0, viewPort.width - iframe.offsetWidth - 20) + "px"), 
                    iframe.offsetLeft < 0 && (iframe.style.left = "20px"), iframe.offsetTop + iframe.offsetHeight > viewPort.height && (iframe.style.top = Math.max(0, viewPort.height - iframe.offsetHeight - 20) + "px"), 
                    iframe.offsetHeight < 0 && (iframe.style.top = "20px");
                };
                if (!iframe) {
                    var adgStylesSelector = protectedApi.createStylesElement(CSS_selector, getStyleNonce(), "adg-styles-selector");
                    return adgStylesSelector && document.documentElement.appendChild(adgStylesSelector), 
                    void function(onIframeLoadCallback) {
                        log.debug("Creating iframe"), iframe = protectedApi.createElement("iframe"), navigator.userAgent.match(/msie/i) && (iframe.src = "javascript:'<script>window.onload=function(){document.write(\\'<script>document.domain=\\\"" + document.domain + "\\\";<\\\\/script>\\');document.close();};<\/script>'");
                        var attributes = {
                        ...
                        var iframeAlreadyLoaded = !1;
                        $(iframe).on("load", (function() {
                            iframeAlreadyLoaded || (iframeAlreadyLoaded = !0, onIframeLoadCallback());
                        })), protectedApi.checkShadowDomSupport() ? (iframeAnchor = protectedApi.createElement("div"), 
                        createShadowRootElement(iframeAnchor).appendChild(iframe)) : iframeAnchor = iframe, 
            ...
            for (var elements = iframe.contentDocument.querySelectorAll("[i18n]"), i = 0; i < elements.length; i++) {
            ...
            var frame = iframe;
            "auto" !== height && height || (height = frame.contentWindow.document.body.querySelector(".main").clientHeight || 407), 
            width && (frame.width = width, frame.style.setProperty("width", width + "px", "important")), 
            height && (frame.height = height, frame.style.setProperty("height", height + "px", "important"));
        }, appendContent = function(view) {
            for (var body = iframe.contentDocument.body, i = 0; i < body.children.length; i++) body.removeChild(body.children[i]);
            body.appendChild(view);
        }, setCloseEventIfNotHitIframe = function(setEvent) {
            document.removeEventListener("click", removeIframe), setEvent && window.setTimeout((function() {
                document.addEventListener("click", removeIframe);
            }), 150);
        }, removeIframe = function(e) {
            return (!e || !1 !== e.isTrusted) && (!!iframeAnchor && (document.removeEventListener("click", removeIframe), 
            document.documentElement.removeChild(iframeAnchor), iframe = null, iframeAnchor = null, 
            currentItem = null, selector.close(), void onCloseMenu.notify()));
        }, hideElementsByPath = function(selectedPath, styleID) {
            if (!selectedPath) return !1;
            var selector, style;
            if (!(selector = selectedPath.indexOf("://") > 0 ? '[src*="' + selectedPath.split("$domain=")[0] + '"]' : selectedPath.split("##")[1])) return log.error("Can`t block element: `selector` path is empty"), 
            !1;
            style = selector + "{display:none!important}", styleID || (styleID = "ag-hide-elements-style-id");
            var stylesElement = document.documentElement.querySelector("#" + styleID);
            stylesElement ? stylesElement.innerHTML = stylesElement.innerHTML + " " + style : document.documentElement.appendChild(protectedApi.createStylesElement(style, getStyleNonce(), styleID)), 
            iframeAnchor && iframeAnchor.style.setProperty("display", "block", "important");
        };
        return {
            showDetailedMenu: function() {
                var controller = Ioc.get(DetailedMenuController);
                showMenuItem(settings.MenuItemsNames.DetailedMenu, controller, 320, "auto", {
                    dragElement: ".menu-head"
                }), setCloseEventIfNotHitIframe(!0);
            },
            showSelectorMenu: function() {
                var controller = Ioc.get(SelectorMenuController);
                showMenuItem(settings.MenuItemsNames.SelectorMenu, controller, menuMaxWidth, 160, {
                    dragElement: ".head"
                }), setCloseEventIfNotHitIframe(!1);
            },
            showSliderMenu: function(initElement, currentElement, path, optionsState) {
                var controller = Ioc.get(SliderMenuController), options = {
                    element: initElement,
                    path: path,
                    dragElement: ".head",
            ...
            showBlockPreview: function(initElement, path, currentElement, optionsState) {
                var controller = Ioc.get(BlockPreviewController), options = {
                    element: initElement,
                    path: path,
                    dragElement: ".head",
                    currentElement: currentElement,
            ...
            showSettingsMenu: function() {
                ...
                showMenuItem(settings.MenuItemsNames.SettingsMenu, controller, 400, 468, {
                    dragElement: ".head"
                }), setCloseEventIfNotHitIframe(!0);
            },
            setButtonPosition: function(coords) {
                buttonPosition = coords;
            },
            onCloseMenu: onCloseMenu,
            onShowMenuItem: onShowMenuItem,
            removeIframe: removeIframe,
            resizeSliderMenuToAdvanced: function() {
                resizeIframe(null, null);
            },
            resizeSliderMenuToNormal: function() {
                resizeIframe(null, null);
            },
            resizeIframe: resizeIframe,
            hideElementsByPath: hideElementsByPath,
            showHiddenElements: function(styleID) {
                styleID || (styleID = "ag-hide-elements-style-id");
                var stylesElement = document.documentElement.querySelector("#" + styleID);
                stylesElement && stylesElement.parentNode.removeChild(stylesElement);
            },
            blockElement: function(path, addRule) {
                gmApi.ADG_addRule ? gmApi.ADG_addRule(path, (function() {
                    removeIframe(), hideElementsByPath(path), CommonUtils.bypassCache();
                })) : (addRule || log.error("Callback function `addRule` can't be undefined!"), 
                addRule(path), removeIframe(), hideElementsByPath(path), CommonUtils.bypassCache());
            }
        };
    }, SliderWidget = function(api, $, protectedApi) {
        var placeholder = null, min = 0, max = 1, value = 0, sliderArea = null, onValueChanged = null, refresh = function() {
            var handle = placeholder.querySelectorAll(".ui-slider-handle");
            $(handle).css("left", 100 * (value - 1) / (max - min) + "%");
            for (var ticks = placeholder.querySelectorAll(".tick"), i = 0; i < ticks.length; i++) i + 1 < value ? $(ticks[i]).css("background-color", "#36BA53") : $(ticks[i]).css("background-color", "#E0DFDB");
        }, setValue = function(v) {
            value = v < min ? min : v > max ? max : v, refresh(), onValueChanged(value);
        };
        return api.init = function(placeholderElement, options) {
            placeholder = placeholderElement, min = options.min, max = options.max, value = options.value, 
            onValueChanged = options.onValueChanged, sliderArea = options.sliderArea, function() {
                $(placeholder).addClass("adg-slide ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all");
                var handle = protectedApi.createElement("span");
                handle.setAttribute("class", "ui-slider-handle ui-state-default ui-corner-all"), 
                placeholder.appendChild(handle);
                for (var count = max - min, prepare = function(i) {
                    var tick = protectedApi.createElement("div");
                    tick.setAttribute("class", "tick ui-widget-content"), tick.style.left = 100 / count * i + "%", 
                    tick.style.width = 100 / count + "%", placeholder.appendChild(tick);
                }, i = 0; i < count; i++) prepare(i);
                refresh();
            }(), function() {
                var $placeholder = $(placeholder), handle = placeholder.querySelectorAll(".ui-slider-handle"), $sliderArea = ($(handle), 
                $(sliderArea));
                $(document).on("mouseup touchend pointerup", (function() {
                    $sliderArea.off("mousemove touchmove pointermove", onMouseMove);
                }));
                var rect = placeholder.getBoundingClientRect(), sliderWidth = rect.width, offsetLeft = rect.left + document.body.scrollLeft, getSliderValue = function(pageX) {
                ...
                $placeholder.on("click", (function(e) {
                    ...
                    e.stopPropagation(), e.preventDefault(), e.cancelBubble = !0, e.returnValue = !1, 
        ...
        var wotData = null, fireEvent = function(name, data) {
            var event = document.createEvent("Events");
            event.initEvent(name, !0, !0), event.data = data, document.dispatchEvent(event);
        };
        return {
            registerWotEventHandler: function() {
                document.addEventListener("wot-score", (function(e) {
                    wotData = e.data.wotData, fireEvent("wot-accepted", null);
                }));
            },
            getWotData: function() {
                return wotData;
            },
            getWotScorecardUrl: function(url) {
                return StringUtils_format("http://adguard.com/wot-scorecard.html?domain={0}", url);
            },
            WOT_URL: "http://adguard.com/wot.html"
        };
    }, Localization = function() {
        var locale, currentLocale = null, SupportedLocales = {
            en: en,
            ru: ru,
            uk: uk,
            pl: pl,
        ...
        if (locale = (locale = "undefined" != typeof AdguardSettings ? AdguardSettings.locale : void 0 !== navigator.languages ? navigator.languages[0] : navigator.language ? navigator.language : navigator.browserLanguage ? navigator.browserLanguage : "en").toLocaleLowerCase(), 
        SupportedLocales[locale]) currentLocale = locale; else {
            var langSplit = locale.split("-")[0];
            currentLocale = SupportedLocales[langSplit] ? langSplit : "en";
        }
        var processString = function(str, element) {
            var el, match1 = /^([^]*?)<(a|strong|span|i)([^>]*)>(.*?)<\/\2>([^]*)$/m.exec(str), match2 = /^([^]*?)<(br|input)([^>]*)\/?>([^]*)$/m.exec(str);
            match1 ? (processString(match1[1], element), el = createElement(match1[2], match1[3]), 
            processString(match1[4], el), element.appendChild(el), processString(match1[5], element)) : match2 ? (processString(match2[1], element), 
            el = createElement(match2[2], match2[3]), element.appendChild(el), processString(match2[4], element)) : element.appendChild(document.createTextNode(str.replace(/&nbsp;/g, " ")));
        }, createElement = function(tagName, attributes) {
            var el = protectedApi.createElement(tagName);
            if (!attributes) return el;
            for (var attrs = attributes.split(/([a-z]+='[^']+')/), i = 0; i < attrs.length; i++) {
                var attr = attrs[i].trim();
                if (attr) {
                    var attrName, attrValue, index = attr.indexOf("=");
                    index > 0 && (attrName = attr.substring(0, index), attrValue = attr.substring(index + 2, attr.length - 1)), 
                    attrName && attrValue && el.setAttribute(attrName, attrValue);
                }
            }
            return el;
        };
        return {
            getMessage: function(messageId) {
                return SupportedLocales[currentLocale][messageId] ? SupportedLocales[currentLocale][messageId].message || SupportedLocales[currentLocale][messageId] : messageId;
            },
            translateElement: function(element, message) {
                try {
                    for (;element.lastChild; ) element.removeChild(element.lastChild);
                    processString(message, element);
                } catch (ex) {}
            }
        };
    }, DetailedMenuController = function($, wot, localization, gmApi, settings, log, protectedApi) {
        var contentDocument = null, iframeCtrl = null, domain = null, setDomain = function() {
            domain = decodeURIComponent(location.hostname), contentDocument.getElementsByClassName("menu-head_name")[0].textContent = domain || "unknown";
        }, bindEvents = function() {
            var menuEvents = {
        ...
        }, onIsFilterChange = function() {
            var isFilter = contentDocument.getElementById("is-filter").checked;
            $(contentDocument.querySelectorAll(".menu-filter_label")).addClass("animate"), showHideBlockAdButton(isFilter), 
            setFilteringStateToStore(isFilter), gmApi.ADG_changeFilteringState(isFilter, (function() {
                CommonUtils.reloadPageBypassCache();
            }));
        }, setInitFilteringState = function() {
            var input = contentDocument.getElementById("is-filter");
            input.checked = getFilteringStateFromStore(), gmApi.ADG_isFiltered((function(isFiltered) {
                input.checked = isFiltered, setFilteringStateToStore(isFiltered), showHideBlockAdButton(isFiltered);
            }));
        }, setFilteringStateToStore = function(state) {
            try {
                localStorage.setItem("__adfstate", protectedApi.json.stringify({
                    state: state
                }));
            } catch (ex) {
                return log.error(ex), null;
            }
        }, getFilteringStateFromStore = function() {
            try {
                var state = localStorage.getItem("__adfstate");
                return !!state && protectedApi.json.parse(state).state;
            } catch (ex) {
                return log.error(ex), !1;
            }
            return !1;
        }, doNotBlock = function() {
        ...
        }, goToSiteReport = function() {
            var url = StringUtils_format(settings.Constants.REPORT_URL, domain);
            window.open(url, "_blank");
        }, setWotData = function() {
            var wotData = wot.getWotData(), wotReputationSettings = getWotReputationSettings(wotData);
            if (wotReputationSettings) {
                var wotIndication = $(contentDocument.getElementById("WotIndication")), wotDescriptionText = contentDocument.getElementById("WotDescriptionText"), confidenceIndication = $(contentDocument.getElementById("ConfidenceIndication"));
                ...
                wotDescriptionText.textContent = wotReputationSettings.text, wotDescriptionText.appendChild(wotLogo);
                var wotConfidenceClass = getWotConfidenceClass(wotData);
                confidenceIndication.addClass(wotConfidenceClass), $(contentDocument.getElementsByClassName("wot-hide")).removeClass("wot-hide");
            }
        }, goToWotUrl = function() {
            window.open(wot.WOT_URL, "_blank");
        }, getWotReputationSettings = function(wotData) {
            if (!wotData) return null;
            var averageWot = wotData.reputation;
            if (0 === averageWot) return {
                text: localization.getMessage("wot_unknown_description"),
                class: "adg-wot-unknown"
            };
            var current = {
                0: {
                    color: "red",
            ...
            }[truncateDecimals(averageWot / 20)];
            return {
                text: current.string,
                class: "adg-wot-" + current.color
            };
        }, truncateDecimals = function(number) {
            return Math[number < 0 ? "ceil" : "floor"](number);
        }, getWotConfidenceClass = function(wotData) {
            if (!wotData) return null;
            var prefix = "adg-wot-confidence-", confidenceWot = wotData.confidence;
            return confidenceWot >= 0 && confidenceWot < 6 ? prefix + "0" : confidenceWot >= 6 && confidenceWot < 12 ? prefix + "1" : confidenceWot >= 12 && confidenceWot < 23 ? prefix + "2" : confidenceWot >= 23 && confidenceWot < 34 ? prefix + "3" : confidenceWot >= 34 && confidenceWot < 45 ? prefix + "4" : confidenceWot >= 45 ? prefix + "5" : void 0;
        }, startAdSelector = function() {
            iframeCtrl.showSelectorMenu();
        }, showHideBlockAdButton = function(isFilter) {
            isFilter ? $(contentDocument.getElementById("block-ad")).removeClass("hidden") : $(contentDocument.getElementById("block-ad")).addClass("hidden"), 
            iframeCtrl.resizeIframe();
        };
        return {
            init: function(iframe) {
                contentDocument = iframe.contentDocument, iframeCtrl = Ioc.get("iframeController"), 
                setDomain(), setWotData(), bindEvents(), setInitFilteringState();
            }
        };
    }, SelectorMenuController = function($, selector) {
        var contentDocument = null, iframeCtrl = Ioc.get("iframeController"), close = function() {
            iframeCtrl.removeIframe();
        }, bindEvents = function() {
            var menuEvents = {
                ".close": close,
            ...
            selector.reset(), selector.init(onElementSelected);
        }, onElementSelected = function(element) {
            iframeCtrl.showSliderMenu(element);
        };
        return iframeCtrl.onCloseMenu.attach(selector.close), {
            init: function(iframe) {
                contentDocument = iframe.contentDocument, bindEvents(), startSelector();
            },
            startSelector: startSelector
        };
    }, SliderMenuController = function($, selector, sliderWidget, settings, adguardRulesConstructor, localization, gmApi, addRule) {
        var contentDocument = null, selectedElement = null, startElement = null, currentElement = null, iframeCtrl = Ioc.get("iframeController"), close = function() {
            iframeCtrl.removeIframe();
        }, bindEvents = function() {
            var menuEvents = {
                ".close": close,
        ...
        }, expandAdvanced = function() {
            !$(contentDocument.getElementById("adv-settings")).hasClass("open") ? ($(contentDocument.getElementById("adv-settings")).addClass("open"), 
            $(contentDocument.getElementById("ExtendedSettingsText")).addClass("active"), iframeCtrl.resizeSliderMenuToAdvanced()) : ($(contentDocument.getElementById("adv-settings")).removeClass("open"), 
        ...
        }, createSlider = function(setElement) {
            var parents = CommonUtils.getParentsLevel(selectedElement), children = CommonUtils.getAllChildren(selectedElement), value = Math.abs(parents.length + 1), max = parents.length + children.length + 1, options = {
                value: value,
                min: 1,
                max: max
            }, slider = contentDocument.getElementById("slider"), sliderArea = contentDocument.getElementById("slider-area");
            1 === max && ($(slider).hide(), $(contentDocument.getElementsByClassName("element-rule_text")).hide(), 
            expandAdvanced()), options.onSliderMove = function(delta) {
                var elem;
                delta > 0 && (elem = parents[delta - 1]), 0 === delta && (elem = startElement), 
                delta < 0 && (elem = children[Math.abs(delta + 1)]), onSliderMove(elem);
            };
            var currentVal = options.value;
            setElement && (currentVal = CommonUtils.getParentsLevel(setElement).length + 1);
        ...
        }, onSliderMove = function(element) {
            selectedElement = element, selector.selectElement(element), makeDefaultCheckboxesForDetailedMenu(), 
            onScopeChange(), handleShowBlockSettings(haveUrlBlockParameter(element), haveClassAttribute(element));
        }, makeDefaultCheckboxesForDetailedMenu = function(options) {
            ...
            options && (options.isBlockByUrl || options.isBlockSimilar) && handleShowBlockSettings(options.isBlockByUrl, options.isBlockSimilar);
        }, onScopeChange = function() {
            var isBlockByUrl = contentDocument.getElementById("block-by-url-checkbox").checked, isBlockSimilar = contentDocument.getElementById("block-similar-checkbox").checked, isBlockOneDomain = contentDocument.getElementById("one-domain-checkbox").checked;
            ...
            }, ruleText = adguardRulesConstructor.constructRuleText(selectedElement, options);
            setFilterRuleInputText(ruleText), iframeCtrl.resizeIframe();
        }, haveUrlBlockParameter = function(element) {
            var value = getUrlBlockAttribute(element);
            return value && "" !== value;
        }, getUrlBlockAttribute = function(element) {
            for (var urlBlockAttributes = [ "src", "data" ], i = 0; i < urlBlockAttributes.length; i++) {
                var attr = urlBlockAttributes[i], value = element.getAttribute(attr);
                if (value) return value;
            }
            return null;
        }, haveClassAttribute = function(element) {
            var className = element.className;
            return className && "string" == typeof className && "" !== className.trim();
        }, handleShowBlockSettings = function(showBlockByUrl, showBlockSimilar) {
            var blockByUrlBlock = $(contentDocument.getElementById("block-by-url-checkbox-block")), blockSimilarBlock = $(contentDocument.getElementById("block-similar-checkbox-block"));
            showBlockByUrl ? blockByUrlBlock.show() : (contentDocument.getElementById("block-by-url-checkbox").checked = !1, 
            blockByUrlBlock.hide()), showBlockSimilar ? blockSimilarBlock.show() : (contentDocument.getElementById("block-similar-checkbox").checked = !1, 
            blockSimilarBlock.hide());
        }, setFilterRuleInputText = function(ruleText) {
            contentDocument.getElementById("filter-rule").value = ruleText;
        }, getFilterRuleInputText = function() {
            return contentDocument.getElementById("filter-rule").value;
        };
        return {
            init: function(iframe, options) {
                selectedElement = options.element, startElement = selectedElement, contentDocument = iframe.contentDocument, 
                currentElement = options.currentElement, bindEvents(), createSlider(currentElement), 
                onScopeChange(), selector.selectElement(selectedElement), currentElement && onSliderMove(currentElement), 
                CommonUtils.events.add(contentDocument.getElementById("filter-rule"), "contextmenu", (function(e) {
                    e.stopPropagation();
                })), options.path && (setFilterRuleInputText(options.path), expandAdvanced()), options.options && makeDefaultCheckboxesForDetailedMenu(options.options);
            }
        };
    }, SliderMenuControllerMobile = function($, selector, adguardRulesConstructor, localization, addRule) {
        var parents, children, contentDocument = null, selectedElement = null, iframeCtrl = Ioc.get("iframeController"), nodeParentsCount = 0, nodeChildsCount = 0, nodeNumber = 0, plus = function() {
            nodeNumber + 1 > nodeParentsCount ? nodeNumber = nodeNumber : nodeNumber++, nodeNumber >= 0 ? parents[nodeNumber] && onSliderMove(parents[nodeNumber]) : children[~nodeNumber] && onSliderMove(children[~nodeNumber]);
        }, minus = function() {
            nodeNumber <= -nodeChildsCount ? nodeNumber = nodeNumber : nodeNumber--, nodeNumber >= 0 ? parents[nodeNumber] && onSliderMove(parents[nodeNumber]) : children[~nodeNumber] && onSliderMove(children[~nodeNumber]);
        }, bindEvents = function() {
            var menuEvents = {
            ...
            selectedElement.classList.remove("sg_hide_element"), selectedElement.style.display = "none", 
            addRule(getFilterText()), iframeCtrl.removeIframe();
        }, showPreview = function() {
            selector.reset(), this.classList.contains("active") ? (selectedElement.classList.remove("sg_hide_element"), 
            this.classList.remove("active"), selector.selectElement(selectedElement), contentDocument.querySelector(".adg-plus").removeAttribute("disabled"), 
            contentDocument.querySelector(".adg-minus").removeAttribute("disabled"), contentDocument.querySelector(".adg-close").removeAttribute("disabled")) : (selectedElement.classList.add("sg_hide_element"), 
            this.classList.add("active"), contentDocument.querySelector(".adg-plus").setAttribute("disabled", "disabled"), 
            ...
            selectedElement = element, selector.selectElement(element);
        ...
        return {
            init: function(iframe, options) {
                selectedElement = options.element, contentDocument = iframe.contentDocument, bindEvents(), 
                selector.selectElement(selectedElement), children = CommonUtils.getAllChildren(selectedElement), 
                (parents = CommonUtils.getParentsLevel(selectedElement)).splice(0, 0, selectedElement), 
                nodeParentsCount = parents.length, nodeChildsCount = children.length;
            }
        };
    }, BlockPreviewController = function($, selector, gmApi, addRule) {
        var contentDocument = null, selectedElement = null, selectedPath = null, optionsState = null, iframeCtrl = Ioc.get("iframeController"), close = function() {
            showElement(), iframeCtrl.removeIframe();
        }, bindEvents = function() {
            var menuEvents = {
                ".close": close,
            ...
            selectedPath ? iframeCtrl.hideElementsByPath(selectedPath, "ag-preview-style-id") : log.error("Can`t block element: `selector` path is empty");
        }, showElement = function() {
            iframeCtrl.showHiddenElements("ag-preview-style-id");
        }, selectAnotherElement = function() {
            showElement(), iframeCtrl.showSelectorMenu();
        }, blockElement = function() {
            iframeCtrl.blockElement(selectedPath, addRule);
        }, showDetailedMenu = function() {
            showElement(), iframeCtrl.showSliderMenu(currentElement, selectedElement, selectedPath, optionsState);
        };
        return {
            init: function(iframe, options) {
                selectedElement = options.element, selectedPath = options.path, currentElement = options.currentElement, 
                contentDocument = iframe.contentDocument, options.iframeAnchor, optionsState = options.options, 
                selector.reset(), bindEvents(), hideElement();
            }
        };
    }, SettingsMenuController = function($, settings, button) {
        var contentDocument = null, iframeCtrl = Ioc.get("iframeController"), buttonSides = {
            ...
            var personalConfig, smallIcon, sideItem;
            personalConfig = contentDocument.getElementById("this-site").checked, settings.setPersonalParam(personalConfig), 
            smallIcon = contentDocument.getElementById("size-small").checked, settings.setIconSize(smallIcon), 
            sideItem = null, Object.keys(buttonSides).forEach((function(item) {
                contentDocument.getElementById(item).checked && (sideItem = item);
            })), sideItem && settings.setButtonSide(buttonSides[sideItem]), settings.saveSettings(), 
            close(), button.remove(), button.show();
        }, setDefaultSettings = function() {
            if (settings.getIconSize() ? contentDocument.getElementById("size-small").checked = !0 : contentDocument.getElementById("size-big").checked = !0, 
            settings.getPersonalConfig() ? contentDocument.getElementById("this-site").checked = !0 : contentDocument.getElementById("all-site").checked = !0, 
            !settings.getUserPositionForButton()) {
                var sideFromSettings = settings.getButtonSide();
                Object.keys(buttonSides).forEach((function(item) {
                    var sideItem = buttonSides[item];
                    sideItem.left === sideFromSettings.left && sideItem.top === sideFromSettings.top && (contentDocument.getElementById(item).checked = !0);
                }));
            }
        };
        return {
            init: function(iframe) {
                contentDocument = iframe.contentDocument, bindEvents(), setDefaultSettings();
            }
        };
    }, IframeControllerMobile = function($, log, selector, localization, protectedApi) {
        var iframe = null, iframeElement = null, currentItem = null, onCloseMenu = new CustomEvent, onShowMenuItem = new CustomEvent, views = {};
        views["mobilePopup.html"] = HTML_popup, views["mobileMenu.html"] = HTML_mobile_menu;
        var defaultCSS = {
            clip: "auto",
            "z-index": 2147483647
        }, defaultAttributes = {
        ...
        }, updateIframeAttrs = function(attrs) {
            iframe.removeAttribute("style"), iframe.removeAttribute("height");
            var attributes = CommonUtils.objectAssign(defaultAttributes, attrs);
            Object.keys(attributes).forEach((function(item) {
                iframe.setAttribute(item, attributes[item]);
            }));
        }, updateIframeStyles = function(styles) {
            var css = CommonUtils.objectAssign(defaultCSS, styles);
            Object.keys(css).forEach((function(item) {
                iframe.style[item] = css[item];
            }));
        }, showMenuItem = function(viewName, controller, options, styles, attrs) {
            if (currentItem !== viewName) {
                var onIframeLoad = function() {
                    var frameElement = iframe, view = protectedApi.createElement(views[viewName]), iframeStyles = CSS_common + CSS_mobile;
                    view.appendChild(protectedApi.createStylesElement(iframeStyles)), appendContent(view), 
                    localize(), options || (options = {}), controller && controller.init(frameElement, options), 
                    updateIframeAttrs(attrs), updateIframeStyles(styles), currentItem = viewName, onShowMenuItem.notify(), 
                    showIframe();
                };
                if (!iframe) {
                    var adgStylesSelector = protectedApi.createStylesElement(CSS_selector, "adg-styles-selector");
                    return adgStylesSelector && document.documentElement.appendChild(adgStylesSelector), 
                    void function(onIframeLoadCallback, styles, attrs) {
                        if (log.debug("Creating iframe"), document.querySelector("#" + defaultAttributes.id)) log.error("Iframe already added"); else {
                            iframe = protectedApi.createElement("iframe"), $(iframe).on("load", (function() {
                                onIframeLoadCallback(), updateIframeAttrs(attrs), updateIframeStyles(styles);
                            })), iframeElement = iframe;
                            var adgStylesSelector = protectedApi.createStylesElement(CSS_selector, "adg-styles-selector");
                            adgStylesSelector && document.documentElement.appendChild(adgStylesSelector), document.documentElement.appendChild(iframeElement);
                        }
                    }(onIframeLoad, styles, attrs);
                }
                onIframeLoad();
            }
        }, hideIframe = function() {
            ...
            hideIframe(), selector.close();
            showMenuItem("mobilePopup.html", {
                init: function() {
                    var startSelectMode = iframe.contentDocument.querySelector(".start-select-mode"), cancelSelectMode = iframe.contentDocument.querySelector(".cancel-select-mode");
                    startSelectMode.addEventListener("click", startSelect), cancelSelectMode.addEventListener("click", removeIframe);
                }
            }, null, {
                position: "fixed",
                left: 0,
            ...
            hideIframe(), Ioc.get(SelectorMenuController).startSelector();
        }, localize = function() {
            for (var elements = iframe.contentDocument.querySelectorAll("[i18n]"), i = 0; i < elements.length; i++) {
                var message = localization.getMessage(elements[i].getAttribute("i18n"));
                localization.translateElement(elements[i], message);
            }
            for (var elementsWithTitle = iframe.contentDocument.querySelectorAll("[i18n-title]"), j = 0; j < elementsWithTitle.length; j++) {
            ...
            return (!e || !1 !== e.isTrusted) && (!!iframeElement && (document.removeEventListener("click", removeIframe), 
            window.removeEventListener("orientationchange", showSelectorMenu), document.documentElement.removeChild(iframeElement), 
            iframe = null, iframeElement = null, currentItem = null, selector.close(), void onCloseMenu.notify()));
        };
        return {
            showSelectorMenu: showSelectorMenu,
            showSliderMenu: function(element) {
                var controller = Ioc.get(SliderMenuControllerMobile);
                showMenuItem("mobileMenu.html", controller, {
                    element: element
                }, {
                    position: "fixed",
                    bottom: 0,
    ...
    /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) ? this.adguardAssistant = function() {
        Ioc.register("protectedApi", new ProtectedApi);
        var protectedApiCtrl = Ioc.get(ProtectedApi);
        Ioc.register("log", new Log), Ioc.register("$", balalaika), Ioc.register("selector", new AdguardSelectorLib({}, balalaika, protectedApiCtrl)), 
        Ioc.register("uiUtils", Ioc.get(UIUtils)), Ioc.register("localization", Ioc.get(Localization)), 
        ...
        return Ioc.register("iframeController", iframeController), {
            start: function(element, callback) {
                Ioc.register("addRule", protectedApiCtrl.functionBind.call(callback, this)), element ? (iframeController.showSelectorMenu(), 
                iframeController.showSliderMenu(element)) : iframeController.showSelectorMenu();
            },
            close: function() {
        ...
        Ioc.register("protectedApi", new ProtectedApi), Ioc.register("log", new Log), Ioc.register("UpgradeHelper", new UpgradeHelper(Ioc.get(Log), Ioc.get(ProtectedApi)));
        var protectedApiCtrl = Ioc.get(ProtectedApi);
        Ioc.register("gmApi", (function() {
            return !1;
        }));
        var adguardSettings = "undefined" == typeof AdguardSettings ? null : AdguardSettings, wot = new Wot;
        wot.registerWotEventHandler(), Ioc.register("wot", wot);
        var settings = Ioc.get(Settings);
        settings.setAdguardSettings(adguardSettings), Ioc.register("settings", settings), 
        Ioc.register("uiValidationUtils", Ioc.get(UIValidationUtils)), Ioc.register("$", balalaika), 
        ...
        return Ioc.register("iframeController", iframe), {
            start: function(element, callback) {
                Ioc.register("addRule", protectedApiCtrl.functionBind.call(callback, this)), element ? (iframe.showSelectorMenu(), 
                iframe.showSliderMenu(element)) : iframe.showSelectorMenu();
            },
            close: function() {
                iframe.removeIframe();
            }
