var notAllowedContentTypes=["application/xml","application/xhtml+xml","text/xml","image/svg+xml","application/rss+xml","application/atom+xml",""];try{notAllowedContentTypes.includes(document.contentType)||
